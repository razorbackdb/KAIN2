...

{
  ...
  local_c = local_c & 0xffff0000 |
            (u_int)(u_short)(((gameTrackerX.playerInstance)->position).z + 0x1c0);
...

{
  ...
  if (*(short *)((int)pvVar6 + 0x98) != *(short *)((int)pvVar6 + 0x96))
  {
    ...
    if ((int)uVar4 < iVar3)
    {
      ...
      *(u_short *)((int)pvVar6 + 0x96) = uVar1 & 0xfff;
    }
    else
    {
    ...
    if (6 < iVar7)
    {
      ...
      if (iVar7 == 0x1000)
      {
             ...
             iVar7 <= (int)uVar2))
        {
          ...
          DRAW_CreateAGlowingCircle(&local_38, 0x140, gameTrackerX.primPool, gameTrackerX.drawOT, 5, 0x1404040, 0x1a, 0x18, 0);
        }
        iVar7 = (int)*(short *)((int)pvVar6 + 0x90);
      }
      (int)glyphtunedata->glyph_darkness;
...

{
  ...
  {
    iVar1 = (u_int) * (u_short *)((int)pvVar3 + 0x90) - ((gameTrackerX.timeMult << 9) >> 0xc);
  ...
  do
  {
    ...
    else
    {
      if (puVar6 == (undefined *)0x10000002)
      {
        ...
        if (iVar4 != 0)
        {
          vol = CAMERA_AngleDifference(*(short *)((int)pvVar7 + 0x96), *(short *)((int)pvVar7 + 0x98));
          if ((int)((u_int)vol << 0x10) < 0)
          {
            sVar2 = CAMERA_AngleDifference(*(short *)((int)pvVar7 + 0x96), *(short *)((int)pvVar7 + 0x98));
            if (-(int)sVar2 < 0x40)
              goto LAB_8007b054;
          }
          else
...

{
  ...
  else
  {
    ...
    {
      if ((u_int)(u_short)HUD_State - 10 < 2)
      {
        HUD_State = 0xc;
      }
    }
...
LAB_8007beb4:
  ...
  if (-0x40 < MANNA_Position)
  {
    ...
    FONT_Flush();
    FONT_SetCursor((short)(((u_int)(u_short)MANNA_Position + 0x3a) * 0x10000 >> 0x10), 0x20);
    if (glyph_cost != -1)
    {
      ");
    }
