...

{
  return (u_int)(data->distance <
                 (u_int) * (u_short *)(*(int *)(*(int *)((int)instance->extraData + 0x164) + 4) + 0xc));
}
...

{
  ...
  p_Var5->mirFlags = p_Var5->mirFlags | (u_short)flags;
    ...
    if ((uVar1 & 0x20) == 0)
    {
      if (*(char *)((int)puVar4 + 0x15e) != '\0')
      {
        ...
        if (((uVar1 & *(u_int *)(*(int *)(puVar4[0x59] + 0xc) + 4)) != 0) &&
            (data->distance < (u_int) * (u_short *)(*(int *)(puVar4[0x59] + 4) + 0x10)))
        {
          flags = flags | 2;
        }
  ...
  if (*(char *)((int)pvVar5 + 0x15e) != '\0')
  {
    ...
    while (puVar3 = puVar6, puVar3 != (u_char *)0x0)
    {
      ...
      if ((puVar3[2] == *(int *)(puVar3[1] + 0x10)) &&
          (((*(u_short *)((int)puVar3 + 0x16) & 0xe0) != 0 ||
            (uVar4 = MON_GetAnim(instance), uVar4 <= (u_int)puVar3[7]))))
      {
        *(u_char **)puVar3 = puVar2;
        *(u_short *)((int)puVar3 + 0x16) = *(u_short *)((int)puVar3 + 0x16) & 0xff1f;
        puVar2 = puVar3;
...

{
  ...
  if (p_Var2 == (_MonsterIR *)0x0)
  {
    ...
    uVar5 = (u_int)(u_short)(instance->rotation).z & 0xfff;
    if (0x800 < uVar5)
    {
      uVar5 = uVar5 - 0x1000;
    }
    uVar4 = (u_int)(u_short)(newenemy->rotation).z & 0xfff;
    iVar3 = uVar5 - uVar4;
    if (0x800 < uVar4)
    {
  ...
  while (Data != (int *)0x0)
  {
    if (((_Instance *)Data[1])->instanceID == Data[2])
    {
      if ((*(u_short *)((int)Data + 0x16) & 1) != 0)
      {
        ...
        if ((*(u_short *)((int)Data + 0x16) & 0x100) != 0)
        {
      ...
      if (((*(u_short *)((int)Data + 0x16) & 0x10) != 0) &&
          ((piVar3 == (int *)0x0 || (*(short *)(Data + 5) < *(short *)((int)piVar3 + 0x14)))))
      {
        piVar3 = Data;
      }
      if (((*(u_short *)((int)Data + 0x16) & 2) != 0) &&
          ((piVar4 == (int *)0x0 || (*(short *)(Data + 5) < *(short *)((int)piVar4 + 0x14)))))
      {
        piVar4 = Data;
      }
      *(u_short *)((int)Data + 0x16) = *(u_short *)((int)Data + 0x16) & 0xfeff;
    }
    Data = (int *)*Data;
  }
  if ((piVar7 == (int *)0x0) ||
...

{
  ...
  LAB_800868d4:
    *(u_int *)((int)pvVar3 + 0xe0) = *(u_int *)((int)pvVar3 + 0xe0) & ~(1 << (uVar4 & 0x1f));
    if ((local_50.type == 3) &&
        ((*(u_short *)((int)((local_50.inst)->node).prev[9].prev + (int)local_50.segment * 0x24 + 0x12) & 2) !=
         0))
    {
        ...
        ((*(u_short *)((int)pvVar6 + 8) & 0x40) != 0))
    {
      ...
      if ((iVar3 < 400) &&
          (x = MATH3D_LengthXYZ((int)(p_Var7->position).x - (int)(instance->position).x,
           ...
           x < (int)((u_int) * (u_short *)((int)pvVar6 + 0x1e) + 0x500)))
      {
        sVar1 = MATH3D_AngleFromPosToPos(&instance->position, &p_Var7->position);
        sVar2 = MATH3D_FastAtan2((u_int) * (u_short *)((int)pvVar6 + 0x1e), x);
