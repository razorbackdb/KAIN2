...
/* File: C:\kain2\game\MONSTER\MONSENSE.C */
...

{
  ...
  p_Var1 = MONSENSE_FindIR((_MonsterVars *)instance->extraData,DAT_800d20f8);
...

{
  ...
  if ((undefined *)(uVar7 & 0x208000) == &DAT_00208000) {
...

{
  ...
  p_Var2->mirFlags = p_Var2->mirFlags | 1;
LAB_80086380:
  if ((mv->enemy == (_MonsterIR *)0x0) || (newenemy == DAT_800d20f8)) {
    mv->enemy = p_Var2;
  }
  return p_Var2;
}
...

{
  ...
  *(_MonsterVars **)(&monsterSenseArray + iVar1) = mv;
...

{
  ...
  gNumMonsters = gNumMonsters + -1;
  iVar3 = (int)*(char *)((int)instance->extraData + 0x15f);
  if (iVar3 < gNumMonsters) {
    do {
      iVar2 = iVar3 + 1;
      iVar1 = *(int *)(&monsterSenseArray + iVar2 * 4);
      *(int *)(&monsterSenseArray + iVar3 * 4) = iVar1;
      *(undefined *)(iVar1 + 0x15f) = (char)iVar3;
      iVar3 = iVar2;
...

{
  ...
  uVar5 = (uint)(byte)(&radarDirIndex)[*(int *)((int)pvVar4 + 0xe4)];
  iVar2 = uVar5 * 6;
  local_60.vx = (instance->position).x + *(short *)(&radarDir_2 + iVar2);
  local_60.vy = (instance->position).y + *(short *)(&DAT_800d089c + iVar2);
  ...
  if (local_50.type == 0) {
    local_58.vx = (instance->position).x + *(short *)(&radarDir_2 + iVar2);
    local_58.vy = (instance->position).y + *(short *)(&DAT_800d089c + iVar2);
    ...
    *(uint *)((int)pvVar4 + 0xe0) = *(uint *)((int)pvVar4 + 0xe0) | 1 << (uVar5 & 0x1f);
    uVar1 = 0x500;
  }
  else {
LAB_800868d4:
    *(uint *)((int)pvVar4 + 0xe0) = *(uint *)((int)pvVar4 + 0xe0) & ~(1 << (uVar5 & 0x1f));
    if ((local_50.type == 3) &&
       ((*(ushort *)
        ...
        0)) {
      *(undefined2 *)((int)pvVar4 + uVar5 * 2 + 0xe8) = 0;
      goto LAB_80086960;
    }
  ...
  *(undefined2 *)((int)pvVar4 + uVar5 * 2 + 0xe8) = uVar1;
LAB_80086960:
  uVar5 = *(int *)((int)pvVar4 + 0xe4) + 1;
  *(uint *)((int)pvVar4 + 0xe4) = uVar5;
  if (7 < uVar5) {
...

{
  ...
  if (lastSenseFrame < DAT_800d21f8) {
    if (lastSenseFrame < DAT_800d21f8 + -1) {
      memset();
      lastSenseFrame = DAT_800d21f8 + -1;
    }
    DAT_800d08d0 = 0;
  }
  if ((DAT_800d08d0 == 0) && (monsterSensed[*(char *)((int)pvVar1 + 0x15f)] == '\0')) {
    lastSenseFrame = DAT_800d21f8;
