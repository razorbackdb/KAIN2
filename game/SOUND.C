...

{
  ...
  do {
    if (((SoundEffectChannel *)pSVar1)->inUse == '\0') {
      ((SoundEffectChannel *)pSVar1)->inUse = -1;
      ((SoundEffectChannel *)pSVar1)->pitchChangeTime = 0;
      ((SoundEffectChannel *)pSVar1)->volumeChangeTime = 0;
      *channelNum = (uchar)iVar2;
      return (SoundEffectChannel *)pSVar1;
    }
    iVar2 = iVar2 + 1;
    pSVar1 = (SoundEffectChannel *)((SoundEffectChannel *)pSVar1 + 1);
  } while (iVar2 < 0x10);
...

{
  ...
  return (SoundEffectChannel *)(soundEffectChannelTbl + channelNum);
}
...

{
  ...
  if ((((DAT_800d223e != 6) && (sfxFileData != (uchar *)0x0)) &&
...

{
  ...
  spectralPlane = (int)DAT_800d20d6;
...

{
  ...
  if (bVar4 == 1) {
    ...
    iVar2 = isOkayToPlaySound((uint)sound->flags,(int)DAT_800d20d6,hidden);
    if (iVar2 == 0) {
LAB_8004041c:
...

{
  ...
  if ((DAT_800d108c == 5) && ((DAT_800d220c & 0x10) != 0)) {
    sVar1 = position->z;
    x = (int)position->x - (int)theCamera;
    y = (int)position->y - (int)DAT_800d0f9e;
    sVar2 = DAT_800d0fa0;
  }
  else {
    x = (int)position->x - (int)*(short *)(DAT_800d10a4 + 0x5c);
    sVar1 = position->z;
    sVar2 = *(short *)(DAT_800d10a4 + 0x60);
    y = (int)position->y - (int)*(short *)(DAT_800d10a4 + 0x5e);
  }
  lVar3 = MATH3D_FastSqrt0(x * x + y * y + ((int)sVar1 - (int)sVar2) * ((int)sVar1 - (int)sVar2));
  if (minVolDist < lVar3) {
    return 0;
  }
  y = ratan2(y,x);
  x = (minVolDist - lVar3) / (minVolDist / maxVolume);
  vol = (ushort)x;
  uVar6 = (int)DAT_800d1050 - (y + 0x400);
...
LAB_80040718:
  ...
  if (x < 0x40) {
    pan = 0x3f - (short)((uint)((0x3f - x) * minVolDist) >> 8);
  }
  else {
    pan = (short)((uint)((x + -0x40) * minVolDist) >> 8) + 0x40;
  }
...
{
  if (newVolume == -1) {
    newVolume = DAT_800d2284;
  }
  DAT_800d2284 = newVolume;
...
{
  if (newVolume == -1) {
    newVolume = DAT_800d2288;
  }
  DAT_800d2288 = newVolume;
...
{
  if (newVolume == -1) {
    newVolume = _DAT_800d228c;
  }
  _DAT_800d228c = newVolume;
  return;
}
...

{
  ...
  if (slot == 0) {
    ...
    if (iVar1 == 0) {
      aadStartSlot(0);
      sprintf(acStack80,s__kain2_music__s__s_snd_800cfcac,userData,userData);
      sprintf(acStack48,s__kain2_music__s__s_smp_800cfcc4,userData,userData);
  ...
  if ((((iVar2 == 0) && (musicLoadInProgress == 0)) && (DAT_800d2291 != '\0')) &&
    ...
    if (reqMusicStartPlaneShift == 0) {
      if (pLVar3->dynamicMusicName == (char *)0x0) {
        ...
        if (iVar2 != 0) {
          if (currentDynamicSoundName[0] == '\0') {
            sprintf((char *)&local_50,s__kain2_music__s__s_snd_800cfcac,&local_58,&local_58);
            sprintf((char *)&local_30,s__kain2_music__s__s_smp_800cfcc4,&local_58,&local_58);
            ...
            strcpy();
            local_50 = DAT_800cfd14;
            local_4c = DAT_800cfd18;
            local_48 = DAT_800cfd1c;
            local_44 = DAT_800cfd20;
            local_40 = DAT_800cfd24;
            local_3c = DAT_800cfd28;
            local_38 = DAT_800cfd2c;
            local_36 = DAT_800cfd2e;
            local_30 = DAT_800cfd30;
            local_2c = DAT_800cfd34;
            local_28 = DAT_800cfd38;
            local_24 = DAT_800cfd3c;
            local_20 = DAT_800cfd40;
            local_1c = DAT_800cfd44;
            local_18 = DAT_800cfd48;
            local_16 = DAT_800cfd4a;
            aadLoadDynamicSoundBank
