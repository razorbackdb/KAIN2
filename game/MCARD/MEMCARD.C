...
/* File: C:\kain2\game\MCARD\MEMCARD.C */
...

{
  ...
  if ((DAT_800d220c & 0x8000000) == 0) {
    ...
    loadAddr = (Object *)(DAT_800d210c + 0xc);
  }
  LOAD_LoadToAddress(s__kain2_object_mcardx_mcardx_drm_80012364,loadAddr,1);
...

{
  ...
  if (address != (Object *)0x0) {
    if (address != (Object *)(DAT_800d210c + 0xc)) {
...

{
  ...
  if (memcard->table == (mcmenu_table_t *)0x0) {
    ...
    memcard->mcmenu = (mcmenu_t *)&gMcmenu;
...
{
  DAT_800d2210 = DAT_800d2210 | 0x1000000;
  MAIN_StartGame();
  memcard_end(DAT_800d20f0);
  return;
}
...
{
  if (flags == 0) {
    menu_item(DAT_800d20ec,(TDRFuncPtr_menu_item1fn)fn,parameter,text);
  }
  else {
    menu_item_flags(DAT_800d20ec,(TDRFuncPtr_menu_item_flags1fn)fn,parameter,flags,text);
  }
  return;
}
