...

{
  ...
  do {
    ...
    if (((((Inst->flags2 & 0x80U) == 0) && ((Inst->object->oflags & 0x10000U) == 0)) &&
      ...
      DAT_1f800000._0_2_ = (Inst->position).x - theCamera;
      iVar5 = (uint)(ushort)(Inst->position).y - (uint)DAT_800d0f9e;
      DAT_1f800000._2_2_ = (undefined2)iVar5;
      iVar5 = iVar5 * 0x10000 >> 0x10;
      iVar4 = (uint)(ushort)(Inst->position).z - (uint)DAT_800d0fa0;
...

{
  ...
  do {
    iVar4 = iVar4 + 1;
    if ((_Instance *)puVar2[3] == instance) {
      puVar2[3] = 0;
      return;
    }
    puVar2 = puVar2 + 5;
...

{
  ...
  instance = INSTANCE_NewInstance(DAT_800d2100);
  ...
  *(undefined4 *)&(instance->rotation).z = uVar10;
  ...
  INSTANCE_InsertInstanceGroup(DAT_800d2100,instance);
...

{
  ...
  while (p_Var1 != (_Instance *)0x0) {
    if ((((DAT_800d223e != 6) || ((p_Var1->object->oflags & 0x20000U) != 0)) &&
        (((DAT_800d2210 & 0x100000) == 0 || ((p_Var1->object->oflags & 0x40000U) != 0)))) &&
       ((p_Var1->additionalCollideFunc != (_func_3 *)0x0 && ((p_Var1->flags2 & 0x24000000U) == 0))))
    {
      DAT_800d2314 = DAT_800d2318;
      if ((p_Var1->object != (Object *)0x0) &&
         (((p_Var1->object->oflags2 & 0x2000000U) != 0 &&
          (DAT_800d2314 = DAT_800d2320, (p_Var1->flags2 & 0x8000000U) != 0)))) {
        DAT_800d2314 = DAT_800d231c;
      }
  ...
  if ((DAT_800d218c & 0x8000010) == 0) {
    ...
    while (Inst != (_Instance *)0x0) {
      ...
      if ((((Inst->intro == (Intro *)0x0) || ((Inst->intro->flags & 0x100U) == 0)) &&
          ((DAT_800d223e != 6 || ((Inst->object->oflags & 0x20000U) != 0)))) &&
         ((((DAT_800d2210 & 0x100000) == 0 || ((Inst->object->oflags & 0x40000U) != 0)) &&
        ...
        if ((((hidden & 0x100000) == 0) &&
          ...
          if (Inst->splineFlags == 0) {
            ...
            if ((Inst->splineFlags & 1U) != 0) {
              if ((DAT_800d2190 & 0x400000) != 0) {
                printf(s_Spline__s_ld_playto__d_preveFram_800cf598,Inst->introName,Inst->introNum,
                       (int)Inst->targetFrame,lVar7,lVar9,lVar8,iVar12);
              }
...
LAB_800334d8:
            ...
            if ((Inst->splineFlags & 2U) != 0) {
              if ((DAT_800d2190 & 0x400000) != 0) {
                FONT_Print(s_Spline__s_d___clip__d__d__prevFr_800cf5e8);
              }
              if (uVar13 == 1) {
...
LAB_80033644:
        ...
        if (Inst->processFunc != (_func_1 *)0x0) {
          if ((Inst->flags2 & 1U) == 0) {
            ...
            INSTANCE_DeactivatedProcess(Inst,(GameTracker *)&gameTrackerX);
          }
        }
...

{
  ...
  if ((object == (Object *)0x0) ||
     (instance = INSTANCE_NewInstance(DAT_800d2100), instance == (_Instance *)0x0)) {
    ...
    *(undefined4 *)&(instance->scale).z = uVar6;
    ...
    do {
      ...
      if (iVar3 <= iVar7) goto LAB_80033a2c;
      iVar7 = iVar7 + 1;
...

{
  ...
  p_Var3 = *(_Instance **)(DAT_800d2100 + 4);
      ...
      if ((lVar5 == 0) ||
        ...
        if (instance != (_Instance *)0x0) {
          ...
          *(undefined4 *)&instance->oldPos = *(undefined4 *)&instance->position;
          ...
          uVar10 = (uint)savedIntro->shiftedSaveSize * 4;
          if (0x20 < uVar10) {
...

{
  ...
  while (Inst_00 != (_Instance *)0x0) {
    if ((Inst_00->flags2 & 0x10000401U) == 0x400) {
      uVar3 = Inst_00->checkMask;
      m0 = (MATRIX *)INSTANCE_Query(Inst_00,0xd);
      INSTANCE_Post(Inst_00,0x200000,0);
      if (m0 != (MATRIX *)0x0) {
        TransposeMatrix(m0,&MStack80);
        Inst = instanceList->first;
        while (Inst != (_Instance *)0x0) {
          if (((((Inst != Inst_00) && ((Inst->flags2 & 0x10000000U) == 0)) &&
               ((Inst->flags & 0x20U) == 0)) &&
              ((uVar1 = INSTANCE_Query(Inst,1), (uVar1 & uVar3) != 0 &&
               ((m0 = (MATRIX *)INSTANCE_Query(Inst,0xe), m0 != (MATRIX *)0x0 ||
                (m0 = Inst->matrix, m0 != (MATRIX *)0x0)))))) &&
             (iVar2 = INSTANCE_SetStatsData(Inst_00,Inst,(_Vector *)m0->t,&eStack48,0xb0),
             iVar2 != 0)) {
            INSTANCE_Post(Inst_00,(int)&DAT_00200001,(int)&eStack48);
          }
          Inst = Inst->next;
        }
      }
...
int INSTANCE_SetStatsData
              ...
              evCollideInstanceStatsData *data,undefined1 mat)

{
  ...
  if (bVar1) {
    ...
    ApplyMatrixSV(_mat,(SVECTOR *)&DAT_1f800000,(SVECTOR *)&data->relativePosition);
