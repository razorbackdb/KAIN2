...

{
  ...
  {
  LAB_80091b3c:
    G2AnimSection_InterpToKeylistAtTime(section, keylist, keylistID, targetTime);
  }
  else
  {
    ...
    {
      p_Var6 = _G2Anim_FreeInterpStateBlockList(section);
      ...
      G2AnimSection_ClearAlarm(section, 0);
    }
    else
    {
      _G2AnimSection_SegValueToQuat(section);
    }
    ...
    G2AnimSection_ClearAlarm(section, 1);
    p_Var6 = p_Var9->stateBlockList;
    iVar5 = 4;
    p_Var4 = p_Var6->quatInfo;
    if ((u_short)(p_Var6->quatInfo[0].destTrans.z |
 ...
 (int)p_Var5->duration);
  ...
  if (bVar1 != 0)
  {
    ...
    do
    {
      ...
      *(u_char *)&p_Var6->rotQuat = local_30;
      *(u_char *)(puVar7 + -9) = local_2c;
      setCopReg(2, 0xc800, (u_int)(u_short)(quatA->srcScale).x);
      setCopReg(2, 0xd000, (u_int)(u_short)(quatA->srcScale).y);
      setCopReg(2, 0xd800, (u_int)(u_short)(quatA->srcScale).z);
      setCopReg(2, 0x4800, (u_int)(u_short)(quatA->destScale).x);
      setCopReg(2, 0x5000, (u_int)(u_short)(quatA->destScale).y);
      setCopReg(2, 0x5800, (u_int)(u_short)(quatA->destScale).z);
      ...
      setCopReg(2, 0xc800, (u_int)(u_short)(quatA->srcTrans).x);
      setCopReg(2, 0xd000, (u_int)(u_short)(quatA->srcTrans).y);
      setCopReg(2, 0xd800, (u_int)(u_short)(quatA->srcTrans).z);
      setCopReg(2, 0x4800, (u_int)(u_short)(quatA->destTrans).x);
      setCopReg(2, 0x5000, (u_int)(u_short)(quatA->destTrans).y);
      setCopReg(2, 0x5800, (u_int)(u_short)(quatA->destTrans).z);
      setCopReg(2, 0x4000, ratio);
      copFunction(2, 0x1a8003e);
      uVar2 = getCopReg(2, 0xc800);
      uVar3 = getCopReg(2, 0xd000);
...
void _G2AnimSection_SegValueToQuat(_G2AnimSection_Type *section)
 ...
 (int)p_Var5->duration);
  ...
  if (bVar1 != 0)
  {
    do
    {
      ...
      *(u_char *)&(quatA->srcQuat).z = local_24;
      *(u_char *)&quatA->srcQuat = local_28;
      setCopReg(2, 0xc800, (u_int)(u_short)(quatA->srcScale).x);
      setCopReg(2, 0xd000, (u_int)(u_short)(quatA->srcScale).y);
      setCopReg(2, 0xd800, (u_int)(u_short)(quatA->srcScale).z);
      setCopReg(2, 0x4800, (u_int)(u_short)(quatA->destScale).x);
...
void G2AnimSection_ClearAlarm(_G2AnimSection_Type *section, int zeroOne)

{
  ...
  if (section->segCount != 0)
  {
    ...
    do
    {
      local_28 = *(u_short *)&p_Var3->rotQuat & 0xfff;
      local_26 = psVar2[-9] & 0xfff;
      local_22 = 0;
      local_24 = psVar2[-8] & 0xfff;
      if (zeroOne == 0)
      {
        G2Quat_ToEuler((int)p_Var1, (short *)&local_28);
      ...
      {
        G2Quat_ToEuler((int)&p_Var1->destQuat, (short *)&local_28);
...
_G2AnimInterpStateBlock_Type *_G2Anim_FreeInterpStateBlockList(_G2AnimSection_Type *section)
...
void _G2Anim_AllocateInterpStateBlockList(_G2AnimInterpStateBlock_Type *block)

{
  ...
  if (block != (_G2AnimInterpStateBlock_Type *)0x0)
  {
    ...
    {
      p_Var1 = block->next;
      G2PoolMem_InitPool(&_interpStateBlockPool, block);
      block = p_Var1;
    } while (p_Var1 != (_G2AnimInterpStateBlock_Type *)0x0);
  }
  return;
