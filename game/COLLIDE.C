...
LAB_8001e5c0:
  ...
  iVar7 = (int)sVar2;
  puVar13 = &DAT_1f800008;
  puVar15 = &DAT_1f800000;
  bVar8 = (int)((uint)uVar3 << 0x10) <= (int)((uint)uVar1 << 0x10);
  do {
    iVar14 = (int)*(short *)((int)puVar15 + 2);
    if (bVar8 == iVar9 <= iVar14) {
      bVar6 = bVar5;
      if ((bVar8 != false) && (iVar9 == (int)*(short *)((int)puVar13 + 2))) {
        if (iVar9 == iVar14) {
          iVar10 = (int)*(short *)puVar15;
          if ((int)*(short *)puVar13 < iVar7 != iVar10 < iVar7) {
            return 1;
          }
          if (iVar7 == (int)*(short *)puVar13) {
            return 1;
          }
        }
        else {
          iVar10 = (int)*(short *)puVar13;
        }
        if (iVar7 == iVar10) {
          return 1;
        }
      ...
      if (iVar7 <= iVar10 == iVar7 <= iVar12) {
        ...
        iVar11 = *(short *)((int)puVar13 + 2) - iVar14;
        iVar10 = (iVar12 - iVar7) * iVar11 - (iVar14 - iVar9) * (iVar10 - iVar12);
        if (iVar11 < 0) {
          iVar10 = -iVar10;
        }
        if (iVar10 < 1) {
...

{
  ...
  local_10 = DAT_800cf348;
  local_c = PTR_DAT_800cf34c;
...

{
  ...
  DAT_1f800024 = (int)(short)-(short)(DAT_1f800000 * DAT_1f800018 - DAT_1f800008 * _DAT_1f800010 >>
                                     0xc);
  iVar2 = DAT_1f800024;
  if (DAT_1f800024 < 0) {
    iVar2 = -DAT_1f800024;
  ...
  DAT_1f800028 = (DAT_1f800000 * DAT_1f800014 - DAT_1f800004 * _DAT_1f800010) * 0x10 >> 0x10;
  if (iVar2 < iVar4) {
    iVar2 = iVar4;
  }
  iVar4 = DAT_1f800028;
...
void COLLIDE_UpdateAllTransforms(_Instance *instance,undefined offset)

{
  ...
  psVar7 = (short *)CONCAT31(in_register_00000015,offset);
  if (instance->matrix != (MATRIX *)0x0) {
    sVar1 = *psVar7;
    pOVar8 = instance->object;
    sVar2 = psVar7[1];
    sVar3 = psVar7[2];
    if ((pOVar8->animList == (_G2AnimKeylist_Type **)0x0) || ((pOVar8->oflags2 & 0x40000000U) != 0))
    {
      ...
      iVar4 = pOVar8->modelList[instance->currentModel]->numSegments + 1;
    }
    piVar6 = pMVar5->t + 2;
    while (iVar4 != 0) {
      iVar4 = iVar4 + -1;
...

{
  ...
  local_40.y = 0;
  local_40.z = 0;
  collide_point0 = (_SVector *)point0;
  collide_point1 = (_SVector *)point1;
  collide_normal0 = (_SVector *)normal0;
  collide_normal1 = (_SVector *)normal1;
...

{
  ...
  DAT_1f8000a4._0_2_ = (short)DAT_1f800080 - pSVar12->vx;
  DAT_1f8000a4._2_2_ = DAT_1f800080._2_2_ - pSVar12->vy;
  DAT_1f8000a8._0_2_ = (short)DAT_1f800084 - pSVar12->vz;
  p_Var14 = (_BSPNode *)&DAT_1f8000ac;
  if (DAT_800d20d4 == 1000) {
    DAT_1f800094 = (int)DAT_800d20d6;
    if (DAT_1f800094 != 1) {
      DAT_1f800094 = 0;
    }
  }
              ...
              if (p_Var6 != p_Var14) {
                do {
                  ...
                  if ((*(ushort *)(iVar11 + 0xe) & 2) == 0) {
                    ...
                    _DAT_1f800058 = _DAT_1f800058 - *(int *)(iVar11 + 0x10);
                    ...
                    if (DAT_1f80005c < (int)sVar2 + 5) {
                      if ((int)sVar3 + -5 < DAT_1f80005c) {
                        if (_DAT_1f800058 < DAT_1f80005c) goto LAB_8001fb50;
                        ...
                        if (((int)sVar3 + -5 <= _DAT_1f800058) && (*(int *)(iVar11 + 0x14) != 0)) {
                          *(int *)&(p_Var13->sphere).position = *(int *)(iVar11 + 0x14);
                          p_Var14 = p_Var13;
                        }
                        iVar11 = *(int *)(iVar11 + 0x18);
...
LAB_8001fb50:
                              ...
                              if (((*pbVar15 & _DAT_1f80006c) == 0) ||
                                ...
                                if ((DAT_1f800094 == 2) &&
                                  ...
                                  if (iVar11 < 0) {
                                    ...
                                    _DAT_1f800054 =
                                         _DAT_1f800054 & 0xffff0000 | (uint)(ushort)-p_Var8->z;
                                  }
                                  else {
                                    _DAT_1f800050 =
                                         *(uint *)(&DAT_1f800098->x + iVar11 * 3) & 0xffff1fff;
                                    _DAT_1f800054 =
                                         _DAT_1f800054 & 0xffff0000 |
                                ...
                                setCopReg(2,in_at,_DAT_1f800054);
                                copFunction(2,0x486012);
                                _DAT_1f800058 = getCopReg(2,0x19);
                                DAT_1f80005c = getCopReg(2,0x1a);
                                _DAT_1f800060 = getCopReg(2,0x1b);
                                _DAT_1f800058 = _DAT_1f800058 - _DAT_1f800060;
                                DAT_1f80005c = DAT_1f80005c - _DAT_1f800060;
                                if (((_DAT_1f800058 < 0) && (-1 < DAT_1f80005c)) ||
                                   (((DAT_1f800088 & 1) != 0 &&
                                    ((0 < _DAT_1f800058 && (DAT_1f80005c < 1)))))) {
                                  if (_DAT_1f800058 - DAT_1f80005c == 0) {
                                    iVar11 = 0;
                                  }
                                  else {
                                    iVar11 = (DAT_1f80005c * 0x1000) /
                                             (_DAT_1f800058 - DAT_1f80005c);
                                  }
                                  _DAT_1f800064 =
                                       CONCAT22(DAT_1f800080._2_2_ +
                                                (short)(DAT_1f8000a4._2_2_ * iVar11 >> 0xc),
                                                (short)DAT_1f800080 +
                                                (short)((short)DAT_1f8000a4 * iVar11 >> 0xc));
                                  _DAT_1f800068 =
                                       _DAT_1f800068 & 0xffff0000 |
                                       (uint)(ushort)((short)DAT_1f800084 +
                                                     (short)((short)DAT_1f8000a8 * iVar11 >> 0xc));
                                  ...
                                  if (iVar11 != 0) {
                                    if ((((_DAT_1f800074 != (short *)0x0) &&
                                         ((DAT_1f800088 & 1) != 0)) && (0 < _DAT_1f800058)) &&
                                       (DAT_1f80005c < 1)) {
                                      *_DAT_1f800074 = 1;
                                    }
                                    if ((*pbVar15 & 8) == 0) {
                                      if (((*(ushort *)(pbVar15 + 4) == 0xffff) ||
                                        ...
                                        DAT_1f8000a4._0_2_ = (short)DAT_1f800080 - DAT_1f800078;
                                        DAT_1f8000a4._2_2_ = DAT_1f800080._2_2_ - DAT_1f80007a;
                                        DAT_1f8000a8._0_2_ = (short)DAT_1f800084 - DAT_1f80007c;
                                        DAT_1f8000a0 = tface;
          ...
          if (((uVar9 & 0x100) == 0) || (DAT_800d22ec != '\0')) {
            cVar1 = DAT_800d22ed;
...

{
  ...
  DAT_1f80004e = v0->y;
  DAT_1f800050 = v0->z;
  SetRotMatrix((MATRIX *)&DAT_1f800040);
  setCopReg(2,in_zero,_DAT_1f800074);
    ...
    if ((DAT_1f800080 < DAT_1f800084) && (-1 < DAT_1f800084)) {
      ...
      if (iVar3 != 0) {
        ...
        *(undefined4 *)&newPos->z = DAT_1f800094;
        hfNormal->x = DAT_1f800074;
        hfNormal->y = DAT_1f800076;
        iVar2 = 1;
...

{
  ...
  local_54 = (VECTOR *)&DAT_1f800130;
  local_50 = (VECTOR *)&DAT_1f800150;
  local_4c = (VECTOR *)&DAT_1f800160;
  local_48 = (_SVector *)&DAT_1f8001a0;
  local_44 = (uint *)&DAT_1f8001b0;
  local_40 = (long *)&DAT_1f8001c0;
  ...
  if (local_34 != 0) {
    ...
    do {
      if (((local_38->hpFlags & 1) != 0) && ((local_38->hpFlags & 8) != 0)) {
        ...
        PIPE3D_InvertTransform((char)local_58,(char)local_5c);
        DAT_1f800114 = local_5c->t[0];
        DAT_1f800118 = local_5c->t[1];
        DAT_1f80011c = local_5c->t[2];
        TransposeMatrix(local_58,(MATRIX *)&DAT_1f800100);
        SetRotMatrix(local_58);
        SetTransMatrix(local_58);
        RotTrans(pcollideInfo->newPoint,(VECTOR *)&DAT_1f800190,local_40);
        RotTrans(pcollideInfo->oldPoint,local_54,local_40);
        sVar2 = *(short *)&local_54->vy;
        sVar3 = *(short *)&local_54->vz;
        local_48->x = *(short *)&local_54->vx;
        local_48->y = sVar2;
        local_48->z = sVar3;
        ...
        if (bVar1 == 2) {
          ...
          iVar8 = COLLIDE_PointAndHFace
                            ((_SVector *)&DAT_1f8001a8,local_48,hface,local_3c,
                             (_SVector *)&SStack136);
          if (iVar8 != 0) {
            ApplyMatrixSV((MATRIX *)&DAT_1f800100,&SStack136,&pcollideInfo->wNormal);
          ...
          if (bVar1 < 3) {
            if (((bVar1 == 1) && (puVar10 = *(uint **)(pbVar11 + 1), (*puVar10 & 0x2000) != 0)) &&
              ...
              if ((uint)(DAT_1f800180 * DAT_1f800180 + DAT_1f800184 * DAT_1f800184 +
                ...
                if (iVar9 != 0) {
                  ...
                  local_50->vx = (DAT_1f800180 << 0xc) / iVar8;
                  local_50->vy = iVar7 / iVar8;
                  local_50->vz = iVar5 / iVar8;
                  ...
                  SetRotMatrix((MATRIX *)&DAT_1f800100);
                  SetTransMatrix(local_5c);
                  RotTrans((SVECTOR *)&DAT_1f8001a8,(VECTOR *)&DAT_1f800190,local_40);
                  ApplyMatrixLV((MATRIX *)&DAT_1f800100,local_50,local_4c);
                  pcollideInfo->newPoint->vx = DAT_1f800190;
                  pcollideInfo->newPoint->vy = DAT_1f800194;
                  pcollideInfo->newPoint->vz = DAT_1f800198;
                  (pcollideInfo->wNormal).vx = *(short *)&local_4c->vx;
                  (pcollideInfo->wNormal).vy = *(short *)&local_4c->vy;
                  sVar2 = *(short *)&local_4c->vz;
                  pcollideInfo->type = (ushort)bVar1;
            ...
            if ((bVar1 == 5) && (hbox = *(_HBox **)(pbVar11 + 1), (hbox->flags & 0x2000U) != 0)) {
              ...
              lVar6 = COLLIDE_IntersectLineAndBox
                                (local_2c,(_SVector *)&SStack136,&_Stack120,&_Stack112,
                                 (_SVector *)&DAT_1f8001a8,local_48,hbox);
              if (lVar6 != 0) {
...

{
  ...
  local_74 = (VECTOR *)&DAT_1f800168;
  local_70 = (VECTOR *)&DAT_1f800188;
  local_6c = (VECTOR *)&DAT_1f800198;
  local_68 = (undefined4 *)&DAT_1f8001a8;
  local_64 = (_Position *)&DAT_1f8001bc;
  local_60 = (SVECTOR *)&DAT_1f8001e0;
  local_5c = &DAT_1f8001ec;
  local_58 = (SVECTOR *)&DAT_1f8001f8;
  local_54 = &DAT_1f800204;
  local_50 = (_HFaceInfo *)&DAT_1f800240;
  p_Var11 = instance1->hModelList + instance1->currentModel;
  if (((instance1->hModelList != (_HModel *)0x0) && (instance2->hModelList != (_HModel *)0x0)) &&
    ...
    local_38 = p_Var11->numHPrims;
    local_40 = p_Var11->hPrimList;
    if (local_38 != 0) {
      local_30 = &lStack152;
      ...
      do {
        if (((local_40->hpFlags & 1) != 0) &&
          ...
          m = instance1->oldMatrix;
          p_Var14 = *(_HBox **)(local_2c + 1);
          SetRotMatrix(local_4c);
          SetTransMatrix(local_4c);
          RotTrans((SVECTOR *)&p_Var14->minZ,local_74,local_30);
          sVar10 = *(short *)&local_74->vy;
          sVar2 = *(short *)&local_74->vz;
          local_60->vx = *(short *)&local_74->vx;
          local_60->vy = sVar10;
          local_60->vz = sVar2;
          SetRotMatrix(m + bVar1);
          SetTransMatrix(m + bVar1);
          RotTrans((SVECTOR *)&p_Var14->minZ,local_74,local_30);
          sVar10 = *(short *)&local_74->vy;
          sVar2 = *(short *)&local_74->vz;
          local_58->vx = *(short *)&local_74->vx;
          local_58->vy = sVar10;
          local_58->vz = sVar2;
          local_34 = local_44->numHPrims;
          local_3c = local_44->hPrimList;
          if (local_34 != 0) {
            pbVar13 = &local_3c->segment;
            do {
              if (((local_3c->hpFlags & 1) != 0) && ((local_3c->hpFlags & 4) != 0)) {
                local_48 = instance2->matrix + *pbVar13;
                m = instance2->oldMatrix + *pbVar13;
                if ((pbVar13[-1] == 1) &&
                   (((local_2c[-2] & 0x20) != 0 && ((pbVar13[-2] & 0x20) != 0)))) {
                  hbox = *(_HBox **)(pbVar13 + 1);
                  SetRotMatrix(local_48);
                  SetTransMatrix(local_48);
                  RotTrans((SVECTOR *)&hbox->minZ,local_74,local_30);
                  uVar3 = *(undefined2 *)&local_74->vy;
                  uVar4 = *(undefined2 *)&local_74->vz;
                  *(undefined2 *)local_5c = *(undefined2 *)&local_74->vx;
                  *(undefined2 *)((int)local_5c + 2) = uVar3;
                  *(undefined2 *)(local_5c + 1) = uVar4;
                  SetRotMatrix(m);
                  SetTransMatrix(m);
                  RotTrans((SVECTOR *)&hbox->minZ,local_74,local_30);
                  iVar7 = (int)local_60->vx - (int)*(short *)local_5c;
                  DAT_1f80014c = (int)local_60->vy - (int)*(short *)((int)local_5c + 2);
                  iVar15 = DAT_1f80014c * DAT_1f80014c;
                  DAT_1f800150 = (int)local_60->vz - (int)*(short *)(local_5c + 1);
                  uVar3 = *(undefined2 *)&local_74->vz;
                  uVar4 = *(undefined2 *)&local_74->vx;
                  DAT_1f800148 = iVar7;
                  *(undefined2 *)((int)local_54 + 2) = *(undefined2 *)&local_74->vy;
                  *(undefined2 *)(local_54 + 1) = uVar3;
                  *(undefined2 *)local_54 = uVar4;
                  iVar8 = (uint)(ushort)p_Var14->maxZ + (uint)(ushort)hbox->maxZ;
                  if (iVar7 * iVar7 + iVar15 + DAT_1f800150 * DAT_1f800150 < iVar8 * iVar8) {
                    if (iVar7 < 0) {
                      iVar7 = -iVar7;
                    }
                    ...
                    iVar7 = local_8c * 0x1e + local_90 * 0xc + local_94 * 9;
                    if (iVar7 != 0) {
                      if ((ushort)p_Var14->maxZ < (ushort)hbox->maxZ) {
                        collide_localPoint.y = p_Var14->maxX;
                        collide_localPoint.x = p_Var14->minZ;
                        collide_localPoint.z = p_Var14->maxY;
                      ...
                      DAT_1f800148 = DAT_1f800148 *
                                     (((uint)(ushort)p_Var14->maxZ + (uint)(ushort)hbox->maxZ) -
                                     iVar8);
                      ...
                      DAT_1f800216 = 1;
                      DAT_1f800217 = 1;
                      DAT_1f800238._0_2_ = (short)((DAT_1f800148 * 0x20) / iVar7);
                      DAT_1f800238._2_2_ = (short)((DAT_1f80014c * 0x20) / iVar7);
                      DAT_1f80023c._0_2_ = (short)((DAT_1f800150 * 0x20) / iVar7);
                      if (instance1->collideFunc != (_func_2 *)0x0) {
                        DAT_1f800215 = *local_2c;
                        DAT_1f800218 = p_Var14;
                        DAT_1f80021c = hbox;
                      ...
                      if (instance2->collideFunc != (_func_2 *)0x0) {
                        ...
                        DAT_1f800215 = *pbVar13;
                        DAT_1f800218 = hbox;
                        DAT_1f80021c = p_Var14;
                  ...
                  if ((pbVar13[-1] == 2) || (pbVar13[-1] == 5)) {
                    p_Var12 = instance2->object->modelList[instance2->currentModel];
                    local_50->flags = 0;
                    PIPE3D_InvertTransform((char)local_84,(char)local_48);
                    SetRotMatrix(local_84);
                    SetTransMatrix(local_84);
                    RotTrans(local_60,local_70,local_30);
                    DAT_1f8001b0 = *(short *)&local_70->vx;
                    DAT_1f8001b2 = *(short *)&local_70->vy;
                    DAT_1f8001b4 = *(short *)&local_70->vz;
                    DAT_1f8001b6 = p_Var14->maxZ;
                    DAT_1f8001b8 = *(undefined4 *)&p_Var14->refMinX;
                    PIPE3D_InvertTransform((char)local_80,(char)m);
                    SetRotMatrix(local_80);
                    SetTransMatrix(local_80);
                    RotTrans(local_58,local_6c,local_30);
                    sVar10 = *(short *)&local_6c->vy;
                    sVar2 = *(short *)&local_6c->vz;
                    local_64->x = *(short *)&local_6c->vx;
                    local_64->y = sVar10;
                    local_64->z = sVar2;
                    sVar6 = DAT_1f8001b4;
                    sVar2 = DAT_1f8001b2;
                    sVar10 = DAT_1f8001b0;
                    if (((pbVar13[-1] == 2) && ((local_2c[-2] & 0x40) != 0)) &&
                       ((pbVar13[-2] & 0x20) != 0)) {
                      hbox = *(_HBox **)(pbVar13 + 1);
                      local_50->flags = 0;
                      *local_7c = sVar10;
                      ...
                      *(_HBox **)&local_50->hface = hbox;
                      local_50->vertex0 = (_HVertex *)(p_Var12->vertexList + hbox->flags);
                      local_50->vertex1 = (_HVertex *)(p_Var12->vertexList + *(short *)&hbox->id);
                      local_50->vertex2 = (_HVertex *)(p_Var12->vertexList + hbox->minX);
                      COLLIDE_GetNormal(hbox->minZ,(short *)p_Var12->normalList,&local_50->normal);
                      ...
                      if (lVar9 != 0) {
                        *(short *)local_68 = DAT_1f8001b0 - *local_7c;
                        sVar10 = DAT_1f8001b4 - local_7c[2];
                        *(short *)((int)local_68 + 2) = DAT_1f8001b2 - local_7c[1];
                        *(short *)(local_68 + 1) = sVar10;
                        ...
                        copFunction(2,0x486012);
                        uVar5 = getCopReg(2,0x19);
                        *local_78 = uVar5;
                        uVar5 = getCopReg(2,0x1a);
                        local_78[1] = uVar5;
...

{
  ...
  if ((hfaceInfo->hface->attr & 0x40) == 0) {
    *edge = 1;
    ...
    _DAT_1f800054 = *(undefined4 *)&hfaceInfo->normal;
    ...
    setCopReg(2,in_zero,_DAT_1f800054);
    ...
    if (((_DAT_1f80007c <= DAT_1f800080) && (lVar10 = 0, _DAT_1f80007c < (int)(uint)sphere->radius))
      ...
      if (_DAT_1f80007c < 0) {
        ...
        COLLIDE_NearestPointOnPlane_S
                  ((short *)&DAT_1f800090,(int *)&DAT_1f800054,DAT_1f800084,(undefined4 *)sphere);
      }
      iVar3 = COLLIDE_PointInTriangle
      ...
      if (iVar3 == 0) {
        ...
        if (iVar9 == 0) {
          local_40 = (short)((int)((int)DAT_1f800054 * (uint)sphere->radius) >> 0xc);
          local_3c = (short)((int)((int)DAT_1f800056 * (uint)sphere->radius) >> 0xc);
        ...
        local_40 = (short)((int)((int)DAT_1f800054 * (uint)sphere->radius) >> 0xc);
        (sphere->position).x = local_40 + (short)DAT_1f800088;
        local_3c = (short)((int)((int)DAT_1f800056 * (uint)uVar1) >> 0xc);
        (sphere->position).y = local_3c + DAT_1f800088._2_2_;
  ...
  if (DAT_1f800294 != 0) {
    ...
    if (0 < terrain->numBSPTrees) {
      do {
        ...
        if (((-1 < pBVar19->ID) &&
            ((uVar12 = pBVar19->flags, (uVar12 & 0x4000) == 0 || (DAT_800d22ed != '\0')))) &&
           (((uVar12 & 0x102) == 0 ||
          ...
          *(_BSPNode **)&(p_Var17->sphere).position = p_Var17;
          SetRotMatrix((MATRIX *)&DAT_1f8001c8);
...

{
  ...
  puVar4 = &StreamTracker;
  do {
    if ((((*(short *)(puVar4 + 1) == 2) && ((Level *)puVar4[2] != level)) &&
        ((uVar6 == 0 || ((*(ushort *)((int)puVar4 + 6) & 1) == 0)))) &&
       (lVar3 = MEMPACK_MemoryValidFunc((char *)(Level *)puVar4[2]), lVar3 != 0)) {
      lVar1 = COLLIDE_SAndT(scollideInfo,(Level *)puVar4[2]);
    }
    iVar5 = iVar5 + 1;
    puVar4 = puVar4 + 0x10;
  } while (iVar5 < 0x10);
...

{
  ...
  local_3c = (VECTOR *)&DAT_1f800148;
  local_38 = (VECTOR *)&DAT_1f800158;
      ...
      if (iVar7 != 0) {
        ...
        do {
          if ((((p_Var6->hpFlags & 1) != 0) && ((pbVar5[-2] & 2) != 0)) && (pbVar5[-1] == 1)) {
            ...
            SetRotMatrix(pMVar2 + bVar1);
            SetTransMatrix(pMVar2 + bVar1);
            RotTrans((SVECTOR *)((int)pvVar4 + 8),local_3c,local_30);
            SetRotMatrix(pMVar3 + bVar1);
            SetTransMatrix(pMVar3 + bVar1);
            RotTrans((SVECTOR *)((int)pvVar4 + 8),local_38,local_30);
            DAT_1f8001b8._0_2_ = *(undefined2 *)&local_3c->vx;
            DAT_1f8001b8._2_2_ = *(undefined2 *)&local_3c->vy;
            DAT_1f8001bc = *(undefined2 *)&local_3c->vz;
            DAT_1f8001be = *(undefined2 *)((int)pvVar4 + 0xe);
            _DAT_1f8001c0 = *(undefined4 *)((int)pvVar4 + 0x10);
            DAT_1f800168 = *(undefined2 *)&local_38->vx;
            DAT_1f80016a = *(undefined2 *)&local_38->vy;
            DAT_1f80016c = *(undefined2 *)&local_38->vz;
        ...
        if ((int **)*ppiVar9 != ppiVar9) {
          do {
            ...
            if ((*(ushort *)((int)piVar6 + 0xe) & 2) == 0) {
              ...
              _DAT_1f800070 = getCopReg(2,0x1b);
                ...
                if ((((short)DAT_1f800090 <= *(short *)((int)piVar6 + 0x1a)) ||
                  ...
                  while (DAT_1f800094 != 0) {
                    ...
                    if (((puVar7[-2] & 0xc0) != 0) && (*puVar7 != 0xffff)) {
                      ...
                      _DAT_1f80006c = getCopReg(2,0x1a);
                      _DAT_1f800070 = getCopReg(2,0x1b);
                      _DAT_1f800068 = _DAT_1f800068 - _DAT_1f800070;
                      _DAT_1f80006c = _DAT_1f80006c - _DAT_1f800070;
                      if ((_DAT_1f800068 < 0) && (-1 < _DAT_1f80006c)) {
                        ...
                        DAT_1f800074 = (short)DAT_1f800084 + (short)(DAT_1f80007c * iVar4 >> 0xc);
                        DAT_1f80007e = (short)((uint)_DAT_1f80007c >> 0x10);
                        DAT_1f800076 = DAT_1f800084._2_2_ + (short)(DAT_1f80007e * iVar4 >> 0xc);
                        DAT_1f800078 = (short)DAT_1f800088 +
                                       (short)((short)DAT_1f800080 * iVar4 >> 0xc);
...

{
  ...
  if ((p_Var6 == DAT_800d20f8) && (DAT_800d2248 != 0)) {
    id_00 = DAT_800d226c;
  }
      ...
      do {
        ...
        if (id != 0) {
          if (local_20[0] == 0) {
            ...
            iVar3 = (int)DAT_800d224a;
            if ((int)DAT_800d224a == -1) {
              iVar3 = CurrentWarpNumber;
            }
            id = **(long **)(&LAB_800d0420 + iVar3 * 0x14);
          }
...

{
  ...
  if (cVar1 != '\x01') {
    if (cVar1 == '\x03') {
      ...
      if (cVar1 == '\x02') {
        v0 = &SStack24;
        pvVar4 = collideInfo->inst1;
        COLLIDE_GetNormal(*(short *)((int)collideInfo->prim1 + 8),
                          *(short **)
                           (*(int *)((int)*(short *)((int)pvVar4 + 0x122) * 4 +
                                    *(int *)(*(int *)((int)pvVar4 + 0x1c) + 0xc)) + 0xc),
                          (_SVector *)v0);
        m = *(MATRIX **)((int)pvVar4 + 0x40);
      }
      else {
        v0 = &collideInfo->point0;
        if ((*(uint *)&collideInfo->flags & 0xffff0000) != 0x5010000) {
          return 0;
        }
        m = *(MATRIX **)((int)collideInfo->inst1 + 0x40);
      }
      ApplyMatrixSV(m,v0,(SVECTOR *)normal);
      lVar3 = 1;
    }
  }
  return lVar3;
...

{
  ...
  if (tface == (_TFace *)0x0) {
    ...
    if ((1 << (tface->attr & 0x1f) & ignoreAttr) == 0) {
      ...
      DAT_1f800070 = DAT_1f800046;
      DAT_1f800072 = DAT_1f800048;
      DAT_1f800074 = DAT_1f80004a;
      SetRotMatrix((MATRIX *)&DAT_1f800040);
