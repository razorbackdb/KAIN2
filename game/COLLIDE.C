...
int COLLIDE_PointInTriangle2DPub(_SVector *v0, _SVector *v1, _SVector *v2, _SVector *point, _SVector *normal)
...
LAB_8001e5c0:
  ...
  bVar5 = false;
  iVar16 = 3;
  iVar9 = (int)((u_int)uVar3 << 0x10) >> 0x10;
  iVar7 = (int)sVar2;
  psVar12 = &DAT_1f800008;
  psVar14 = &DAT_1f800000;
  bVar8 = (int)((u_int)uVar3 << 0x10) <= (int)((u_int)uVar1 << 0x10);
  do
  {
...

{
  ...
  iVar1 = COLLIDE_PointInTriangle2DPub((_SVector *)v0, (_SVector *)v1, (_SVector *)v2, (_SVector *)point,
                                       (_SVector *)&local_10);
  return iVar1;
}
...

{
  ...
  if (iVar3 < 0)
  {
    puVar4 = (u_short *)(nrmlArray + iVar3 * 0x7ffffffd);
    uVar1 = *puVar4;
    nrml->x = -(uVar1 & 0x1fff);
    nrml->y = -puVar4[1];
    uVar2 = -puVar4[2];
  ...
  {
    puVar4 = (u_short *)(nrmlArray + iVar3 * 3);
    uVar1 = *puVar4;
    nrml->x = uVar1 & 0x1fff;
    nrml->y = puVar4[1];
    uVar2 = puVar4[2];
  ...
  nrml->z = uVar2;
  return (int)((u_int)uVar1 << 0x10) >> 0x1d;
}
...

{
  ...
  {
    uVar1 = (u_int)(hbox->maxZ < point->z) ^ 1;
  }
  return uVar1;
}
...

{
  ...
  {
    uVar1 = (u_int)(hbox->maxY < point->y) ^ 1;
  }
  return uVar1;
}
...
long COLLIDE_IntersectLineAndPlane_S(_SVector *point0, _SVector *normal0, _SVector *point1, _SVector *normal1, _SVector *end,
...

{
  ...
  COLLIDE_LineWithBoxFace(-start->x, -local_38, -hbox->minX, start, (_Vector *)&local_38, hbox, COLLIDE_WithinXYBounds,
                          &local_40);
  local_40.x = 0x1000;
  local_40.y = 0;
  local_40.z = 0;
  COLLIDE_LineWithBoxFace(start->x, local_38, hbox->maxX, start, (_Vector *)&local_38, hbox, COLLIDE_WithinXYBounds,
                          &local_40);
  local_40.x = 0;
  local_40.y = -0x1000;
  local_40.z = 0;
  ...
  local_40.y = 0;
  local_40.z = 0x1000;
  COLLIDE_LineWithBoxFace(start->z, local_30, hbox->maxZ, start, (_Vector *)&local_38, hbox, COLLIDE_WithinYZBounds,
                          &local_40);
...
_TFace *COLLIDE_PointAndWorld(_Terrain *terrain, _PCollideInfo *pCollideInfo, int Flags, short *Backface_Flag,
...

{
  ...
  _DAT_1f80007c = _DAT_1f80007c & 0xffff0000 | (u_int)(u_short)pSVar12->vz;
        ...
        code_r0x8001f2f4:
          ...
          LAB_8001f2fc:
            if (((pBVar5->flags & 0x1000U) == 0) || ((DAT_1f80006c & 0x10) == 0))
            {
              ...
              _DAT_1f80007c = _DAT_1f80007c & 0xffff0000 | (u_int)uVar9;
              ...
              *(_BSPNode **)&(p_Var14->sphere).position = p_Var6;
                                  ...
                                  ((*pbVar15 & DAT_1f800070) != 0))
                              {
                                ...
                                else
                                {
                                  ...
                                  if (iVar11 < 0)
                                  {
                                    ...
                                    DAT_1f800054 = DAT_1f800054 & 0xffff0000 |
                                                   (u_int)(u_short)-p_Var8->z;
                                  }
                                  else
                                  {
                                    DAT_1f800050 = *(u_int *)(&DAT_1f800098->x + iVar11 * 3) &
                                                   0xffff1fff;
                                    DAT_1f800054 = DAT_1f800054 & 0xffff0000 |
                                                   (u_int)(u_short)(&DAT_1f800098->x + iVar11 * 3)[1];
                                  }
                                }
                                      ...
                                      ((0 < DAT_1f800058 && (DAT_1f80005c < 1))))))
                                {
                                  ...
                                  _DAT_1f800068 =
                                      ...
                                      (u_int)(u_short)(DAT_1f800084 +
                                                       (short)(DAT_1f8000a8 * iVar11 >> 0xc));
                                  iVar11 = COLLIDE_PointInTriangle2DPub((_SVector *)v0,
                                                                        (_SVector *)(DAT_1f80009c + *(u_short *)(pbVar15 + -4)),
                                                                        (_SVector *)(DAT_1f80009c + *(u_short *)(pbVar15 + -2)),
                                  ...
                                  if (iVar11 != 0)
                                  {
                                    ...
                                    if ((*pbVar15 & 8) == 0)
                                    {
                                      if (((*(u_short *)(pbVar15 + 4) == 0xffff) ||
                                           ((*(u_short *)((int)&terrain->StartTextureList->attr +
                                                          (u_int) * (u_short *)(pbVar15 + 4)) &
                                             0x2000) == 0)) ||
                                          ((*pbVar15 & DAT_1f800070) != 0))
                                      {
                                        ...
                                        DAT_1f80007a = (short)((u_int)_DAT_1f800064 >> 0x10);
              ...
              _DAT_1f80007c =
                  ...
                  (u_int)(u_short)(DAT_1f80007c + (pBVar5->globalOffset).z);
              DAT_1f800080 = DAT_1f800080 + (pBVar5->globalOffset).x;
              DAT_1f800082 = DAT_1f800082 + (pBVar5->globalOffset).y;
              DAT_1f800084 = DAT_1f800084 + (pBVar5->globalOffset).z;
            }
...
int COLLIDE_PointAndTfaceFunc(_SVector *newPos, _SVector *oldPos, _HFace *hface, _Model *model, _SVector *hfNormal)

{
  ...
  if (_DAT_1f800080 < 0)
  {
    ...
    if ((_DAT_1f800080 < _DAT_1f800084) && (-1 < _DAT_1f800084))
    {
      ...
      iVar3 = COLLIDE_PointInTriangle2DPub(v0, (_SVector *)(p_Var4 + sVar1), (_SVector *)(model->vertexList + hface->v2), (_SVector *)&DAT_1f800090, (_SVector *)&DAT_1f800074);
      iVar2 = 0;
      if (iVar3 != 0)
      {
    ...
    do
    {
      if (((local_38->hpFlags & 1) != 0) && ((local_38->hpFlags & 8) != 0))
      {
        ...
        if (bVar1 == 2)
        {
          ...
          iVar8 = COLLIDE_PointAndTfaceFunc((_SVector *)&DAT_1f8001a8, local_48, hface, local_3c, &_Stack136);
          if (iVar8 != 0)
          {
            ApplyMatrix(&DAT_1f800100, &_Stack136, &pcollideInfo->wNormal);
            pcollideInfo->type = (u_short)bVar1;
            bVar1 = *pbVar11;
            *(_HFace **)&pcollideInfo->prim = hface;
          LAB_800205c4:
            pcollideInfo->inst = instance;
          LAB_800205d0:
            pcollideInfo->segment = (u_short)bVar1;
          }
        }
        else
        {
          if (bVar1 < 3)
          {
            if (((bVar1 == 1) && (puVar10 = *(u_int **)(pbVar11 + 1), (*puVar10 & 0x2000) != 0)) &&
                ((local_30 & 0x20) == 0))
            {
              COLLIDE_NearestPointOnLine_S(local_44, (u_int *)local_48, (u_int *)&DAT_1f8001a8, puVar10 + 2);
              ...
              if ((u_int)(DAT_1f800180 * DAT_1f800180 + DAT_1f800184 * DAT_1f800184 +
                          DAT_1f800188 * DAT_1f800188) < puVar10[4])
              {
                ...
                if (iVar9 != 0)
                {
                  ...
                  bVar1 = *pbVar11;
                  *(u_int **)&pcollideInfo->prim = puVar10;
                  pcollideInfo->inst = instance;
                  goto LAB_800205d0;
                }
              }
          ...
          else
          {
            if ((bVar1 == 5) && (hbox = *(_HBox **)(pbVar11 + 1), (hbox->flags & 0x2000U) != 0))
            {
              ...
              {
                hbox->maxX = (short)((int)((int)hbox->refMaxX * (u_int)uVar4) >> 0xc);
                hbox->minX = (short)((int)((int)hbox->refMinX * (u_int)uVar4) >> 0xc);
              }
              ...
              {
                hbox->maxY = (short)((int)((int)hbox->refMaxY * (u_int)uVar4) >> 0xc);
                hbox->minY = (short)((int)((int)hbox->refMinY * (u_int)uVar4) >> 0xc);
              }
              ...
              lVar6 = COLLIDE_IntersectLineAndPlane_S(local_2c, &_Stack136, &_Stack120, &_Stack112, (_SVector *)&DAT_1f8001a8, local_48, hbox);
              if (lVar6 != 0)
              {
...

{
  ...
  {
    COLLIDE_NearestPointOnLine_S((u_int *)&local_20, (u_int *)pcollideInfo->oldPoint, (u_int *)pcollideInfo->newPoint,
                                 (u_int *)&instance->position);
...

{
  ...
  if ((pcollideInfo->collideType & 1U) != 0)
  {
    ...
    if (tface == (_TFace *)0x0)
    {
      puVar7 = (u_short *)&StreamTracker.StreamList[0].flags;
      do
      {
...

{
  ...
  lVar1 = 0;
  if ((u_int)(_DAT_1f800000 * _DAT_1f800000 + _DAT_1f800004 * _DAT_1f800004 +
...

{
  ...
  if (lVar2 == 0)
  {
    lVar2 = COLLIDE_IntersectLineAndPlane_S(&local_58, &local_48, &_Stack80, &_Stack64, (_SVector *)sphere, (_SVector *)oldPos, hbox);
    if (lVar2 == 0)
    {
    ...
    else
    {
      ...
      (sphere->position).x =
          local_58.x + (short)((int)((int)normal->x * (u_int)sphere->radius) >> 0xc);
      (sphere->position).y =
          local_58.y + (short)((int)((int)normal->y * (u_int)sphere->radius) >> 0xc);
      lVar2 = 1;
      (sphere->position).z =
          local_58.z + (short)((int)((int)normal->z * (u_int)sphere->radius) >> 0xc);
    }
  }
  else
  {
    ...
    if (lVar2 == 0)
    {
      ...
      iVar8 = (int)((((int)hbox->minX + (int)hbox->maxX >> 1) - (u_int)(u_short)(sphere->position).x) * 0x10000) >> 0x10;
      iVar6 = iVar8;
      if (iVar8 < 0)
      {
        iVar6 = -iVar8;
    ...
    if (local_38 != 0)
    {
      ...
      do
      {
        if (((local_40->hpFlags & 1) != 0) &&
            ((undefined **)(*(u_int *)local_40 & 0xff0400) == &PTR_00010400))
        {
          bVar1 = *local_2c;
              ...
              if (((local_3c->hpFlags & 1) != 0) && ((local_3c->hpFlags & 4) != 0))
              {
                    ...
                    (((local_2c[-2] & 0x20) != 0 && ((pbVar11[-2] & 0x20) != 0))))
                {
                  ...
                  *(short *)local_54 = sVar2;
                  iVar6 = (u_int)(u_short)p_Var12->maxZ + (u_int)(u_short)hbox->maxZ;
                  if (iVar5 * iVar5 + iVar13 + DAT_1f800150 * DAT_1f800150 < iVar6 * iVar6)
                  {
                    ...
                    if (iVar5 != 0)
                    {
                      if ((u_short)p_Var12->maxZ < (u_short)hbox->maxZ)
                      {
                      ...
                      DAT_1f800148 = DAT_1f800148 *
                                     (((u_int)(u_short)p_Var12->maxZ + (u_int)(u_short)hbox->maxZ) -
                                      iVar6);
...

{
  ...
  if ((hfaceInfo->hface->attr & 0x40) == 0)
  {
    *edge = 1;
    ...
    lVar10 = 0;
    if (((_DAT_1f80007c <= _DAT_1f800080) && (lVar10 = 0, _DAT_1f80007c < (int)(u_int)sphere->radius)) && (lVar10 = 0, (int)-(u_int)sphere->radius <= _DAT_1f800080))
    {
      if (_DAT_1f80007c < 0)
      {
      ...
      {
        COLLIDE_NearestPointOnPlane_S((short *)&DAT_1f800090, &DAT_1f800054, _DAT_1f800084, (u_char *)sphere);
      }
      iVar3 = COLLIDE_PointInTriangle2DPub((_SVector *)hfaceInfo->vertex0, (_SVector *)hfaceInfo->vertex1,
                                           (_SVector *)hfaceInfo->vertex2, (_SVector *)&DAT_1f800090,
                                           (_SVector *)&DAT_1f800054);
      if (iVar3 == 0)
      {
        COLLIDE_NearestPointOnLine_S(&DAT_1f800088, (u_int *)hfaceInfo->vertex0, (u_int *)hfaceInfo->vertex1,
                                     (u_int *)sphere);
        ...
        {
          COLLIDE_NearestPointOnLine_S(&DAT_1f800090, (u_int *)hfaceInfo->vertex1, (u_int *)hfaceInfo->vertex2,
                                       (u_int *)sphere);
          ...
          if (sphere->radiusSquared <= uVar8)
          {
            COLLIDE_NearestPointOnLine_S(&DAT_1f800090, (u_int *)hfaceInfo->vertex2, (u_int *)hfaceInfo->vertex0,
                                         (u_int *)sphere);
            setCopReg(2, 0x4800, (int)(sphere->position).x - (int)(short)DAT_1f800090);
            setCopReg(2, 0x5000, (int)(sphere->position).y - (int)DAT_1f800090._2_2_);
            setCopReg(2, 0x5800, (int)(sphere->position).z - (int)(short)DAT_1f800094);
        ...
        if (iVar9 == 0)
        {
          local_40 = (short)((int)((int)(short)DAT_1f800054 * (u_int)sphere->radius) >> 0xc);
          local_3c = (short)((int)((int)DAT_1f800054._2_2_ * (u_int)sphere->radius) >> 0xc);
          local_38 = (short)((int)((int)(short)DAT_1f800058 * (u_int)sphere->radius) >> 0xc);
        }
        else
        {
 iVar9);
 ...
 iVar9);
      ...
      else
      {
        ...
        local_40 = (short)((int)((int)(short)DAT_1f800054 * (u_int)sphere->radius) >> 0xc);
        (sphere->position).x = local_40 + (short)DAT_1f800088;
        local_3c = (short)((int)((int)DAT_1f800054._2_2_ * (u_int)uVar1) >> 0xc);
        (sphere->position).y = local_3c + DAT_1f800088._2_2_;
        local_38 = (short)((int)((int)(short)DAT_1f800058 * (u_int)uVar2) >> 0xc);
        (sphere->position).z = local_38 + (short)DAT_1f80008c;
        *edge = 0;
        lVar10 = -1;
      }
...

{
  ...
  DAT_1f80027c._2_2_ = (short)((u_int)DAT_1f80027c >> 0x10);
    ...
    if (0 < terrain->numBSPTrees)
    {
      do
      {
              ...
              (((uVar12 & 0xe0) != 0 && (uVar9 = INSTANCE_Post(DAT_1f80025c, 1), (uVar9 & 2) != 0))))))
        {
          ...
          DAT_1f800280 = DAT_1f800280 & 0xffff0000 | (u_int)uVar12;
          ...
          *(_BSPNode **)&(p_Var17->sphere).position = p_Var10;
            ...
            do
            {
              ...
              else
              {
                ...
                if (bVar3)
                {
                  ...
                  DAT_1f8001ce = (u_short)(uVar4 >> 0x10);
                  ...
                  if (DAT_1f80028a != 0)
                  {
                    do
                    {
                      ...
                      if (((((bVar1 & DAT_1f80028c) == 0) || ((bVar1 & DAT_1f800290) != 0)) &&
                           ((puVar18[3] == 0xffff ||
                             ((*(u_short *)((int)&terrain->StartTextureList->attr + (u_int)puVar18[3]) &
                               0x2000) == 0)))) &&
                          ((bVar1 & 8) == 0))
                      {
                        if ((DAT_1f800264 == 2) &&
                        ...
                        else
                        {
                          ...
                          if (iVar13 < 0)
                          {
                            ...
                            DAT_1f800278 = DAT_1f800278 & 0xffff0000 | (u_int)(u_short)-p_Var11->z;
                          }
                          else
                          {
                            DAT_1f800274 = *(u_int *)(&DAT_1f8001f4->x + iVar13 * 3) & 0xffff1fff;
                            DAT_1f800278 = DAT_1f800278 & 0xffff0000 |
                                           (u_int)(u_short)(&DAT_1f8001f4->x + iVar13 * 3)[1];
                          }
                        }
          ...
          DAT_1f800280 = DAT_1f800280 & 0xffff0000 |
                         (u_int)(u_short)((short)DAT_1f800280 + (pBVar19->globalOffset).z);
        }
        local_2c = local_2c + 1;
...

{
  ...
  DAT_1f800086 = (short)((u_int)_DAT_1f800084 >> 0x10);
  DAT_1f80008c._2_2_ = (short)((u_int)DAT_1f80008c >> 0x10);
                  ...
                  while (DAT_1f800094 != 0)
                  {
                    ...
                    if (((puVar7[-2] & 0xc0) != 0) && (*puVar7 != 0xffff))
                    {
                      ...
                      if (iVar4 < 0)
                      {
                        ...
                        _DAT_1f800064 = _DAT_1f800064 & 0xffff0000 | (u_int)(u_short)-p_Var5->z;
                      }
                      else
                      {
                        DAT_1f800060 = *(u_int *)(&DAT_1f80009c->x + iVar4 * 3) & 0xffff1fff;
                        _DAT_1f800064 =
                            _DAT_1f800064 & 0xffff0000 |
                            (u_int)(u_short)(&DAT_1f80009c->x + iVar4 * 3)[1];
                      }
                      ...
                      if ((_DAT_1f800068 < 0) && (-1 < DAT_1f80006c))
                      {
                        ...
                        iVar4 = COLLIDE_PointInTriangle2DPub((_SVector *)v0, (_SVector *)(DAT_1f8000a0 + puVar7[-4]),
                        ...
                        if ((iVar4 != 0) && (iVar3 < maxSignals))
                        {
                          iVar13 = iVar3 + 1;
                          signalList[iVar3] =
                              (_MultiSignal *)((int)&p_Var11->signals->numSignals + (u_int)*puVar7);
                        }
                      }
                    }
                    puVar7 = puVar7 + 6;
...

{
  ...
  if ((instance->matrix != (MATRIX *)0x0) && (instance->oldMatrix != (MATRIX *)0x0))
  {
    ...
    else
    {
      ...
      local_44 = local_44 & 0xffff0000 | (u_int) * (u_short *)(instance->oldMatrix[1].t + 2);
      local_40 = CONCAT22(*(undefined2 *)(instance->matrix[1].t + 1),
                          *(undefined2 *)instance->matrix[1].t);
      local_3c = local_3c & 0xffff0000 | (u_int) * (u_short *)(instance->matrix[1].t + 2);
    }
    signalList = local_38;
    iVar3 = 0;
...

{
  ...
  {
    lVar2 = COLLIDE_LineWithSignals((_SVector *)&local_70, (_SVector *)&local_68, local_60, 8, p_Var1->level);
    iVar7 = 0;
    if (0 < lVar2)
    {
      iVar3 = 0;
...

{
  ...
  if (instance->hModelList != (_HModel *)0x0)
  {
    ...
    while (iVar3 != 0)
    {
      if ((u_int)p_Var2->segment == segment)
      {
...

{
  ...
  if (instance->hModelList != (_HModel *)0x0)
  {
    ...
    while (iVar4 != 0)
    {
      if ((u_int)p_Var3->segment == segment)
      {
...

{
  ...
  if (cVar1 != '\x01')
  {
    if (cVar1 == '\x03')
    {
      uVar2 = *(u_short *)((int)collideInfo->prim1 + 10);
      if ((uVar2 == 0xffff) ||
          ((*(u_short *)(*(int *)(*(int *)collideInfo->level + 0x34) + (u_int)uVar2 + 10) & 0x2000) ==
           0))
      {
    ...
    else
    {
      if (cVar1 == '\x02')
      {
        ...
        COLLIDE_GetNormal(*(short *)((int)collideInfo->prim1 + 8),
                          *(short **)(*(int *)((int)*(short *)((int)pvVar5 + 0x122) * 4 +
...

{
  ...
  puVar1 = (u_short *)COLLIDE_SetBSPTreeFlag(collideInfo);
  *puVar1 = *puVar1 | flag;
  return;
}
  ...
  else
  {
    if ((1 << (tface->attr & 0x1f) & ignoreAttr) == 0)
    {
      ...
      if (iVar3 < 0)
      {
        ...
        _DAT_1f80007c = _DAT_1f80007c & 0xffff0000 | (u_int)(u_short)-p_Var5->z;
      }
      else
      {
        puVar4 = (u_int *)(&terrain->normalList->x + iVar3 * 3);
        _DAT_1f800078 = *puVar4 & 0xffff1fff;
        _DAT_1f80007c = _DAT_1f80007c & 0xffff0000 | (u_int) * (u_short *)(puVar4 + 1);
      }
      ...
      if ((((_DAT_1f800080 < 0) && (-1 < _DAT_1f800084)) ||
          ...
          ((iVar3 = COLLIDE_IntersectLineAndBox(&DAT_1f800060, &DAT_1f800070, &DAT_1f800068, &DAT_1f800078, DAT_1f800088),
            iVar3 != 0 &&
                (iVar3 = COLLIDE_PointInTriangle2DPub((_SVector *)v0, (_SVector *)(p_Var7 + uVar1),
