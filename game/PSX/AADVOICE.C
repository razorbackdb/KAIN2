...

{
  ...
  if ((toneAtr->centerFine & 0x80U) == 0) {
    sVar5 = aadPitchTable[midiNote] +
            (ushort)((int)(&aadStepsPerCent)[midiNote] * 100 * (uint)(byte)toneAtr->centerFine >>
                    0x17);
  }
  else {
    sVar5 = aadPitchTable[midiNote] -
            (ushort)((int)(&aadStepsPerCent)[midiNote] * 100 *
                     (0x100 - (uint)(byte)toneAtr->centerFine) >> 0x17);
  }
...

{
  ...
  if ((toneAtr->centerFine & 0x80U) == 0) {
    sVar5 = aadPitchTable[iVar2] +
            (ushort)((int)(&aadStepsPerCent)[iVar2] * 100 * (uint)(byte)toneAtr->centerFine >> 0x17)
    ;
  }
  else {
    sVar5 = aadPitchTable[iVar2] -
            (ushort)((int)(&aadStepsPerCent)[iVar2] * 100 *
                     (0x100 - (uint)(byte)toneAtr->centerFine) >> 0x17);
  }
  SpuSetVoicePitch((uint)voice->voiceNum,
                   sVar5 + (short)(((int)(&camera_still)[iVar2] *
