...

{
  ...
  while( true ) {
    ...
    if ((((*(char *)(iVar1 + 8) == -0x30) && (aadMem->voiceStatus[iVar2] != '\0')) &&
        (aadMem->voiceStatus[iVar2] != '\x02')) && (*(u_long *)(iVar1 + 4) == handle)) break;
    iVar2 = iVar2 + 1;
    iVar3 = iVar3 + 0x1c;
    if (0x17 < iVar2) {
      return 0;
...

{
  ...
  while ((((iVar1 = (int)&aadMem->updateCounter + iVar3, *(char *)(iVar1 + 8) != -0x30 ||
           ((u_int)*(ushort *)(iVar1 + 4) != (toneID & 0xffff))) ||
...

{
  ...
  if (uVar1 != 0) {
    ...
    do {
      pcVar2 = (char *)((int)&aadMem->updateCounter + iVar3);
      if ((*pcVar2 == '\0') && ((u_int)*(ushort *)(pcVar2 + 4) == sfxToneID)) {
        EnterCriticalSection();
        return 1;
      }
      uVar4 = uVar4 + 1;
...
// decompiled code
// original method signature: 
// void /*$ra*/ aadPutSfxCommand(int statusByte /*$s0*/, int dataByte0 /*$s2*/, int dataByte1 /*$s3*/, unsigned long u_longParam /*$s4*/, int shortParam /*stack 16*/)
...

{
  ...
  while ((((pAVar3 = aadMem->synthVoice + uVar2, pAVar3->voiceID != -0x30 ||
           (pAVar3->handle != sfxCmd->u_longParam)) || (aadMem->voiceStatus[uVar2] == '\0')) ||
  ...
  SpuSetVoiceADSR1ADSR2
            ((u_int)uVar4,
             (ushort)((u_int)((short)((u_int)((short)((u_int)((short)((u_int)(local_10 * iVar5) >> 0xe)
                                                          * iVar6) >> 0xe) * iVar7) >> 0xe) * iVar8)
                     >> 0xe),
             (ushort)((u_int)((short)((u_int)((short)((u_int)((short)((u_int)(local_e * iVar5) >> 0xe) *
                                                          iVar6) >> 0xe) * iVar7) >> 0xe) * iVar8)
                     >> 0xe));
  return;
}
...

{
  ...
  while ((((pAVar5 = aadMem->synthVoice + uVar2, pAVar5->voiceID != -0x30 ||
           (pAVar5->handle != sfxCmd->u_longParam)) || (aadMem->voiceStatus[uVar2] == '\0')) ||
         (aadMem->voiceStatus[uVar2] == '\x02'))) {
    uVar6 = uVar6 + 1;
    uVar2 = (u_int)uVar6;
    if (0x17 < uVar6) {
  ...
  SpuSetVoiceADSR1ADSR2
            ((u_int)uVar6,
             (ushort)((u_int)((short)((u_int)((short)((u_int)((short)((u_int)(local_18 * iVar7) >> 0xe)
                                                          * iVar8) >> 0xe) * iVar9) >> 0xe) * iVar10
                            ) >> 0xe),
             (ushort)((u_int)((short)((u_int)((short)((u_int)((short)((u_int)(local_16 * iVar7) >> 0xe)
                                                          * iVar8) >> 0xe) * iVar9) >> 0xe) * iVar10
                            ) >> 0xe));
  ...
  if ((pAVar4->centerFine & 0x80U) == 0) {
    ...
    sVar3 = (&aadPitchTable)[uVar2] +
            (ushort)((&aadStepsPerCent)[uVar2] * 100 * (u_int)(byte)pAVar4->centerFine >> 0x17);
  }
  else {
    uVar2 = uVar2 & 0xffff;
    sVar3 = (&aadPitchTable)[uVar2] -
            (ushort)((&aadStepsPerCent)[uVar2] * 100 *
                     (0x100 - (u_int)(byte)pAVar4->centerFine & 0xffff) >> 0x17);
  }
...

{
  ...
  SpuSetVoiceADSR1ADSR2(vNum,*(ushort *)(puVar2 + 2),*(ushort *)((int)puVar2 + 10));
  SpuSetVoiceStartAddr(vNum,*(word *)(puVar2 + 5));
  SpuSetVoicePitch(vNum,puVar2[7]);
  SOUND_SetVoiceVolume(vNum,*(ushort *)((int)puVar2 + 0x3a),*(ushort *)(puVar2 + 0xf));
  return;
}
