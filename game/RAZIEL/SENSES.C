...
/* File: C:\kain2\game\RAZIEL\SENSES.C */
...

{
  ...
  if ((uVar2 & 0x20) == 0) {
    if (((uVar2 & 0x10000a) == 0) || ((Inst->flags2 & 0x20000000U) != 0)) {
      if (((uVar2 & 0x20000) != 0) && (DAT_800d5b70 == 0)) {
    ...
    if ((((Inst->flags2 & 0x20U) != 0) && (Ptr->xyDistance < 0x780)) &&
      ...
      if ((ControlFlag & 4U) == 0) {
        if ((Inst != DAT_800d5b14) || (DAT_800d5b10 == (_Instance *)0x0)) goto LAB_800a30a0;
      }
      else {
        if (DAT_800d5b10 == (_Instance *)0x0) {
LAB_800a30a0:
...
LAB_800a30b4:
          ...
          if (Inst == DAT_800d5b10) {
            Data_00 = SetEngagedInstance(player,Ptr,6);
            if (Data_00 != 0) goto LAB_800a30b4;
            DAT_800d5b10 = (_Instance *)0x0;
          }
        }
      }
    }
    ...
    if ((Ptr->distance < 0x1e00) && (Attribute = INSTANCE_Query(Ptr->instance,0x25), Attribute != 0)
      ...
      DAT_800d5ae0 = DAT_800d5ae0 | 0x20;
    }
    goto LAB_800a32a0;
  }
  ...
  if ((((Attribute & 0xe) != 0) && (Data_01 == 0)) &&
     (Data_00 = MATH3D_ConeDetect(&Ptr->relativePosition,0x3c7,0x3c7), Data_00 != 0)) {
    PHYSICS_GenericLineCheckSetup(0,0,0,0xc0);
    PHYSICS_GenericLineCheckSetup(0,-0x140,0,200);
    Data_00 = PHYSICS_CheckForTerrainCollide(DAT_800d20f8,0xc0,200,1);
    if (Data_00 == 0) {
  ...
  if ((Attribute & 0x80) != 0) {
    ...
    if (((*(ushort *)(Attribute + 8) & 1) == 0) && ((*(ushort *)(Attribute + 10) & 1) == 0)) {
      ...
      if (Inst == (_Instance *)0x0) {
        uVar6 = 0x800;
        if (DAT_800d5b70 != 0) {
          uVar6 = DAT_800d5b48 >> 9 & 0x1fe & (uint)*(ushort *)(Attribute + 8) | 0x800;
        }
        if (DAT_800d5b74 == 6) {
          uVar6 = uVar6 | 0x200;
        }
  ...
  if ((Attribute != 0) && (Data_01 == 0)) {
    ...
    local_40 = CONCAT22(*(undefined2 *)(DAT_800d20f8->matrix[0x12].t + 1),
                        *(undefined2 *)DAT_800d20f8->matrix[0x12].t);
    local_3c._0_2_ = *(short *)(DAT_800d20f8->matrix[0x12].t + 2);
    Data_01 = MATH3D_DistanceBetweenPositions((_Position *)&local_40,(_Position *)&local_38);
    local_40 = CONCAT22(*(undefined2 *)(DAT_800d20f8->matrix[1].t + 1),
                        *(undefined2 *)DAT_800d20f8->matrix[1].t);
    local_3c = CONCAT22(local_3c._2_2_,*(undefined2 *)(DAT_800d20f8->matrix[1].t + 2));
    ...
    if (((Ptr->distance < uVar5) || (Data_01 < uVar5)) || (uVar6 < uVar5)) {
      ...
      case 0:
        DAT_800d5b3a = DAT_800d5b3a + 1;
        in_t3 = (undefined4)((ulonglong)((longlong)(int)DAT_800d5b3a * 0x66666667) >> 0x20);
        if ((int)DAT_800d5b38 < (((int)DAT_800d5b3a / 5) * 0x10000 >> 0x10) + 1) {
          BumpUpHealth();
        }
        Inst = Ptr->instance;
        Data_01 = SEXT24(DAT_800d5b3a);
LAB_800a2e9c:
        INSTANCE_Post(Inst,0x800026,Data_01);
        break;
      case 1:
        if (DAT_800d5b50 < DAT_800d5b52) {
          DAT_800d5b50 = DAT_800d5b50 + *(short *)(Attribute + 10);
          if (DAT_800d5b52 < DAT_800d5b50) {
            DAT_800d5b50 = DAT_800d5b52;
          }
          Inst = Ptr->instance;
          Data_01 = (uint)DAT_800d5b50;
          goto LAB_800a2e9c;
        }
        break;
      case 2:
        INSTANCE_Post(Ptr->instance,0x800026,0);
        debugRazielFlags1 = DAT_800d5b48 | (int)*(short *)(Attribute + 10) << 0x11;
        DAT_800d5b48 = debugRazielFlags1;
        break;
      case 4:
        DAT_800d5b50 = DAT_800d5b52 + *(short *)(Attribute + 10);
        DAT_800d5b52 = DAT_800d5b50;
        INSTANCE_Post(Ptr->instance,0x800026,0);
        break;
      case 5:
        INSTANCE_Post(Ptr->instance,0x800026,(uint)DAT_800d5b50);
...
LAB_800a32a0:
  ...
  if (((uVar2 & 4) != 0) && (DAT_800d5ce8 = DAT_800d5ce8 | 0x1000, (ControlFlag & 0x40U) != 0)) {
  ...
  if ((Ptr->instance->object->oflags2 & 0x4000000U) != 0) {
    if ((DAT_800d5b64 & 0x20) != 0) {
      local_40 = (int)(Ptr->instance->position).x - (int)DAT_800d5b5c;
      local_38 = 0;
      local_3c = (int)(Ptr->instance->position).y - (int)DAT_800d5b5e;
      ...
      if (local_30 + local_2c < 0x64000) {
        ...
        if (((DAT_800d5b64 & 0x10) == 0) || (Data_00 == 0)) {
          ...
          if ((Inst->constrictAngle == 1) || (Inst->constrictAngle == -1)) {
            FX_StartConstrict(DAT_800d5748,(_SVector *)&DAT_800d5b5c,1,0x12);
            ...
            if (2 < (ushort)(Inst->constrictAngle + 1U)) {
              ...
              razSetupSoundRamp(DAT_800d20f8,(_SoundRamp *)&DAT_800d5ca0,0x30,100,100,100,100,0,
                                0xdac);
            }
          }
        }
  ...
  if (((((Ptr->instance->object->oflags2 & 0x1000000U) != 0) && (DAT_800d20d6 != 0)) &&
      (DAT_800d5b78 == 2)) && ((Ptr->xyDistance < 0x1c2 && (Ptr->zDelta + 0x3fU < 0x7f)))) {
    DAT_800d5ae0 = DAT_800d5ae0 | 0x40;
  }
