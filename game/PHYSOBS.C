...

{
  ...
  p_Var2 = *(_Instance **)(theCamera.core.vvNormalWorVecMat[1].t[2] + 4);
  do {
    instance = p_Var2;
...

{
  ...
  if (pvVar3 == (void *)0x0) {
    lVar1 = EVENT_GetScalerValueFromOperand
                      ((StackType *)instance,(long *)CONCAT22(in_register_00000016,ability),
                       (short *)0x0);
    return lVar1;
  }
  if (*(short *)((int)pvVar3 + 4) != -0x4ff5) {
    return 0;
  }
  if (*(short *)((int)pvVar3 + 2) == 3) {
    ...
    iVar2 = 1;
    if ((*(ushort *)((int)pvVar3 + 6) & ability) == 0) {
      iVar2 = 0;
    }
  }
  return iVar2;
...

{
  ...
  while( true ) {
    ...
    if (((((*(uint *)(*(int *)(iVar1 + 0x1c) + 0x2c) & 0x40000) != 0) &&
       ...
       ((**(uint **)(iVar1 + 0x14c) & 0x14e) != 0)) break;
    iVar1 = *(int *)(iVar1 + 8);
  }
  return 1;
}
...
void SetThrowDirection(_Instance *param_1,int param_2,undefined2 *param_3,int param_4)

{
  ...
  case 0:
    if (*(int *)(param_2 + 300) == 0) {
      angle = *(short *)(param_2 + 0x78);
    }
    else {
      angle = *(short *)(*(int *)(param_2 + 300) + 0x78);
    }
    PhysicsSetVelFromZRot(param_1,angle,(uint)(ushort)param_3[10]);
    param_1->zVel = (int)(short)param_3[0xd];
    break;
  case 1:
    iVar1 = *(int *)(param_3 + 2);
    *(int *)(param_4 + 8) = iVar1;
    angle = MATH3D_AngleFromPosToPos(&param_1->position,(_Position *)(iVar1 + 0x5c));
    PhysicsSetVelFromZRot(param_1,angle,(uint)(ushort)param_3[10]);
    param_1->zVel = 0;
    if (*(int *)(*(int *)((int)*(short *)(iVar1 + 0x10a) * 4 +
                         *(int *)(*(int *)(iVar1 + 0x1c) + 0xc)) + 0x18) < 2) {
      iVar1 = *(int *)(iVar1 + 0x40);
    }
    else {
      iVar1 = *(int *)(iVar1 + 0x40) + 0x20;
    }
    iVar5 = param_1->xVel;
    iVar3 = param_1->yVel;
    iVar2 = iVar5;
    ...
    if (iVar4 < iVar2) {
      iVar2 = *(int *)(iVar1 + 0x14) - (int)(param_1->position).x;
      if (iVar5 == 0) {
        return;
      }
      if (iVar2 == 0) {
      ...
      iVar4 = (param_1->zAccl * iVar2) / iVar5;
      iVar5 = (*(int *)(iVar1 + 0x1c) - (int)(param_1->position).z) * iVar5;
    }
    else {
      iVar2 = *(int *)(iVar1 + 0x18) - (int)(param_1->position).y;
      if (iVar3 == 0) {
        return;
      }
      if (iVar2 == 0) {
      ...
      iVar4 = (param_1->zAccl * iVar2) / iVar3;
      iVar5 = (*(int *)(iVar1 + 0x1c) - (int)(param_1->position).z) * iVar3;
    }
    param_1->zVel = iVar5 / iVar2 - (iVar4 >> 1);
    break;
  case 2:
    angle = MATH3D_AngleFromPosToPos(&param_1->position,(_Position *)(param_3 + 2));
    PhysicsSetVelFromZRot(param_1,angle,(uint)(ushort)param_3[10]);
    iVar3 = param_1->xVel;
    iVar2 = param_1->yVel;
    iVar1 = iVar3;
    ...
    param_1->zVel = 0;
    if (iVar5 < iVar1) {
      iVar1 = (int)(short)param_3[2] - (int)(param_1->position).x;
      if (iVar3 == 0) {
        return;
      }
      if (iVar1 == 0) {
      ...
      iVar5 = (param_1->zAccl * iVar1) / iVar3;
      iVar3 = ((int)(short)param_3[4] - (int)(param_1->position).z) * iVar3;
    }
    else {
      iVar1 = (int)(short)param_3[3] - (int)(param_1->position).y;
      if (iVar2 == 0) {
        return;
      }
      if (iVar1 == 0) {
      ...
      iVar5 = (param_1->zAccl * iVar1) / iVar2;
      iVar3 = ((int)(short)param_3[4] - (int)(param_1->position).z) * iVar2;
    }
    param_1->zVel = iVar3 / iVar1 - (iVar5 >> 1);
    break;
  case 3:
    PhysicsSetVelFromRot(param_1,(_Rotation *)(param_3 + 2),(uint)(ushort)param_3[10]);
    break;
  case 4:
    param_1->xVel = (int)(short)param_3[2];
    param_1->yVel = (int)(short)param_3[3];
    param_1->zVel = (int)(short)param_3[4];
    param_1->zAccl = (int)(short)param_3[0xb];
  }
  return;
}
...

{
  ...
  if (instance->LinkParent != (_Instance *)0x0) {
    ...
    *(undefined4 *)((int)pvVar1 + 0x44) = 0x96000;
...

{
  ...
  if (Mode != 0) {
    ...
    if (*(char *)((int)pvVar6 + 0x14) != -1) {
      if (Action == 2) {
        ...
        if (Action < 3) {
          if (Action == 1) {
            ...
            *(undefined2 *)(puVar2 + 1) = *(undefined2 *)((int)pvVar6 + 0x18);
            *(undefined2 *)((int)puVar2 + 6) = *(undefined2 *)((int)pvVar6 + 0x1a);
      ...
      if (Action == (uint)*(ushort *)((int)pvVar6 + 0xc)) {
        instance->flags = instance->flags | 8;
      }
      if (Action == (uint)*(ushort *)((int)pvVar6 + 0xe)) {
        instance->flags = instance->flags | 0x10;
      }
    }
    if ((*(byte *)((int)pvVar6 + 0x11) != 0xff) && ((*(ushort *)((int)pvVar6 + 6) & 0x8000) != 0)) {
      G2EmulationInstanceSetAnimation(instance,0,(uint)*(byte *)((int)pvVar6 + 0x11),0,0);
      bVar4 = *(byte *)((int)pvVar6 + 0x15) & 0x30;
      if (bVar4 == 0x10) {
        Mode = 1;
LAB_800697ec:
                    /* WARNING: Subroutine does not return */
      ...
      if (bVar4 < 0x11) {
        if ((*(byte *)((int)pvVar6 + 0x15) & 0x30) == 0) {
          Mode = 2;
          goto LAB_800697ec;
        }
      }
    ...
    if (pp_Var5 != (_Model **)0x0) {
      if ((*(byte *)((int)pvVar6 + 0x15) & 0x80) == 0) {
  ...
  if (Force != (_Instance *)0x0) {
    if (((Force->object->oflags2 & 0x80000U) == 0) && (Force->matrix != (MATRIX *)0x0)) {
      ...
      if (instance->matrix != (MATRIX *)0x0) {
        ...
        if (1 < local_50.type) {
                    /* WARNING: Subroutine does not return */
          MATH3D_LengthXYZ((int)local_20.vx - (int)local_18.vx,(int)local_20.vy - (int)local_18.vy,
...

{
  ...
  object = (Object *)DebugMenuLine_800c883c.text;
  if (type != 0) {
    object = (Object *)DebugMenuLine_800c883c.bit_mask;
  }
...

{
  ...
  if ((levelSelectMenu.text != (char *)0x0) &&
     (instance_00 = INSTANCE_BirthObject(instance,(Object *)levelSelectMenu.text,0),
     instance_00 != (_Instance *)0x0)) {
    ...
    *(int *)((int)instance_00->extraData + 4) = type;
    ...
    if (*pcVar3 == '\0') {
      ...
      local_20.y = 0;
      local_20.z = 0;
      p_Var1 = FX_StartFField(instance_00,0x78,&local_20,0x20,0x10,0x80,(long)&LAB_00202020);
...

{
  ...
  uVar2 = (uint)*(byte *)&(instance->node).prev;
  uVar7 = (int)((uint)(ushort)StreamTracker.StreamList[6].sfxFileHandle *
               (int)*(short *)((int)&(instance->node).prev + 2)) % (uVar2 << 0xc);
  pNVar4 = (instance->node).next;
  uVar6 = uVar7 & 0xfff;
  iVar3 = (int)uVar7 >> 0xc;
  uVar7 = iVar3 + 1;
  pNVar5 = pNVar4 + iVar3;
  ...
  *(undefined *)((int)&Force->instanceID + 2) = *(undefined *)((int)&(instance->node).prev + 1);
  pNVar4 = pNVar4 + uVar7;
  iVar3 = ((int)(((uint)*(ushort *)((int)&pNVar5->next + 2) +
                 ((int)(((int)*(short *)((int)&pNVar4->next + 2) -
                        (int)*(short *)((int)&pNVar5->next + 2)) * uVar6) >> 0xc)) * 0x10000) >>
          0x10) * (int)(short)LinkNode >> 0xc;
  *(short *)&Force->instanceID = (short)iVar3;
  if (iVar3 << 0x10 < 1) {
    *(undefined2 *)&Force->instanceID = 1;
  }
  (Force->node).next =
       (NodeType *)
       (int)(short)((int)((int)*(short *)&pNVar5->prev * 0x1000 +
                         ((int)*(short *)&pNVar4->prev - (int)*(short *)&pNVar5->prev) * uVar6) /
                   (int)*(short *)&Force->instanceID);
  iVar3 = (int)*(short *)((int)&pNVar5->prev + 2);
  Force->next = (_Instance *)
                (int)(short)((int)(iVar3 * 0x1000 +
                                  (*(short *)((int)&pNVar4->prev + 2) - iVar3) * uVar6) /
                            (int)*(short *)&Force->instanceID);
  p_Var1 = (_Instance *)
           (int)(short)((int)((int)*(short *)&pNVar5->next * 0x1000 +
                             ((int)*(short *)&pNVar4->next - (int)*(short *)&pNVar5->next) * uVar6)
                       / (int)*(short *)&Force->instanceID);
  Force->prev = p_Var1;
  return (int)p_Var1;
}
...
{
  if ((pLight != (_PhysObLight *)0x0) &&
     ((_Instance *)theCamera.core.vvNormalWorVecMat[0].t[0] == instance)) {
...

{
  ...
  *puVar1 = *puVar1 | 0x18000;
  if (pLight != (_PhysObLight *)0x0) {
    theCamera.core.vvNormalWorVecMat[0].t[0] = (long)instance;
    CanBePickedUp((_Instance *)pLight,(_Instance *)theCamera.core.vvNormalWorVecMat[0].t,
                  (int)*(short *)(puVar1 + 0xd));
  }
  return;
}
...

{
  ...
  if (*(short *)((int)instance->data + 0x1c) == 2) {
    Data = SetObjectIdleData(0,(_Instance *)0x0);
                    /* WARNING: Subroutine does not return */
    INSTANCE_Post(*(_Instance **)(grabJoint + 0x2c),0x800024,Data);
  }
...

{
  ...
  if (((instance == (gameTracker->gameData).asmData.lightInstances[0].lightInstance) &&
      (instance_00 = (_Instance *)PhysObGetLight(instance), instance_00 != (_Instance *)0x0)) &&
     ((gameTracker->gameData).asmData.lightInstances[0].lightInstance == instance)) {
    LinkNode = 0x1000;
    if ((*puVar9 & 0x8000) != 0) {
      sVar8 = *(short *)(puVar9 + 0xd);
      if (sVar8 < 0) {
        sVar8 = -sVar8;
      }
      LinkNode = (int)sVar8;
    }
    CanBePickedUp(instance_00,(_Instance *)(gameTracker->gameData).asmData.lightInstances,LinkNode);
  }
  LinkNode = CheckPhysObAbility(instance,2);
  if (LinkNode != 0) {
    instance_00 = PHYSOBS_IsAnythingAttached(instance);
    if (instance_00 == (_Instance *)0x0) {
      uVar3 = instance->flags2 & 0xffffff7f;
    }
    else {
      uVar3 = instance->flags2 | 0x80;
    }
    instance->flags2 = uVar3;
  }
  if (((*puVar9 & 0x2000000) != 0) &&
     (LinkNode = (uint)(ushort)instance->fadeValue + ((uint)theCamera.tiltList[0][0] >> 5),
     instance->fadeValue = (short)LinkNode, 0xfff < LinkNode * 0x10000 >> 0x10)) {
  ...
  LinkNode = CheckPhysObFamily(instance,5);
  if (LinkNode != 0) {
    pvVar7 = instance->extraData;
    if (0 < *(int *)((int)pvVar7 + 4)) {
      LinkNode = *(int *)((int)pvVar7 + 4) - theCamera.tiltList[0][0];
      *(int *)((int)pvVar7 + 4) = LinkNode;
      if (LinkNode < 0) {
      ...
      if (LinkNode < 0x1e000) {
        instance->fadeValue = 0x1000 - (short)(LinkNode / 0x1e);
      }
      else {
  ...
  LinkNode = CheckPhysObFamily(instance,6);
  if ((LinkNode != 0) && ((*(ushort *)((int)instance->data + 8) & 1) != 0)) {
                    /* WARNING: Subroutine does not return */
    INSTANCE_Query((_Instance *)theCamera.core.vvNormalWorVecMat[1].t[0],0x24);
  }
  LinkNode = CheckPhysObAbility(instance,0x40);
  if (LinkNode != 0) {
  ...
  LinkNode = CheckPhysObAbility(instance,0x8000);
  if (LinkNode != 0) {
    G2EmulationInstancePlayAnimation(instance);
  }
  uVar3 = *puVar9;
  ...
  if (((*puVar9 & 0x100000) != 0) && (LinkNode = CheckPhysObFamily(instance,5), LinkNode != 0)) {
  ...
  LinkNode = CheckPhysObFamily(instance,7);
  if ((LinkNode != 0) && (*(int *)((int)instance->extraData + 4) == 8)) {
                    /* WARNING: Subroutine does not return */
    STREAM_GetLevelWithID(instance->currentStreamUnitID);
  }
  uVar3 = *puVar9;
  if (((uVar3 & 0x1000) != 0) || (instance->matrix == (MATRIX *)0x0)) {
    instance->tface = (_TFace *)0x0;
    instance->tfaceLevel = (void *)0x0;
    goto LAB_8006be18;
  }
  LinkNode = (int)(instance->oldPos).z - (int)(instance->position).z;
  if (LinkNode < 0xa0) {
    LinkNode = 0xa0;
  }
  iVar10 = instance->zAccl * theCamera.tiltList[0][0];
  if (iVar10 < 0) {
    iVar10 = iVar10 + 0xfff;
  }
  iVar10 = (instance->zVel + ((iVar10 << 4) >> 0x10)) * theCamera.tiltList[0][0];
  if (iVar10 < 0) {
    iVar10 = iVar10 + 0xfff;
  }
  iVar10 = 0x40 - (iVar10 >> 0xc);
  sVar8 = (short)iVar10;
  puVar4 = (undefined *)(iVar10 * 0x10000);
  if (iVar10 * 0x10000 >> 0x10 < 0xa0) {
    sVar8 = 0xa0;
    puVar4 = &DAT_00a00000;
  }
  sVar6 = (short)((uint)puVar4 >> 0x10);
  if ((int)puVar4 >> 0x10 < LinkNode) {
    sVar6 = (short)LinkNode;
    sVar8 = (short)LinkNode;
  }
  LinkNode = SetPhysicsGravityData((int)sVar6,(int)sVar8,0,0,0,0xb50);
  uVar5 = PhysicsCheckGravity(instance,LinkNode,0xd);
  if ((uVar5 & 1) == 0) {
LAB_8006bbd8:
...
code_r0x8006bbe0:
    if ((iVar10 == 0) && (instance->oldMatrix != (MATRIX *)0x0)) {
      if ((uVar5 & 1) != 0) {
        (instance->position).x = (instance->position).x + *(short *)(LinkNode + 4);
        (instance->position).y = (instance->position).y + *(short *)(LinkNode + 6);
      }
    ...
    iVar10 = instance->attachedID;
    if ((iVar10 != 0) && ((uVar3 & 4) == 0)) goto code_r0x8006bbe0;
    if ((instance->wNormal).z < 0xb51) goto LAB_8006bbd8;
    LinkNode = instance->zVel;
    if ((*puVar9 & 0x14) != 0) {
    ...
    *puVar9 = uVar3 & 0xfffffffb;
    if ((uVar3 & 0x400000) == 0) {
      *puVar9 = uVar3 & 0xff7ffffb;
      if ((uVar3 & 0x4000000) == 0) {
        *puVar9 = uVar3 & 0xff7ffffb | 1;
      }
    }
    else {
      *puVar9 = uVar3 & 0xffbfffeb | 0x200000;
      puVar9[0x11] = 10;
  ...
  if (((((instance->object->oflags & 0x80000U) == 0) &&
       (LinkNode = CheckPhysObAbility(instance,8), LinkNode != 0)) &&
      (theCamera.core.vvNormalWorVecMat[0]._18_2_ == 0)) &&
     ((theCamera.core.vvNormalWorVecMat[0].m[2][2] != 1000 && ((instance->flags2 & 0x8000000U) == 0)
      ))) {
    _Stack96.newPoint = &local_28;
    local_30.vx = (instance->position).x;
    local_30.vy = (instance->position).y;
    sVar8 = (instance->position).z;
    local_28.vz = sVar8 - 0x500;
    local_30.vz = sVar8 + 0x140;
    _Stack96.oldPoint = &local_30;
    local_28.vx = local_30.vx;
    local_28.vy = local_30.vy;
    PHYSICS_CheckLineInWorld(instance,&_Stack96);
    instance->zAccl = 0;
    LinkNode = ((uint)local_30.vz - (uint)local_28.vz) + -0x140;
    sVar8 = (short)LinkNode;
    if (0x3bf < LinkNode * 0x10000 >> 0x10) {
      uVar2 = (instance->position).z;
      sVar8 = uVar2 - (*(ushort *)((int)puVar9 + 0x12) +
                      ((short)((uint)((((int)(((uint)*(ushort *)((int)puVar9 + 0x12) - (uint)uVar2)
                                             * 0x10000) >> 0x10) / 0x280) * 0x10000) >> 0x10) + 1) *
                      -0x280);
    }
    instance->zVel =
         -(int)(short)((uint)((((int)sVar8 * 1000) /
                               ((1000 - (int)theCamera.core.vvNormalWorVecMat[0].m[2][2]) * 0x32) <<
                              0x10) >> 4) / (uint)theCamera.tiltList[0][0]);
  }
LAB_8006be18:
  if ((*puVar9 & 0x200000) != 0) {
    puVar9[0x11] = puVar9[0x11] - 1;
    LinkNode = PHYSOB_ReAlignFalling(instance,-900);
    if ((LinkNode != 0) || ((int)puVar9[0x11] < 1)) {
      *puVar9 = *puVar9 & 0xff5fffff | 1;
      TurnOffCollisionPhysOb(instance,7);
    }
  }
  if ((((instance->object->oflags & 0x80000U) != 0) ||
      (LinkNode = CheckPhysObAbility(instance,8), LinkNode != 0)) ||
     (theCamera.core.vvNormalWorVecMat[0]._16_4_ == 1000)) {
...

{
  ...
  case 5:
    ...
    pMVar4 = (MATRIX *)0x0;
    if (iVar2 != 0) {
      pMVar4 = (MATRIX *)(int)*(short *)((int)pvVar5 + 4);
    }
    break;
  case 6:
    pMVar4 = (MATRIX *)
             SetPhysicsDropOffData
                       ((int)(instance->position).x,(int)(instance->position).y,
                        (int)(instance->position).z,in_a3,local_20);
    break;
  case 7:
    iVar2 = CheckPhysObAbility(instance,0x40);
    if (iVar2 == 0) {
      ...
      if (iVar2 == 0) {
        pMVar4 = (MATRIX *)
                 SetPhysicsDropOffData
                           ((int)(instance->rotation).x,(int)(instance->rotation).y,
                            (int)(instance->rotation).z,in_a3,local_20);
      }
      else {
        if (instance->matrix == (MATRIX *)0x0) {
          local_18.x = 0;
        ...
        pMVar4 = (MATRIX *)
                 SetPhysicsDropOffData
                           ((int)local_18.x,(int)local_18.y,(int)local_18.z,in_a3,local_20);
      }
    }
    else {
      pMVar4 = (MATRIX *)
               SetPhysicsDropOffData
                         (0,0,(int)(((uint)(ushort)(instance->rotation).z +
...
LAB_8006c360:
  ...
  case 0x2f:
    ...
    pMVar4 = *(MATRIX **)((MATRIX *)instance->extraData)->m;
    if (((uint)pMVar4 & 0x800) != 0) {
      return (ulong)(MATRIX *)&UNK_00000001;
    }
    if (((uint)pMVar4 & 0x14e) != 0) {
      return (ulong)(MATRIX *)&UNK_00000001;
    }
...

{
  ...
  if (Message < 0x800011) {
    ...
    if (Message < 0x200004) {
      ...
      if (*(short *)((int)instance->data + 2) == 7) {
        if (instance->parent != (_Instance *)0x0) {
                    /* WARNING: Subroutine does not return */
          INSTANCE_Query(instance->parent,1);
        }
        return;
      }
      return;
    ...
    if (Message == 0x800001) {
      ...
      if ((iVar3 == 0) && (theCamera.core.vvNormalWorVecMat[0]._18_2_ != 0)) {
        return;
      }
...

{
  ...
  if (message == G2ANIM_MSG_DONE) {
    ...
    G2AnimSection_NextKeyframe(anim->section + sectionID);
    uVar1 = *puVar2;
...
/* WARNING: Removing unreachable block (ram,0x8006d340) */
/* WARNING: Removing unreachable block (ram,0x8006d350) */
/* WARNING: Removing unreachable block (ram,0x8006d258) */
/* WARNING: Removing unreachable block (ram,0x8006d268) */
...

{
  ...
  if (((*puVar8 & 0x10) == 0) || (hitinst != (_Instance *)puVar8[0x10])) {
    GetPhysObCollisionType(instance);
    if ((*puVar8 & 0x4000) == 0) {
      uVar3 = *puVar8;
      if ((uVar3 & 0x10) != 0) {
        local_30 = GetObliqueDirection(instance,a_Stack128);
        if ((*puVar8 & 0x400000) == 0) {
          instance->xVel = 0;
          instance->yVel = 0;
          instance->zVel = 0;
          instance->xAccl = 0;
      ...
      if ((uVar3 & 0x200004) == 0) {
        if (((uVar3 & 0x80) != 0) &&
           (ppvVar2 = (void **)&local_70, instance->LinkParent != (_Instance *)0x0)) {
          p_Var4 = collideInfo + 1;
          do {
            pvVar5 = *(void **)&collideInfo->flags;
            pvVar6 = collideInfo->prim0;
            pvVar7 = collideInfo->prim1;
            *ppvVar2 = collideInfo->level;
            ppvVar2[1] = pvVar5;
            ppvVar2[2] = pvVar6;
            ppvVar2[3] = pvVar7;
            collideInfo = (_CollideInfo *)&collideInfo->inst0;
            ppvVar2 = ppvVar2 + 4;
          } while (collideInfo != p_Var4);
        ...
        if (((Data != 0) && ((*puVar8 & 0x800000) == 0)) &&
           (theCamera.core.vvNormalWorVecMat[0]._16_4_ == 1000)) {
          pPVar1 = PhysObGetSplinter(instance);
          splintDef = (FXSplinter *)0x0;
          if (pPVar1 != (PhysObSplinter *)0x0) {
            splintDef = (FXSplinter *)pPVar1->splinterData;
          }
        ...
        CheckForceCollision(instance,hitinst,(_TFace *)0x0,collideInfo,a_Stack128,local_30);
      }
      else {
        if (((collideInfo->type1 != '\x01') || ((_Instance *)puVar8[0x10] != hitinst)) &&
           (0xb4f < (collideInfo->point0).vz)) {
          if ((uVar3 & 0x200000) != 0) {
      ...
      if (((_Instance *)puVar8[2] != hitinst) &&
         ((hitinst == (_Instance *)0x0 ||
          (((*(uint *)&collideInfo->flags & 0xffff0000) != 0x1010000 &&
           ((hitinst->object->oflags2 & 0x40000U) == 0)))))) {
        *puVar8 = *puVar8 & 0xffffbfff | 0x10;
        puVar8[0x11] = 0x96000;
...

{
  ...
  collideInfo = (_CollideInfo *)instance->collideInfo;
  if ((*puVar3 & 0x1600001) == 0) {
    pvVar2 = collideInfo->prim0;
    if ((instance->LinkParent == (_Instance *)theCamera.core.vvNormalWorVecMat[1].t[0]) &&
       (*(char *)((int)pvVar2 + 4) == '\t')) {
      if (collideInfo->type1 == '\x03') {
    ...
    if ((((*(uint *)&collideInfo->flags & 0xffff0000) == 0x1010000) &&
        (*(char *)((int)pvVar2 + 4) == '\t')) && (*(char *)((int)collideInfo->prim1 + 4) == '\b')) {
      ...
      if (pPVar1 != (PhysObWeaponAttributes *)0x0) {
        ...
        if (instance->LinkParent != (_Instance *)0x0) {
          ...
          if ((Data != 0) && ((*puVar3 & 0x10000) == 0)) {
            Power = pPVar1->AltDamage;
          }
          Data = SetMonsterHitData(Sender,(_Instance *)0x0,Power,0,0);
                    /* WARNING: Subroutine does not return */
          INSTANCE_Post(instance->LinkParent,0x2000002,Data);
        }
                    /* WARNING: Subroutine does not return */
        INSTANCE_Query(Sender,0);
      }
    }
  }
  return 0;
...

{
  ...
  if ((*(ushort *)((int)pvVar2 + 0x36) & 1) != 0) {
                    /* WARNING: Subroutine does not return */
    memset((_Instance *)auStack32,0,6);
  }
  ...
  iVar1 = *(int *)((int)pvVar2 + 0x44) - theCamera.tiltList[0][0];
  *(int *)((int)pvVar2 + 0x44) = iVar1;
  if (-1 < iVar1) {
    ExecuteThrow((_Instance *)auStack32);
    return;
  }
                    /* WARNING: Subroutine does not return */
  INSTANCE_KillInstance(instance);
  ...
  if (parent != (_Instance *)0x0) {
    ...
    if (instance->matrix != (MATRIX *)0x0) {
      ...
      do {
        ...
        local_90.vz = *(short *)(pMVar4->t + 2) + 100;
        iVar2 = ((int)(((uint)*(ushort *)pMVar4->t - (local_a0 & 0xffff)) * 0x10000) >> 0x10) * 6000
        ;
        if (iVar2 < 0) {
          iVar2 = iVar2 + 0xfff;
        }
        iVar3 = (int)(short)(*(short *)(pMVar4->t + 1) - local_a0._2_2_) * 6000;
        local_88 = (short)(iVar2 >> 0xc);
        if (iVar3 < 0) {
          iVar3 = iVar3 + 0xfff;
        }
        local_86 = (short)(iVar3 >> 0xc);
        iVar2 = (int)(short)(*(short *)(pMVar4->t + 2) - local_90.vz) * 6000;
        if (iVar2 < 0) {
          iVar2 = iVar2 + 0xfff;
        }
        local_84 = (short)(iVar2 >> 0xc);
      ...
      local_68[0].x = local_70 - local_78;
      local_68[0].y = local_6e - local_76;
      local_68[0].z = local_6c - local_74;
                    /* WARNING: Subroutine does not return */
...

{
  ...
  Inst = *(_Instance **)(theCamera.core.vvNormalWorVecMat[1].t[2] + 4);
  while( true ) {
    ...
    if (lVar3 == 0) {
      ...
      if ((uVar4 & 2) == 0) {
        if ((uVar4 & 0x4000) == 0) {
          ...
          if (local_1c == 0) goto LAB_8006f428;
...

{
  ...
  if (*(short *)(puVar4 + 9) != 0) {
    G2EulerAngles_FromMatrix(&local_30,(_G2Matrix_Type *)(pMVar3 + sVar2),0x15);
...

{
  ...
  iVar1 = theCamera.tiltList[0][0] * 0x32;
