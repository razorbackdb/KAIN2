...

{
  ...
  INSTANCE_Post((_Instance *)theCamera.core.vvNormalWorVecMat[1].t[0],(int)&DAT_00040001,0);
}
...
{
  if ((theCamera.positionVel._0_4_ != time) && (_BlockVramEntry_800d59a0.area != 0)) {
                    /* WARNING: Subroutine does not return */
...

{
  ...
  if ((int)p0->sx < (int)p1->sx) {
    ...
    if ((int)p2->sx <= (int)p0->sx) goto LAB_800b4e50;
  }
  else {
    iVar2 = (int)p2->sx << 0x10;
    uVar1 = p1->sx;
    if ((int)p2->sx <= (int)p1->sx) goto LAB_800b4e50;
  }
...

{
  ...
  *primStart = 0xffffff;
  do {
    ...
    iVar1 = iVar4;
    do {
      p0 = (UW_ScreenXY *)(mainMenuScreen + iVar1 * 2);
      p1 = (UW_ScreenXY *)(mainMenuScreen + iVar1 * 2 + 2);
      p2 = (UW_ScreenXY *)(mainMenuScreen + iVar1 * 2 + 8);
      p2_00 = (UW_ScreenXY *)(mainMenuScreen + iVar1 * 2 + 6);
...

{
  ...
  local_20 = 0;
  local_1a = 0xf0;
  local_1e = (undefined2)(theCamera.core.vvNormalWorVecMat[0].m[2]._0_4_ << 8);
  MoveImage((undefined4 *)&local_20,0,(theCamera.core.vvNormalWorVecMat[0].m[2]._0_4_ ^ 1) << 8);
...

{
  ...
  intro = pIGpffffb614;
  iVar1 = CheckVolatile(pIGpffffb614);
  if (iVar1 != 0) {
    SAVE_IsIntroDeadDead(intro);
    return;
  }
  iVar1 = CheckVolatile(uGpffffb610);
  if (iVar1 != 0) {
    SAVE_IsIntroDeadDead((Intro *)&UNK_00000048);
    return;
  }
                    /* WARNING: Subroutine does not return */
...

{
  ...
  instance = theCamera.positionVel._0_4_;
  while (iVar1 = STREAM_PollLoadQueue(), iVar1 != 0) {
    instance = (_Instance *)UNDERWORLD_RotateScreenStep((long)instance);
  }
  ...
  if (iVar1 != 0) {
    UNDERWORLD_RotateScreenStep((long)instance);
    streamUnit = (_StreamUnit *)SAVE_GetSavedSmallIntro(instance);
    return streamUnit;
  }
  ...
  STREAM_LoadMainVram(gameTracker,(char *)&controlsScreen,streamUnit);
                    /* WARNING: Subroutine does not return */
