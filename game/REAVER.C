...

{
  ...
  if ((((*(uint *)&collideInfo->flags & 0xffff0000) == 0x1010000) &&
    ...
    if (instance->LinkParent != (_Instance *)0x0) {
      ...
      INSTANCE_Post(DAT_800d20f8,0x100001f,Data);
  ...
  if ((*(uint *)&collideInfo->flags & 0xffff0000) == 0x1010000) {
    ...
    if (Power != 0) {
      ...
      if (iVar2 == 2) {
        ...
        INSTANCE_Post(Inst,(int)&LAB_00080000_1,0);
      }
    }
  }
  if (collideInfo->type1 == '\x03') {
...
{
  FX_DoBlastRing(instance,(_SVector *)&instance->position,(char)instance->matrix,0,0x140,0,0xf0,0,0,
...

{
  ...
  if (data->ReaverChargeTime != 0) {
    data->ReaverChargeTime = data->ReaverChargeTime - DAT_800d2314;
    if (data->ReaverShockAmount < 0x3c000) {
      motor1_speed = data->ReaverShockAmount + DAT_800d2314;
    ...
    if (data->ReaverChargeTime < 1) {
      ...
      FX_DoBlastRing(instance,(_SVector *)&instance->position,(char)instance->matrix,0,0x168,0,0,0,0
    ...
    if (message < 0x800102) {
      if (message == 0x800002) {
        ...
        if (message == 0x800010) {
          ...
          local_20.vx = local_20.vx + (instance->position).x;
          local_20.vy = local_20.vy + (instance->position).y;
          local_20.vz = local_20.vz + (instance->position).z;
          ...
          (p_Var2->position).x = local_20.vx;
          (p_Var2->position).y = local_20.vy;
          (p_Var2->position).z = local_20.vz;
