...

{
  ...
  if ((theCamera.positionAccl._4_4_ & 0x2000000) == 0) {
...

{
  ...
  if ((instance->flags & 0x10000U) != 0) {
    ...
    if (pOVar1->animList != (_G2AnimKeylist_Type **)0x0) {
      if ((pOVar1->oflags2 & 0x40000000U) == 0) {
        G2Anim_Free(&instance->anim);
      }
      pOVar1 = instance->object;
    }
    if ((pOVar1->oflags2 & 4U) != 0) {
      SOUND_EndInstanceSounds(pOVar1->soundData,instance->soundInstanceTbl);
    }
    if (instance->LinkParent == (_Instance *)0x0) {
      ...
      if (instance->hModelList == (_HModel *)0x0) {
        ...
        do {
          iVar4 = iVar4 + 1;
          if (*(_Instance **)(iVar2 + 0xc) == instance) {
  ...
  INSTANCE_InstanceGroupNumber(instance_00);
  return;
}
...

{
  ...
  if (instance != (_Instance *)0x0) {
    do {
      uVar2 = instance->flags;
      pp_Var1 = &instance->next;
      if ((uVar2 & 0x400) == 0) {
        if ((uVar2 & 0x20) != 0) {
          instance->flags = uVar2 | 0x20;
        }
      }
      else {
        if ((uVar2 & 0x20) != 0) {
          instance->flags = uVar2 & 0xffffffdf;
        }
      }
      instance = *pp_Var1;
  ...
  if (instance != (_Instance *)0x0) {
    ...
    if (p_Var3 != (_Instance *)0x0) {
      INSTANCE_IntroduceInstance((Intro *)list,(short)p_Var3);
      return;
    }
  }
  return;
...

{
  ...
  iVar3 = *(int *)(theCamera.core.vvNormalWorVecMat[1].t[2] + 4);
  lVar4 = 0;
  if (iVar3 != 0) {
    do {
  ...
  if (lVar1 == 0) {
    ...
    if ((((objectTracker != (_ObjectTracker *)0x0) &&
       ...
       ((((object->oflags2 & 0x10000000U) == 0 ||
        ...
        (instance = INSTANCE_NewInstance((_InstanceList *)theCamera.core.vvNormalWorVecMat[1].t[2]),
...

{
  ...
  while (p_Var1 != (_Instance *)0x0) {
    if ((((theCamera.maxFocusVel.pad != 6) || ((p_Var1->object->oflags & 0x20000U) != 0)) &&
        (((theCamera.positionAccl._4_4_ & 0x100000) == 0 ||
         ((p_Var1->object->oflags & 0x40000U) != 0)))) &&
       ((p_Var1->additionalCollideFunc != (_func_3 *)0x0 && ((p_Var1->flags2 & 0x24000000U) == 0))))
    {
      theCamera.tiltList[0][0] = theCamera.tiltList[0][1];
      if ((p_Var1->object != (Object *)0x0) &&
         (((p_Var1->object->oflags2 & 0x2000000U) != 0 &&
          (theCamera.tiltList[0][0] = theCamera.tiltList[1][0], (p_Var1->flags2 & 0x8000000U) != 0))
         )) {
        theCamera.tiltList[0][0] = theCamera.tiltList[0][2];
      }
      (*p_Var1->additionalCollideFunc)(p_Var1,0x800d0fac);
    }
    p_Var1 = p_Var1->next;
  }
  theCamera.tiltList[0][0] = theCamera.tiltList[0][1];
...

{
  ...
  int iVar11;
  MultiSpline *object;
  SplineDef *rsplineDef;
  _Instance *instance;
  int iVar12;
  ushort uVar13;
  
  if ((theCamera.core.debugRot._4_4_ & 0x8000010) == 0) {
    if ((theCamera.maxFocusVel.pad != 6) && ((theCamera.positionAccl._4_4_ & 0x100000) == 0)) {
      theCamera.positionAccl._4_4_ = theCamera.positionAccl._4_4_ & 0xfffffffb;
    }
    ...
    while (instance != (_Instance *)0x0) {
      ...
      if (((instance->object != (Object *)0x0) && ((instance->object->oflags2 & 0x2000000U) != 0))
         && (theCamera.tiltList[0][0] = theCamera.tiltList[1][0],
      ...
      if (((((instance->intro == (Intro *)0x0) || ((instance->intro->flags & 0x100U) == 0)) &&
           ((theCamera.maxFocusVel.pad != 6 || ((instance->object->oflags & 0x20000U) != 0)))) &&
          (((theCamera.positionAccl._4_4_ & 0x100000) == 0 ||
        ...
        rsplineDef = &multi->curRotational;
        lVar8 = SCRIPT_InstanceSplineProcess
                          (instance,&multi->curPositional,rsplineDef,&multi->curScaling,
                           (int)(short)uVar13);
        if (instance->splineFlags == 0) {
          if ((theCamera.core._212_4_ & 0x400000) != 0) {
          ...
          if ((instance->splineFlags & 1U) != 0) {
            if ((theCamera.core._212_4_ & 0x400000) != 0) {
              rsplineDef = (SplineDef *)instance->introNum;
              object = (MultiSpline *)instance->introName;
              printf(s_Spline__s_ld_playto__d_preveFram_800ce3b8);
            }
            if ((int)(short)uVar13 < 1) {
              iVar11 = (int)instance->targetFrame;
              if (lVar9 <= iVar11) {
                if (iVar11 <= lVar7) goto LAB_800337a4;
                if (lVar7 < lVar9) {
...
LAB_8003379c:
                  if (!bVar5) goto LAB_800337a4;
                }
              }
              else {
LAB_800337a4:
                rsplineDef = (SplineDef *)0x0;
                object = (MultiSpline *)(int)instance->targetFrame;
...
LAB_80033910:
              ...
              if ((instance->clipBeg <= lVar7) && (lVar9 <= instance->clipBeg)) {
                INSTANCE_BirthObject
                          ((_Instance *)(GameCheat_800cfff8.cheatKeys + 8),(Object *)object,
                           (int)rsplineDef);
                return;
              }
              if (instance->clipEnd < lVar9) {
                if ((*(uint *)&multi->positional->numkeys & 0x6000000) == 0) {
                  frameNum = instance->clipBeg;
                  goto LAB_8003390c;
                }
...
LAB_80033ad0:
        if (instance->processFunc != (_func_1 *)0x0) {
          if ((instance->flags2 & 1U) == 0) {
            (*instance->processFunc)(instance,0x800d0fac);
          }
          else {
            INSTANCE_DeactivatedProcess
                      (instance,(GameTracker *)(theCamera.core.vvNormalWorVecMat[0].m + 4));
          }
        }
...

{
  ...
  if (Inst->LinkChild != instance) {
    LIGHT_GetLightMatrix(instance,in_a1,in_a2,in_a3);
    return;
  }
  ...
  iVar2 = (int)sVar1 * (int)(Inst->scale).x;
  if (iVar2 < 0) {
    iVar2 = iVar2 + 0xfff;
  }
  (instance->scale).x = (short)(iVar2 >> 0xc);
  iVar2 = (int)(instance->scale).y * (int)(Inst->scale).y;
  if (iVar2 < 0) {
    iVar2 = iVar2 + 0xfff;
  }
  (instance->scale).y = (short)(iVar2 >> 0xc);
  iVar2 = (int)(instance->scale).z * (int)(Inst->scale).z;
  if (iVar2 < 0) {
    iVar2 = iVar2 + 0xfff;
  }
  (instance->scale).z = (short)(iVar2 >> 0xc);
...

{
  ...
  while (instance_00 != (_Instance *)0x0) {
    ...
    INSTANCE_ReallyRemoveInstance
              ((_InstanceList *)theCamera.core.vvNormalWorVecMat[1].t[2],instance_00,0);
    instance_00 = p_Var1;
  }
  return;
}
...

{
  ...
  iVar2 = (int)instance->fadeValue;
  if (theCamera.core.vvNormalWorVecMat[0].m[2][2] != 1000) {
    instance_00 = (_Instance *)instance->object;
    iVar2 = 0x1000 - iVar2;
    lVar1 = MEMPACK_MemoryValidFunc((char *)instance_00);
    if ((lVar1 != 0) &&
       (((instance->object->oflags2 & 0x2000000U) != 0 ||
        ((instance->LinkParent != (_Instance *)0x0 &&
         ((instance->LinkParent->object->oflags2 & 0x2000000U) != 0)))))) {
      if ((instance->flags2 & 0x8000000U) != 0) {
        iVar2 = (int)(short)theCamera.focusDistanceList[0][2];
        LIGHT_PresetInstanceLight(instance_00,in_a1,in_a2);
        return iVar2;
      }
      iVar3 = theCamera.focusDistanceList[0][2]._2_2_ * iVar2;
      iVar2 = iVar3 >> 0xc;
      if (iVar3 < 0) {
        iVar2 = iVar3 + 0xfff >> 0xc;
      }
    }
    iVar2 = 0x1000 - iVar2;
  }
...

{
  ...
  if (message != G2ANIM_MSG_PLAYEFFECT) {
    INSTANCE_ReallyRemoveAllChildren((_Instance *)anim);
    return uVar2;
  }
  uVar2 = 1;
  if (messageDataA == 0) {
    ...
    if (999 < maxVolume) {
      ...
      iVar3 = HUMAN_TypeOfHuman(instance);
      if (iVar1 != iVar3) {
        return 0;
      }
    }
    SOUND_Play3dSound(&instance->position,(int)*(short *)messageDataB,
                      (int)*(short *)(messageDataB + 4),maxVolume,(int)*(short *)(messageDataB + 6))
    ;
  }
  else {
    if (messageDataA == 1) {
