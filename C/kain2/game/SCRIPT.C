...
void SCRIPT_InstanceSplineSet(_Instance *instance, short frameNum, SplineDef *splineDef, SplineDef *rsplineDef,
...
long SCRIPT_SplineProcess(_Instance *instance, MultiSpline *multi, SplineDef *splineDef, SplineDef *rsplineDef,
...
long SCRIPT_InstanceSplineProcess(_Instance *instance, SplineDef *splineDef, SplineDef *rsplineDef, SplineDef *ssplineDef, int direction)
