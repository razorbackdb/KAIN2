...
// void /*$ra*/ InitAlgorithmicWings(struct _Instance *instance /*$s2*/)
 // line 24, offset 0x800a1b54
	/* begin block 1 */
		// Start line: 25
		// Start offset: 0x800A1B54
		// Variables:
	// 		struct _G2EulerAngles_Type Rot; // stack offset -24
	// 		unsigned char i; // $s1
	/* end block 1 */
	// End offset: 0x800A1CD4
	// End Line: 91
...
// void /*$ra*/ DeInitAlgorithmicWings(struct _Instance *instance /*$s1*/)
 // line 94, offset 0x800a1cec
	/* begin block 1 */
		// Start line: 95
		// Start offset: 0x800A1CEC
		// Variables:
	// 		unsigned char i; // $s0
	/* end block 1 */
...
// void /*$ra*/ AlgorithmicWings(struct _Instance *instance /*$s0*/, struct evAnimationControllerDoneData *ControllerData /*$s1*/)
 // line 117, offset 0x800a1d7c
	/* begin block 1 */
		// Start line: 118
		// Start offset: 0x800A1D7C
		// Variables:
	// 		struct _G2EulerAngles_Type Rot; // stack offset -24
	/* end block 1 */
	// End offset: 0x800A1DD8
	// End Line: 143
...
// void /*$ra*/ AlgorithmicNeck(struct _Instance *Player /*$s1*/, struct _Instance *Target /*$s2*/)
 // line 150, offset 0x800a1dec
	/* begin block 1 */
		// Start line: 151
		// Start offset: 0x800A1DEC
		// Variables:
	...
	// 		struct MATRIX matrix; // stack offset -72
		...
		/* begin block 1.1 */
			// Start line: 162
			// Start offset: 0x800A1E20
			// Variables:
		// 		struct evCollideInstanceStatsData data; // stack offset -40
		/* end block 1.1 */
		// End offset: 0x800A1E88
		// End Line: 183

		/* begin block 1.2 */
			// Start line: 208
			// Start offset: 0x800A1F2C
			// Variables:
		// 		struct MATRIX *matrix; // $v1
		/* end block 1.2 */
		// End offset: 0x800A1F64
		// End Line: 223
	/* end block 1 */
	// End offset: 0x800A2054
	// End Line: 256
