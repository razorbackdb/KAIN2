...
// int /*$ra*/ StateHandlerDecodeHold(int *Message /*$s2*/, int *Data /*$s3*/)
 // line 16, offset 0x8009ba7c
	/* begin block 1 */
		// Start line: 17
		// Start offset: 0x8009BA7C
		// Variables:
	// 		int rc; // $s4
	// 		int WhoAmI; // $s0
	// 		struct _Instance *heldInstance; // $s1
		...
		/* begin block 1.1 */
			// Start line: 53
			// Start offset: 0x8009BBA8
			// Variables:
		// 		int hitState; // $v1
		/* end block 1.1 */
		// End offset: 0x8009BC94
		// End Line: 90

		/* begin block 1.2 */
			// Start line: 117
			// Start offset: 0x8009BD34
			// Variables:
		// 		struct _Instance *heldWeapon; // $v1
		/* end block 1.2 */
		// End offset: 0x8009BD98
		// End Line: 137
	/* end block 1 */
	// End offset: 0x8009BDC4
	// End Line: 147
      ...
      *Message = 0x100000a;
      if (Inst == Raziel.soulReaver) {
        *Message = 0x1000023;
        ...
        if (((uVar2 & 0x20) == 0) || (*Message = 0x1000018, *Data == 0)) goto LAB_8009bd98;
...
// void /*$ra*/ StateHandlerAttack2(struct __CharacterState *In /*$s4*/, int CurrentSection /*$s5*/, int Data /*stack 8*/)
 // line 157, offset 0x8009bde4
	/* begin block 1 */
		// Start line: 158
		// Start offset: 0x8009BDE4
		// Variables:
	...
	// 		struct _Instance *ignoreInst; // stack offset -44
		...
		/* begin block 1.1 */
			// Start line: 233
			// Start offset: 0x8009C190
			// Variables:
		// 		struct _Instance *inst; // $s0
		// 		unsigned long startColor; // $s3
		// 		unsigned long endColor; // $s2
		/* end block 1.1 */
		// End offset: 0x8009C2E0
		// End Line: 279

		/* begin block 1.2 */
			// Start line: 332
			// Start offset: 0x8009C438
			// Variables:
		// 		struct _Instance *weaponInst; // $s0
		/* end block 1.2 */
		// End offset: 0x8009C498
		// End Line: 349

		/* begin block 1.3 */
			// Start line: 406
			// Start offset: 0x8009C6CC
			// Variables:
		// 		struct _Instance *inst; // $s0
		...
		/* end block 1.4 */
		// End offset: 0x8009C988
		// End Line: 500

		/* begin block 1.5 */
			// Start line: 518
			// Start offset: 0x8009CA18
		/* end block 1.5 */
		// End offset: 0x8009CA18
		// End Line: 519

		/* begin block 1.6 */
			// Start line: 544
			// Start offset: 0x8009CB00
		/* end block 1.6 */
		// End offset: 0x8009CB48
		// End Line: 551

		/* begin block 1.7 */
			// Start line: 574
			// Start offset: 0x8009CBDC
			// Variables:
		// 		struct evMonsterHitData *data; // $s0
		/* end block 1.7 */
		// End offset: 0x8009CCAC
		// End Line: 588

		/* begin block 1.8 */
			// Start line: 608
			// Start offset: 0x8009CD60
			// Variables:
		// 		struct evMonsterHitData *hitData; // $s0
		/* end block 1.8 */
		// End offset: 0x8009CD78
		// End Line: 614

		/* begin block 1.9 */
			// Start line: 634
			// Start offset: 0x8009CDF0
			// Variables:
		// 		struct _G2AnimSection_Type *animSection; // $v1
		/* end block 1.9 */
		// End offset: 0x8009CE54
		// End Line: 641
	/* end block 1 */
	// End offset: 0x8009CE84
	// End Line: 648
...

{
  ...
  if (CurrentSection != 0) goto LAB_8009beb0;
  if ((ControlFlag & 0x20U) == 0) {
    if (((ControlFlag & 0x10000000U) == 0) || ((Raziel.Mode & 2U) != 0)) goto LAB_8009beb0;
    mode = 2;
    if ((*PadData & 0x8000000fU) == 0) goto LAB_8009be9c;
...
LAB_8009c174:
            G2EmulationSwitchAnimationAlpha
                      (In,mode,(uint)bVar1,0,(uint)bVar2,local_54,(uint)(Raziel.attack)->alphaIn);
            if (CurrentSection == 1) {
          ...
          if ((int)puVar6 < 0x100002) {
            if (puVar6 == &DAT_80000020) {
              ...
              if ((int)puVar6 < -0x7fffffdf) {
                if (puVar6 == (undefined *)0x80000000) goto LAB_8009c398;
                if (puVar6 == (undefined *)0x80000001) {
                  if (CurrentSection == 0) {
                    ...
                    Raziel.Mode = 8;
                    mode = razSwitchVAnimCharacterGroup
...
LAB_8009cdbc:
                ...
                if (puVar6 == (undefined *)0x80000) {
                  ...
                  if (puVar6 != (undefined *)0x100000) goto LAB_8009cdbc;
            ...
            if (puVar6 == &DAT_00100015) {
              ...
              if ((int)puVar6 < 0x100016) {
                if (puVar6 == &DAT_00100002) {
                  ...
                  if (puVar6 != &DAT_00100004) goto LAB_8009cdbc;
                  if (CurrentSection == 1) {
...
LAB_8009cd2c:
                ...
                if (puVar6 != (undefined *)0x1000001) goto LAB_8009cdbc;
              }
            }
          }
        }
...
LAB_8009caa0:
                  ...
                  if (puVar6 != (undefined *)0x1000018) goto LAB_8009cdbc;
                  if (p_Var4->Data == 0) {
                    uVar7 = ControlFlag | 0x20;
                    if (CurrentSection == 1) {
                      mode = 0x8a;
                    ...
                    if ((CurrentSection == 1) && ((Raziel.Senses.EngagedMask & 0x200) != 0)) {
                      ...
                      razAlignYRotMoveInterp
                                (In->CharacterInstance,Raziel.Senses.EngagedList[9].instance,0x1e6,
                                 '\0',0x14,0);
                      (In->CharacterInstance->anim).section[1].swAlarmTable = (short *)0x800d7124;
                      uVar7 = ControlFlag;
                    }
                  }
                }
                ...
                if (puVar6 == (undefined *)0x1000023) {
                  ...
                  if (puVar6 != (undefined *)0x1000024) goto LAB_8009cdbc;
                  local_30 = 1;
                }
              }
            }
            ...
            if (puVar6 != (undefined *)0x4020000) {
              if ((int)puVar6 < 0x4020001) {
                if (puVar6 == (undefined *)0x2000002) {
                  ...
                  if (puVar6 != (undefined *)0x4010080) goto LAB_8009cdbc;
                  if (CurrentSection == 0) {
                    if (p_Var4->Data == 0) {
                ...
                if (puVar6 == (undefined *)0x8000000) {
                  if (((Raziel.attackFlags & 4U) == 0) ||
                     (*(int *)(&((__AttackItem *)PlayerData->attackList[Raziel.currentAttack])->
                                switchDelay + (int)pp_Var8[0x48] * 4) == 0)) {
...
LAB_8009cb6c:
                    ...
                    if (Raziel.currentAttack < 10) {
                      ...
                      if ((*PadData & 0x8000000fU) == 0) goto LAB_8009cdcc;
                      mode = 0x100000;
                    }
LAB_8009cd48:
                  ...
                  if (puVar6 != (undefined *)0x8000004) goto LAB_8009cdbc;
                  if ((Raziel.Senses.EngagedMask & 0x200) != 0) {
                    instance = Raziel.Senses.EngagedList[9].instance;
                    if (Raziel.Senses.heldClass == 0x1000) {
...
// void /*$ra*/ StateHandlerCannedReaction(struct __CharacterState *In /*$s1*/, int CurrentSection /*$s2*/, int Data /*$s4*/)
 // line 651, offset 0x8009ceb4
	/* begin block 1 */
		// Start line: 652
		// Start offset: 0x8009CEB4
		// Variables:
	// 		struct __Event *Ptr; // $v0

		/* begin block 1.1 */
			// Start line: 694
			// Start offset: 0x8009D074
			// Variables:
		// 		struct _Instance *Inst; // $v0
		/* end block 1.1 */
		// End offset: 0x8009D090
		// End Line: 697

		/* begin block 1.2 */
			// Start line: 707
			// Start offset: 0x8009D098
			// Variables:
		// 		struct _Instance *Inst; // $s0
		/* end block 1.2 */
		// End offset: 0x8009D108
		// End Line: 724
	/* end block 1 */
	// End offset: 0x8009D124
	// End Line: 767
      ...
      if ((int)puVar2 < 0x100015) {
        if (puVar2 != &DAT_80000020) {
          if ((int)puVar2 < -0x7fffffdf) {
            if ((puVar2 != (undefined *)0x80000000) && (puVar2 != &DAT_80000008)) goto LAB_8009d10c;
          }
          else {
            if (puVar2 == &DAT_00100001) {
              ...
              if (puVar2 != &DAT_00100004) goto LAB_8009d10c;
              if (CurrentSection == 1) {
        ...
        if (puVar2 == (undefined *)0x8000000) goto LAB_8009d034;
...
LAB_8009d10c:
          ...
          if (puVar2 == (undefined *)0x8000003) {
            if (CurrentSection != 0) goto LAB_8009d114;
            Inst = razGetHeldItem();
          }
          else {
            if (puVar2 != (undefined *)0x8000004) goto LAB_8009d10c;
            Inst = razGetHeldItem();
...
// void /*$ra*/ StateHandlerStumble(struct __CharacterState *In /*$s1*/, int CurrentSection /*$s3*/, int Data /*$s7*/)
 // line 770, offset 0x8009d144
	/* begin block 1 */
		// Start line: 771
		// Start offset: 0x8009D144
		// Variables:
	// 		struct __Event *Ptr; // $s0

		/* begin block 1.1 */
			// Start line: 821
			// Start offset: 0x8009D47C
			// Variables:
		// 		struct evActionPlayHostAnimationData *data; // $v0
		/* end block 1.1 */
		// End offset: 0x8009D47C
		// End Line: 823

		/* begin block 1.2 */
			// Start line: 831
			// Start offset: 0x8009D4D0
			// Variables:
		// 		struct evMonsterHitData *data; // $v0
		/* end block 1.2 */
		// End offset: 0x8009D4D0
		// End Line: 832
	/* end block 1 */
	// End offset: 0x8009D53C
	// End Line: 871
...
LAB_8009d524:
                ...
                if (ID != &DAT_80000020) goto LAB_8009d524;
              }
            }
          }
          else {
            if (ID != &DAT_00040005) {
              if ((int)ID < 0x40006) {
                if (ID != &DAT_00040003) goto LAB_8009d524;
                if (CurrentSection == 0) {
                ...
                if (ID != (undefined *)0x100000) goto LAB_8009d524;
        ...
        if (ID == (undefined *)0x1000000) {
          ...
          if ((int)ID < 0x1000001) {
            if (ID != &DAT_00100009) {
              if ((int)ID < 0x10000a) {
                if (ID != &DAT_00100004) goto LAB_8009d524;
                G2Anim_SetSpeedAdjustment(&In->CharacterInstance->anim,0x1000);
              }
              else {
                if (ID != &DAT_00100015) goto LAB_8009d524;
            ...
            if (ID != (undefined *)0x2000000) {
              if ((int)ID < 0x2000001) {
                if (ID != (undefined *)0x1000001) goto LAB_8009d524;
              }
              else {
                if (ID != (undefined *)0x4000001) {
                  if (ID != (undefined *)0x10000000) goto LAB_8009d524;
                  pp_Var3 = &In->CharacterInstance + CurrentSection * 0x47;
                  if (pp_Var3[0x48] == (_Instance *)0x1) {
                    pp_Var3[0x48] = (_Instance *)0x0;
                    pp_Var3[0x47] = (_Instance *)(pp_Var3[0x47][-1].relativeMatrix.m + 4);
                  }
                }
              }
            }
...
// void /*$ra*/ StateHandlerHitReaction(struct __CharacterState *In /*$s1*/, int CurrentSection /*$s2*/, int Data /*$s4*/)
 // line 892, offset 0x8009d568
	/* begin block 1 */
		// Start line: 893
		// Start offset: 0x8009D568
		// Variables:
	// 		struct __Event *Ptr; // $v0

		/* begin block 1.1 */
			// Start line: 902
			// Start offset: 0x8009D64C
			// Variables:
		// 		struct evMonsterHitData *data; // $s0

			/* begin block 1.1.1 */
				// Start line: 906
				// Start offset: 0x8009D658
				// Variables:
			// 		struct _Instance *weapon; // $v0
			/* end block 1.1.1 */
			// End offset: 0x8009D6E4
			// End Line: 927
		/* end block 1.1 */
		// End offset: 0x8009D72C
		// End Line: 934
	/* end block 1 */
	// End offset: 0x8009D7C4
	// End Line: 969
  ...
  do {
    ...
    if (puVar2 == &DAT_00100001) {
      ...
      if ((int)puVar2 < 0x100002) {
        if ((-0x7fffffff < (int)puVar2) && (puVar2 != &DAT_80000020)) goto LAB_8009d7ac;
      }
      else {
...
LAB_8009d7ac:
            ...
            if ((0x8000001 < (int)puVar2) || ((int)puVar2 < 0x8000000)) goto LAB_8009d7ac;
            if (CurrentSection == 0) {
...
// void /*$ra*/ StateHandlerThrow2(struct __CharacterState *In /*$s1*/, int CurrentSection /*$s2*/, int Data /*$s7*/)
 // line 1049, offset 0x8009d7e4
	/* begin block 1 */
		// Start line: 1050
		// Start offset: 0x8009D7E4
		// Variables:
	...
	// 		int Anim; // $s4
		...
		/* begin block 1.1 */
			// Start line: 1193
			// Start offset: 0x8009DDE8
			// Variables:
		// 		struct evMonsterHitData *data; // $v1
		/* end block 1.1 */
		// End offset: 0x8009DDFC
		// End Line: 1196

		/* begin block 1.2 */
			// Start line: 1269
			// Start offset: 0x8009DFDC
			// Variables:
		// 		struct _Instance *weaponInst; // $s0

			/* begin block 1.2.1 */
				// Start line: 1273
				// Start offset: 0x8009DFF0
				// Variables:
			// 		int spin_type; // $a3

				/* begin block 1.2.1.1 */
					// Start line: 1287
					// Start offset: 0x8009E048
					// Variables:
				// 		struct _Position To; // stack offset -64
				// 		struct _Rotation Rot; // stack offset -56
				// 		struct MATRIX *matrix; // $v0
				/* end block 1.2.1.1 */
				// End offset: 0x8009E048
				// End Line: 1292
			/* end block 1.2.1 */
			// End offset: 0x8009E114
			// End Line: 1308
		/* end block 1.2 */
		...
		/* begin block 1.3 */
			// Start line: 1359
			// Start offset: 0x8009E280
			// Variables:
		// 		struct _Position To; // stack offset -64
		// 		struct _Rotation Rot; // stack offset -48
		// 		struct MATRIX *matrix; // $v0
		/* end block 1.3 */
		// End offset: 0x8009E2C4
		// End Line: 1369
	/* end block 1 */
	// End offset: 0x8009E2C4
	// End Line: 1392
      ...
      if ((int)puVar9 < 0x1000001) {
        if (puVar9 == (undefined *)0x100000) {
          if ((Raziel.Mode & 0x40000U) == 0) {
            ...
            if (((*PadData & 0x800) == 0) || ((*PadData & 0x400) == 0)) goto LAB_8009e250;
            Raziel.returnState = StateHandlerIdle;
...
LAB_8009e248:
                ...
                if (puVar9 != &DAT_80000020) goto LAB_8009e248;
              }
            }
          }
          else {
            if (puVar9 == &DAT_00100004) {
              ...
              if ((int)puVar9 < 0x100005) {
                if (puVar9 != &DAT_00100001) goto LAB_8009e248;
                if (CurrentSection == 0) {
                  ControlFlag = (int)&DAT_00041001;
                  if ((Raziel.Mode & 0x40000U) == 0) {
                    SteerSwitchMode(In->CharacterInstance,0);
                        ...
                        if (Raziel.Senses.heldClass == 8) {
                          ...
                          if (Raziel.Senses.heldClass == 0x1000) {
                            ...
                            razSetupSoundRamp(In->CharacterInstance,
                                              (_SoundRamp *)&Raziel.soundHandle,0xc,-100,0,0x32,0x55
                                              ,(int)&LAB_0002d000,(int)&DAT_00002710);
...
LAB_8009dc60:
                ...
                if (puVar9 != &DAT_00100009) goto LAB_8009e248;
                if (CurrentSection == 1) {
                  if (p_Var7->Data == 1) {
...
LAB_8009dee8:
          ...
          if ((int)puVar9 < 0x8000001) {
            ...
            if ((int)puVar9 < 0x4000002) {
              if (puVar9 != (undefined *)0x1000001) goto LAB_8009e248;
            }
            else {
              if (puVar9 != (undefined *)0x4020000) goto LAB_8009e248;
            }
          }
          else {
            if (puVar9 != (undefined *)0x20000002) {
              if ((int)puVar9 < 0x20000003) {
                if (puVar9 != (undefined *)0x8000004) goto LAB_8009e248;
                Inst = razGetHeldWeapon();
                if (Inst == (_Instance *)0x0) goto LAB_8009e250;
...
LAB_8009e0f8:
                ...
                if (puVar9 != (undefined *)0x20000020) goto LAB_8009e248;
...
// void /*$ra*/ PointAt(struct _Instance *instance /*$s0*/, struct _Position *Target /*$s1*/, struct _Rotation *Rot1 /*$s2*/)
 // line 1393, offset 0x8009e2f0
	/* begin block 1 */
		// Start line: 1394
		// Start offset: 0x8009E2F0
		// Variables:
...
// void /*$ra*/ ThrowSetFocusPoint(struct _Instance *instance /*$s4*/, struct _Rotation *rot /*$s2*/)
 // line 1431, offset 0x8009e410
	/* begin block 1 */
		// Start line: 1432
		// Start offset: 0x8009E410
		// Variables:
...
// void /*$ra*/ StateHandlerGrab(struct __CharacterState *In /*$s1*/, int CurrentSection /*$s3*/, int Data /*$s7*/)
 // line 1539, offset 0x8009e6c4
	/* begin block 1 */
		// Start line: 1540
		// Start offset: 0x8009E6C4
		// Variables:
	...
	// 		int Anim; // $s4
		...
		/* begin block 1.1 */
			// Start line: 1573
			// Start offset: 0x8009E910
			// Variables:
		// 		struct _Instance *Inst; // $a1
		/* end block 1.1 */
		// End offset: 0x8009E960
		// End Line: 1584

		/* begin block 1.2 */
			// Start line: 1610
			// Start offset: 0x8009E9D0
			// Variables:
		// 		struct _Instance *Inst; // $s0
		/* end block 1.2 */
		...
		/* begin block 1.3 */
			// Start line: 1715
			// Start offset: 0x8009EBC4
			// Variables:
		// 		struct _Instance *Inst; // $s0
		/* end block 1.3 */
		// End offset: 0x8009EC74
		// End Line: 1747

		/* begin block 1.4 */
			// Start line: 1754
			// Start offset: 0x8009EC8C
			// Variables:
		// 		struct _Instance *Inst; // $s0
		/* end block 1.4 */
		// End offset: 0x8009ECDC
		// End Line: 1766
		...
		// 		struct _Instance *Inst; // $s0
		/* end block 1.5 */
		// End offset: 0x8009ED8C
		// End Line: 1787
	/* end block 1 */
	// End offset: 0x8009EE00
	// End Line: 1819
          ...
          if ((int)puVar3 < 1) {
            if (puVar3 != &DAT_80000008) {
              if ((int)puVar3 < -0x7ffffff7) {
                if (puVar3 != (undefined *)0x80000000) goto LAB_8009ede8;
              }
              else {
                if (puVar3 != &DAT_80000020) goto LAB_8009ede8;
              }
            }
          }
          else {
            if (puVar3 == &DAT_00100004) {
              Inst = razGetHeldItem();
              if (Inst != (_Instance *)0x0) goto LAB_8009ec34;
            }
            else {
              if ((int)puVar3 < 0x100005) {
                if (puVar3 != &DAT_00100001) goto LAB_8009ede8;
                if (CurrentSection == 0) {
                ...
                if (puVar3 != &DAT_00100014) goto LAB_8009ede8;
        ...
        if ((int)puVar3 < 0x4010081) {
          if (puVar3 != (undefined *)0x1000001) {
            if ((int)puVar3 < 0x1000002) {
              ...
              if (puVar3 == (undefined *)0x1000006) goto LAB_8009ecdc;
            }
LAB_8009ede8:
            DefaultStateHandler(In,CurrentSection,Data);
          }
          ...
          if (puVar3 == (undefined *)0x8000000) {
            ...
            if ((int)puVar3 < 0x8000001) {
              if (puVar3 != (undefined *)0x4020000) goto LAB_8009ede8;
            }
            else {
              if (puVar3 == (undefined *)0x10000000) {
                ...
                if (puVar3 != (undefined *)0x20000020) goto LAB_8009ede8;
                if (CurrentSection == 0) {
