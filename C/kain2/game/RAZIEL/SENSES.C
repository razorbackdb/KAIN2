...

{
  ...
  if ((Attribute & 1) != 0)
  {
    ...
    {
      Ptr->xyDistance = (int)(Ptr->xyDistance + ((uint)Ptr->xyDistance >> 0x1f)) >> 1;
      Ptr->zDelta = (int)(Ptr->zDelta + ((uint)Ptr->zDelta >> 0x1f)) >> 1;
    }
    Inst = Ptr->instance->LinkParent;
    if ((((Inst == (_Instance *)0x0) || (uVar3 = INSTANCE_Query(Inst, 0), (uVar3 & 0x40000000) != 0)) && (Ptr->xyDistance < 0x200)) && (Ptr->zDelta + 0xffU < 0x37f))
    {
  ...
  if ((Attribute & 0x80) != 0)
  {
    ...
    if (((((uVar6 & (uint) * (ushort *)(Attribute + 8)) != 0) ||
          ((uVar6 & (uint) * (ushort *)(Attribute + 10)) != 0)) &&
  ...
  case 0:
    ...
    if (0xf < Raziel.HealthBalls)
    {
      Raziel.HealthBalls = 0xf;
    }
    Data_00 = (int)((uint)(ushort)Raziel.HealthBalls << 0x10) >> 0x10;
    in_t3 = (undefined4)((ulonglong)((longlong)Data_00 * 0x66666667) >> 0x20);
    if ((int)Raziel.HealthScale <
        (((Data_00 / 5 + (Data_00 >> 0x1f)) -
          ((int)((uint)(ushort)Raziel.HealthBalls << 0x10) >> 0x1f)) *
             0x10000 >>
         0x10) +
            1)
    {
  ...
  case 2:
    ...
    Data_01 = (uint) * (byte *)(Attribute + 10) << 0x11;
    if ((Raziel.Abilities & Data_01) == 0)
    {
      debugRazielFlags1 = Raziel.Abilities | Data_01;
      Data_01 = (uint)Raziel.GlyphManaMax + ((int)((int)*(short *)(Attribute + 10) & 0xff00U) >> 8);
      Raziel.GlyphManaMax = (ushort)Data_01;
      if (0x34 < (Data_01 & 0xffff))
      {
...
LAB_800a410c:
  ...
  if ((((((Inst->object->oflags2 & 0x1000000U) != 0) && ((Inst->flags & 0x800U) == 0)) &&
       ...
       ((Raziel.CurrentPlane == 2 && (Ptr->xyDistance < 0x1c2)))) &&
      (Ptr->zDelta + 0x3fU < 0x7f))
  {
