...
// int /*$ra*/ SetEngagedInstance(struct __Player *player /*$t0*/, struct evCollideInstanceStatsData *Ptr /*$a1*/, unsigned long Attribute /*$a2*/)
 // line 4, offset 0x800a32c4
	/* begin block 1 */
		// Start line: 5
		// Start offset: 0x800A32C4
		// Variables:
	// 		int rc; // $t1
	/* end block 1 */
	// End offset: 0x800A3354
	// End Line: 23
...
// void /*$ra*/ UpdateEngagementList(struct evCollideInstanceStatsData *Ptr /*$s3*/, struct __Player *player /*$s4*/)
 // line 29, offset 0x800a335c
	/* begin block 1 */
		// Start line: 30
		// Start offset: 0x800A335C
		// Variables:
	// 		int WhoAmI; // $s5
	// 		int Ability; // $s1
	// 		int hidden; // $s6
	// 		struct PhysObCollectibleProperties *collectibleProp; // $s1
		...
		// 		int testConditions; // $s2
			...
			// End Line: 192
		/* end block 1.4 */
		// End offset: 0x800A3940
		// End Line: 230

		/* begin block 1.5 */
			// Start line: 235
			// Start offset: 0x800A3960
			// Variables:
		...
		// 		long rootDistance; // $a1
			...
			/* begin block 1.5.1 */
				// Start line: 286
				// Start offset: 0x800A3B50
				// Variables:
			// 		unsigned long ability_bit; // $v1
			/* end block 1.5.1 */
			// End offset: 0x800A3B7C
			// End Line: 294
		/* end block 1.5 */
		// End offset: 0x800A3C2C
		// End Line: 322

		/* begin block 1.6 */
			// Start line: 484
			// Start offset: 0x800A4074
			// Variables:
		// 		struct _Instance *Inst; // $a0
		/* end block 1.6 */
		// End offset: 0x800A40AC
		// End Line: 490

		/* begin block 1.7 */
			// Start line: 497
			// Start offset: 0x800A40E4
			// Variables:
		...
		// 		struct VECTOR out; // stack offset -48
			...
			/* begin block 1.7.1 */
				// Start line: 506
				// Start offset: 0x800A415C
				// Variables:
			// 		int rc; // $v0
			/* end block 1.7.1 */
			// End offset: 0x800A42E0
			// End Line: 538
		/* end block 1.7 */
		// End offset: 0x800A42E0
		// End Line: 539
	/* end block 1 */
	// End offset: 0x800A4438
	// End Line: 587
...

{
  ...
  if ((uVar2 & 0x20) == 0) {
    if ((((uVar2 & 10) == 0) && ((Inst->flags2 & 0x20U) == 0)) ||
       ((Inst->flags2 & 0x20000000U) != 0)) {
    ...
    if ((Attribute & 0x44000000) != 0) goto LAB_800a3fe4;
    Inst = Ptr->instance;
    if ((Inst->flags2 & 0x20U) != 0) {
      if ((Ptr->xyDistance < 0x780) && (Ptr->zDelta + 0x1ffU < 0x3ff)) {
        if ((ControlFlag & 4U) == 0) {
          if ((Inst != Raziel.Senses.LastAutoFace) ||
             (Raziel.Senses.CurrentAutoFace == (_Instance *)0x0)) goto LAB_800a3d88;
        }
        else {
...
LAB_800a3d9c:
            ...
            if (Inst == Raziel.Senses.CurrentAutoFace) {
              Data_00 = SetEngagedInstance(player,Ptr,6);
              if (Data_00 != 0) goto LAB_800a3d9c;
              Raziel.Senses.CurrentAutoFace = (_Instance *)0x0;
            }
          }
        }
      }
      if (((-1 < Ptr->instance->object->oflags2) && (0x280 < Ptr->distance)) &&
    ...
    if ((uVar2 & 10) != 0) {
      ...
      if ((((uVar2 & 10) != 0) && (Ptr->xyDistance < 0x3c0)) &&
         ((Ptr->zDelta + 0xffU < 0x1ff &&
          (Data_00 = MATH3D_ConeDetect(&Ptr->relativePosition,0x555,0x38e), Data_00 != 0)))) {
  ...
  if ((Attribute & 0x80) != 0) {
    ...
    if (((*(ushort *)(Attribute + 8) & 1) == 0) && ((*(ushort *)(Attribute + 10) & 1) == 0)) {
      ...
      if (Inst == (_Instance *)0x0) {
        uVar6 = 0x800;
        Data_00 = GetMaxHealth();
        if (Raziel.HitPoints == Data_00) {
  ...
  if ((Attribute == 0) || (Data_01 != 0)) goto switchD_800a3a8c_caseD_7;
  ...
  local_3c = CONCAT22(local_3c._2_2_,*(undefined2 *)((gameTrackerX.playerInstance)->matrix[1].t + 2)
                     );
  uVar6 = MATH3D_DistanceBetweenPositions((_Position *)&local_40,(_Position *)&local_38);
  uVar5 = *(uint *)(Attribute + 0xc);
  if (((uVar5 <= Ptr->distance) && (uVar5 <= Data_01)) && (uVar5 <= uVar6))
  goto switchD_800a3a8c_caseD_7;
...
LAB_800a3b40:
  ...
  case 2:
    ...
    uVar6 = (uint)*(byte *)(Attribute + 10) << 0x11;
    Data_01 = Raziel.Abilities | uVar6;
    if ((Raziel.Abilities & uVar6) == 0) {
      Raziel.GlyphManaBalls =
           Raziel.GlyphManaMax + ((ushort)((uint)(int)*(short *)(Attribute + 10) >> 8) & 0xff);
      debugRazielFlags1 = Data_01;
      Raziel.Abilities = Data_01;
...
LAB_800a3fe4:
  ...
  Inst = Ptr->instance;
  if ((Inst->object->oflags2 & 0x4000000U) != 0) {
    if ((Raziel.constrictFlag & 0x20U) != 0) {
      local_40 = (int)(Inst->position).x - (int)Raziel.constrictCenter.x;
      local_38 = 0;
  ...
  if ((((((Inst->object->oflags2 & 0x1000000U) != 0) && ((Inst->flags & 0x800U) == 0)) &&
       (gameTrackerX.gameData.asmData.MorphType != 0)) &&
      ((Raziel.CurrentPlane == 2 && (Ptr->xyDistance < 0x1c2)))) && (Ptr->zDelta + 0x3fU < 0x7f)) {
...
// long /*$ra*/ UpdateAutoFaceAngle(struct _Instance *player /*$a0*/, struct _Instance *instance /*$a1*/)
 // line 592, offset 0x800a4460
	/* begin block 1 */
		// Start line: 593
		// Start offset: 0x800A4460
		// Variables:
	// 		long rc; // $v0
	/* end block 1 */
	// End offset: 0x800A4460
	// End Line: 593
