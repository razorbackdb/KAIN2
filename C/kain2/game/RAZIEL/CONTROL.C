...
// void /*$ra*/ ResetPhysics(struct _Instance *instance /*$s2*/, short gravity /*$s3*/)
 // line 36, offset 0x8009a1ac
	/* begin block 1 */
		// Start line: 37
		// Start offset: 0x8009A1AC
		// Variables:
	// 		int i; // $s1
	/* end block 1 */
	// End offset: 0x8009A22C
	// End Line: 45
...
// void /*$ra*/ SetImpulsePhysics(struct _Instance *instance /*$t1*/, struct __Player *player /*$a1*/)
 // line 67, offset 0x8009a310
	/* begin block 1 */
		// Start line: 68
		// Start offset: 0x8009A310

		/* begin block 1.1 */
			// Start line: 70
			// Start offset: 0x8009A324
			// Variables:
		// 		int Dot; // $a3
		// 		int vLength; // $a2
		/* end block 1.1 */
		// End offset: 0x8009A438
		// End Line: 87
	/* end block 1 */
	// End offset: 0x8009A438
	// End Line: 91
...
// void /*$ra*/ InitExternalForces(struct __Force *Forces /*$a0*/, int MaxForces /*$a1*/)
 // line 147, offset 0x8009a478
	/* begin block 1 */
		// Start line: 149
		// Start offset: 0x8009A478
		// Variables:
	// 		int i; // $a1
	/* end block 1 */
	// End offset: 0x8009A4AC
	// End Line: 157
...
// void /*$ra*/ ProcessPhysics(struct __Player *player /*$s3*/, struct __CharacterState *In /*$s2*/, int CurrentSection /*$a2*/, int Mode /*$a3*/)
 // line 188, offset 0x8009a560
	/* begin block 1 */
		// Start line: 189
		// Start offset: 0x8009A560
		// Variables:
	// 		int time; // $s1

		/* begin block 1.1 */
			// Start line: 233
			// Start offset: 0x8009A6C0
		/* end block 1.1 */
		// End offset: 0x8009A6D4
		// End Line: 244

		/* begin block 1.2 */
			// Start line: 246
			// Start offset: 0x8009A6D4
		/* end block 1.2 */
		// End offset: 0x8009A73C
		// End Line: 258
	/* end block 1 */
	// End offset: 0x8009A73C
	// End Line: 289
...
// void /*$ra*/ ApplyExternalLocalForces(struct __Player *player /*$a0*/, struct _Instance *instance /*$a1*/, struct __Force *Forces /*$a2*/, int MaxForces /*$a3*/, struct _Vector *Out /*stack 16*/)
 // line 347, offset 0x8009a758
	...
	// 		int i; // $t1
		...
		/* begin block 1.1 */
			// Start line: 385
			// Start offset: 0x8009A85C
			// Variables:
		// 		int friction; // $a1
		/* end block 1.1 */
		// End offset: 0x8009A8E8
		// End Line: 394
	/* end block 1 */
	// End offset: 0x8009A8F8
	// End Line: 397
