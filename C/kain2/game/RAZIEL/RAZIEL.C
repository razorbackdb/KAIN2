...

{
  ...
  *(char **)&PlayerInstance->InstanceState = &CHAR____800d5218;
  ...
  G2AnimSection_SetInterpInfo
            ((PlayerInstance->anim).section + 1,(_G2AnimInterpInfo_Type *)&vramBlockList);
  G2AnimSection_SetInterpInfo
            ((PlayerInstance->anim).section + 2,(_G2AnimInterpInfo_Type *)&vramBlockList.x);
  _CHAR____800d5574 = 1;
  theCamera.core._212_4_ = theCamera.core._212_4_ | 0x800;
  InitHealthSystem();
...

{
  ...
  if (p_Var1 == (_Instance *)0x0) {
    StateHandlerIdle((__CharacterState *)0x0,3,0x68);
    return;
  }
  if (CurrentSection == 1) {
    if (local_18 - 2U < 3) {
...

{
  ...
  In_00 = (__CharacterState *)&In->SectionList[CurrentSection].Event;
  p_Var2 = PeekMessageQueue((__MessageQueue *)In_00);
  if (p_Var2 == (__Event *)0x0) {
    if (((((CurrentSection == 0) &&
          (CurrentSection_00 = CheckHolding(In->CharacterInstance), CurrentSection_00 == 0)) &&
         (iVar1 != 0x37)) &&
        ((iVar1 != 0xd6 && (_CHAR____800d5654 = _CHAR____800d5654 + 1, 300 < _CHAR____800d5654))))
      ...
      G2EmulationInstanceToInstanceSwitchAnimationCharacter
                (In->CharacterInstance,_CHAR____800d5658,1,0,3,1);
    }
    return;
  }
      ...
      if ((_CHAR____800d55f0 & 0x2010) == 0) {
        ...
        if ((_CHAR____800d55f0 & 0x4000) == 0) {
          ...
          if (((CurrentSection_00 == 0) || (CurrentSection != 0)) ||
             ((_CHAR____800d55b0 & 0x80) != 0)) goto LAB_800a8e10;
          NewProcess = StateHandlerAttack2;
        }
        else {
          if (CurrentSection != 0) goto LAB_800a8e10;
...
LAB_800a8df0:
    ...
    if ((int)puVar3 < 0x2000001) {
      if (puVar3 == &DAT_80000002) {
        StateHandlerDropAction(In_00,CurrentSection_00,Mode);
        return;
      }
      if ((int)puVar3 < -0x7ffffffd) {
        if (puVar3 == (undefined *)0x80000000) {
          if ((_CHAR____800d55b0 & 0x80) != 0) goto LAB_800a8e10;
          NewProcess = StateHandlerAttack2;
LAB_800a8b34:
        ...
        if ((int)puVar3 < 0x100002) {
          if (puVar3 == &DAT_80000010) {
            if ((CurrentSection != 0) || ((_CHAR____800d55b0 & 4) == 0)) goto LAB_800a8e10;
            if (((_CHAR____800d55b0 & 0x80) != 0) || ((theCamera.positionAccl._4_4_ & 4) != 0)) {
                    /* WARNING: Subroutine does not return */
      ...
      if (puVar3 == (undefined *)0x4010400) {
        if ((((*(uint *)(p_Var2->Data + 0x20) & 0x20000) != 0) && ((_CHAR____800d561c & 1) != 0)) &&
           (_CHAR____800d564c == 2)) {
      ...
      if ((int)puVar3 < 0x4010401) {
        if ((int)puVar3 < 0x2000003) goto LAB_800a8e10;
        ...
        if ((int)puVar3 < 0x8000001) {
          ...
          if (puVar3 == (undefined *)0x10000000) {
            if ((*gameTracker._4_4_ & LONG_ARRAY_800cf57c[0]) == 0) {
              ...
              if (0x200 < _CHAR____800d5598) {
                if (CurrentSection == 1) {
                  if (In->CharacterInstance->LinkChild != (_Instance *)0x0) {
                    StateSwitchStateData(In,1,StateHandlerStartTurn,0);
                    pp_Var4[0x47] = (_Instance *)0x33;
                    goto LAB_800a8e10;
                  }
                  CurrentSection_00 = 1;
                  Mode = CurrentSection;
  ...
  if (puVar2 == (undefined *)0x100000) {
    ...
    if ((int)puVar2 < 0x100001) {
      if (puVar2 != &DAT_00040005) {
        ...
        if (puVar2 != &UNK_00040025) goto LAB_800a91ec;
      }
      Data_00 = p_Var1->Data;
      ...
      if (puVar2 != (undefined *)0x1000000) goto LAB_800a91ec;
      if (CurrentSection == 0) {
...

{
  ...
  if (puVar2 != &DAT_00100001) {
    if ((int)puVar2 < 0x100002) {
      if (puVar2 == &DAT_80000008) goto LAB_800a9950;
        ...
        if ((int)puVar2 < -0x7fffffff) {
          if (Inst != (_Instance *)0x0) {
            razSwitchVAnimGroup(In->CharacterInstance,CurrentSection,0x50,-1,-1);
                    /* WARNING: Subroutine does not return */
            pp_Var3[0x48] = (_Instance *)0x50;
            INSTANCE_Post(Inst,0x200005,0);
          }
          goto LAB_800a9950;
        }
        if (puVar2 == &DAT_80000004) goto LAB_800a9950;
      }
      else {
        if (puVar2 == &DAT_80000020) {
          if ((NewAnim == 5) || (NewAnim == 0x55)) goto LAB_800a9950;
        }
        else {
...
LAB_800a9848:
              if (((NewAnim != 5) && (NewAnim != 0x55)) && (pp_Var3[0x48] != (_Instance *)0x50)) {
                    /* WARNING: Subroutine does not return */
                SetPhysicsWallCrawlData(0,0,3,in_a3);
              }
              goto LAB_800a9950;
      ...
      if (puVar2 == (undefined *)0x4020000) goto LAB_800a9950;
      if ((int)puVar2 < 0x4020001) {
        ...
        if ((int)puVar2 < 0x2000001) {
          ...
          if (puVar2 == (undefined *)0x4010400) goto LAB_800a9950;
        }
      }
      else {
        ...
        if ((int)puVar2 < 0x10000001) {
          if (puVar2 == (undefined *)0x8000000) {
            ...
            if (CurrentSection == 1) {
              ...
              pp_Var3[0x48] = (_Instance *)0x4c;
              Inst = In->CharacterInstance;
              In->SectionList[2].Data2 = 0x4c;
              NewAnim = razSwitchVAnimCharacterGroup(Inst,0x4c,(int *)0x0,(int *)0x0);
              if (NewAnim != 0) {
          ...
          if (puVar2 == (undefined *)0x20000008) goto LAB_800a9848;
        }
      }
    }
    DefaultStateHandler(In,CurrentSection,Data);
...

{
  ...
  if ((int)puVar2 < 0x8000001) {
    if (puVar2 == (undefined *)0x80000001) goto LAB_800a9c38;
    if (puVar2 == &DAT_00100001) {
      In_00 = In;
      Inst = razGetHeldItem();
      if ((Inst != (_Instance *)0x0) && (CurrentSection == 1)) {
        if (_CHAR____800d5600 == 2) {
          ...
          if (2 < _CHAR____800d5600) {
            StateHandlerSoulSuck(In_00,NewAnim,Data_00);
            return;
          }
          ...
          NewAnim = 0x53;
                    ...
                    /* WARNING: Subroutine does not return */
        G2EmulationSwitchAnimation(In,1,NewAnim,0,3,1);
      }
      if (CurrentSection == 2) {
...

{
  ...
  if ((InterfaceItems.name._0_4_ & 3) == 0) {
    ...
    if ((int)puVar3 < 0x1000007) {
      if (puVar3 == &DAT_00100001) {
        ...
        if (CurrentSection == 1) {
          ...
          if ((p_Var2 == (_Instance *)0x0) && ((_CHAR____800d55f0 & 0x1000) == 0)) {
            Frames = 0x4e;
          }
          else {
            Frames = 0x5e;
      ...
      if ((int)puVar3 < 0x100002) {
        if (puVar3 == &DAT_80000010) goto LAB_800aa16c;
      }
      else {
        if (puVar3 == &DAT_00100004) {
          if (CurrentSection == 1) {
            ...
            if ((_CHAR____800d55f0 & 0x1000) == 0) goto LAB_800aa16c;
            goto LAB_800a9fac;
          }
          goto LAB_800aa16c;
        }
        if (puVar3 == (undefined *)0x1000001) goto LAB_800aa16c;
      }
    }
    else {
...
LAB_800aa11c:
        ...
        if (puVar3 == (undefined *)0x1000016) {
          if (((theCamera.core._212_4_ & 0x800) != 0) && (CurrentSection == 1)) {
        ...
        if (puVar3 == (undefined *)0x20000002) goto LAB_800a9f14;
      }
    }
    DefaultStateHandler(In,CurrentSection,Data);
  }
...
LAB_800aa2b4:
    if (CurrentSection != 0) goto LAB_800aa374;
    ...
    if (0x100000 < (int)puVar3) {
      ...
      if (puVar3 != (undefined *)0x8000000) goto LAB_800aa36c;
      goto LAB_800aa2b4;
    }
    if (puVar3 != (undefined *)0x80000001) {
...

{
  ...
  if (p_Var1 == (__Event *)0x0) {
    ...
    if (((_CHAR____800d5588 != 0) && (_CHAR____800d5588 < 0x1000)) && ((_CHAR____800d5720 & 1) != 0)
       ) {
...
LAB_800aa6c0:
      if (CurrentSection != 0) goto LAB_800aa990;
...
LAB_800aa6fc:
    ...
    if ((int)puVar4 < -0x7ffffffd) {
      if (puVar4 == (undefined *)0x80000000) {
        ...
        if ((CurrentSection != 0) || ((_CHAR____800d55b0 & 0x80) != 0)) goto LAB_800aa990;
        NewProcess = StateHandlerAttack2;
        goto LAB_800aa940;
      }
...
LAB_800aa7f0:
      ...
      if (puVar4 == &DAT_80000010) goto LAB_800aa6c0;
      if ((int)puVar4 < -0x7fffffef) {
        ...
        if (puVar4 == (undefined *)0x0) goto LAB_800aa6fc;
      }
    }
  }
  else {
    ...
    if ((int)puVar4 < 0x4010402) {
      if (puVar4 == (undefined *)0x4000001) {
        if ((CurrentSection != 0) || (iVar2 = G2EmulationQueryFrame(In,0), iVar2 < 7))
        goto LAB_800aa990;
        PhysicsMode.next = (_BlockVramEntry *)0x0;
        SetExternalForce((__Force *)In->CharacterInstance,0x5214,y,z,local_20,in_stack_ffffffe4);
        if (-0x21 < In->CharacterInstance->zVel) goto LAB_800aa990;
...
LAB_800aa858:
        ...
        if (puVar4 == (undefined *)0x10000000) goto LAB_800aa990;
      }
    }
  }
  DefaultStateHandler(In,CurrentSection,Data);
...
LAB_800aafdc:
    if (CurrentSection != 0) goto LAB_800ab3d0;
    if (((_CHAR____800d559c == 9) || (_CHAR____800d559c == 0xe)) || (_CHAR____800d559c == 0xf)) {
      razApplyMotion(In,0);
      goto LAB_800ab3d0;
    }
    if (((_CHAR____800d5574 == 2) || (Data_00 == 0x7b)) || (Data_00 == 0x7c)) {
                    /* WARNING: Subroutine does not return */
      SetPhysicsWallCrawlData(0,0,3,in_a3);
    }
    if (_CHAR____800d5574 != 0x1000000) {
      if ((p_Var2->Data < 4) && ((_BlockVramEntry_800d59a0._12_4_ & 0x800000) == 0)) {
        _BlockVramEntry_800d59a0._12_4_ = _BlockVramEntry_800d59a0._12_4_ | 0x2000;
        if ((*gameTracker._4_4_ & 0x8000000f) == 0) {
                    /* WARNING: Subroutine does not return */
...
LAB_800ab380:
    ...
    if ((int)puVar4 < 1) {
      if (puVar4 == &DAT_80000002) {
LAB_800aaf84:
        if ((*gameTracker._4_4_ & LONG_800cf578) != 0) goto LAB_800ab3d0;
LAB_800aafa0:
        if (CurrentSection != 0) goto LAB_800ab3d0;
        if (In->CharacterInstance->tface != (_TFace *)0x0) {
                    /* WARNING: Subroutine does not return */
...
LAB_800ab390:
          ...
          if (pp_Var1[0x48] == (_Instance *)0x44) {
          ...
          if (pp_Var1[0x48] != (_Instance *)0x38) goto LAB_800ab390;
          p_Var3 = razGetHeldItem();
          if ((p_Var3 == (_Instance *)0x0) || (CurrentSection != 0)) goto LAB_800ab3d0;
...
LAB_800ab2a8:
        ...
        if (puVar4 == &DAT_80000008) goto LAB_800ab3d0;
        if ((int)puVar4 < -0x7ffffff7) {
          ...
          if (puVar4 == &DAT_80000010) goto LAB_800aafa0;
        }
      }
    }
    else {
...
LAB_800ab2c4:
        ...
        if ((int)puVar4 < 0x20000005) {
          ...
          if (puVar4 == (undefined *)0x20000008) goto LAB_800ab204;
        }
      }
    }
    DefaultStateHandler(In,CurrentSection,Data);
...
LAB_800ab688:
    ...
    if ((int)puVar2 < -0x7ffffffd) {
      ...
      if (puVar2 == &DAT_80000010) goto LAB_800ab688;
    }
  }
  else {
    if ((int)puVar2 < 0x8000002) {
      ...
      if (puVar2 == (undefined *)0x2000000) goto LAB_800ab688;
...

{
  ...
  if (puVar6 == (undefined *)0x4000001) goto LAB_800abb1c;
...
LAB_800abb00:
    ...
    if ((int)puVar6 < -0x7fffffff) goto LAB_800abb1c;
    if (puVar6 == &DAT_00100001) {
      if (CurrentSection == 0) {
        ...
        if (_CHAR____800d5574 == 0x10) {
          ...
          if ((_CHAR____800d5574 < 0x11) || (_CHAR____800d5574 != 0x20)) goto LAB_800abb1c;
          SteerSwitchMode(In->CharacterInstance,4);
          sVar1 = (In->CharacterInstance->rotation).z;
          p_Var7 = In->CharacterInstance;
          lVar3 = 0x15;
    ...
    if ((int)puVar6 < 0x8000001) {
      if (puVar6 == (undefined *)0x4020000) goto LAB_800abb1c;
    }
    else {
...

{
  ...
  puVar2 = (undefined *)p_Var1->ID;
  if (puVar2 == (undefined *)0x1000001) goto LAB_800abf4c;
  if ((int)puVar2 < 0x1000002) {
    if (puVar2 == &DAT_80000008) goto LAB_800abf4c;
    if ((int)puVar2 < -0x7ffffff7) {
      if (puVar2 == (undefined *)0x80000000) goto LAB_800abf4c;
      if (puVar2 == (undefined *)0x80000001) {
      ...
      if (puVar2 == &DAT_00040005) goto LAB_800abf4c;
      if ((int)puVar2 < 0x40006) {
        if (puVar2 == &DAT_80000020) goto LAB_800abf4c;
      }
      else {
        if (puVar2 == &DAT_00100001) {
          if (CurrentSection == 0) {
  ...
  if (puVar2 == (undefined *)0x4020000) goto LAB_800abf4c;
  if ((int)puVar2 < 0x4020001) {
    if (puVar2 == (undefined *)0x4000001) goto LAB_800abf4c;
    if ((int)puVar2 < 0x4000002) {
      ...
      if (puVar2 == (undefined *)0x4010008) goto LAB_800abf4c;
    }
    goto LAB_800abf44;
  }
...
LAB_800abdb8:
    ...
    if (puVar2 == (undefined *)0x20000001) {
      In->SectionList[CurrentSection].Data2 = 1;
      if (CurrentSection != 0) goto LAB_800abf4c;
      ...
      if (In->SectionList[0].Data1 == 0) {
        ...
        if (NewAnim + 4 != 0) goto LAB_800abe58;
      }
      else {
LAB_800abe58:
        NewAnim = G2EmulationQueryFrame(In,0);
        if (In->SectionList[0].Data1 < NewAnim) {
          SetExternalForce((__Force *)In->CharacterInstance,0x5214,y,in_a3,local_28,
                           in_stack_ffffffdc);
          NewAnim = razSwitchVAnimCharacterGroup(In->CharacterInstance,8,(int *)0x0,(int *)0x0);
          if (NewAnim != 0) {
...

{
  ...
  puVar2 = (undefined *)p_Var1->ID;
  if (puVar2 == (undefined *)0x1000001) goto LAB_800ac3b8;
  if ((int)puVar2 < 0x1000002) {
    if (puVar2 == &DAT_80000020) goto LAB_800ac3b8;
    if ((int)puVar2 < -0x7fffffdf) {
      if (puVar2 == (undefined *)0x80000001) {
        if (((_CHAR____800d5600 != 3) && ((_BlockVramEntry_800d59a0._12_4_ & 0x2000000) == 0)) &&
           (CurrentSection == 0)) {
          StateSwitchStateCharacterData(In,StateHandlerGlide,3);
        }
        goto LAB_800ac3b8;
      }
      if (((int)puVar2 < -0x7fffffff) || (puVar2 == &DAT_80000008)) goto LAB_800ac3b8;
    }
    else {
      if (puVar2 == (undefined *)0x100000) {
      ...
      if ((int)puVar2 < 0x100001) {
        ...
        if (puVar2 == &DAT_00100001) {
          ...
          if ((p_Var1->Data != 0) && ((*gameTracker._4_4_ & LONG_800cf56c) != 0)) {
                    /* WARNING: Subroutine does not return */
            EnMessageQueueData(&p_Var4->Defer,-0x7fffffff,0);
          }
          goto LAB_800ac3b8;
        }
      }
    ...
    if (puVar2 == (undefined *)0x4020000) {
      iVar3 = p_Var1->Data;
      if (((*(short *)(iVar3 + 0xc) < 0) && (instance = In->CharacterInstance, instance->zVel == 0))
         && (-1 < instance->zAccl)) {
      ...
      y = *(short *)(iVar3 + 0xe);
      if (((y < 0) && (y != -0x7fff)) && (_CHAR____800d564c == 1)) {
        _BlockVramEntry_800d59a0._12_4_ = _BlockVramEntry_800d59a0._12_4_ | 0x2000000;
      }
      goto LAB_800ac3b8;
    }
    if ((int)puVar2 < 0x4020001) {
      if (puVar2 == (undefined *)0x4000001) goto LAB_800ac3b8;
      if ((int)puVar2 < 0x4000002) {
        if (puVar2 == (undefined *)0x2000000) {
          razPickupAndGrab(In,CurrentSection);
          goto LAB_800ac3b8;
        ...
        if (puVar2 == (undefined *)0x4010008) {
                    /* WARNING: Subroutine does not return */
          EnMessageQueueData(&p_Var4->Event,0x4010008,0);
        }
      }
    }
    else {
      if (puVar2 == (undefined *)0x10000000) goto LAB_800ac3b8;
      if ((int)puVar2 < 0x10000001) {
        if (puVar2 == (undefined *)0x8000000) goto LAB_800ac3b8;
      }
      else {
        if (puVar2 == (undefined *)0x20000001) {
          if (((_CHAR____800d5574 != 0x10) && (_CHAR____800d5574 != 0x20)) && (CurrentSection == 0))
          {
            SetExternalForce((__Force *)In->CharacterInstance,0x5214,y,in_a3,local_28,local_24);
          }
          goto LAB_800ac3b8;
        }
      }
...
LAB_800ac570:
  ...
  if ((int)puVar2 < 0x100001) {
    if (puVar2 == &DAT_80000008) goto LAB_800ac5ac;
    if ((int)puVar2 < -0x7ffffff7) {
      if ((int)puVar2 < -0x7ffffffe) goto LAB_800ac5ac;
    }
    else {
      if (puVar2 == &DAT_80000020) goto LAB_800ac5ac;
    }
  }
  else {
    if (puVar2 == (undefined *)0x4010008) goto LAB_800ac570;
    if ((int)puVar2 < 0x4010009) {
      if (puVar2 == &DAT_00100001) {
        if (CurrentSection == 0) {
          ...
          _CHAR____800d577c = SOUND_Play3dSound(&In->CharacterInstance->position,0x1e,0,0x3c,0xdac);
        }
        goto LAB_800ac5ac;
      }
      if (puVar2 == &DAT_00100004) {
...

{
  ...
  Data_00 = G2EmulationQueryAnimation(In,CurrentSection);
  if (CurrentSection == 0) {
    InterfaceItem_800cf854.name._44_4_ = InterfaceItem_800cf854.name._44_4_ + 1;
  }
  p_Var1 = PeekMessageQueue(&In->SectionList[CurrentSection].Event);
  if (p_Var1 == (__Event *)0x0) {
    return;
  ...
  if ((int)puVar2 < 0x100005) {
    if (puVar2 == &DAT_80000008) goto LAB_800aca08;
    if ((int)puVar2 < -0x7ffffff7) {
      if (puVar2 == (undefined *)0x80000000) goto LAB_800aca08;
    }
    else {
    ...
    if (puVar2 == (undefined *)0x4010400) {
      if ((((*(uint *)(p_Var1->Data + 0x20) & 0x20000) != 0) && ((_CHAR____800d561c & 1) != 0)) &&
         (_CHAR____800d564c == 2)) {
                    /* WARNING: Subroutine does not return */
    ...
    if ((int)puVar2 < 0x4010401) {
      ...
      if (puVar2 == (undefined *)0x8000004) {
        if ((_CHAR____800d55f0 & 1) != 0) {
          ...
          Data_00 = SetPhysicsSwimData(-(int)_CHAR____800d55b4,(_SVector *)-(int)_CHAR____800d55b6,6
                                       ,0,0);
                    /* WARNING: Subroutine does not return */
...

{
  ...
  if (puVar3 != &DAT_00100001) {
    if ((int)puVar3 < 0x100002) {
      if ((puVar3 == (undefined *)0x80000000) || (puVar3 == &DAT_80000020)) goto LAB_800acd80;
    }
    else {
      if (puVar3 == (undefined *)0x8000000) {
        if ((*gameTracker._4_4_ & LONG_800cf578) == 0) {
          ...
          if (CurrentSection != 0) goto LAB_800acd70;
...
LAB_800acd70:
      ...
      if ((int)puVar3 < 0x8000001) {
        ...
        if (puVar3 == (undefined *)0x10000000) goto LAB_800acd80;
      }
    }
    DefaultStateHandler(In,CurrentSection,Data);
    goto LAB_800acd80;
  ...
  NewAnim = G2EmulationQueryAnimation(In,0);
  sVar1 = (short)NewAnim;
  if (((((_CHAR____800d5574 & 0x20) == 0) && (sVar1 != 0x11)) && (sVar1 != 0x12)) && (sVar1 != 0x13)
     ) {
    instance = In->CharacterInstance;
    if (instance->zVel < -0x100) goto LAB_800acbe4;
    ...
    if (NewAnim == 0) goto LAB_800acd80;
    NewAnim = 0x25;
  }
  else {
LAB_800acbe4:
...
/* WARNING: Removing unreachable block (ram,0x800ad480) */
/* WARNING: Removing unreachable block (ram,0x800ad4e4) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
...

{
    ...
    if ((CurrentSection == 0) && (uVar5 = In->SectionList[0].Data2, (uVar5 & 1) != 0)) {
      if ((uVar5 & 2) == 0) {
        SetExternalTransitionForce
                  ((__Force *)&_BlockVramEntry_800d58c0.type,In->CharacterInstance,10,0,0,-0x18);
  ...
  if (puVar4 == (undefined *)0x4000001) goto LAB_800ad444;
    ...
    if ((int)puVar4 < 0x8000001) {
      ...
      if (puVar4 == (undefined *)0x10000000) {
        if (local_34 != 0x10) {
          ...
          if ((_CHAR____800d5598 == 0) && (pp_Var6[0x47] == (_Instance *)0x2)) {
                    /* WARNING: Subroutine does not return */
      ...
      if ((int)puVar4 < 0x10000001) {
        ...
        if (puVar4 == (undefined *)0x20000001) {
          if (((iVar2 < 0xd) && (local_34 == 0x10)) || ((*gameTracker._4_4_ & LONG_800cf56c) != 0))
          {
                    /* WARNING: Subroutine does not return */
        ...
        if (puVar4 == (undefined *)0x20000004) {
          if (CurrentSection == 0) {
            SetExternalTransitionForce
                      ((__Force *)&_BlockVramEntry_800d58c0.type,In->CharacterInstance,4,0,0x34,
                       -0x18);
          }
                    /* WARNING: Subroutine does not return */
          G2EmulationSwitchAnimation(In,CurrentSection,0x12,0,5,2);
  ...
  if (puVar4 == &DAT_80000020) goto LAB_800ad444;
  if ((int)puVar4 < -0x7fffffdf) {
    if (puVar4 == &DAT_80000004) {
      if (CurrentSection == 1) {
        SetExternalTransitionForce
                  ((__Force *)&_BlockVramEntry_800d58c0.type,In->CharacterInstance,4,0,0x18,-0x18);
      }
                    /* WARNING: Subroutine does not return */
      G2EmulationSwitchAnimation(In,CurrentSection,0x11,0,5,2);
    }
    if ((int)puVar4 < -0x7ffffffb) {
      if (puVar4 == (undefined *)0x80000000) goto LAB_800ad444;
    }
    else {
      puVar1 = &DAT_80000008;
joined_r0x800aced8:
      if (puVar4 == puVar1) goto LAB_800ad444;
    }
  }
  else {
    if (puVar4 == &DAT_00100001) {
    ...
    if (puVar4 == (undefined *)0x1000001) goto LAB_800ad444;
  }
LAB_800ad43c:
  DefaultStateHandler(In,CurrentSection,Data);
LAB_800ad444:
...

{
  ...
  puVar2 = (undefined *)p_Var1->ID;
  if ((int)puVar2 < 0x1000002) {
    if (0xffffff < (int)puVar2) goto LAB_800ada84;
    if (puVar2 == (undefined *)0x100000) {
      if ((*gameTracker._4_4_ & 0x8000000f) == 0) {
                    /* WARNING: Subroutine does not return */
        SetPhysicsWallCrawlData(0,0,3,in_a3);
    ...
    if ((int)puVar2 < 0x100001) {
      if (puVar2 == &DAT_80000008) goto LAB_800ada84;
      if ((int)puVar2 < -0x7ffffff7) {
        if (puVar2 == (undefined *)0x80000000) goto LAB_800ada84;
      }
      else {
        if (puVar2 == &DAT_80000020) goto LAB_800ada84;
      }
    }
    else {
      if (puVar2 == &DAT_00100004) {
      ...
      if ((int)puVar2 < 0x100005) {
        if (puVar2 == &DAT_00100001) {
          ...
          if (CurrentSection == 0) {
            ...
            if (*piVar4 != 0) {
              _CHAR____800d5604 = *piVar4;
            }
            SteerSwitchMode(In->CharacterInstance,0);
          }
          if (_CHAR____800d5584 < 0) {
            CurrentSection_00 = piVar4[2];
            local_2c = 4;
          }
          else {
            CurrentSection_00 = piVar4[2];
...
LAB_800ada10:
    ...
    if (puVar2 == (undefined *)0x4010200) goto LAB_800ada84;
    if ((int)puVar2 < 0x4010201) {
      if (puVar2 == (undefined *)0x4000011) goto LAB_800ada84;
      if ((int)puVar2 < 0x4000012) {
        if (puVar2 == (undefined *)0x4000001) goto LAB_800ada84;
      }
      else {
        if (puVar2 == (undefined *)0x4010010) goto LAB_800ada84;
      }
    }
    else {
      ...
      if ((int)puVar2 < 0x8000002) {
        ...
        if (puVar2 == (undefined *)0x10000000) {
          ...
          if (local_2c == 0x10000003) {
            if (CurrentSection_00 == 6) goto LAB_800ada10;
            local_2c = p_Var1->Data;
          }
          if ((local_2c == 0x10000001) || ((*gameTracker._4_4_ & 1) != 0)) {
...

{
  ...
  if (puVar2 == &DAT_00100001) {
    ...
    if ((int)puVar2 < 0x100002) {
      if (puVar2 == &DAT_80000008) goto LAB_800addbc;
      if (puVar2 == (undefined *)0x100000) {
                    /* WARNING: Subroutine does not return */
      ...
      if (0x7ffffff < (int)puVar2) {
        ...
        if (puVar2 == (undefined *)0x8000004) {
          CurrentSection_00 =
               SetPhysicsSwimData(-(int)_CHAR____800d55b4,(_SVector *)-(int)_CHAR____800d55b6,6,0,0)
          ;
                    /* WARNING: Subroutine does not return */
...

{
  ...
  if (puVar2 == &DAT_00100015) {
    ...
    if ((int)puVar2 < 0x100016) {
      ...
      if ((int)puVar2 < 0x100002) {
        if (puVar2 == (undefined *)0x80000000) goto LAB_800ae1b8;
      }
      else {
        if (puVar2 == &DAT_00100004) goto LAB_800ae1b8;
      }
    }
    else {
      if (0x7ffffff < (int)puVar2) {
...

{
  ...
  if ((int)puVar2 < 0x100001) {
    if (puVar2 == &DAT_80000008) goto LAB_800ae7b4;
    if ((int)puVar2 < -0x7ffffff7) {
      if (puVar2 == (undefined *)0x80000000) goto LAB_800ae7b4;
    }
    else {
      if ((puVar2 == &DAT_80000010) || (puVar2 == &DAT_80000020)) goto LAB_800ae7b4;
    }
  }
  else {
    ...
    if ((int)puVar2 < 0x1000001) {
      ...
      if (puVar2 == (undefined *)0x1000001) goto LAB_800ae7b4;
      if (puVar2 == (undefined *)0x8000000) {
        if (CurrentSection == 2) {
                    /* WARNING: Subroutine does not return */
...

{
  ...
  if ((int)puVar4 < 0x100001) {
    if (puVar4 == &DAT_80000008) goto LAB_800aeeec;
    if ((int)puVar4 < -0x7ffffff7) {
      if ((int)puVar4 < -0x7ffffffe) goto LAB_800aeeec;
    }
    else {
      if ((puVar4 == &DAT_80000010) || (puVar4 == &DAT_80000020)) goto LAB_800aeeec;
    }
  }
  else {
    if (puVar4 == (undefined *)0x8000000) {
      if (iVar2 != 0x17) {
        DefaultStateHandler((__CharacterState *)0x0,CurrentSection_00,Data_00);
        return;
      }
                    /* WARNING: Subroutine does not return */
      SetPhysicsWallCrawlData(0,0,3,in_a3);
    ...
    if ((int)puVar4 < 0x8000001) {
      ...
      if (puVar4 == (undefined *)0x1000000) {
        if (CurrentSection == 0) {
          if (iVar2 != 0x16) {
            ...
            Data_00 = SetMonsterHitData(*(_Instance **)&Inst->node,
      ...
      if (puVar4 == (undefined *)0x10000000) {
        if (CurrentSection == 0) {
          theCamera.noTeleport._1_1_ = 1;
          if (((iVar2 == 0) || (iVar2 == 0x16)) && (Inst != (_Instance *)0x0)) {
            Data_00 = p_Var1->Data;
            if (Data_00 == 0x10000002) {
              uVar3 = PHYSOB_CheckSlideNormal
                                (In->CharacterInstance,-(int)_CHAR____800d55b6,
                                 (int)_CHAR____800d55b4,apeStack48);
              if ((uVar3 & 0x4002) == 0x4000) {
                Data_00 = SetPhysicsSwimData(-(int)_CHAR____800d55b6,
                                             (_SVector *)(int)_CHAR____800d55b4,2,0,0);
                    /* WARNING: Subroutine does not return */
              ...
              if (Data_00 < 0x10000003) {
                if (Data_00 == 0x10000001) {
                  theCamera.noTeleport._1_1_ = 0;
                  Data_00 = SetPhysicsSwimData(-(int)_CHAR____800d55b4,
                                               (_SVector *)-(int)_CHAR____800d55b6,5,0,0);
                    /* WARNING: Subroutine does not return */
                  INSTANCE_Post(Inst,0x800000,Data_00);
                }
              }
                ...
                if (Data_00 == 0x10000003) {
                  uVar3 = PHYSOB_CheckSlideNormal
                                    (In->CharacterInstance,(int)_CHAR____800d55b4,
                                     (int)_CHAR____800d55b6,apeStack48);
                  if ((uVar3 & 0x4002) == 0x4000) {
                    Data_00 = SetPhysicsSwimData((int)_CHAR____800d55b4,
                                                 (_SVector *)(int)_CHAR____800d55b6,4,0,0);
                    /* WARNING: Subroutine does not return */
                    INSTANCE_Post(Inst,0x800000,Data_00);
                  }
                }
                  ...
                  if ((Data_00 == 0x10000004) &&
                     ...
                     (uVar3 & 0x4002) == 0x4000)) {
                    Data_00 = SetPhysicsSwimData((int)_CHAR____800d55b6,
                                                 (_SVector *)-(int)_CHAR____800d55b4,3,0,0);
                    /* WARNING: Subroutine does not return */
                    INSTANCE_Post(Inst,0x800000,Data_00);
                  }
                }
      ...
      if ((int)puVar4 < 0x10000001) {
        if (puVar4 == (undefined *)0x8000001) {
          if ((((iVar2 == 0) || (iVar2 == 0x16)) || (iVar2 == 0x14)) &&
             ((*gameTracker._4_4_ & LONG_800cf568) == 0)) {
                    /* WARNING: Subroutine does not return */
            EnMessageQueueData(&p_Var5->Event,0x100000,0);
          }
          goto LAB_800aeeec;
        }
      }
      else {
        if (puVar4 == (undefined *)0x20000000) goto LAB_800aeeec;
      }
    }
  }
  DefaultStateHandler(In,CurrentSection,Data);
...
void StateHandlerPickupObject(__CharacterState *param_1,int param_2,int param_3,int param_4)

{
  ...
  if (puVar2 == &DAT_00100001) {
    if (param_2 == 1) {
      local_20[0] = 0xff5400;
      puGpfffffef8 = &DAT_00001108;
      uGpfffffac0 = uGpfffffac0 | 0x800;
      uGpfffffafc = uGpfffffafc | 0x80;
      uGpfffffe60 = 3;
      FX_DoInstanceOneSegmentGlowWithTime(param_1->CharacterInstance,0x29,local_20,1,0,0x4b,0x4b,10)
      ;
  ...
  if ((int)puVar2 < 0x100002) {
    if ((puVar2 == (undefined *)0x80000000) || (puVar2 == &DAT_80000020)) goto LAB_800af118;
  }
  else {
    if (puVar2 == &DAT_00100004) {
      if (param_2 == 1) {
        puGpfffffef8 = (undefined *)((uint)puGpfffffef8 & 0xffffefff);
        FX_StopAllGlowEffects(param_1->CharacterInstance,0);
      }
      goto LAB_800af118;
    }
    if (puVar2 == (undefined *)0x8000000) {
      ...
      if ((uGpfffffac0 & 0x40000) == 0) {
        if ((pTGpfffffc68 == StateHandlerIdle) ||
           (NewProcess = pTGpfffffc68,
           pTGpfffffc68 == (TDRFuncPtr_StateSwitchStateData2NewProcess)0x0)) {
                    /* WARNING: Subroutine does not return */
          SetPhysicsWallCrawlData(0,0,3,param_4);
        }
      }
      ...
      StateSwitchStateData(param_1,param_2,NewProcess,0);
      pTGpfffffc68 = (TDRFuncPtr_StateSwitchStateData2NewProcess)0x0;
      goto LAB_800af118;
    }
  }
...

{
  ...
  puVar2 = (undefined *)p_Var1->ID;
  if (puVar2 == &DAT_00100004) {
    if (CurrentSection != 0) goto LAB_800af800;
LAB_800af3d0:
    razResetPauseTranslation(In->CharacterInstance);
    goto LAB_800af800;
  }
  ...
  if ((int)puVar2 < 0x100005) {
    if (puVar2 != &DAT_80000002) {
      if ((int)puVar2 < -0x7ffffffd) {
        ...
        if (puVar2 == (undefined *)0x80000001) goto LAB_800af800;
      }
      else {
        if (puVar2 == (undefined *)0x100000) {
LAB_800af71c:
        ...
        if ((int)puVar2 < 0x100001) {
          if (puVar2 == (undefined *)0x0) {
            if (2 < NewAnim - 0x5bU) {
              if (5 < _CHAR____800d5758) goto LAB_800af71c;
              if (NewAnim != 0x37) {
                    /* WARNING: Subroutine does not return */
          ...
          if (puVar2 == &DAT_00100001) {
            ...
            _CHAR____800d5574 = _CHAR____800d5574 | uVar3;
            PhysicsMode.next = (_BlockVramEntry *)&UNK_00000003;
            if (CurrentSection == 0) {
    ...
    if (_CHAR____800d5600 == 3) goto LAB_800af800;
    _CHAR____800d571c = StateHandlerIdle;
    ...
    if (puVar2 != (undefined *)0x2000000) {
      if ((int)puVar2 < 0x2000001) {
        if (puVar2 == (undefined *)0x1000001) {
          ...
          if (CurrentSection_00 == 0x10001002) {
            if ((NewAnim != 0xf) && (NewAnim != 0x5d)) {
              NewAnim = 0xf;
              goto LAB_800af70c;
            }
            if (((gameTracker._4_4_[1] & LONG_800cf56c) != 0) && (NewAnim != 0x5d)) {
            ...
            if (CurrentSection_00 < 0x10001003) {
              if (CurrentSection_00 == 0x10001001) {
                if (NewAnim != 0xc) {
                  NewAnim = 0xc;
                  goto LAB_800af70c;
                }
...
LAB_800af70c:
                ...
                if (((gameTracker._4_4_[1] & LONG_800cf56c) != 0) && (NewAnim != 0x5b)) {
                  SteerSwitchMode(In->CharacterInstance,0xe);
                  NewAnim = 0x5b;
LAB_800af620:
                    /* WARNING: Subroutine does not return */
                ...
                if (CurrentSection_00 == 0x10001004) {
                  if ((NewAnim != 0xe) && (NewAnim != 0x5c)) {
                    NewAnim = 0xe;
                    goto LAB_800af70c;
                  }
                  if (((gameTracker._4_4_[1] & LONG_800cf56c) != 0) && (NewAnim != 0x5c)) {
                    SteerSwitchMode(In->CharacterInstance,0xe);
                    NewAnim = 0x5c;
                    goto LAB_800af620;
                  }
...
LAB_800af7f0:
    ...
    if (NewAnim == 0) goto LAB_800af800;
    NewProcess = StateHandlerAttack2;
  }
  else {
    if (puVar2 != (undefined *)0x10000000) {
    ...
    if (((uint)_BlockVramEntry_800d59a0._12_4_ & 2) != 0) goto LAB_800af800;
    if (CurrentSection != 0) {
                    /* WARNING: Subroutine does not return */
...
LAB_800af7b0:
  StateSwitchStateData(In,CurrentSection_00,NewProcess,0);
LAB_800af800:
                    /* WARNING: Subroutine does not return */
  DeMessageQueue((__MessageQueue *)(&In->CharacterInstance + CurrentSection * 0x47 + 3));
}
...
LAB_800b00b0:
      ...
      if (puVar3 == (undefined *)0x80003) {
        ...
        if ((int)puVar3 < 0x80004) {
          if (puVar3 == (undefined *)0x80001) {
            ...
            if (puVar3 != (undefined *)0x80002) goto LAB_800b00c8;
            if (CurrentSection == 0) {
              razPrepGlyph();
    ...
    if ((int)puVar3 < -0x7fffffef) {
      if (puVar3 == (undefined *)0x80000000) goto LAB_800aff50;
      puVar1 = &DAT_80000008;
    }
    else {
...
LAB_800b00a0:
                    /* WARNING: Subroutine does not return */
        EnMessageQueueData(&p_Var6->Defer,ID,Data_00);
      }
      if (0x40003 < (int)puVar3) {
        if (puVar3 == &DAT_00040005) goto LAB_800b00b0;
        goto LAB_800b00c8;
      }
      puVar1 = &DAT_80000020;
    }
    if (puVar3 == puVar1) goto LAB_800b00d0;
  }
  else {
    if (puVar3 == (undefined *)0x2000000) {
LAB_800aff50:
      ...
      if ((int)puVar3 < 0x100005) {
        if (puVar3 == (undefined *)0x100000) {
          if (pp_Var5[0x47] == (_Instance *)0x0) {
            ...
            if (((_CHAR____800d5574 & 0x40000) == 0) && (pp_Var5[0x47] != (_Instance *)0x2)) {
                    /* WARNING: Subroutine does not return */
              SetPhysicsWallCrawlData(0,0,3,in_a3);
            }
          }
        ...
        if ((int)puVar3 < 0x1000001) {
          if (puVar3 == &DAT_00100015) goto LAB_800afbac;
        }
        else {
          if (puVar3 == (undefined *)0x1000001) goto LAB_800b00d0;
        }
      }
    }
    else {
      if (puVar3 == (undefined *)0x4020000) goto LAB_800b00d0;
      if ((int)puVar3 < 0x4020001) {
        if (puVar3 == (undefined *)0x4000001) {
          if ((_CHAR____800d5574 & 0x40000) == 0) {
            PhysicsMode.next = (_BlockVramEntry *)0x0;
            SetExternalForce((__Force *)In->CharacterInstance,0x5214,y,(short)in_a3,local_38,
                             local_34);
          }
          goto LAB_800b00d0;
        }
        if (puVar3 == (undefined *)0x4010200) goto LAB_800b00d0;
      }
      else {
...
LAB_800afbac:
        ...
        if ((int)puVar3 < 0x8000004) {
          if (puVar3 == (undefined *)0x8000000) goto LAB_800afbac;
        }
        else {
          if (puVar3 == (undefined *)0x10000000) {
            if (CurrentSection == 0) {
...
LAB_800b0a2c:
    ...
    if ((int)puVar3 < 0x40006) {
      ...
      if ((int)puVar3 < 0x100006) {
        if (puVar3 == &UNK_00040025) goto LAB_800b0a2c;
        if (puVar3 != (undefined *)0x100000) {
          return;
        }
    ...
    if (puVar3 == (undefined *)0x4010200) {
      ...
      if (0x4010200 < (int)puVar3) {
        ...
        if ((int)puVar3 < 0x8000001) {
          ...
          if (CurrentSection == 0) {
            if (InterfaceItem_800cf854._48_4_ + 2 < InterfaceItems.name._0_4_) {
              InterfaceItem_800cf854.name._44_4_ = 0;
            }
            InterfaceItem_800cf854._48_4_ = InterfaceItems.name._0_4_;
            InterfaceItem_800cf854.name._44_4_ = InterfaceItem_800cf854.name._44_4_ + 1;
          }
          if (InterfaceItem_800cf854.name._44_4_ < 0x10) {
            return;
          }
      ...
      if ((int)puVar3 < 0x4000005) {
        ...
        if (puVar3 == (undefined *)0x4010008) {
          if (PhysicsMode.next == (_BlockVramEntry *)&UNK_00000003) {
            return;
          }
          PhysicsMode.next = (_BlockVramEntry *)&UNK_00000003;
          SetPhysics(In->CharacterInstance,-0x10,0,0,0);
  ...
  case G2ANIM_MSG_PLAYEFFECT:
    if (messageDataA != 2) {
      ...
      INSTANCE_DefaultAnimCallback
                (anim,sectionID,message,messageDataA_00,messageDataB,_CHAR____800d5218);
      return messageDataA;
    }
    Inst = razGetHeldWeapon();
    ...
    case 5:
      ...
      break;
    case 6:
      _LastTime_360 = *(undefined2 *)(theCamera.core.vvNormalWorVecMat[1].t[0] + 0xec);
...
code_r0x800b0e90:
        ...
        if (sVar1 < 3) {
          ...
          iVar3 = 6;
          if (sVar1 == 3) goto code_r0x800b0e90;
        }
      }
      if (bVar2) {
        iVar3 = (int)*(short *)(messageDataB + 2) * 0x14;
                    /* WARNING: Subroutine does not return */
        razSetupSoundRamp((_Instance *)theCamera.core.vvNormalWorVecMat[1].t[0],
                          (_SoundRamp *)
                          (&CHAR____800d577c +
                          (int)*(short *)(InterfaceItem_800cf7e4.name + iVar3 + 0x24) * 0x18),
                          (int)*(short *)(InterfaceItem_800cf7e4.name + iVar3 + 0x26),
                          (int)*(short *)(InterfaceItem_800cf7e4.name + iVar3 + 0x28),
                          (int)*(short *)(InterfaceItem_800cf7e4.name + iVar3 + 0x2a),
                          (int)*(short *)(InterfaceItem_800cf7e4.name +
                                         (int)*(short *)(messageDataB + 2) * 0x14 + 0x2c),
                          (int)*(short *)(InterfaceItem_800cf7e4.name +
                                         (int)*(short *)(messageDataB + 2) * 0x14 + 0x2e),
                          *(int *)(&InterfaceItem_800cf7e4.timeout +
                                  (int)*(short *)(messageDataB + 2) * 10),
                          *(int *)(&InterfaceItem_800cf7e4.itemType +
                                  (int)*(short *)(messageDataB + 2) * 10));
      }
    }
  }
...

{
  ...
  case 6:
    p_Var2 = (_Instance *)
             SetPhysicsDropOffData
                       ((int)(instance->position).x,(int)(instance->position).y,
                        (int)(instance->position).z,in_a3,unaff_s0);
    break;
  case 7:
    if (_CHAR____800d559c == 4) {
      p_Var2 = (_Instance *)
               SetPhysicsDropOffData
                         ((int)(instance->rotation).x,(int)(instance->rotation).y,_CHAR____800d55a4,
                          in_a3,unaff_s0);
    }
    else {
      p_Var2 = (_Instance *)
               SetPhysicsDropOffData
                         ((int)(instance->rotation).x,(int)(instance->rotation).y,
                          (int)(instance->rotation).z,in_a3,unaff_s0);
    }
    break;
  case 8:
    ...
    break;
  case 9:
    p_Var2 = InterfaceItems.name._4_4_;
    break;
  case 10:
...

{
  ...
  if (in_a1 == (undefined **)&DAT_0010000a) {
    reaverType = 0;
    if (in_a2 == (_Instance *)0x0) {
      iVar2 = 0x1b8;
      do {
        iVar1 = (int)&(in_a0->node).prev + iVar2;
        reaverType = reaverType + 1;
        *(undefined4 *)(iVar1 + 0x1c) = 0x800b0aac;
        *(undefined4 *)(iVar1 + 0x20) = 0;
        iVar2 = iVar2 + 0x30;
      } while (reaverType < 3);
      InitAlgorithmicWings(in_a0);
      instance = EngagedList._4_4_;
    }
    else {
      iVar2 = 0x1b8;
      do {
        iVar1 = (int)&(in_a0->node).prev + iVar2;
        reaverType = reaverType + 1;
        *(undefined4 *)(iVar1 + 0x1c) = 0x800b10b0;
        *(undefined4 *)(iVar1 + 0x20) = 0;
        iVar2 = iVar2 + 0x30;
      } while (reaverType < 3);
      DeInitAlgorithmicWings(in_a0);
      razResetPauseTranslation(in_a0);
      instance = EngagedList._4_4_;
    }
  }
  else {
    if (&DAT_0010000a < in_a1) {
      instance = EngagedList._4_4_;
      if (in_a1 == (undefined **)0x200001) {
        if (((_CHAR____800d61b4 & 0x40000) == 0) &&
           (reaverType = HealthCheckForLowHealth(), instance = EngagedList._4_4_, reaverType == 0))
        {
          UpdateEngagementList
                    ((evCollideInstanceStatsData *)in_a2,(__Player *)&_BlockVramEntry_800d5a10.x);
          instance = EngagedList._4_4_;
        }
      }
      else {
        if (in_a1 < (undefined **)0x200002) {
          if (in_a1 == (undefined **)&DAT_00100012) {
                    /* WARNING: Subroutine does not return */
            INSTANCE_Query(in_a2,4);
          }
          if (in_a1 < &DAT_00100013) {
            if (in_a1 != (undefined **)&DAT_00100010) {
              if (in_a1 == (undefined **)&DAT_00100011) {
                    /* WARNING: Subroutine does not return */
                EnMessageQueueData((__MessageQueue *)&_BlockVramEntry_800d5a9c.udata,
                                   (int)&DAT_00100011,(int)in_a2);
              }
              goto LAB_800b1eb8;
            }
            if (in_a2 == (_Instance *)0x0) {
              if ((_BlockVramEntry_800d5d74._8_4_ & 0x40000000) != 0) {
                _BlockVramEntry_800d5d74._8_4_ = _BlockVramEntry_800d5d74._8_4_ & 0xbfffffff;
                    /* WARNING: Read-only address (ram,0x800d5d7c) is written */
              }
            }
            else {
              if ((_BlockVramEntry_800d5d74._8_4_ & 0x40000000) == 0) {
                    /* WARNING: Read-only address (ram,0x800d5d7c) is written */
                _BlockVramEntry_800d5d74._8_4_ = 0x40000000;
                ResetPhysics(in_a0,-0x10);
                    /* WARNING: Subroutine does not return */
                SetPhysicsWallCrawlData(0,0,3,in_a3);
              }
            }
            ...
            if (in_a1 == (undefined **)&UNK_00100016) {
                    /* WARNING: Subroutine does not return */
              razSetupSoundRamp(in_a0,(_SoundRamp *)&_BlockVramEntry_800d5f6c.udata,0x33,-200,-200,
                                0x78,0x78,(int)in_a2 << 0xc,0xdac);
            }
            if (&UNK_00100016 < in_a1) {
              if (in_a1 != (undefined **)0x200000) goto LAB_800b1eb8;
              if ((_CHAR____800d61b4 & 0x40000) == 0) {
                ExtraRot.area = 0;
              }
              _BlockVramEntry_800d5dac._12_4_ = _BlockVramEntry_800d5dac._12_4_ & 0xffffffdf;
              uVar3 = 0xffffffbf;
            }
            else {
              if (in_a1 != (undefined **)&DAT_00100013) goto LAB_800b1eb8;
              if (in_a2 != (_Instance *)_BlockVramEntry_800d5e38.area) {
                reaverType = razReaverOn();
                if (reaverType == 0) {
                    /* WARNING: Read-only address (ram,0x800d5e08) is written */
                  _BlockVramEntry_800d5e00._8_4_ = 0;
                }
                razReaverBladeOn();
              }
              uVar3 = 0xffffff7f;
            }
            _BlockVramEntry_800d5dac._12_4_ = _BlockVramEntry_800d5dac._12_4_ & uVar3;
            instance = EngagedList._4_4_;
                    /* WARNING: Read-only address (ram,0x800d5db8) is written */
          }
        }
        else {
          if (in_a1 == (undefined **)0x4000001) {
            if (((_CHAR____800d61b4 & 8) != 0) && ((_BlockVramEntry_800d5dac._12_4_ & 2) == 0)) {
                    /* WARNING: Subroutine does not return */
              EnMessageQueueData((__MessageQueue *)&_BlockVramEntry_800d5a9c.udata,0x4000001,
                                 (int)in_a2);
            }
          }
          else {
            if (in_a1 < (undefined **)0x4000002) {
              if (in_a1 == (undefined **)0x200004) {
                if ((_CHAR____800d61b4 & 0x40000000) != 0) {
                  *(_Instance **)&in_a0->collideInfo = in_a2;
                  *(undefined2 *)&in_a2->parent = 0;
                  RazielCollide(in_a0,(GameTracker *)&fontTracker.font_buffer[0x1f].y);
                  instance = razGetHeldItem();
                    /* WARNING: Subroutine does not return */
                  COLLIDE_UpdateAllTransforms(instance,(SVECTOR *)((int)in_a0->collideInfo + 0x28));
                }
              }
              else {
                if (in_a1 != (undefined **)0x800024) goto LAB_800b1eb8;
                EngagedList._12_4_ = (in_a2->node).next;
              }
            }
            else {
              if (in_a1 == (undefined **)0x4000006) {
                EngagedList._4_4_ = (_Instance *)&DAT_00000b50;
                instance = EngagedList._4_4_;
              }
              else {
                if (in_a1 < (undefined **)0x4000007) {
                  instance = in_a2;
                  if (in_a1 != (undefined **)0x4000005) goto LAB_800b1eb8;
                }
                else {
                  if (in_a1 != (undefined **)0x10002000) goto LAB_800b1eb8;
                  razPlaneShift(in_a0);
                  instance = EngagedList._4_4_;
                }
              }
      ...
      if (in_a1 == (undefined **)&LAB_00040010_2) {
        NewProcess = StateHandlerDropAction;
      }
      else {
        if (&LAB_00040010_2 < in_a1) {
          if (in_a1 == (undefined **)0x40022) {
            _BlockVramEntry_800d5fa4.udata = in_a2;
            return;
          }
          if (in_a1 < (undefined **)0x40023) {
            if (in_a1 == (undefined **)&LAB_00040014_1) {
              SignalInfo_800d0548.signalHandleFunc =
                   (_func_17 *)((uint)_BlockVramEntry_800d5e1c._8_4_ | (uint)in_a2);
              _BlockVramEntry_800d5e1c._8_4_ = (NodeType *)SignalInfo_800d0548.signalHandleFunc;
              RAZIEL_DebugHealthFillUp();
              if (((uint)in_a2 & 0x3fc00) == 0) {
                return;
              }
              if (_BlockVramEntry_800d5e38.area == 0) {
                return;
              }
              razReaverOn();
              reaverType = razGetReaverFromMask((int)in_a2);
              razReaverImbue(reaverType);
              return;
            }
            if (in_a1 == (undefined **)0x40019) {
              razReaverBladeOn();
              return;
            }
          }
          else {
            if (in_a1 == (undefined **)&DAT_00100007) {
              pNVar4 = (in_a2->node).next;
              SignalInfo_800d0548.signalHandleFunc = (_func_17 *)pNVar4->prev;
              _BlockVramEntry_800d5e1c._8_4_ = (NodeType *)SignalInfo_800d0548.signalHandleFunc;
              reaverType = razInBaseArea(InterfaceItem_800cf854.name + 0xc,5);
              EngagedList.next = (_BlockVramEntry *)&DAT_00000002;
              if (reaverType == 0) {
                EngagedList.next = (_BlockVramEntry *)pNVar4->next;
              }
              _BlockVramEntry_800d5e00.area._0_2_ = *(undefined2 *)&pNVar4[1].prev;
                    /* WARNING: Read-only address (ram,0x800d5e14) is written */
              _BlockVramEntry_800d5e00.area._2_2_ = *(undefined2 *)&pNVar4[1].next;
                    /* WARNING: Read-only address (ram,0x800d5e16) is written */
              HUD_Setup_Chit_Count((int)pNVar4[1].next);
              _BlockVramEntry_800d5e1c.w = *(short *)&pNVar4[2].prev;
              _BlockVramEntry_800d5e1c.h = *(short *)((int)&pNVar4[2].prev + 2);
                    /* WARNING: Read-only address (ram,0x800d5e4c) is written */
              _BlockVramEntry_800d5e38.area = 0;
              if (((uint)_BlockVramEntry_800d5e1c._8_4_ & 8) != 0) {
                SignalInfo_800d0548._4_4_ = 0;
              }
              _BlockVramEntry_800d5fc0._16_4_ = pNVar4[2].next;
                    /* WARNING: Read-only address (ram,0x800d5fd0) is written */
              if (((uint)_BlockVramEntry_800d5fc0._16_4_ & 0x1000) == 0) {
                _BlockVramEntry_800d5e00.udata = 100;
                _BlockVramEntry_800d5e38.area = 0;
                return;
              }
              _BlockVramEntry_800d5e00.udata = GetMaxHealth();
              return;
                    /* WARNING: Read-only address (ram,0x800d5e18) is written */
            }
            if (&DAT_00100007 < in_a1) {
              if (in_a1 == (undefined **)&DAT_00100008) {
                if ((_CHAR____800d61b4 & 0x200000) != 0) {
                  RelocateConstrict((_SVector *)in_a2);
                }
                _BlockVramEntry_800d5f50.udata._0_2_ =
                     (short)_BlockVramEntry_800d5f50.udata + *(short *)&(in_a2->node).prev;
                    /* WARNING: Read-only address (ram,0x800d5f68) is written */
                _BlockVramEntry_800d5f50.udata._2_2_ =
                     _BlockVramEntry_800d5f50.udata._2_2_ + *(short *)((int)&(in_a2->node).prev + 2)
                ;
                    /* WARNING: Read-only address (ram,0x800d5f6a) is written */
                _BlockVramEntry_800d5f6c.next._0_2_ =
                     (short)_BlockVramEntry_800d5f6c.next + *(short *)&(in_a2->node).next;
                STREAM_MORPH_Relocate();
                return;
              }
            }
            else {
              if (in_a1 == (undefined **)&DAT_00040024) {
                reaverType = SndTypeIsPlayingOrRequested(1);
                if (reaverType != 0) {
                  return;
                }
                SOUND_Play3dSound((_Position *)(fontTracker.font_buffer._232_4_ + 0x5c),1,0,0x4b,
                                  0xdac);
                return;
              }
            }
...
LAB_800b1eb8:
                    /* WARNING: Subroutine does not return */
          EnMessageQueueData((__MessageQueue *)&_BlockVramEntry_800d5a9c.udata,(int)in_a1,(int)in_a2
                            );
        }
        if (in_a1 == &PTR_00040006) {
          DrainHealth((int)in_a2);
          return;
        }
        if (&PTR_00040006 < in_a1) {
          if (in_a1 == (undefined **)&LAB_0004000c_2) {
            if (in_a2 != (_Instance *)0x0) {
                    /* WARNING: Read-only address (ram,0x800d5f24) is written */
              _BlockVramEntry_800d5f18._12_4_ = StateHandlerPuppetShow;
              StateSwitchStateCharacterDataDefault
                        ((__CharacterState *)&_BlockVramEntry_800d5a10.w,StateHandlerPuppetShow,0);
              InitAlgorithmicWings(in_a0);
                    /* WARNING: Subroutine does not return */
              PurgeMessageQueue((__MessageQueue *)&_BlockVramEntry_800d5a2c);
            }
                    /* WARNING: Read-only address (ram,0x800d5f24) is written */
            _BlockVramEntry_800d5f18._12_4_ = StateHandlerIdle;
            _BlockVramEntry_800d5dac._12_4_ = _BlockVramEntry_800d5dac._12_4_ & 0xffffffef;
            _CHAR____800d61b4 = _CHAR____800d61b4 & 0xfffdffff;
                    /* WARNING: Read-only address (ram,0x800d5db8) is written */
                    /* WARNING: Subroutine does not return */
            SetPhysicsWallCrawlData(0,0,3,-0x11);
          }
          if (&LAB_0004000c_2 < in_a1) {
            if (in_a1 == (undefined **)&LAB_00040010_1) {
              HealthInstantDeath(in_a0);
              return;
            }
          }
          else {
            if (in_a1 == (undefined **)0x40008) {
              DrainMana((int)in_a2);
              return;
            }
          }
        ...
        if (in_a1 == (undefined **)&DAT_00040001) {
          *(_Instance **)&in_a0->currentStreamUnitID = in_a2;
          in_a0->tface = (_TFace *)0x0;
          *(_Instance **)(_BlockVramEntry_800d5e1c._12_4_ + 0x38) = in_a2;
          *(undefined4 *)(_BlockVramEntry_800d5e1c._12_4_ + 0xb4) = 0;
          if (_BlockVramEntry_800d5e38.area == 0) {
            return;
          }
          *(_Instance **)(_BlockVramEntry_800d5e38.area + 0x38) = in_a2;
          *(undefined4 *)(_BlockVramEntry_800d5e38.area + 0xb4) = 0;
          return;
        }
        if (in_a1 != (undefined **)&UNK_00040004) goto LAB_800b1eb8;
        G2EmulationSwitchAnimationCharacter
                  ((__CharacterState *)&_BlockVramEntry_800d5a10.w,0x80,0,3,1);
        NewProcess = StateHandlerCannedReaction;
      }
      StateSwitchStateCharacterData((__CharacterState *)&_BlockVramEntry_800d5a10.w,NewProcess,0);
      instance = EngagedList._4_4_;
    }
  }
                    /* WARNING: Read-only address (ram,0x800d17e0) is written */
                    /* WARNING: Read-only address (ram,0x800d5d7c) is written */
                    /* WARNING: Read-only address (ram,0x800d5db8) is written */
                    /* WARNING: Read-only address (ram,0x800d5e08) is written */
                    /* WARNING: Read-only address (ram,0x800d5e14) is written */
                    ...
                    /* WARNING: Read-only address (ram,0x800d5f68) is written */
                    /* WARNING: Read-only address (ram,0x800d5f6a) is written */
                    /* WARNING: Read-only address (ram,0x800d5fbc) is written */
                    /* WARNING: Read-only address (ram,0x800d5fd0) is written */
  EngagedList._4_4_ = instance;
  return;
}
...

{
  ...
  _LastTime_366 = uVar1 & 0xffff | gameTimer << 0x10;
  InterfaceItems.name._0_4_ = InterfaceItems.name._0_4_ + 1;
  gameTracker.next = (_BlockVramEntry *)GT;
  gameTracker._4_4_ = controlCommand;
                    /* WARNING: Subroutine does not return */
  DeMessageQueue((__MessageQueue *)&CHAR____800d52ac);
}
...

{
  ...
  if ((_CHAR____800d5730 & 1) != 0) {
    _CHAR____800d573c = _CHAR____800d573c + _CHAR____800d5738 * theCamera.tiltList[0][0];
...

{
  ...
  if ((_CHAR____800d72ac & 0x2000) == 0) {
    if ((_CHAR____800d72a8 & 0x2000) != 0) {
      if (lVar1 == -1) {
        HINT_StartHint(0xc);
      }
      if ((lVar1 == 0xc) && (_CHAR____800d6d04 == StateHandlerGlyphs)) {
        HINT_KillSpecificHint(0xc);
        HINT_StartHint(0x28);
      }
      if ((lVar1 == 0x28) && (_CHAR____800d6d04 != StateHandlerGlyphs)) {
        HINT_KillSpecificHint(0x28);
        HINT_StartHint(0xc);
      }
      goto LAB_800b2ca4;
...
LAB_800b2c94:
    ...
    if (lVar1 != iVar2) goto LAB_800b2ca4;
  }
  else {
    hintNumber = 0xc;
    if (lVar1 != 0xc) {
...
LAB_800b2ca4:
  if ((_CHAR____800d72ac & 0x10000) == 0) {
    if ((_CHAR____800d72a8 & 0x10000) == 0) {
      if (lVar1 == 0x20) {
...

{
  if ((0 < _CHAR____800d575c) &&
     (_CHAR____800d575c = _CHAR____800d575c - theCamera.tiltList[0][0], _CHAR____800d575c < 1)) {
                    /* WARNING: Subroutine does not return */
    INSTANCE_Post(instance,(int)&DAT_00100015,-_CHAR____800d575c);
  }
  if ((0 < _CHAR____800d57ac) &&
     (_CHAR____800d57ac = _CHAR____800d57ac - theCamera.tiltList[0][0], _CHAR____800d57ac < 1)) {
    _CHAR____800d57ac = 0;
    switch(_CHAR____800d57b0) {
    case 1:
                    /* WARNING: Subroutine does not return */
      razSetupSoundRamp(instance,(_SoundRamp *)&CHAR____800d577c,0x13,1000,1000,0x78,0x78,0x1000,
                        0xdac);
    case 2:
                    /* WARNING: Subroutine does not return */
    ...
    case 6:
      if (_CHAR____800d5794 == 0) {
        _CHAR____800d5794 = 0;
                    /* WARNING: Subroutine does not return */
        razSetupSoundRamp(instance,(_SoundRamp *)&CHAR____800d5794,0xd,100,100,0x4b,0x4b,0x1000,
                          0xdac);
      }
                    /* WARNING: Subroutine does not return */
      SndEndLoop(_CHAR____800d5794);
    case 7:
      if (_CHAR____800d577c == 0) {
        _CHAR____800d577c = 0;
                    /* WARNING: Subroutine does not return */
        razSetupSoundRamp(instance,(_SoundRamp *)&CHAR____800d577c,0xd,-100,-100,0x41,0x41,0x1000,
                          0xdac);
      }
                    /* WARNING: Subroutine does not return */
      SndEndLoop(_CHAR____800d577c);
    case 8:
      if (_CHAR____800d5794 == 0) {
        _CHAR____800d5794 = 0;
                    /* WARNING: Subroutine does not return */
        razSetupSoundRamp(instance,(_SoundRamp *)&CHAR____800d5794,0xd,0x1e,0x1e,0x3c,0x3c,0x1000,
                          0xdac);
      }
                    /* WARNING: Subroutine does not return */
      SndEndLoop(_CHAR____800d5794);
    ...
    case 10:
                    /* WARNING: Subroutine does not return */
      razSetupSoundRamp(instance,(_SoundRamp *)&CHAR____800d577c,0x33,-200,-200,0x78,0,0x3c000,0xdac
                       );
    default:
      if (_CHAR____800d577c != 0) {
                    /* WARNING: Subroutine does not return */
...

{
  ...
  gameTracker = (GameTracker *)debugRazielFlags2;
  if ((_CHAR____800d561c & 8) == 0) {
    ...
    if (debugRazielFlags2 == 0) {
      ...
      razGetReaverFromMask(reaverMask);
    }
    if (_CHAR____800d5644 != (_Instance *)0x0) {
      RazielAdditionalCollide(_CHAR____800d5644,gameTracker);
      return;
    }
    if (DebugMenuLine_800c8824.text != (char *)0x0) {
      soulReaver = INSTANCE_BirthObject(instance,(Object *)DebugMenuLine_800c8824.text,0);
              ...
              if ((controlCommand[2] & LONG_ARRAY_800cf57c[0]) == 0) {
                if ((controlCommand[1] & LONG_800cf578) == 0) {
                  if ((controlCommand[2] & LONG_800cf578) == 0) {
                    if ((controlCommand[1] & gpSaved) != 0) {
                    /* WARNING: Subroutine does not return */
                      EnMessageQueueData((__MessageQueue *)&CHAR____800d5694,(int)&DAT_80000020,0);
                    }
                    pPVar1 = UNDERWORLD_Poly((POLY_GT3 *)controlCommand,(UW_ScreenXY *)&DAT_80000000
                                             ,in_a2,in_a3,unaff_s0);
                    return (int)pPVar1;
                  }
...

{
  ...
  uVar1 = _BlockVramEntry_800d59a0._12_4_ & 8;
  ...
  if (uVar1 == 0) {
    ...
    Data = (uint)uVar2 << 0x10;
    if ((int)(short)uVar2 < (int)(instance->oldPos).z - (int)(instance->position).z) {
  ...
  if ((_BlockVramEntry_800d59a0._12_4_ & 0x100) == 0) {
    InterfaceItems.name._4_4_ = 0x20;
    FX_UpdateInstanceWaterSplit(instance);
  }
  else {
    Inst = razGetHeldWeapon();
    ...
    Data = SetPhysicsSwimData(_CHAR____800d5574 >> 0x12 & 1,(_SVector *)&CHAR____800d5580,0x100,
                              0x1a0,0x70);
    InterfaceItems.name._4_4_ = PhysicsCheckSwim(instance,Data,3);
    ...
    if (((PhysicsMode.next == (_BlockVramEntry *)((int)&mainMenuScreen + 1)) && (instance->zVel < 0)
...

{
  ...
  int iVar2;
  GameTracker *gt;
  GameTracker *collideInfo;
  
  collideInfo = (GameTracker *)instance->collideInfo;
  gt = (GameTracker *)instance;
  if (*(char *)(*(int *)&(collideInfo->gameData).asmData.MorphTime + 4) == '\t') {
    gt = collideInfo;
    if (*(char *)((int)&(collideInfo->gameData).asmData.dispPage + 3) == '\x03') {
      COLLIDE_SetBSPTreeFlag((_CollideInfo *)collideInfo,0x800);
    }
    else {
      iVar2 = (collideInfo->gameData).asmData.lightInstances[0].g;
      *(uint *)(iVar2 + 0x14) = *(uint *)(iVar2 + 0x14) | 4;
    }
    if (*(char *)((int)&(collideInfo->gameData).asmData.dispPage + 3) != '\x01') {
                    /* WARNING: Subroutine does not return */
      COLLIDE_SegmentCollisionOff
                (instance,(uint)*(byte *)((int)&(collideInfo->gameData).asmData.dispPage + 1));
    }
  }
  uVar1 = (collideInfo->gameData).asmData.dispPage & 0xffff0000;
  if (uVar1 != 0x1010000) {
    SAVE_Init(gt);
    return uVar1;
  }
  if ((_BlockVramEntry_800d59a0._12_4_ & 0x1000) == 0) {
    ...
    iVar2 = 8;
    if (*(char *)&(((collideInfo->gameData).asmData.lightInstances[0].lightInstance)->node).next !=
        '\b') {
      SAVE_Init(gt);
      return iVar2;
    }
    if (_CHAR____800d55dc == 0) {
      _CHAR____800d55dc = (collideInfo->gameData).asmData.lightInstances[0].g;
    }
    else {
      if (_CHAR____800d55dc != (collideInfo->gameData).asmData.lightInstances[0].g) {
        printf((char *)&InterfaceItem_800cf854.itemType);
      }
    }
  }
  return 1;
...

{
  ...
  if (levelSelectMenu.bit_mask == 0) {
    SAVE_GetSavedBlock((long)param_1,0);
    return;
  }
  extraSize = levelSelectMenu.bit_mask;
  p_Var1 = INSTANCE_BirthObject(param_1,(Object *)levelSelectMenu.bit_mask,0);
  if (p_Var1 == (_Instance *)0x0) {
    SAVE_GetSavedBlock((long)param_1,extraSize);
    return;
  }
  p_Gpfffffb6c = p_Var1;
  return;
...
void RAZIEL_SetLookAround(int param_1)

{
                    /* WARNING: Subroutine does not return */
  G2Anim_EnableController((_G2Anim_Type *)(param_1 + 0x194),0x11,0xe);
}
...
/* WARNING: Removing unreachable block (ram,0x800b47c8) */
...

{
  ...
  if ((uGpfffffafc & 4) != 0) {
    ...
    if (pcGpfffff76c == StateHandlerIdle) {
      SAVE_IntroForStreamID((_StreamUnit *)StateHandlerIdle);
      return uVar1;
    }
