...
// UW_ScreenXY * @0x800CF894, len = 0x00000004
ScreenMorphArray = 00000000;
// long @0x800D59B0, len = 0x00000004
UW_angle = null;
// long @0x800D59BC, len = 0x00000004
UW_angleInc = null;
// long @0x800D59B4, len = 0x00000004
UW_scalex = null;
// long @0x800D59B8, len = 0x00000004
UW_scalexInc = null;
// decompiled code
...

{
  ...
  UNDERWORLD_LoadLevel(s_under1_800cf898, &gameTrackerX);
...

{
  ...
  if (0 < pLVar4->numIntros)
  {
    ...
    do
    {
      iVar3 = strcmpi(pLVar4->introList->name + iVar7, s_raziel_800cf8a0);
      if (iVar3 == 0)
      {
