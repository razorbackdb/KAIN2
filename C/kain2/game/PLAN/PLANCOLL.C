...
// int /*$ra*/ PLANCOLL_DoesLOSExistFinal(struct _Position *startPos /*$a0*/, struct _Position *endPos /*$a1*/, int collideType /*$a2*/, int passThroughHit /*$s0*/, int zoffset /*stack 16*/)
 // line 75, offset 0x80098ae0
	/* begin block 1 */
		// Start line: 76
		// Start offset: 0x80098AE0
		// Variables:
...
// int /*$ra*/ PLANCOLL_CheckUnderwaterPoint(struct _Position *position /*$s5*/)
 // line 108, offset 0x80098be4
	/* begin block 1 */
		// Start line: 109
		// Start offset: 0x80098BE4
		// Variables:
	...
	// 		struct _Position center; // stack offset -40
		...
		/* end block 1.1 */
		// End offset: 0x80098C40
		// End Line: 124
	/* end block 1 */
	// End offset: 0x80098D28
	// End Line: 146
...
{ // line 162, offset 0x80098d50
	/* begin block 1 */
		// Start line: 163
		// Start offset: 0x80098D50
		// Variables:
		...
		/* begin block 1.3 */
			// Start line: 201
			// Start offset: 0x80098FA0
			// Variables:
				short _y1; // $v1
				short _z1; // $a0
		/* end block 1.3 */
		// End offset: 0x80098FA0
		// End Line: 201
	/* end block 1 */
	// End offset: 0x80098FE0
	// End Line: 208
...
// int /*$ra*/ PLANCOLL_DoesStraightLinePathExist(struct _Position *startPos /*$s2*/, struct _Position *endPos /*$s3*/, int collideType /*$s4*/)
 // line 214, offset 0x80099010
	/* begin block 1 */
		// Start line: 215
		// Start offset: 0x80099010
	/* end block 1 */
	// End offset: 0x80099078
	// End Line: 221
...
// int /*$ra*/ PLANCOLL_DoesWaterPathUpExist(struct _Position *startPos /*$s2*/, struct _Position *endPos /*$s1*/, int collideType /*$s4*/, struct _Position *peakPos /*$s3*/, int passThroughHit /*stack 16*/)
 // line 227, offset 0x8009909c
	/* begin block 1 */
		// Start line: 228
		// Start offset: 0x8009909C
		// Variables:
	// 		long time_ftop; // $s0
	// 		long time_ptow; // $a0
	// 		long time_tot; // $a1
...

{
  ...
  lVar3 = MATH3D_FastSqrt((long)&LAB_00050000);
