...
// _fth @0x800CF75C, len = 0x00000004
directionList =
	{
		// char @0x800CF75C, len = 0x00000001
		.x = 0x00,
		// char @0x800CF75D, len = 0x00000001
		.y = 0x00,
		// char @0x800CF75E, len = 0x00000001
		.z = 0x01,
		// char @0x800CF75F, len = 0x00000001
		.nodeType = 0x00};
// decompiled code
	...
	if ((((passThroughHit == 0) || (local_48.type != 3)) ||
		...
		(uVar1 = 1,
		 (*(ushort *)((int)&((local_48.inst)->node).prev[6].next[1].prev +
					  (uint) * (ushort *)((int)local_48.prim + 10) + 2) &
		  0x1000) == 0))
	{
...
int PLANCOLL_DoesWaterPathUpExist(_Position *startPos, _Position *endPos, int collideType, _Position *peakPos,
								  int passThroughHit)

{
	...
	peakPos->x = endPos->x +
				 (short)((((int)(((uint)(ushort)startPos->x - (uint)(ushort)endPos->x) * 0x10000) >>
						  ...
						  iVar5) /
						 (lVar3 + iVar5));
	peakPos->y = endPos->y + (short)(((int)(short)(sVar2 - sVar1) * iVar5) / (lVar3 + iVar5));
