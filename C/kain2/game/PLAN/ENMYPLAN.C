...

{
  ...
  iVar1 = 0;
  pcVar2 = (char *)theCamera.tempsplinePointAhead;
  do {
    if (*pcVar2 == '\0') {
      return iVar1;
    }
...

{
  ...
  lVar1 = theCamera.tempsplinePointAhead;
  iVar2 = ENMYPLAN_GetNextAvailablePlanningSlot();
  if (iVar2 != -1) {
    puVar3 = (undefined *)(iVar2 * 0x5e + lVar1);
    *puVar3 = 1;
    puVar3[1] = 0;
  }
  return iVar2;
      ...
      if ((*puVar13 != '\x02') && ((puVar13[8] >> 3 & 3) == 0)) {
        do {
          ...
          *puVar13 = '\x01';
          ...
          puVar8 = planData->nodeSkipArray + uVar10;
          if (*puVar13 == '\x02') goto LAB_80096db0;
          bVar1 = bVar11 == 0;
          iVar3 = iVar3 + 1;
          bVar11 = bVar12;
        } while (bVar1);
...
LAB_80096db0:
  ...
  iVar3 = ENMYPLAN_WayPointReached
                    ((short *)(param_1 + 0x5c),&planSlot->oldCurrentPos,(short *)p_Var14);
  if ((iVar3 != 0) &&
     (planSlot->wayPointBeingServoedTo = planSlot->wayPointBeingServoedTo + '\x01',
...

{
  ...
  lVar1 = theCamera.tempsplinePointAhead;
  iVar2 = ValidSlotAndState((EnemyPlanSlotData *)theCamera.tempsplinePointAhead,slotID);
  if (iVar2 == 0) {
    uVar3 = 0x40;
  }
  else {
    iVar2 = lVar1 + slotID * 0x5e;
...

{
  ...
  lVar3 = theCamera.tempsplinePointAhead;
  iVar4 = ValidSlotAndState((EnemyPlanSlotData *)theCamera.tempsplinePointAhead,slotID);
  if (iVar4 != 0) {
    iVar5 = lVar3 + slotID * 0x5e;
...

{
  ...
  iVar7 = theCamera.tempsplinePointAhead + slotID * 0x5e;
