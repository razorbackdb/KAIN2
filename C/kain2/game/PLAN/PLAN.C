...
// long /*$ra*/ PLAN_CalcMinDistFromExistingNodes(struct _Position *pos /*$s0*/, struct PlanningNode *planningPool /*$a1*/, int distanceType /*$s1*/)
 // line 129, offset 0x800972c8
	/* begin block 1 */
		// Start line: 130
		// Start offset: 0x800972C8
		// Variables:
	// 		struct PlanningNode *closestNode; // $a2
	// 		long minDist; // $v0
	/* end block 1 */
	// End offset: 0x80097350
	// End Line: 148
...
// void /*$ra*/ PLAN_UpdatePlanMkrNodes(struct PlanningNode *planningPool /*stack 0*/, struct _Position *playerPos /*$fp*/)
 // line 158, offset 0x80097364
	/* begin block 1 */
		// Start line: 159
		// Start offset: 0x80097364
		// Variables:
	// 		int i; // $s4
	...
	// 		struct _StreamUnit *streamUnit; // $s7
		...
		// 		long suID; // stack offset -44
			...
			/* begin block 1.1.1 */
				// Start line: 181
				// Start offset: 0x80097438
				// Variables:
			// 		long nodeType; // $s0
			// 		long nodeID; // $s3
			/* end block 1.1.1 */
			// End offset: 0x800974AC
			// End Line: 203
		/* end block 1.1 */
		// End offset: 0x800974C0
		// End Line: 206
	/* end block 1 */
	// End offset: 0x80097580
	// End Line: 221
      ...
      if ((iVar5 != 0) && (iVar4 = 0, 0 < iVar5)) {
        ...
        do {
          ...
          if ((lVar2 < 8000) && (type < 4000)) {
            ...
            if ((uVar1 & 0x1000) == 0) {
              type = 0xc;
              if (((((int)(short)*puVar3 & 0x8000U) == 0) && (type = 0x1c, (uVar1 & 0x4000) == 0))
              ...
              if (nodeToDelete == (PlanningNode *)0x0) {
                PLANPOOL_AddNodeToPool
                          ((_Position *)pos,planningPool,(short)type,(short)id,
...
// void /*$ra*/ PLAN_UpdatePlayerNode(struct PlanningNode *planningPool /*$s3*/, struct _Position *playerPos /*$s2*/)
 // line 226, offset 0x800975b0
	/* begin block 1 */
		// Start line: 227
		// Start offset: 0x800975B0
		// Variables:
	...
	// 		struct _PlanCollideInfo pci; // stack offset -48
		...
		/* end block 1.1 */
		// End offset: 0x80097618
		// End Line: 245
	/* end block 1 */
	// End offset: 0x800976E8
	// End Line: 265
...
// void /*$ra*/ PLAN_AddRandomNode(struct PlanningNode *planningPool /*$s5*/, struct _Position *playerPos /*$s0*/)
 // line 273, offset 0x80097704
	/* begin block 1 */
		// Start line: 274
		// Start offset: 0x80097704
		// Variables:
	// 		int i; // $s2
	...
	// 		int successFlag; // $s4
		...
		/* end block 1.1 */
		// End offset: 0x80097740
		// End Line: 282

		/* begin block 1.2 */
			// Start line: 301
			// Start offset: 0x8009785C

			/* begin block 1.2.1 */
				// Start line: 307
				// Start offset: 0x8009789C
				// Variables:
			// 		struct _SVector normal; // stack offset -40
			/* end block 1.2.1 */
			// End offset: 0x800978EC
			// End Line: 313
		/* end block 1.2 */
		// End offset: 0x800978EC
		// End Line: 314
...
// void /*$ra*/ PLAN_DeleteRandomNode(struct PlanningNode *planningPool /*$s0*/)
 // line 321, offset 0x80097910
	/* begin block 1 */
		// Start line: 322
		// Start offset: 0x80097910
	/* end block 1 */
...
// void /*$ra*/ PLAN_DeleteOutOfRangeNodesOfSource(struct PlanningNode *planningPool /*$s3*/, struct _Position *playerPos /*$s2*/, int nodeSourceToCheck /*$s4*/, long removeDist /*$s5*/)
 // line 332, offset 0x80097944
	/* begin block 1 */
		// Start line: 333
		// Start offset: 0x80097944
		// Variables:
	// 		int i; // $s1
	/* end block 1 */
	// End offset: 0x800979F8
	// End Line: 345
...
// void /*$ra*/ PLAN_AddOrRemoveRandomNodes(struct PlanningNode *planningPool /*$a0*/, struct _Position *playerPos /*$a1*/)
 // line 348, offset 0x80097a1c
	/* begin block 1 */
		// Start line: 349
		// Start offset: 0x80097A1C
		// Variables:
	// 		int numNodeError; // $v0
	/* end block 1 */
	// End offset: 0x80097A5C
	// End Line: 360
...
// void /*$ra*/ PLAN_AddOrRemoveNodes(struct PlanningNode *planningPool /*$s1*/, struct _Instance *player /*$s2*/)
 // line 385, offset 0x80097b28
	/* begin block 1 */
		// Start line: 386
		// Start offset: 0x80097B28
	/* end block 1 */
	// End offset: 0x80097BEC
	// End Line: 399
...
// struct PlanningNode * /*$ra*/ PLAN_FindNodeMostInNeedOfConnectivityExpansion(struct PlanningNode *planningPool /*$a0*/)
 // line 405, offset 0x80097c10
	/* begin block 1 */
		// Start line: 406
		// Start offset: 0x80097C10
		// Variables:
	// 		int i; // $s2
