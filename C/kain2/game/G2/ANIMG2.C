...
// enum _G2Bool_Enum /*$ra*/ G2Anim_Install()
 // line 260, offset 0x80092ae4
	/* begin block 1 */
		// Start line: 261
		// Start offset: 0x80092AE4
		// Variables:
	// 		struct _G2AnimController_Type *dummyController; // $a0
	/* end block 1 */
	// End offset: 0x80092AE4
	// End Line: 261
...
// void /*$ra*/ G2Anim_ResetInternalState()
 // line 309, offset 0x80092b4c
	/* begin block 1 */
		// Start line: 310
		// Start offset: 0x80092B4C
		// Variables:
	// 		struct _G2AnimController_Type *dummyController; // $v0
	/* end block 1 */
	// End offset: 0x80092B4C
	// End Line: 310
...
// void /*$ra*/ G2Anim_Init(struct _G2Anim_Type *anim /*$s0*/, struct _Model *modelData /*$s1*/)
 // line 374, offset 0x80092ba4
	/* begin block 1 */
		// Start line: 375
		// Start offset: 0x80092BA4
		// Variables:
...
// struct _G2AnimSection_Type * /*$ra*/ G2Anim_AddSection(struct _G2Anim_Type *anim /*$s1*/, int firstSegID /*$s2*/, int segCount /*$s3*/)
 // line 439, offset 0x80092c38
	/* begin block 1 */
		// Start line: 440
		// Start offset: 0x80092C38
		// Variables:
	// 		struct _G2AnimSection_Type *section; // $s0
	/* end block 1 */
	// End offset: 0x80092C38
	// End Line: 440
...
// void /*$ra*/ G2Anim_Restore(struct _G2Anim_Type *anim /*$s2*/)
 // line 531, offset 0x80092d90
	/* begin block 1 */
		// Start line: 532
		// Start offset: 0x80092D90
		// Variables:
...
// void /*$ra*/ G2Anim_BuildTransforms(struct _G2Anim_Type *anim /*$s0*/)
 // line 562, offset 0x80092e10
	/* begin block 1 */
		// Start line: 563
		// Start offset: 0x80092E10

		/* begin block 1.1 */
			// Start line: 574
			// Start offset: 0x80092E38
		/* end block 1.1 */
		// End offset: 0x80092E40
		// End Line: 574

		/* begin block 1.2 */
			// Start line: 586
			// Start offset: 0x80092E78
		...
		/* begin block 1.3 */
			// Start line: 598
			// Start offset: 0x80092EAC
		/* end block 1.3 */
		// End offset: 0x80092EAC
		// End Line: 598
	/* end block 1 */
	// End offset: 0x80092EAC
	// End Line: 598
...
// void /*$ra*/ G2Anim_UpdateStoredFrame(struct _G2Anim_Type *anim /*$s2*/)
 // line 617, offset 0x80092edc
	/* begin block 1 */
		// Start line: 618
		// Start offset: 0x80092EDC
		// Variables:
	// 		struct _G2AnimSection_Type *section; // $s0
	// 		short storedTime; // $s3
	...
	// 		struct _G2AnimInterpInfo_Type *interpInfo; // $v0
		...
		/* begin block 1.1 */
			// Start line: 669
			// Start offset: 0x80092F68
			// Variables:
		// 		struct _G2SVector3_Type *vector; // $a3
		/* end block 1.1 */
		// End offset: 0x80092F68
		// End Line: 669
	/* end block 1 */
	// End offset: 0x80093038
	// End Line: 703
...
// struct _G2AnimSection_Type * /*$ra*/ G2Anim_GetSectionWithSeg(struct _G2Anim_Type *anim /*$a0*/, int segNumber /*$a1*/)
 // line 712, offset 0x80093058
	/* begin block 1 */
		// Start line: 715
		// Start offset: 0x80093058
		// Variables:
...
// void /*$ra*/ G2Anim_GetSegChannelValue(struct _G2Anim_Type *anim /*$s0*/, int segIndex /*$s1*/, unsigned short *valueTable /*$s3*/, unsigned short channelMask /*$s2*/)
 // line 866, offset 0x80093204
	/* begin block 1 */
		// Start line: 867
		// Start offset: 0x80093204
		// Variables:
	// 		unsigned short *chanFinalValue; // $v1
		...
		/* begin block 1.1 */
			...
			// 		unsigned long xy; // $v0
			/* end block 1.1.1 */
			// End offset: 0x80093204
			// End Line: 867
		/* end block 1.1 */
		// End offset: 0x80093204
		// End Line: 867
	/* end block 1 */
	// End offset: 0x80093294
	// End Line: 905
...
// void /*$ra*/ G2Anim_GetRootMotionFromTimeForDuration(struct _G2Anim_Type *anim /*$t0*/, short durationStart /*$s1*/, short duration /*$s3*/, struct _G2SVector3_Type *motionVector /*$s5*/)
 // line 922, offset 0x800932b0
	/* begin block 1 */
		// Start line: 923
		// Start offset: 0x800932B0
		// Variables:
	...
	// 		struct _G2AnimInterpInfo_Type *interpInfo; // $a0
		...
		// 		long alpha; // $a1
		/* end block 1.1 */
		// End offset: 0x80093308
		// End Line: 949

		/* begin block 1.2 */
			// Start line: 965
			// Start offset: 0x800933EC
			// Variables:
		...
		/* begin block 1.3 */
			// Start line: 1001
			// Start offset: 0x800934E0
			// Variables:
		// 		struct _G2SVector3_Type *dest; // $s5
		// 		struct _G2SVector3_Type *base; // $s5
		// 		long alpha; // $a1
		/* end block 1.3 */
		// End offset: 0x800934E0
		// End Line: 1001
	/* end block 1 */
	// End offset: 0x80093560
	// End Line: 1015
...
// void /*$ra*/ G2AnimSection_SwitchToKeylistAtTime(struct _G2AnimSection_Type *section /*$s1*/, struct _G2AnimKeylist_Type *keylist /*$s4*/, int keylistID /*$s5*/, short targetTime /*$s3*/)
 // line 1121, offset 0x80093588
	/* begin block 1 */
		// Start line: 1122
		// Start offset: 0x80093588
		// Variables:
	...
	// 		struct _G2AnimInterpInfo_Type *interpInfo; // $s0
		...
		/* begin block 1.1 */
			// Start line: 1144
			// Start offset: 0x80093610
		/* end block 1.1 */
		// End offset: 0x80093618
		// End Line: 1144

		/* begin block 1.2 */
			// Start line: 1197
			// Start offset: 0x800936D4
			...
			// 		unsigned long xy; // $v0
			/* end block 1.2.1 */
			// End offset: 0x800936F4
			// End Line: 1197
		/* end block 1.2 */
		// End offset: 0x800936F4
		// End Line: 1197
	/* end block 1 */
	// End offset: 0x80093710
	// End Line: 1206
...
// void /*$ra*/ G2AnimSection_JumpToTime(struct _G2AnimSection_Type *section /*$s0*/, short targetTime /*$a1*/)
 // line 1225, offset 0x80093740
	/* begin block 1 */
		// Start line: 1226
		// Start offset: 0x80093740
		// Variables:
	// 		struct _G2Anim_Type *anim; // $s1

		/* begin block 1.1 */
			// Start line: 1266
			// Start offset: 0x800937C0
		/* end block 1.1 */
		// End offset: 0x800937C8
		// End Line: 1266
	/* end block 1 */
	// End offset: 0x800937C8
	// End Line: 1268
...
// short /*$ra*/ G2AnimSection_UpdateOverInterval(struct _G2AnimSection_Type *section /*$s0*/, short interval /*$a1*/)
 // line 1273, offset 0x800937e0
	/* begin block 1 */
		// Start line: 1274
		// Start offset: 0x800937E0
		// Variables:
	// 		struct _G2Anim_Type *anim; // $s2
	// 		struct _G2SVector3_Type motionVector; // stack offset -32
	...
	// 		short elapsedTime; // $s3
		...
		/* begin block 1.1 */
			...
			// 		unsigned long xy; // $v0
			/* end block 1.1.1 */
			// End offset: 0x800938C8
			// End Line: 1324
		/* end block 1.1 */
		// End offset: 0x800938C8
		// End Line: 1324
	/* end block 1 */
	// End offset: 0x800939B4
	// End Line: 1361
...
// short /*$ra*/ G2AnimSection_AdvanceOverInterval(struct _G2AnimSection_Type *section /*$s1*/, short interval /*$s0*/)
 // line 1381, offset 0x800939d4
	...
	// 		unsigned long message; // $s3
		...
		/* end block 1.1 */
		// End offset: 0x80093D18
		// End Line: 1614

		/* begin block 1.2 */
			// Start line: 1624
			// Start offset: 0x80093D28
			...
			// 		unsigned long xy; // $v0
			/* end block 1.2.1 */
			// End offset: 0x80093D28
			// End Line: 1624
		/* end block 1.2 */
		// End offset: 0x80093D28
		// End Line: 1624
	/* end block 1 */
	// End offset: 0x80093D7C
	// End Line: 1658
...

{
  ...
  if (((section->flags & 1) == 0) && ((section->alarmFlags & 1) == 0)) {
    ...
    while( true ) {
      ...
      if ((section->flags & 2) == 0) goto LAB_80093d70;
...
// short /*$ra*/ G2AnimSection_RewindOverInterval(struct _G2AnimSection_Type *section /*$s1*/, short interval /*$a1*/)
 // line 1671, offset 0x80093dac
	/* begin block 1 */
		// Start line: 1672
		// Start offset: 0x80093DAC
		// Variables:
	// 		short newTime; // $s3
	// 		short extraTime; // $s6
	...
	// 		unsigned long message; // $s5
		...
		/* begin block 1.1 */
			// Start line: 1832
			// Start offset: 0x80093F74
		/* end block 1.1 */
		// End offset: 0x80093F7C
		// End Line: 1832

		/* begin block 1.2 */
			// Start line: 1841
			// Start offset: 0x80093F8C
			...
			// 		unsigned long xy; // $v0
			/* end block 1.2.1 */
			// End offset: 0x80093F8C
			// End Line: 1841
		/* end block 1.2 */
		// End offset: 0x80093F8C
		// End Line: 1841
	/* end block 1 */
	// End offset: 0x80093FC0
	// End Line: 1867
...
// void /*$ra*/ _G2Anim_BuildTransformsNoControllers(struct _G2Anim_Type *anim /*$s4*/)
 // line 1876, offset 0x80093fec
	/* begin block 1 */
		// Start line: 1877
		// Start offset: 0x80093FEC
		// Variables:
...
// void /*$ra*/ _G2Anim_BuildSegLocalRotMatrix(struct _G2AnimSegValue_Type *segValue /*$v1*/, struct _G2Matrix_Type *segMatrix /*$a1*/)
 // line 2063, offset 0x80094368
	/* begin block 1 */
		// Start line: 2064
		// Start offset: 0x80094368
		// Variables:
	// 		struct _G2SVector3_Type rot; // stack offset -16

		/* begin block 1.1 */
			// Start line: 2070
			// Start offset: 0x80094394
			// Variables:
		...
		// 		struct _G2SVector3_Type *dest; // $a0
			...
			// 		unsigned long xy; // $v1
			/* end block 1.1.1 */
			// End offset: 0x80094394
			// End Line: 2070
		/* end block 1.1 */
		// End offset: 0x80094394
		// End Line: 2070
	/* end block 1 */
	// End offset: 0x800943B8
	// End Line: 2074
...
// void /*$ra*/ wombat(unsigned char *segKeyList /*$a0*/, int flagBitOffset /*$a1*/, struct _G2AnimSegKeyflagInfo_Type *kfInfo /*$a2*/)
 // line 2113, offset 0x800943c8
	/* begin block 1 */
		// Start line: 2116
		// Start offset: 0x800943C8
		// Variables:
	// 		int flagDWordOffset; // $a3
	// 		int flagBitShift; // $a1
	/* end block 1 */
	// End offset: 0x800943C8
	// End Line: 2118
...
// void /*$ra*/ _G2Anim_InitializeSegValue(struct _G2Anim_Type *anim /*$a0*/, struct _G2AnimSegValue_Type *segValue /*$a1*/, int segIndex /*$a2*/)
 // line 2167, offset 0x80094488
	/* begin block 1 */
		// Start line: 2170
		// Start offset: 0x80094488
		// Variables:
...
// void /*$ra*/ _G2AnimSection_InitStatus(struct _G2AnimSection_Type *section /*$s7*/, struct _G2Anim_Type *anim /*stack 4*/)
 // line 2224, offset 0x800944dc
	/* begin block 1 */
		// Start line: 2225
		// Start offset: 0x800944DC
		// Variables:
	...
	// 		int lastSeg; // $fp
		...
		// 		struct _G2AnimSection_Type *section; // $s7
			...
			/* end block 1.1.1 */
			// End offset: 0x800945B0
			// End Line: 2225
		/* end block 1.1 */
		// End offset: 0x800945B0
		// End Line: 2225
	/* end block 1 */
	// End offset: 0x80094740
	// End Line: 2336
 ...
 // line 2346, offset 0x80094788
	...
	// 		struct _G2AnimChanStatus_Type nextChanStatus; // stack offset -56
		...
		// 		struct _G2AnimSection_Type *section; // $s6
			...
			// 		unsigned char *segKeyList; // $s1
			/* end block 1.1.1 */
			// End offset: 0x80094868
			// End Line: 2347
		/* end block 1.1 */
		// End offset: 0x80094868
		// End Line: 2347
	/* end block 1 */
	// End offset: 0x80094BE0
	// End Line: 2508
...
// void /*$ra*/ _G2AnimSection_UpdateStoredFrameFromData(struct _G2AnimSection_Type *section /*$s0*/, struct _G2Anim_Type *anim /*$s3*/)
 // line 2513, offset 0x80094c10
	/* begin block 1 */
		// Start line: 2514
		// Start offset: 0x80094C10
		// Variables:
	// 		short timePerKey; // $s2
	// 		long storedKey; // $a2
	// 		long targetKey; // $s1
...
// struct _G2Anim_Type * /*$ra*/ _G2AnimSection_GetAnim(struct _G2AnimSection_Type *section /*$a0*/)
 // line 2557, offset 0x80094ce0
	/* begin block 1 */
		// Start line: 2560
		// Start offset: 0x80094CE0
	/* end block 1 */
	// End offset: 0x80094CE0
	// End Line: 2564
...
// void /*$ra*/ _G2AnimSection_TriggerEffects(struct _G2AnimSection_Type *section /*$s1*/, short startTime /*$a1*/, short endTime /*$a2*/)
 // line 2576, offset 0x80094d00
	/* begin block 1 */
		// Start line: 2577
		// Start offset: 0x80094D00
		// Variables:
	// 		struct _G2AnimKeylist_Type *keylist; // $s4
...
// void /*$ra*/ _G2Anim_FreeChanStatusBlockList(struct _G2AnimChanStatusBlock_Type *block /*$a1*/)
 // line 2621, offset 0x80094e2c
	/* begin block 1 */
		// Start line: 2622
		// Start offset: 0x80094E2C
		// Variables:
	// 		struct _G2AnimChanStatusBlock_Type *nextBlock; // $s0
	/* end block 1 */
	// End offset: 0x80094E5C
	// End Line: 2633
...
// long /*$ra*/ _G2AnimAlphaTable_GetValue(struct _G2AnimAlphaTable_Type *table /*$a2*/, long trueAlpha /*$v0*/)
 // line 2638, offset 0x80094e6c
	/* begin block 1 */
		// Start line: 2639
		// Start offset: 0x80094E6C
		// Variables:
	// 		long position; // $a0
	// 		long positionInt; // $v1
