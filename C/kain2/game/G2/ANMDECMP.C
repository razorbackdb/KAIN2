...

{
  ...
  while (true)
  {
    ...
    iVar8 = iVar7 + *(int *)(&_indexTable + (uVar5 & 0xf) * 2);
    iVar7 = iVar8;
    if (iVar8 < 0)
    {
      iVar7 = 0;
...
void _G2Anim_InitializeChannel_AdaptiveDelta(_G2AnimDecompressChannelInfo_Type *dcInfo, _G2AnimChanStatus_Type *status)
...
void _G2Anim_InitializeChannel_Linear(_G2AnimDecompressChannelInfo_Type *dcInfo, _G2AnimChanStatus_Type *status)
