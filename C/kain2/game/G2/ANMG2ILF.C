...
// short /*$ra*/ G2Anim_GetElapsedTime(struct _G2Anim_Type *anim /*$a0*/)
 // line 97, offset 0x8008fb50
	/* begin block 1 */
		// Start line: 100
		// Start offset: 0x8008FB50
		// Variables:
	// 		struct _G2AnimSection_Type *section; // $v0
	/* end block 1 */
	// End offset: 0x8008FB50
	// End Line: 104
...
// struct _G2AnimKeylist_Type * /*$ra*/ G2Anim_GetKeylist(struct _G2Anim_Type *anim /*$a0*/)
 // line 136, offset 0x8008fb74
	/* begin block 1 */
		// Start line: 139
		// Start offset: 0x8008FB74
		// Variables:
	// 		struct _G2AnimSection_Type *section; // $v0
	/* end block 1 */
	// End offset: 0x8008FB74
	// End Line: 143
...
// void /*$ra*/ G2Anim_GetRootMotionOverInterval(struct _G2Anim_Type *anim /*$a0*/, short intervalStart /*$a1*/, short intervalEnd /*$a2*/, struct _G2SVector3_Type *motionVector /*$a3*/)
 // line 165, offset 0x8008fb98
	/* begin block 1 */
		// Start line: 166
		// Start offset: 0x8008FB98
	/* end block 1 */
	// End offset: 0x8008FB98
	// End Line: 166
...
// void /*$ra*/ G2Anim_InterpToKeylistFrame(struct _G2Anim_Type *anim /*$s2*/, struct _G2AnimKeylist_Type *keylist /*$s4*/, int keylistID /*$s5*/, int targetFrame /*$s6*/, int duration /*stack 16*/)
 // line 292, offset 0x8008fbc8
	/* begin block 1 */
		// Start line: 293
		// Start offset: 0x8008FBC8
		// Variables:
	// 		int i; // $s0
	/* end block 1 */
	// End offset: 0x8008FC44
	// End Line: 307
...
// void /*$ra*/ G2Anim_SetAlphaTable(struct _G2Anim_Type *anim /*$s2*/, struct _G2AnimAlphaTable_Type *table /*$s3*/)
 // line 412, offset 0x8008fc6c
	/* begin block 1 */
		// Start line: 413
		// Start offset: 0x8008FC6C
		// Variables:
	// 		int i; // $s0
	/* end block 1 */
	// End offset: 0x8008FCC0
	// End Line: 422
...
// void /*$ra*/ G2Anim_SetCallback(struct _G2Anim_Type *anim /*$a0*/, TDRFuncPtr_G2Anim_SetCallback1callback callback /*$a1*/, void *data /*$a2*/)
 // line 428, offset 0x8008fcdc
	/* begin block 1 */
		// Start line: 431
		// Start offset: 0x8008FCDC
		// Variables:
	// 		int i; // $v1
	/* end block 1 */
	// End offset: 0x8008FD10
	// End Line: 439
...
// void /*$ra*/ G2Anim_SetLooping(struct _G2Anim_Type *anim /*$s2*/)
 // line 518, offset 0x8008fd18
	/* begin block 1 */
		// Start line: 519
		// Start offset: 0x8008FD18
		// Variables:
	// 		int i; // $s0
	/* end block 1 */
	// End offset: 0x8008FD60
	// End Line: 527
...
// void /*$ra*/ G2Anim_SetNoLooping(struct _G2Anim_Type *anim /*$s2*/)
 // line 565, offset 0x8008fd78
	/* begin block 1 */
		// Start line: 566
		// Start offset: 0x8008FD78
		// Variables:
	// 		int i; // $s0
	/* end block 1 */
	// End offset: 0x8008FDC0
	// End Line: 574
...
// void /*$ra*/ G2Anim_SetPaused(struct _G2Anim_Type *anim /*$s2*/)
 // line 591, offset 0x8008fdd8
	/* begin block 1 */
		// Start line: 592
		// Start offset: 0x8008FDD8
		// Variables:
	// 		int i; // $s0
	/* end block 1 */
	// End offset: 0x8008FE20
	// End Line: 600
...
// void /*$ra*/ G2Anim_SetSpeedAdjustment(struct _G2Anim_Type *anim /*$a0*/, long adjustment /*$a1*/)
 // line 618, offset 0x8008fe38
	/* begin block 1 */
		// Start line: 621
		// Start offset: 0x8008FE38
		// Variables:
	// 		int i; // $v1
	/* end block 1 */
	// End offset: 0x8008FE64
	// End Line: 629
...
// void /*$ra*/ G2Anim_SetUnpaused(struct _G2Anim_Type *anim /*$s2*/)
 // line 649, offset 0x8008fe6c
	/* begin block 1 */
		// Start line: 650
		// Start offset: 0x8008FE6C
		// Variables:
	// 		int i; // $s0
	/* end block 1 */
	// End offset: 0x8008FEB4
	// End Line: 658
...
// void /*$ra*/ G2Anim_SwitchToKeylist(struct _G2Anim_Type *anim /*$s2*/, struct _G2AnimKeylist_Type *keylist /*$s3*/, int keylistID /*$s4*/)
 // line 678, offset 0x8008fecc
	/* begin block 1 */
		// Start line: 679
		// Start offset: 0x8008FECC
		// Variables:
	// 		int i; // $s0
	/* end block 1 */
	// End offset: 0x8008FF2C
	// End Line: 689
...
// void /*$ra*/ G2AnimSection_InterpToKeylistFrame(struct _G2AnimSection_Type *section /*$a0*/, struct _G2AnimKeylist_Type *keylist /*$a1*/, int keylistID /*$a2*/, int targetFrame /*$a3*/, int duration /*stack 16*/)
 // line 1005, offset 0x8009003c
	/* begin block 1 */
		// Start line: 1006
		// Start offset: 0x8009003C
	/* end block 1 */
	// End offset: 0x8009003C
	// End Line: 1006
...
// enum _G2Bool_Enum /*$ra*/ G2AnimSection_IsInInterpolation(struct _G2AnimSection_Type *section /*$a0*/)
 // line 1023, offset 0x8009007c
	/* begin block 1 */
		// Start line: 1026
		// Start offset: 0x8009007C
		// Variables:
	// 		struct _G2AnimInterpInfo_Type *interpInfo; // $v0
	/* end block 1 */
	// End offset: 0x800900A4
	// End Line: 1035
