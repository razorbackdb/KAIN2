...
// void /*$ra*/ G2Quat_ToEuler(struct _G2Quat_Type *quat /*$a0*/, struct _G2EulerAngles_Type *euler /*$s0*/, int order /*$s1*/)
 // line 74, offset 0x80096018
	/* begin block 1 */
		// Start line: 75
		// Start offset: 0x80096018
		// Variables:
	// 		struct _G2Matrix_Type tempMatrix; // stack offset -48
	/* end block 1 */
	// End offset: 0x80096018
	// End Line: 75
...
// void /*$ra*/ G2EulerAngles_FromMatrix(struct _G2EulerAngles_Type *euler /*$s3*/, struct _G2Matrix_Type *matrix /*$s4*/, long order /*stack 8*/)
 // line 328, offset 0x8009605c
	/* begin block 1 */
		// Start line: 329
		// Start offset: 0x8009605C
		// Variables:
	// 		long i; // $a2
	// 		long j; // $s5
	...
	// 		long f; // stack offset -48
		...
		// 		unsigned int o; // $v1
		/* end block 1.1 */
		// End offset: 0x8009605C
		// End Line: 329

		/* begin block 1.2 */
			// Start line: 336
			// Start offset: 0x800960FC
			// Variables:
		// 		long sy; // $s0
		/* end block 1.2 */
		...
		/* begin block 1.3 */
			// Start line: 356
			// Start offset: 0x80096208
			// Variables:
		// 		long cy; // $s5
		/* end block 1.3 */
		// End offset: 0x80096330
		// End Line: 375

		/* begin block 1.4 */
			// Start line: 384
			// Start offset: 0x80096374
			// Variables:
		// 		short t; // $v1
		/* end block 1.4 */
		// End offset: 0x80096384
		// End Line: 387
	/* end block 1 */
	// End offset: 0x80096384
	// End Line: 389
...

{
  ...
  uVar8 = (uint)*(byte *)((int)&PTR_LAB_800d1c08 + ((uint)order >> 3 & 3));
  uVar9 = (uint)(byte)(&DAT_800d1c10)[uVar8 + uVar6];
  uVar2 = (uint)(byte)(&DAT_800d1c10)[uVar8 - (uVar6 - 1)];
  if (((uint)order >> 1 & 1) == 1) {
