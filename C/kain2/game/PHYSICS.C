...

{
  ...
  else
  {
    ...
    DAT_800d10ec = DAT_800d10ec | 0x8000;
    PHYSICS_CheckLineInWorld(instance, &local_68);
    DAT_800d10ec = DAT_800d10ec & 0xffff7fff;
  }
      ...
      (0 < Data_00))
  {
    ...
    iVar8 = (short)(local_74 - (short)(Data_00 >> 0xc)) * iVar8;
...

{
  ...
  if ((instance == DAT_800d0fd8) && (0x80 < Data->z))
  {
...

{
  ...
  iVar1 = *Time + (uint)(rate << 0xc) / DAT_800d11ec;
  *Time = iVar1;
  if (0x1000 < iVar1)
  {
    *Time = iVar1 + -0x1000;
...
uint PHYSICS_CheckForTerrainCollide(_Instance *param_1, SVECTOR *param_2, SVECTOR *param_3, int param_4)

{
  ...
  PHYSICS_GenericLineCheckMask(param_1, param_1->matrix + param_4, param_1->matrix + param_4, &local_38);
...

{
  ...
  PHYSICS_GenericLineCheckMask(param_1, param_1->matrix + param_4, param_1->matrix + param_4, &_Stack56);
...

{
  ...
  if (sVar1 == 3)
  {
    ...
    if (uVar2 != 0xffff)
    {
      uVar3 = (uint)((*(ushort *)((int)&(CInfo->inst->node).prev[6].next[1].prev + (uint)uVar2 + 2) & 0x80) != 0);
    }
