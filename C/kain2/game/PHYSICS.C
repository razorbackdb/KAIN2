...
// void /*$ra*/ SetNoPtCollideInFamily(struct _Instance *instance /*$a0*/)
 // line 57, offset 0x800748d0
	/* begin block 1 */
		// Start line: 58
		// Start offset: 0x800748D0
		// Variables:
	// 		struct _Instance *child; // $s0
	/* end block 1 */
	// End offset: 0x80074908
	// End Line: 65
...
// void /*$ra*/ ResetNoPtCollideInFamily(struct _Instance *instance /*$a0*/)
 // line 67, offset 0x80074918
	/* begin block 1 */
		// Start line: 68
		// Start offset: 0x80074918
		// Variables:
	// 		struct _Instance *child; // $s0
	/* end block 1 */
...
// void /*$ra*/ PHYSICS_CheckLineInWorldMask(struct _Instance *instance /*$s2*/, struct _PCollideInfo *pcollideInfo /*$s1*/)
 // line 85, offset 0x80074988
	/* begin block 1 */
		// Start line: 86
		// Start offset: 0x80074988
		// Variables:
	// 		struct Level *level; // $s0
	/* end block 1 */
	// End offset: 0x800749DC
	// End Line: 113
...
// int /*$ra*/ PhysicsCheckLinkedMove(struct _Instance *instance /*$s2*/, int Data /*stack 4*/, short Mode /*stack -72*/)
 // line 124, offset 0x800749fc
	/* begin block 1 */
		// Start line: 125
		// Start offset: 0x800749FC
		...
		// 		long iz; // stack offset -48
			...
			/* begin block 1.1.1 */
				// Start line: 146
				// Start offset: 0x80074AB8
				// Variables:
			// 		struct _Instance *oldOn; // $a0
			/* end block 1.1.1 */
			// End offset: 0x80074ADC
			// End Line: 153

			/* begin block 1.1.2 */
				// Start line: 182
				// Start offset: 0x80074BC8
				// Variables:
			...
			// 		int rotated; // $s0
			/* end block 1.1.2 */
			// End offset: 0x80074D78
			// End Line: 245
		/* end block 1.1 */
		// End offset: 0x80074E20
		// End Line: 260
	/* end block 1 */
	// End offset: 0x80074E28
	// End Line: 266
...
// int /*$ra*/ PhysicsCheckGravity(struct _Instance *instance /*$s0*/, int Data /*stack 4*/, short Mode /*$s7*/)
 // line 296, offset 0x80074ee0
	/* begin block 1 */
		// Start line: 297
		// Start offset: 0x80074EE0
		// Variables:
	...
	// 		int slide; // $fp
		...
		/* begin block 1.1 */
			// Start line: 326
			// Start offset: 0x80074FD8
			// Variables:
		// 		int stillOnOldTFace; // $v0
		// 		struct Level *level; // $s2
		// 		struct _TFace *tface; // $s1
		/* end block 1.1 */
		// End offset: 0x80075098
		// End Line: 361

		/* begin block 1.2 */
			// Start line: 504
			// Start offset: 0x80075534
			// Variables:
		// 		struct _Instance *oldOn; // $a0
		/* end block 1.2 */
		// End offset: 0x80075558
		// End Line: 511
	/* end block 1 */
	// End offset: 0x80075664
	// End Line: 564
...
LAB_800750b4:
    ...
    tface = (_TFace *)0x0;
    p_Var5 = (_Instance *)STREAM_GetLevelWithID(*(long *)((int)instance->cachedTFaceLevel + 0xf8));
    gameTrackerX.gameFlags = gameTrackerX.gameFlags | 0x8000;
    if (p_Var5 == (_Instance *)0x0) {
      Data_00 = 0;
    }
    else {
      pNVar3 = (p_Var5->node).prev;
      tface = (_TFace *)((int)pNVar3[4].prev + (int)instance->cachedTFace * 0xc);
      Data_00 = COLLIDE_PointAndTfaceFunc
                          ((_Terrain *)(p_Var5->node).prev,
                           (BSPTree *)((int)pNVar3[9].prev + (int)instance->cachedBSPTree * 0x24),
...
LAB_800750d0:
  if (((((uint)local_68.type - 2 < 2) || (local_68.type == 5)) &&
    ...
    iVar7 = -(local_68.wNormal.vx * iVar8);
...
// int /*$ra*/ PhysicsCheckEdgeGrabbing(struct _Instance *instance /*$s2*/, struct GameTracker *gameTracker /*$a1*/, int Data /*stack 8*/, short Mode /*$s7*/)
 // line 589, offset 0x80075710
	/* begin block 1 */
		// Start line: 590
		// Start offset: 0x80075710
		// Variables:
...

{
  ...
  if (local_68.type == 0) {
    ...
    PHYSICS_GenericLineCheck(instance,instance->matrix,pTempMat_41,&local_68);
    if (local_68.type == 0) goto LAB_80075898;
  }
  bVar4 = false;
LAB_80075898:
  if ((bVar4) || (bVar10)) {
...
// void /*$ra*/ PhysicsDefaultEdgeGrabResponse(struct _Instance *instance /*$s2*/, struct evPhysicsEdgeData *Data /*$s1*/, int blockFlag /*$a2*/)
 // line 886, offset 0x80075dc8
	/* begin block 1 */
		// Start line: 887
		// Start offset: 0x80075DC8
		// Variables:
	...
	// 		struct SVECTOR New; // stack offset -24
		...
		/* begin block 1.1 */
			// Start line: 936
			// Start offset: 0x80075EE4
			// Variables:
		// 		long dp; // $v0
		/* end block 1.1 */
		// End offset: 0x80075EE4
		// End Line: 936
	/* end block 1 */
	// End offset: 0x80075EE4
	// End Line: 936
...
// int /*$ra*/ PhysicsCheckSliding(struct _Instance *instance /*$s3*/, int Data /*$a1*/, short Mode /*$s6*/)
 // line 983, offset 0x8007606c
	/* begin block 1 */
		// Start line: 984
		// Start offset: 0x8007606C
		// Variables:
	...
	// 		static struct MATRIX *pTempMat; // offset 0x24
		...
		/* begin block 1.1 */
			// Start line: 1015
			// Start offset: 0x800760F4
		/* end block 1.1 */
		// End offset: 0x800760F4
		// End Line: 1017
...
// int /*$ra*/ PhysicsCheckBlockers(struct _Instance *instance /*$s3*/, struct GameTracker *gameTracker /*$a1*/, int Data /*$s4*/, short Mode /*$s2*/)
 // line 1232, offset 0x80076614
	/* begin block 1 */
		// Start line: 1233
		// Start offset: 0x80076614
		// Variables:
	// 		struct evPhysicsEdgeData *Ptr; // $s1
	// 		struct VECTOR OutTrans; // stack offset -120
	// 		struct _PCollideInfo CInfo; // stack offset -104
	...
	// 		static struct MATRIX *pTempMat; // offset 0x28
		...
		// 		struct _TFace *tface; // $s0
			...
			/* begin block 1.1.2 */
				// Start line: 1351
				// Start offset: 0x80076878
				// Variables:
			// 		struct _HFace *hface; // stack offset -32
			/* end block 1.1.2 */
			// End offset: 0x80076878
			// End Line: 1357
		/* end block 1.1 */
		// End offset: 0x80076990
		// End Line: 1401
	/* end block 1 */
	// End offset: 0x80076994
	// End Line: 1404
  ...
  *(undefined4 *)(Data + 0x18) = 0;
  ...
  if (((local_68.type == 3) || (local_68.type == 5)) || (local_68.type == 2)) {
    ...
    if (((local_68.type == 3) && (*(ushort *)((int)local_68.prim + 10) != 0xffff)) &&
      ...
      if (-0xec8 < iVar2 >> 0xc) goto LAB_80076990;
    }
    else {
      if (-0xfc1 < iVar2 >> 0xc) goto LAB_80076990;
    }
    if ((Mode & 1U) != 0) {
      **(short **)(Data + 0xc) = local_68.wNormal.vx;
      *(short *)(*(int *)(Data + 0xc) + 2) = local_68.wNormal.vy;
...
// int /*$ra*/ PhysicsCheckSwim(struct _Instance *instance /*$s1*/, int Data /*$s3*/, short Mode /*$s5*/)
 // line 1486, offset 0x800769b4
	/* begin block 1 */
		// Start line: 1487
		// Start offset: 0x800769B4
		// Variables:
...
// int /*$ra*/ PhysicsDefaultCheckSwimResponse(struct _Instance *instance /*$s2*/, struct evPhysicsSwimData *Data /*$s3*/)
 // line 1584, offset 0x80076ba4
	/* begin block 1 */
		// Start line: 1585
		// Start offset: 0x80076BA4
		// Variables:
	// 		int rc; // $s0
	// 		long waterZLevel; // $s1
	/* end block 1 */
...
// void /*$ra*/ PhysicsForceSetWater(struct _Instance *instance /*$s1*/, int *Time /*$t0*/, int Depth /*$a2*/, int rate /*$a3*/, int maxAmplitude /*stack 16*/)
 // line 1856, offset 0x80076d9c
	/* begin block 1 */
		// Start line: 1857
		// Start offset: 0x80076D9C
		// Variables:
	// 		int Amplitude; // $s0
	/* end block 1 */
	// End offset: 0x80076E60
	// End Line: 1874
...
// int /*$ra*/ PhysicsCheckLOS(struct _Instance *instance /*$a0*/, int Data /*$a1*/, int Mode /*$a2*/)
 // line 1887, offset 0x80076e74
	/* begin block 1 */
		// Start line: 1888
		// Start offset: 0x80076E74
		// Variables:
	// 		struct _PCollideInfo CInfo; // stack offset -56
	/* end block 1 */
	// End offset: 0x80076E74
	// End Line: 1888
...
// int /*$ra*/ PhysicsCheckDropHeight(struct _Instance *instance /*$s2*/, int Data /*$a1*/, int Mode /*$s3*/)
 // line 1915, offset 0x80076ea4
	/* begin block 1 */
		// Start line: 1916
		// Start offset: 0x80076EA4
		// Variables:
	...
	// 		static struct MATRIX *pTempMat; // offset 0x50
		...
		/* begin block 1.2 */
			// Start line: 1982
			// Start offset: 0x80076FE8
			// Variables:
		// 		long waterZLevel; // $a0
		/* end block 1.2 */
		// End offset: 0x80077024
		// End Line: 2000
	/* end block 1 */
	// End offset: 0x80077114
	// End Line: 2048
...
// int /*$ra*/ PhysicsCheckDropOff(struct _Instance *instance /*$s0*/, int Data /*$a1*/, short Mode /*$s3*/)
 // line 2060, offset 0x80077134
	/* begin block 1 */
		// Start line: 2061
		// Start offset: 0x80077134
		// Variables:
...
// int /*$ra*/ PhysicsFollowWall(struct _Instance *instance /*$s2*/, struct GameTracker *gameTracker /*$a1*/, int Data /*$s7*/, short Mode /*$s5*/)
 // line 2209, offset 0x80077354
	/* begin block 1 */
		// Start line: 2210
		// Start offset: 0x80077354
		// Variables:
  ...
  *(undefined4 *)(Data + 0x28) = 0;
  ...
  PHYSICS_GenericLineCheckSetup
            (0,(short)(((uint)*(ushort *)(Data + 2) + ((iVar3 >> 0x10) - (iVar3 >> 0x1f) >> 1)) *
                       0x10000 >> 0x10),*(short *)(Data + 4),&local_68);
  PHYSICS_GenericLineCheck(instance,pTempMat_72,pTempMat_72,&local_98);
  if ((local_98.type == 3) || (local_98.type == 5)) {
...
// void /*$ra*/ PhysicsMove(struct _Instance *instance /*$a0*/, struct _Position *position /*$a1*/, long time /*$a2*/)
 // line 2662, offset 0x8007793c
	/* begin block 1 */
		// Start line: 2664
		// Start offset: 0x8007793C
		// Variables:
	// 		long xVel; // $t0
	// 		long yVel; // $t1
	// 		long zVel; // $t2
...
// void /*$ra*/ PHYSICS_SetVAndAFromRot(struct _Instance *instance /*$s0*/, struct _Rotation *rot /*$a1*/, long v /*$s1*/, long a /*$s2*/)
 // line 2765, offset 0x80077bb8
	...
	// 		struct MATRIX mat; // stack offset -64
		...
		/* begin block 1.1 */
			// Start line: 2780
			// Start offset: 0x80077C00
			// Variables:
		// 		struct SVECTOR newPt; // stack offset -32
		/* end block 1.1 */
		// End offset: 0x80077C00
		// End Line: 2782
		...
		/* end block 1.2 */
		// End offset: 0x80077C4C
		// End Line: 2801
	/* end block 1 */
	// End offset: 0x80077C90
	// End Line: 2815
...
// long /*$ra*/ PHYSICS_FindVFromAAndD(long a /*$a0*/, long d /*$a1*/)
 // line 2835, offset 0x80077ce4
	/* begin block 1 */
		// Start line: 2836
		// Start offset: 0x80077CE4
		// Variables:
	// 		long vsq; // $a0
	/* end block 1 */
	// End offset: 0x80077D0C
	// End Line: 2842
...
// int /*$ra*/ PHYSICS_CheckForTerrainCollide(struct _Instance *instance /*$a0*/, struct SVECTOR *startVec /*$a1*/, struct SVECTOR *endVec /*$a2*/, int segment /*$a3*/)
 // line 2898, offset 0x80077dfc
	/* begin block 1 */
		// Start line: 2899
		// Start offset: 0x80077DFC
		// Variables:
	// 		struct _PCollideInfo CInfo; // stack offset -56
	// 		struct MATRIX *pTempMat; // $a1
	/* end block 1 */
	// End offset: 0x80077DFC
	// End Line: 2899
...
// int /*$ra*/ PHYSICS_CheckForObjectCollide(struct _Instance *instance /*$a0*/, struct SVECTOR *startVec /*$a1*/, struct SVECTOR *endVec /*$a2*/, int segment /*$a3*/)
 // line 2917, offset 0x80077e44
	/* begin block 1 */
		// Start line: 2918
		// Start offset: 0x80077E44
		// Variables:
	// 		struct _PCollideInfo CInfo; // stack offset -56
	// 		struct MATRIX *pTempMat; // $a1
	/* end block 1 */
	// End offset: 0x80077E44
	// End Line: 2918
...
// int /*$ra*/ PHYSICS_CheckFaceStick(struct _PCollideInfo *CInfo /*$a0*/)
 // line 2966, offset 0x80077ef4
	...
	// 		int rc; // $a1
		...
		/* begin block 1.1 */
			// Start line: 2973
			// Start offset: 0x80077F08
			// Variables:
		// 		struct _TFace *tface; // $a2
		/* end block 1.1 */
		// End offset: 0x80077F20
		// End Line: 2975

		/* begin block 1.2 */
			// Start line: 2979
			// Start offset: 0x80077F4C
			// Variables:
		// 		struct _HFace *hface; // stack offset -8
		/* end block 1.2 */
		// End offset: 0x80077F4C
		// End Line: 2987
	/* end block 1 */
	// End offset: 0x80077F4C
	// End Line: 2988
...
// int /*$ra*/ PHYSICS_CheckDontGrabEdge(struct _PCollideInfo *CInfo /*$s0*/)
 // line 2992, offset 0x80077f58
	/* begin block 1 */
		// Start line: 2993
		// Start offset: 0x80077F58
		// Variables:
	// 		int rc; // $s1

		/* begin block 1.1 */
			// Start line: 2998
			// Start offset: 0x80077F7C
			// Variables:
		...
		/* begin block 1.2 */
			// Start line: 3012
			// Start offset: 0x80078008
			// Variables:
		// 		struct _HFace *hface; // $v0
		/* end block 1.2 */
		// End offset: 0x80078024
		// End Line: 3016

		/* begin block 1.3 */
			// Start line: 3021
			// Start offset: 0x80078034
		/* end block 1.3 */
		// End offset: 0x80078068
		// End Line: 3029
	/* end block 1 */
	// End offset: 0x80078068
	// End Line: 3030
