...
{
  if (((_FX_PRIM *)FX_LastUsedPrim == fxPrim) &&
      (FX_LastUsedPrim = (ulong)(fxPrim->node).prev,
       ((NodeType *)FX_LastUsedPrim)->prev == (NodeType *)0x0))
  {
    FX_LastUsedPrim = 0;
  }
...

{
  ...
  uVar1 = FX_LastUsedPrim;
  if (p_Var3 == (_FX_PRIM *)0x0)
  {
    if (FX_LastUsedPrim != 0)
    {
      FX_LastUsedPrim = *(ulong *)FX_LastUsedPrim;
      iVar2 = *(int *)FX_LastUsedPrim;
      ((int *)FX_LastUsedPrim)[1] = 0;
      p_Var3 = (_FX_PRIM *)uVar1;
      if (iVar2 == 0)
      {
        FX_LastUsedPrim = 0;
      }
...

{
  ...
  if ((bVar1 & 2) == 0)
  {
    if ((bVar1 & 8) == 0)
    {
      setCopReg(2, in_zero, (&debugImbueSoulReaverMenu.var_address)[(uint)mface->normal * 2]);
      setCopReg(2, in_at, (&debugImbueSoulReaverMenu.bit_mask)[(uint)mface->normal * 2]);
...

{
  ...
  local_3c = DAT_800d0fe8;
  local_38 = DAT_800d0fe8 + 0x210;
  local_44 = instance->object->modelList[instance->currentModel];
  local_58 = (undefined2)shardFlags;
  local_40 = local_44->vertexList;
  PIPE3D_TransformVerticesToWorld(instance, DAT_800d0fe8, (long *)local_38, local_70);
...

{
  ...
  PIPE3D_TransformVerticesToWorld(instance, DAT_800d0fe8, (long *)(DAT_800d0fe8 + 0x210), (_Vector *)&local_98);
  if (splintDef == (FXSplinter *)0x0)
  {
    /* WARNING: Subroutine does not return */
    rand();
  ...
  if (mface < local_40)
  {
    ...
    do
    {
      p_Var13 = p_Var1 + (mface->face).v0;
      p_Var15 = p_Var1 + (mface->face).v1;
      p_Var16 = p_Var1 + (mface->face).v2;
      ...
      iVar8 = (int)p_Var13->y + (int)p_Var15->y + (int)p_Var16->y;
      iVar8 = (int)((ulonglong)((longlong)iVar8 * (longlong)local_34) >> 0x20) - (iVar8 >> 0x1f);
      local_7e = (undefined2)iVar8;
      iVar4 = (int)p_Var13->z + (int)p_Var15->z + (int)p_Var16->z;
      ...
      if (fxPrim != (_FX_PRIM *)0x0)
      {
        if (fxSetup == (TDRFuncPtr__FX_BuildNonSegmentedSplinters6fxSetup)0x0)
        {
          ...
          (fxPrim->v0).y = p_Var13->y - local_86;
          (fxPrim->v0).z = p_Var13->z - local_84;
          (fxPrim->v1).x = p_Var15->x - local_88;
          (fxPrim->v1).y = p_Var15->y - local_86;
          (fxPrim->v1).z = p_Var15->z - local_84;
          (fxPrim->v2).x = p_Var16->x - local_88;
          (fxPrim->v2).y = p_Var16->y - local_86;
          sVar2 = p_Var16->z;
...

{
  ...
  iVar2 = (int)(((uint)FX_Frames._2_2_ + (uint)(ushort)DAT_800d11ec) * 0x10000) >> 0x10;
  if (iVar2 < 0)
  {
    iVar2 = iVar2 + 0xfff;
  }
  FX_Frames._0_2_ = (short)(iVar2 >> 0xc);
  pNVar4 = (fxTracker->usedMatrixList).next;
  FX_Frames._2_2_ =
      (short)((uint)FX_Frames._2_2_ + (uint)(ushort)DAT_800d11ec) + (short)FX_Frames * -0x1000;
...

{
  ...
  if (pNVar18 != (NodeType *)0x0)
  {
    ...
    do
    {
      if (p_Var24->lastPrim <= puVar19 + 10)
        break;
      ...
      if (((uint)pNVar22 & 0x10) == 0)
      {
        ...
        else
        {
          ...
          local_54 = local_54 & 0xffff0000 |
                     (int)*(short *)&pNVar18[10].prev * (int)*(short *)((int)&pNVar18[9].next + 2) >> 0xc & 0xffffU;
          ...
          else
          {
            ...
            else
            {
              ...
              if (bVar11 < bVar10)
              {
                ...
                {
                LAB_800450e4:
                  uVar9 = (ushort) * (byte *)((int)&(gameTracker->gameData).asmData.MorphTime + 1) << 8;
                }
              }
              else
              {
...

{
  ...
  if (sVar4 <= iVar5)
  {
    ...
    if ((DebugMenuLine_800c8798.type != DEBUG_LINE_TYPE_BIT) && ((fxPrim->v1).y < iVar5))
    {
      iVar5 = **(int **)(DebugMenuLine_800c8798.type + 0xc);
...

{
  ...
  if ((DebugMenuLine_800c8798.type != DEBUG_LINE_TYPE_BIT) &&
...

{
  ...
  if (puVar3 + 7 < *(uint **)(DAT_800d0fec + 8))
  {
...

{
  ...
  iVar2 = DAT_800d1180;
  pPVar4 = *(POLY_GT4 **)(DAT_800d0fec + 4);
  if (*(POLY_GT4 **)(DAT_800d0fec + 8) <= pPVar4 + 1)
  {
    return (POLY_GT4 *)0x0;
  }
  ...
  *(POLY_GT4 **)(DAT_800d0fec + 4) = pPVar4 + 1;
  return pPVar4;
}
...

{
  ...
  /* WARNING: Subroutine does not return */
  FX_GetTextureObject((Object *)DebugMenuLine_800c87c8.upper, 0, 9);
}
...

{
  ...
  {
    /* WARNING: Subroutine does not return */
    FX_GetTextureObject((Object *)DebugMenuLine_800c8810.var_address, 0, 7);
  }
  return;
}
...

{
  if (param_2 != (Object *)0x0)
  {
    ...
    {
      /* WARNING: Subroutine does not return */
      FX_GetTextureObject((Object *)DebugMenuLine_800c87c8.upper, 0, 0);
    }
  }
  return;
}
...

{
  ...
  if ((((instance->matrix != (MATRIX *)0x0) && (instance->oldMatrix != (MATRIX *)0x0)) &&
      ...
      (DAT_800d0fb4 == 1000))
  {
    local_30[0].vx = *(short *)instance->matrix[1].t;
    local_30[0].vy = *(short *)(instance->matrix[1].t + 1);
    local_30[0].vz = (instance->splitPoint).z;
    iVar2 = instance->matrix[1].t[2] - instance->oldMatrix[1].t[2];
    if (DebugMenuLine_800c8798.type != DEBUG_LINE_TYPE_BIT)
    {
      piVar1 = (int *)(DebugMenuLine_800c8798.type + 0xc);
      *(uint *)(DebugMenuLine_800c8798.type + 0x2c) =
          *(uint *)(DebugMenuLine_800c8798.type + 0x2c) | 0x20000000;
...

{
  ...
  if (FX_ConstrictStage == 1)
  {
    ...
    if (sVar4 == 0)
    {
      ...
      iVar3 = ratan2((int)sVar4 - (int)FX_ConstrictPosition._2_2_,
                     (int)(fxPrim->v0).x - (int)(short)FX_ConstrictPosition);
      sVar4 = (fxPrim->v1).y;
      fxPrim->work2 = (short)iVar3;
      iVar3 = ratan2((int)sVar4 - (int)FX_ConstrictPosition._2_2_,
                     (int)(fxPrim->v1).x - (int)(short)FX_ConstrictPosition);
      sVar4 = (fxPrim->v2).z;
      sVar1 = (fxPrim->v0).z;
      sVar2 = (fxPrim->v0).z;
      fxPrim->work3 = (short)iVar3;
      iVar3 = (int)sVar4 - (int)sVar1;
      if (iVar3 < 0)
      {
        iVar3 = iVar3 + 3;
      }
      (fxPrim->v2).z = sVar2 + (short)(iVar3 >> 2);
    ...
    else
    {
      ...
      fxPrim->fadeValue[2] = 0;
      iVar3 = ratan2((int)sVar4 - (int)FX_ConstrictPosition._2_2_,
                     (int)(fxPrim->v2).x - (int)(short)FX_ConstrictPosition);
      sVar4 = (fxPrim->v3).y;
      fxPrim->work2 = (short)iVar3;
      iVar3 = ratan2((int)sVar4 - (int)FX_ConstrictPosition._2_2_,
                     (int)(fxPrim->v3).x - (int)(short)FX_ConstrictPosition);
      sVar4 = (fxPrim->v0).z;
      sVar1 = (fxPrim->v2).z;
      sVar2 = (fxPrim->v2).z;
      fxPrim->work3 = (short)iVar3;
      ...
      (fxPrim->v0).z = sVar2 + (short)(iVar3 >> 2);
      (fxPrim->v1).z = (fxPrim->v3).z + ((fxPrim->v1).z - (fxPrim->v3).z) * 3;
    }
    sVar4 = (short)FX_ConstrictPosition;
    (fxPrim->v1).x = (short)FX_ConstrictPosition;
    (fxPrim->v3).x = sVar4;
    sVar4 = FX_ConstrictPosition._2_2_;
    (fxPrim->v1).y = FX_ConstrictPosition._2_2_;
    (fxPrim->v3).y = sVar4;
  }
  else
  {
...

{
  ...
  if (ConstrictEnemyFlag != 0)
  {
    ...
    {
      FX_ConstrictPosition._0_2_ = *(short *)FX_ConstrictPositionPtr;
      p_Var1 = (_Position *)FX_ConstrictPositionPtr;
    }
    else
    {
      FX_ConstrictPosition._0_2_ = (instance->position).x;
      p_Var1 = &instance->position;
    }
    FX_ConstrictPosition._2_2_ = p_Var1->y;
    ULONG_800d1598._0_2_ = p_Var1->z;
...

{
      ...
      (pMVar11 = param_1->instance->matrix, pMVar11 != (MATRIX *)0x0))
  {
    ...
    if ((((param_1->instance->flags & 0x800U) == 0) &&
         ((param_1->instance->flags2 & 0x4000000U) == 0)) &&
        (iVar15 < iVar3 + -1))
    {
      iVar24 = iVar15 << 3;
      do
...
void FX_Blood2(_SVector *param_1, _SVector *param_2, _SVector *param_3, int param_4, long param_5)

{
  FX_Blood(param_1, param_2, param_3, param_4, param_5, 4);
  return;
}
...

{
  ...
  object = DebugMenuLine_800c87c8.upper;
  if (DebugMenuLine_800c87c8.upper == 0)
  {
...

{
  ...
  iVar1 = ((int)DAT_800d0fb4 << 0xc) / 1000;
  if (DAT_800d0fb6 == 1)
  {
    iVar1 = 0x1000 - iVar1;
  }
...

{
  ...
  {
    if (((sGpffffb502 == 1) || (sGpffffb500 != 1000)) || (sGpffff90c0 == 0))
      goto LAB_80048e70;
    param_1->work0 = 0;
...

{
  ...
  sVar4 = *(short *)((int)&fxPrim->duo + 4) + (short)LONG_800cffbc;
  if (0 < fxPrim->timeToLive)
  {
    fxPrim->timeToLive = fxPrim->timeToLive + -1;
  }
...

{
  ...
  if (DAT_800d0fb4 == 1000)
  {
    if ((current_rain_fade < 0x1000) &&
        (iVar1 = (uint)(ushort)current_rain_fade + (DAT_800d11ec >> 7),
...

{
  if (((object != (Object *)0x0) ||
       (object = (Object *)DebugMenuLine_800c87c8.upper, DebugMenuLine_800c87c8.upper != 0)) &&
      (fxPrim != (_FX_PRIM *)0x0))
  {
...

{
  ...
  if ((((*(short *)((int)instance->extraData + 2) != 0) &&
        (*(int *)(DAT_800d0fec + 4) + 0x640U < *(uint *)(DAT_800d0fec + 8))) &&
       (DebugMenuLine_800c87c8.upper != 0)) &&
...

{
  ...
  {
    /* WARNING: Subroutine does not return */
    CompMatrix((undefined4 *)wcTransform, (ushort *)(*(int *)(DAT_800d0fd8 + 0x40) + 0x500), auStack96);
  }
  return;
}
...

{
  ...
  if ((instance != DAT_800d0fd8) || (instance->cachedTFace == -1))
  {
...
void FX_DrawAllGeneralEffects(MATRIX *param_1, _VertexPool *param_2, _PrimPool *param_3, ulong **param_4)
    ...
    do
    {
                                            ...
                                            (((instance->flags & 0x800U) == 0 && ((instance->flags2 & 0x4000000U) == 0))))))
      {
        ...
        else
        {
          if (bVar1 == 0x82)
          {
            PIPE3D_HalvePlaneGetRingPoints(instance, param_1, param_2, param_3, param_4, (_FXHalvePlane *)blast);
          }
          else
          {
            if (bVar1 == 0x84)
...

{
  ...
  *(int *)&param_1[3].effectType = *(int *)&param_1[3].effectType + (iVar9 >> 8);
  ...
  if ((int)pvVar5 < iVar9)
  {
    ...
    if (iVar9 < 0x1000)
    {
      LoadAverageCol((byte *)&param_1[7].continue_process, (byte *)(param_1 + 7), iVar9, 0x1000 - iVar9, &param_1[6].effectType);
    }
    else
    {
...

{
  ...
  object = (Object *)0x0;
  if ((DebugMenuLine_800c87c8.upper == 0) ||
      ((psVar4 = (short *)(**(int **)(DebugMenuLine_800c87c8.upper + 0x1c) + num * 0x30),
  ...
  else
  {
    ...
    {
      object = (Object *)DebugMenuLine_800c87c8.upper;
...

{
  ...
  if (((DebugMenuLine_800c87c8.upper != 0) &&
       ((iVar1 = *(int *)(*(int *)(DebugMenuLine_800c87c8.upper + 0x1c) + 4) + num * 0x14,
         *(char *)(iVar1 + 5) == '\0' ||
             (instance = instance->LinkChild, instance != (_Instance *)0x0)))) &&
...

{
  ...
  if (DebugMenuLine_800c87c8.upper != 0)
  {
    pcVar2 = (char *)(*(int *)(*(int *)(DebugMenuLine_800c87c8.upper + 0x1c) + 8) + num * 0x18);
    if (((InitFlag == 0) || (*pcVar2 != '\0')) &&
        ((pcVar2[5] == '\0' || (instance = instance->LinkChild, instance != (_Instance *)0x0))))
    {
      iVar1 = (int)pcVar2[3];
      color = (long *)(*(int *)(*(int *)(DebugMenuLine_800c87c8.upper + 0x1c) + 0x18) +
...

{
  ...
  if (DebugMenuLine_800c87c8.upper != 0)
  {
    pcVar3 = (char *)(*(int *)(*(int *)(DebugMenuLine_800c87c8.upper + 0x1c) + 0xc) + num * 0x28);
    if ((*(short *)(pcVar3 + 2) == 0) ||
...

{
  ...
  if (DebugMenuLine_800c87c8.upper != 0)
  {
    iVar3 = *(int *)(*(int *)(DebugMenuLine_800c87c8.upper + 0x1c) + 0x10) + num * 0x30;
    if ((*(char *)(iVar3 + 1) == '\0') ||
        (instance = instance->LinkChild, instance != (_Instance *)0x0))
    {
      iVar4 = segOverride;
...

{
  ...
  plVar1 = DebugMenuLine_800c8948.var_address;
  if ((0 < currentHealth) &&
      (plVar1 = (long *)debugImbueSoulReaverMenu.text, (uint)currentHealth < 6))
  {
    plVar1 = (&DebugMenuLine_800c8948.var_address)[currentHealth + -1];
  }
...

{
  ...
  /* WARNING: Read-only address (ram,0x800d16b4) is written */
  WarpRoom_800d16ac.name._8_2_ = (undefined2)local_48;
  /* WARNING: Read-only address (ram,0x800d16b6) is written */
  WarpRoom_800d16ac.name._10_2_ = (undefined2)local_44;
  next_deg = 0x2000;
  iVar1 = 0;
  do
  {
    ...
    next_deg = iVar1 * 4;
    *(undefined2 *)(&Spiral_Array + iVar1) = (undefined2)local_48;
    *(undefined2 *)((int)&Spiral_Array + next_deg + 2) = (undefined2)local_44;
    if (iVar1 == 0x3f)
    {
      local_40 = local_48;
      local_3c = local_44;
    ...
    *(undefined2 *)(WarpRoom_800d16c0.name + next_deg + 4) = (undefined2)local_40;
    *(undefined2 *)(WarpRoom_800d16c0.name + next_deg + 6) = (undefined2)local_3c;
    if (local_40 < iVar4)
    {
      iVar4 = local_40;
    }
...

{
  ...
  if (((DAT_800d0fb4 != 1000) && (DAT_800d0fb6 == 0)) && (Spiral_Number != 0))
  {
  ...
  if (puVar9 + 0x451 < primPool->lastPrim)
  {
    ...
    DVar11 = WarpRoom_800d16ac.name._8_4_;
    DVar12 = WarpRoom_800d16ac.name._8_4_;
    DVar14 = WarpRoom_800d16ac.name._8_4_;
    local_4c = local_50;
    do
    {
      puVar10 = puVar9;
      ...
      pDVar7[-9] = local_50;
      pDVar7[-5] = local_50;
      DVar11 = *(DVECTOR *)(&Spiral_Array + iVar8);
      DVar14 = *(DVECTOR *)(WarpRoom_800d16c0.name + iVar8 * 4 + 4);
    ...
    *puVar9 = (uint)ot[1] & 0xffffff | 0x1000000;
    ...
    if ((sVar1 != 0) || (Spiral_Current == Spiral_Max))
    {
      ...
      DRAW_CreateAGlowingCircle(&local_60, 0x140, DAT_800d0fec, ot, 5, 0x8000, Spiral_Glow_Size, Spiral_Glow_Size, angle);
    }
  }
  return;
}
...
{
  if (*(int *)(DAT_800d0fec + 4) + 0x900U < *(uint *)(DAT_800d0fec + 8))
  {
    PushMatrix();
    SetRotMatrix((undefined4 *)wcTransform);
    /* WARNING: Subroutine does not return */
...

{
  ...
  iVar2 = DAT_800d0fec;
  if ((otz - 1U < 0xbff) &&
      (puVar5 = *(uint **)(DAT_800d0fec + 4), puVar5 + 0x12 < *(uint **)(DAT_800d0fec + 8)))
  {
