...
musicInfo =
	{
		...
		.numCmdsInQueue = null};
// long[3] @0x800CEA90, len = 0x0000000C
objectOneShotTriggerTbl =
	{
		0x1000,
		0x2000,
		0x4000};
// char[13256] @0x800D5C08, len = 0x000033C8
soundBuffer =
	{
		'\x00',
		'\x00',
		...
		if (pLVar1 != (Level *)0x0)
		{
			...
			if (dynamicBankIndex != 0)
			{
				...
				else
				{
					...
					dynamicBankIndex = 1;
					loadOption = 0;
					local_50 = DAT_800ceab4;
					local_4c = DAT_800ceab8;
					local_48 = DAT_800ceabc;
					local_44 = DAT_800ceac0;
					local_40 = DAT_800ceac4;
					local_3c = DAT_800ceac8;
					local_38 = DAT_800ceacc;
					local_36 = DAT_800ceace;
					local_30 = DAT_800cead0;
					local_2c = DAT_800cead4;
					local_28 = DAT_800cead8;
					local_24 = DAT_800ceadc;
					local_20 = DAT_800ceae0;
					local_1c = DAT_800ceae4;
					local_18 = DAT_800ceae8;
					local_16 = DAT_800ceaea;
					musicInfo.state = 3;
