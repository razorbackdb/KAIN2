...
// struct SoundEffectChannel * /*$ra*/ SndOpenSfxChannel(unsigned char *channelNum /*$a0*/)
 // line 40, offset 0x8003ec58
	/* begin block 1 */
		// Start line: 42
		// Start offset: 0x8003EC58
		// Variables:
	// 		int i; // $a1
	/* end block 1 */
	// End offset: 0x8003EC98
	// End Line: 56
...
// void /*$ra*/ SOUND_ProcessInstanceSounds(unsigned char *sfxFileData /*$s0*/, struct SoundInstance *soundInstTbl /*$a1*/, struct _Position *position /*$s4*/, int livesInOnePlace /*stack 12*/, int inSpectral /*stack 16*/, int hidden /*stack 20*/, int burning /*stack 24*/, long *triggerFlags /*stack 28*/)
 // line 97, offset 0x8003ecf0
	/* begin block 1 */
		// Start line: 98
		// Start offset: 0x8003ECF0
		// Variables:
	// 		int numSounds; // $s3
	// 		int numSfxIDs; // $v0
	// 		int i; // $s2
	/* end block 1 */
	// End offset: 0x8003EE48
	// End Line: 141
...
// void /*$ra*/ SOUND_EndInstanceSounds(unsigned char *sfxFileData /*$s0*/, struct SoundInstance *soundInstTbl /*$a1*/)
 // line 149, offset 0x8003ee78
	/* begin block 1 */
		// Start line: 150
		// Start offset: 0x8003EE78
		// Variables:
	// 		int numSounds; // $s3
	// 		int numSfxIDs; // $v0
	// 		int i; // $s2
...
LAB_8003ef9c:
          ...
          if (bVar2 < 2) {
            ...
            if (bVar2 < 5) {
              pbVar4 = pbVar4 + (uint)pbVar4[1] * 2 + 0xe;
              pSVar3 = SndGetSfxChannel((uint)soundInstTbl->channel);
              if (pSVar3 != (SoundEffectChannel *)0x0) goto LAB_8003ef9c;
            }
          }
        }
        soundInstTbl = soundInstTbl + 1;
...
// int /*$ra*/ isOkayToPlaySound(int flags /*$s0*/, int spectralPlane /*$s1*/, int hidden /*$s2*/, int burning /*$s3*/)
 // line 218, offset 0x8003efe4
	/* begin block 1 */
		// Start line: 219
		// Start offset: 0x8003EFE4

		/* begin block 1.1 */
			// Start line: 224
			// Start offset: 0x8003F014
			// Variables:
		// 		int mask; // $v0
		// 		int tod; // $v1
		/* end block 1.1 */
		// End offset: 0x8003F088
		// End Line: 245
	/* end block 1 */
	// End offset: 0x8003F0DC
	// End Line: 259
...

{
  ...
  if ((flags & 0xfU) == 0) goto LAB_8003f088;
...
// void /*$ra*/ processPeriodicSound(struct _Position *position /*$fp*/, int livesInOnePlane /*$s4*/, int inSpectral /*$s5*/, int hidden /*$s7*/, int burning /*stack 16*/, struct SoundInstance *soundInst /*stack 20*/, struct ObjectPeriodicSound *sound /*stack 24*/)
 // line 280, offset 0x8003f184
	/* begin block 1 */
		// Start line: 281
		// Start offset: 0x8003F184
		// Variables:
...
LAB_8003f58c:
        ...
        if (inSpectral == 0) {
          if (spectralPlane == 0) goto LAB_8003f468;
        }
        else {
          if (spectralPlane != 0) goto LAB_8003f468;
        }
...
// void /*$ra*/ processEventSound(struct _Position *position /*$s5*/, struct SoundInstance *soundInst /*$s1*/, struct ObjectEventSound *sound /*$s3*/)
 // line 449, offset 0x8003f624
	/* begin block 1 */
		// Start line: 450
		// Start offset: 0x8003F624
		// Variables:
	// 		struct SoundEffectChannel *channel; // $s0
	// 		int sfxIDNum; // $v1
	// 		int sfxToneID; // $a1
...
// void /*$ra*/ SOUND_StopInstanceSound(struct SoundInstance *soundInst /*$s0*/)
 // line 573, offset 0x8003f9e8
	/* begin block 1 */
		// Start line: 574
		// Start offset: 0x8003F9E8
		// Variables:
	// 		struct SoundEffectChannel *channel; // $v0
	/* end block 1 */
	// End offset: 0x8003FA2C
	// End Line: 585
...
// int /*$ra*/ SOUND_IsInstanceSoundLoaded(unsigned char *sfxFileData /*$a0*/, long soundNumber /*$a1*/)
 // line 594, offset 0x8003fa44
	/* begin block 1 */
		// Start line: 595
		// Start offset: 0x8003FA44
		// Variables:
...
// void /*$ra*/ SOUND_SetInstanceSoundPitch(struct SoundInstance *soundInst /*$a0*/, long pitchChangeAmt /*$s1*/, long time /*$s0*/)
 // line 665, offset 0x8003fb40
	/* begin block 1 */
		// Start line: 666
		// Start offset: 0x8003FB40
		// Variables:
	// 		struct SoundEffectChannel *channel; // $a0
	/* end block 1 */
	// End offset: 0x8003FBEC
	// End Line: 687
...
// void /*$ra*/ SOUND_SetInstanceSoundVolume(struct SoundInstance *soundInst /*$a0*/, long volumeChangeAmt /*$s0*/, long time /*$s1*/)
 // line 694, offset 0x8003fc00
	/* begin block 1 */
		// Start line: 695
		// Start offset: 0x8003FC00
		// Variables:
	// 		struct SoundEffectChannel *channel; // $a0
	/* end block 1 */
	// End offset: 0x8003FCF0
	// End Line: 720
...
// void /*$ra*/ processOneShotSound(struct _Position *position /*$s6*/, int hidden /*$t0*/, int burning /*$t1*/, long *triggerFlags /*$s4*/, struct SoundInstance *soundInst /*stack 16*/, struct ObjectOneShotSound *sound /*stack 20*/)
 // line 741, offset 0x8003fd04
	/* begin block 1 */
		// Start line: 742
		// Start offset: 0x8003FD04
		// Variables:
	// 		struct SoundEffectChannel *channel; // $s0
	// 		int sfxIDNum; // $v1
	// 		int sfxToneID; // $a1
...
// unsigned long /*$ra*/ SOUND_Play3dSound(struct _Position *position /*$t0*/, int sfxToneID /*$s5*/, int pitch /*$s6*/, int maxVolume /*$s4*/, int minVolDist /*stack 16*/)
 // line 863, offset 0x8004004c
	/* begin block 1 */
		// Start line: 864
		// Start offset: 0x8004004C
		// Variables:
	// 		long dx; // $s1
	// 		long dy; // $s0
	// 		long dz; // $a0
...
// unsigned long /*$ra*/ SOUND_Update3dSound(struct _Position *position /*$t0*/, unsigned long handle /*$s5*/, int pitch /*$s6*/, int maxVolume /*$s4*/, int minVolDist /*stack 16*/)
 // line 962, offset 0x80040288
	/* begin block 1 */
		// Start line: 963
		// Start offset: 0x80040288
		// Variables:
	// 		long dx; // $s1
	// 		long dy; // $s0
	// 		long dz; // $a0
...

{
  ...
  iVar4 = (int)(uVar6 & 0x3ff) >> 4;
  if (uVar7 == 1) goto LAB_8004042c;
  if (uVar7 < 2) {
    if (uVar7 != 0) goto LAB_80040424;
    _vol = 0x3f;
  }
  else {
    if (uVar7 == 2) {
...
// original method signature: 
// void /*$ra*/ SOUND_Init()
 // line 1100, offset 0x800404c4
	/* begin block 1 */
		// Start line: 1101
		// Start offset: 0x800404C4
		// Variables:
	// 		struct AadInitAttr initAttr; // stack offset -32
	/* end block 1 */
	// End offset: 0x800404C4
	// End Line: 1101
...
// void /*$ra*/ SOUND_MusicOff()
 // line 1306, offset 0x80040714
	/* begin block 1 */
		// Start line: 1307
		// Start offset: 0x80040714
		// Variables:
	// 		int slotNumber; // $s0
	/* end block 1 */
	// End offset: 0x80040764
	// End Line: 1322
...
// void /*$ra*/ SOUND_MusicOn()
 // line 1324, offset 0x80040778
	/* begin block 1 */
		// Start line: 1325
		// Start offset: 0x80040778
		// Variables:
	// 		int slotNumber; // $s0
	/* end block 1 */
	// End offset: 0x800407A0
	// End Line: 1330
...
// unsigned long /*$ra*/ SndPlayVolPan(unsigned int sample /*$a0*/, unsigned short vol /*$a1*/, unsigned short pan /*$a2*/, short pitch /*$a3*/)
 // line 1400, offset 0x80040890
	/* begin block 1 */
		// Start line: 1401
		// Start offset: 0x80040890
	/* end block 1 */
	// End offset: 0x800408BC
	// End Line: 1411
...
// void /*$ra*/ SOUND_PutMusicCommand(int cmdType /*$a0*/, int cmdData /*$a1*/)
 // line 1487, offset 0x8004099c
	/* begin block 1 */
		// Start line: 1489
		// Start offset: 0x8004099C
		// Variables:
	// 		struct MusicLoadCmd *cmd; // $v0
	/* end block 1 */
	// End offset: 0x800409DC
	// End Line: 1498
...
// void /*$ra*/ SOUND_ProcessMusicLoad()
 // line 1533, offset 0x80040a40
	...
	// 		char smpFileName[32]; // stack offset -48
		...
		/* begin block 1.1 */
			// Start line: 1546
			// Start offset: 0x80040A90
			// Variables:
		// 		struct MusicLoadCmd *cmd; // $v1
		/* end block 1.1 */
		// End offset: 0x80040B00
		// End Line: 1558

		/* begin block 1.2 */
			// Start line: 1562
			// Start offset: 0x80040B10
			// Variables:
		// 		struct Level *level; // $v1
		/* end block 1.2 */
		// End offset: 0x80040D58
		// End Line: 1630
	/* end block 1 */
	// End offset: 0x80040F24
	// End Line: 1724
    ...
    if (pLVar1 != (Level *)0x0) {
      ...
      if (dynamicBankIndex != 0) {
        ...
        aadLoadDynamicSoundBank
                  ((char *)&local_50,(char *)&local_30,dynamicBankIndex,loadOption,
                   musicLoadReturnFunc);
        return;
      }
      return;
...
// void /*$ra*/ SOUND_ShutdownMusic()
 // line 1793, offset 0x80041024
	/* begin block 1 */
		// Start line: 1794
		// Start offset: 0x80041024
	/* end block 1 */
	// End offset: 0x800410A0
	// End Line: 1814
