...
// void /*$ra*/ VM_UpdateMorph(struct Level *level /*$a0*/, int initFlg /*$s5*/)
 // line 295, offset 0x8004fc44
	/* begin block 1 */
		// Start line: 296
		// Start offset: 0x8004FC44
		// Variables:
	...
	// 		int i; // $s4
		...
		/* begin block 1.1 */
			// Start line: 305
			// Start offset: 0x8004FCA0
			// Variables:
		// 		struct _VMOffsetTable *curTable; // $a0

			/* begin block 1.1.1 */
				// Start line: 308
				// Start offset: 0x8004FCB0
			/* end block 1.1.1 */
			// End offset: 0x8004FD24
			// End Line: 337

			/* begin block 1.1.2 */
				// Start line: 341
				// Start offset: 0x8004FD40
				// Variables:
			// 		short ratio; // $s2
			// 		int j; // $t1
			// 		long num; // $s1
				...
				/* begin block 1.1.2.1 */
					// Start line: 353
					// Start offset: 0x8004FD64
					// Variables:
				// 		long len; // $a0
				/* end block 1.1.2.1 */
				// End offset: 0x8004FD9C
				// End Line: 360

				/* begin block 1.1.2.2 */
					// Start line: 362
					// Start offset: 0x8004FDB0
					// Variables:
				// 		struct _VMOffset *material; // $a1
				// 		struct _VMOffset *spectral; // $a0
				// 		struct _VMOffset *offset; // $v1
				/* end block 1.1.2.2 */
				// End offset: 0x8004FE84
				// End Line: 374

				/* begin block 1.1.2.3 */
					// Start line: 374
					// Start offset: 0x8004FE8C
					// Variables:
				// 		short dr; // $a3
				// 		short dg; // $a0
				// 		short db; // $v1
    ...
    do {
      ...
      if ((*(short *)(pp_Var17 + -8) != *(short *)((int)pp_Var17 + -0x1e)) ||
        ...
        if (gameTrackerX.gameData.asmData.MorphTime == 1000) {
          ...
          if (initFlg == 0) {
            if (gameTrackerX.gameData.asmData.MorphType == 0) goto LAB_8004fd18;
...
// void /*$ra*/ VM_VMObjectSetTable(struct Level *level /*$a0*/, struct _VMObject *vmobject /*$s0*/, int table /*$s1*/)
 // line 521, offset 0x8005001c
	/* begin block 1 */
		// Start line: 522
		// Start offset: 0x8005001C
		// Variables:
	// 		struct _VMOffsetTable *curTable; // $a0
	/* end block 1 */
	// End offset: 0x8005005C
	// End Line: 530
