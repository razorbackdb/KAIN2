...
ulong *DRAW_DrawGlowPoints2(_Instance *instance, long seg1, long seg2, _PrimPool *primPool, ulong **ot, long color, long height)
...

{
  ...
  *(undefined *)((int)puVar7 + 0x6f) = *(undefined *)((int)puVar7 + 99);
  ...
  uVar3 = DRAW_DisplayTFace_zclipped_C(vertex2, vertex1, (SVECTOR *)((uint)puVar7 | 0x28), uv2, uv1,
  ...
  *(undefined2 *)((int)puVar7 + 0x5e) = *(undefined2 *)((int)puVar7 + 0x4e);
  ...
  uVar5 = DRAW_DisplayTFace_zclipped_C(vertex1_00, (SVECTOR *)((uint)puVar7 | 0x20), vertex1, uv1_00,
