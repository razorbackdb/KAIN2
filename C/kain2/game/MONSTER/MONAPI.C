...
void MONAPI_TurnHead(_Instance *param_1, short *param_2, short *param_3)

{
  short sVar1;

  sVar1 = -0x300;
  if ((*param_2 < -0x300) || (sVar1 = 0x200, 0x200 < *param_2))
  {
    *param_2 = sVar1;
  }
  if (*param_3 < 0x401)
  ...
  *param_3 = sVar1;
LAB_8007f0b0:
  MON_LookInDirection(param_1, -*param_2, *param_3);
  return;
}
