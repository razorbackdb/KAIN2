...
lastSenseFrame = null;
// _MonsterVars *[40] @0x800D4900, len = 0x000000A0
monsterSenseArray40 =
	{
		// _MonsterVars * @0x800D4900, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4904, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4908, len = 0x00000004
		null,
		// _MonsterVars * @0x800D490C, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4910, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4914, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4918, len = 0x00000004
		null,
		// _MonsterVars * @0x800D491C, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4920, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4924, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4928, len = 0x00000004
		null,
		// _MonsterVars * @0x800D492C, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4930, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4934, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4938, len = 0x00000004
		null,
		// _MonsterVars * @0x800D493C, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4940, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4944, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4948, len = 0x00000004
		null,
		// _MonsterVars * @0x800D494C, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4950, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4954, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4958, len = 0x00000004
		null,
		// _MonsterVars * @0x800D495C, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4960, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4964, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4968, len = 0x00000004
		null,
		// _MonsterVars * @0x800D496C, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4970, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4974, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4978, len = 0x00000004
		null,
		// _MonsterVars * @0x800D497C, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4980, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4984, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4988, len = 0x00000004
		null,
		// _MonsterVars * @0x800D498C, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4990, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4994, len = 0x00000004
		null,
		// _MonsterVars * @0x800D4998, len = 0x00000004
		null,
		// _MonsterVars * @0x800D499C, len = 0x00000004
		null};
// char[40] @0x800D49A0, len = 0x00000028
monsterSensed =
	{
		'\x00',
		'\x00',
		...
		'\x00',
		'\x00'};
// RadarInfo[8] @0x800CF638, len = 0x00000030
radarDir =
	{
		// RadarInfo @0x800CF638, len = 0x00000006
		{
			...
			.y = -0x500},
		// RadarInfo @0x800CF63E, len = 0x00000006
		{
			// short @0x800CF63E, len = 0x00000002
			.angle = 0x200,
			// short @0x800CF640, len = 0x00000002
			.x = 0x389,
			// short @0x800CF642, len = 0x00000002
			.y = -0x389},
		// RadarInfo @0x800CF644, len = 0x00000006
		{
			// short @0x800CF644, len = 0x00000002
			.angle = 0x400,
			// short @0x800CF646, len = 0x00000002
			.x = 0x500,
			// short @0x800CF648, len = 0x00000002
			.y = 0x0},
		// RadarInfo @0x800CF64A, len = 0x00000006
		{
			// short @0x800CF64A, len = 0x00000002
			.angle = 0x600,
			// short @0x800CF64C, len = 0x00000002
			.x = 0x389,
			// short @0x800CF64E, len = 0x00000002
			.y = 0x389},
		// RadarInfo @0x800CF650, len = 0x00000006
		{
			// short @0x800CF650, len = 0x00000002
			.angle = 0x800,
			// short @0x800CF652, len = 0x00000002
			.x = 0x0,
			// short @0x800CF654, len = 0x00000002
			.y = 0x500},
		// RadarInfo @0x800CF656, len = 0x00000006
		{
			// short @0x800CF656, len = 0x00000002
			.angle = 0xa00,
			// short @0x800CF658, len = 0x00000002
			.x = -0x389,
			// short @0x800CF65A, len = 0x00000002
			.y = 0x389},
		// RadarInfo @0x800CF65C, len = 0x00000006
		{
			// short @0x800CF65C, len = 0x00000002
			.angle = 0xc00,
			// short @0x800CF65E, len = 0x00000002
			.x = -0x500,
			// short @0x800CF660, len = 0x00000002
			.y = 0x0},
		// RadarInfo @0x800CF662, len = 0x00000006
		{
			// short @0x800CF662, len = 0x00000002
			.angle = 0xe00,
			// short @0x800CF664, len = 0x00000002
			.x = -0x389,
			// short @0x800CF666, len = 0x00000002
			.y = -0x389}};
// uchar[8] @0x800CF668, len = 0x00000008
radarDirIndex =
	{
		// uchar @0x800CF668, len = 0x00000001
		0x00,
		// uchar @0x800CF669, len = 0x00000001
		0x04,
		// uchar @0x800CF66A, len = 0x00000001
		0x06,
		// uchar @0x800CF66B, len = 0x00000001
		0x02,
		// uchar @0x800CF66C, len = 0x00000001
		0x07,
		// uchar @0x800CF66D, len = 0x00000001
		0x03,
		// uchar @0x800CF66E, len = 0x00000001
		0x05,
		// uchar @0x800CF66F, len = 0x00000001
		0x01};
// decompiled code
