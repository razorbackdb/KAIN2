...
LAB_8008673c:
	if ((mv->enemy == (_MonsterIR *)0x0) || (newenemy == DAT_800d0fd8))
	{
		mv->enemy = p_Var2;
	}
	return p_Var2;
...

{
	...
	pvVar4 = instance->extraData;
	uVar5 = (uint)radarDirIndex[*(ushort *)((int)pvVar4 + 0xe2)];
...

{
	...
	if (_lastSenseFrame < DAT_800d10d8)
	{
		if (_lastSenseFrame < DAT_800d10d8 + -1)
		{
			/* WARNING: Subroutine does not return */
	...
	if ((DAT_800cf670 == 0) && ((&monsterSensed)[*(char *)((int)pvVar1 + 0x14f)] == '\0'))
	{
		_lastSenseFrame = DAT_800d10d8;
