...
// struct _MonsterIR * /*$ra*/ MONSENSE_FindIR(struct _MonsterVars *mv /*$a0*/, struct _Instance *instance /*$a1*/)
 // line 64, offset 0x80085c70
	/* begin block 1 */
		// Start line: 66
		// Start offset: 0x80085C70
		// Variables:
	// 		struct _MonsterIR *mir; // $v1
	/* end block 1 */
	// End offset: 0x80085CA0
	// End Line: 72
...
// int /*$ra*/ MONSENSE_See(struct _Instance *instance /*$s2*/, struct evCollideInstanceStatsData *data /*$s1*/)
 // line 97, offset 0x80085ca8
	/* begin block 1 */
		// Start line: 98
		// Start offset: 0x80085CA8
		// Variables:
		...
		// 		int elevation; // $a2
			...
			// 		struct _Instance *target; // $s0
				...
				// 		struct evPhysicsLOSData losData; // stack offset -40
					...
					/* end block 1.1.1.1.2 */
					// End offset: 0x80085DBC
					// End Line: 128

					/* begin block 1.1.1.1.3 */
						// Start line: 132
						// Start offset: 0x80085DCC
						// Variables:
					...
					// 		struct _Position *_v1; // $v0
					/* end block 1.1.1.1.4 */
					// End offset: 0x80085E10
					// End Line: 138
				/* end block 1.1.1.1 */
				// End offset: 0x80085E28
				// End Line: 141
			/* end block 1.1.1 */
			// End offset: 0x80085E28
			// End Line: 144
...

{
  ...
  psVar4 = *(short **)(*(int *)((int)instance->extraData + 0x168) + 4);
  arc = 0;
...
// int /*$ra*/ MONSENSE_Hear(struct _Instance *instance /*$a0*/, struct evCollideInstanceStatsData *data /*$s1*/)
 // line 153, offset 0x80085e44
	/* begin block 1 */
		// Start line: 154
		// Start offset: 0x80085E44
		// Variables:
	// 		struct _MonsterVars *mv; // $v0
	// 		struct _MonsterSenses *senses; // $s0
	// 		long mode; // $a0
...

{
  ...
  iVar3 = *(int *)(*(int *)((int)instance->extraData + 0x168) + 4);
...

{
  return (uint)(data->distance <
               (uint)*(ushort *)(*(int *)(*(int *)((int)instance->extraData + 0x168) + 4) + 0xc));
}
...
// struct _MonsterIR * /*$ra*/ MONSENSE_FirstSense(struct _Instance *instance /*$s2*/, struct _Instance *sensed /*$s4*/)
 // line 186, offset 0x80085efc
	/* begin block 1 */
		// Start line: 187
		// Start offset: 0x80085EFC
		// Variables:
	...
	// 		struct _MonsterVars *mv; // $s1
		...
		/* begin block 1.1 */
			// Start line: 194
			// Start offset: 0x80085F38
			// Variables:
		// 		long whatAmI; // $s2
		// 		struct _MonsterAllegiances *allegiances; // $s3
		/* end block 1.1 */
		// End offset: 0x80086070
		// End Line: 224
	/* end block 1 */
	// End offset: 0x80086070
	// End Line: 226
...
// void /*$ra*/ MONSENSE_SetupMIR(struct _Instance *instance /*$s3*/, struct evCollideInstanceStatsData *data /*$s1*/, int flags /*$s2*/)
 // line 233, offset 0x80086094
	/* begin block 1 */
		// Start line: 234
		// Start offset: 0x80086094
		// Variables:
	// 		struct _MonsterIR *mir; // $s0
	// 		struct _MonsterVars *mv; // $s4
		...
		// 		long mode; // $s1
			...
			/* end block 1.1.1 */
			// End offset: 0x80086138
			// End Line: 256

			/* begin block 1.1.2 */
				// Start line: 301
				// Start offset: 0x800862E0
				// Variables:
			// 		int run; // $s2
			// 		int distance; // $a0
				...
				/* begin block 1.1.2.1 */
					// Start line: 312
					// Start offset: 0x8008631C
				/* end block 1.1.2.1 */
				// End offset: 0x8008637C
				// End Line: 319
			/* end block 1.1.2 */
			// End offset: 0x8008637C
			// End Line: 336
		/* end block 1.1 */
		// End offset: 0x800864A0
		// End Line: 367
	/* end block 1 */
	// End offset: 0x800864A0
	// End Line: 368
...

{
  ...
  if ((uVar4 & 0x400) == 0) {
    ...
    if ((uVar7 & 0x200000) != 0) goto LAB_80086388;
...
// void /*$ra*/ MONSENSE_SenseInstance(struct _Instance *instance /*$s3*/, struct evCollideInstanceStatsData *data /*$s2*/)
 // line 374, offset 0x800864c0
	/* begin block 1 */
		// Start line: 375
		// Start offset: 0x800864C0
		// Variables:
	// 		struct _MonsterVars *mv; // $s1
	// 		long flags; // $s0
	// 		unsigned long whatAmI; // $s4
		...
		// 		struct PhysObProperties *prop; // $s0
			...
			/* end block 1.1.1 */
			// End offset: 0x800865D8
			// End Line: 401
		/* end block 1.1 */
		// End offset: 0x800865D8
		// End Line: 401
	/* end block 1 */
	// End offset: 0x80086694
	// End Line: 419
  ...
  if ((*puVar4 & 0x200) == 0) {
    if ((uVar1 & 0x20) == 0) {
      if (*(char *)((int)puVar4 + 0x162) != '\0') {
        ...
        if (((uVar1 & *(uint *)(*(int *)(puVar4[0x5a] + 0xc) + 4)) != 0) &&
           (data->distance < (uint)*(ushort *)(*(int *)(puVar4[0x5a] + 4) + 0x10))) {
          flags = flags | 2;
        }
...
// void /*$ra*/ MONSENSE_StartMonsterIRList(struct _Instance *instance /*$s5*/)
 // line 424, offset 0x800866b4
	/* begin block 1 */
		// Start line: 425
		// Start offset: 0x800866B4
		// Variables:
	// 		struct _MonsterVars *mv; // $s1
	// 		struct _MonsterIR *mir; // $s0
	...
	// 		int enemyOnList; // $s4
		...
		/* end block 1.1 */
		// End offset: 0x80086788
		// End Line: 463
	/* end block 1 */
	// End offset: 0x800867A4
	// End Line: 471
  ...
  if (*(char *)((int)pvVar5 + 0x162) != '\0') {
    ...
    while (puVar3 = puVar6, puVar3 != (undefined4 *)0x0) {
      ...
      if ((puVar3[2] == *(int *)(puVar3[1] + 0x10)) &&
        ...
        *puVar3 = *(undefined4 *)((int)pvVar5 + 0x16c);
        *(undefined4 **)((int)pvVar5 + 0x16c) = puVar3;
      }
    }
    if (!bVar1) {
...
// struct _MonsterIR * /*$ra*/ MONSENSE_GetMonsterIR(struct _MonsterVars *mv /*$a0*/)
 // line 476, offset 0x800867c8
	/* begin block 1 */
		// Start line: 478
		// Start offset: 0x800867C8
		// Variables:
	// 		struct _MonsterIR *mir; // $v1
	/* end block 1 */
	// End offset: 0x800867E8
	// End Line: 488
...
// void /*$ra*/ MONSENSE_InitIRList(struct _MonsterVars *mv /*$a0*/, struct _MonsterIR *list /*$a1*/, int num /*$a2*/)
 // line 494, offset 0x800867f0
	/* begin block 1 */
		// Start line: 496
		// Start offset: 0x800867F0
		// Variables:
	// 		int i; // $a2
	/* end block 1 */
	// End offset: 0x80086810
	// End Line: 505
...
// struct _MonsterIR * /*$ra*/ MONSENSE_SetEnemy(struct _Instance *instance /*$s1*/, struct _Instance *newenemy /*$s2*/)
 // line 512, offset 0x8008681c
	/* begin block 1 */
		// Start line: 513
		// Start offset: 0x8008681C
		// Variables:
	...
	// 		struct _MonsterIR *mir; // $a2
		...
		/* begin block 1.1 */
			// Start line: 532
			// Start offset: 0x80086890
			// Variables:
		// 		long angle; // $v0
		/* end block 1.1 */
		// End offset: 0x800868EC
		// End Line: 538
	/* end block 1 */
	// End offset: 0x80086920
	// End Line: 548
...

{
  ...
  if (p_Var2 == (_MonsterIR *)0x0) {
    ...
    if (p_Var2 == (_MonsterIR *)0x0) {
      ...
      mv->freeIRs = p_Var2;
      p_Var2 = MONSENSE_FirstSense(instance,newenemy);
      if (p_Var2 == (_MonsterIR *)0x0) goto LAB_800868fc;
    }
...
// void /*$ra*/ MONSENSE_ProcessIRList(struct _Instance *instance /*$s7*/)
 // line 554, offset 0x8008693c
	/* begin block 1 */
		// Start line: 555
		// Start offset: 0x8008693C
		// Variables:
	// 		struct _MonsterVars *mv; // $s4
	// 		struct _MonsterIR *mir; // $s0
...

{
  ...
  iVar6 = *(int *)(*(int *)((int)pvVar5 + 0x168) + 8);
  piVar7 = (int *)0x0;
  while (Data != (int *)0x0) {
  ...
  if ((piVar7 == (int *)0x0) ||
     (((iVar6 != 0 && (*(char *)(iVar6 + 0x1c) != '\0')) && (*(short *)((int)pvVar5 + 0x144) == 0)))
     ) {
...
// void /*$ra*/ MONSENSE_SetupSenses(struct _Instance *instance /*$s2*/)
 // line 630, offset 0x80086b5c
	/* begin block 1 */
		// Start line: 631
		// Start offset: 0x80086B5C
		// Variables:
	// 		struct _MonsterVars *mv; // $s1
	// 		struct _MonsterAllegiances *allegiances; // $s0
	// 		int num; // $v0
	/* end block 1 */
	// End offset: 0x80086CB0
	// End Line: 697
...
// void /*$ra*/ MONSENSE_RemoveSenses(struct _Instance *instance /*$a0*/)
 // line 702, offset 0x80086cc8
	/* begin block 1 */
		// Start line: 704
		// Start offset: 0x80086CC8
		// Variables:
	// 		struct _MonsterVars *mv; // $a0
	// 		int i; // $a1
	/* end block 1 */
	// End offset: 0x80086D60
	// End Line: 723
...

{
  ...
  iVar2 = (int)*(char *)((int)instance->extraData + 0x163);
...
// void /*$ra*/ MONSENSE_Radar(struct _Instance *instance /*$s0*/)
 // line 847, offset 0x80086d68
	/* begin block 1 */
		// Start line: 848
		// Start offset: 0x80086D68
		// Variables:
	// 		struct _MonsterVars *mv; // $s1
...

{
  ...
  if (local_50.type == 0) {
    ...
    if (local_50.type != 0) goto LAB_80086ed0;
...
// short /*$ra*/ MONSENSE_GetClosestFreeDirection(struct _Instance *instance /*$a0*/, short angle /*$t1*/, long range /*$a2*/)
 // line 924, offset 0x80086fa0
	/* begin block 1 */
		// Start line: 925
		// Start offset: 0x80086FA0
		// Variables:
	// 		struct _MonsterVars *mv; // $t0
	// 		int bit; // $a1
	// 		int search; // $a0
	/* end block 1 */
	// End offset: 0x8008709C
	// End Line: 958
...
/* WARNING: Removing unreachable block (ram,0x80086fc0) */
...
// int /*$ra*/ MONSENSE_GetDistanceInDirection(struct _Instance *instance /*$a0*/, short angle /*$a1*/)
 // line 963, offset 0x800870a4
	/* begin block 1 */
		// Start line: 965
		// Start offset: 0x800870A4
		// Variables:
...
/* WARNING: Removing unreachable block (ram,0x800870c0) */
...
// void /*$ra*/ MONSENSE_DoSenses(struct _Instance *instance /*$s1*/)
 // line 974, offset 0x800870dc
	/* begin block 1 */
		// Start line: 975
		// Start offset: 0x800870DC
		// Variables:
	// 		struct _MonsterVars *mv; // $s0
	// 		static int doneThisFrame; // offset 0x44
	/* end block 1 */
	// End offset: 0x800871C0
	// End Line: 1005
...

{
  ...
  if ((DAT_800d1b2c == 0) && ((&monsterSensed)[*(char *)((int)pvVar1 + 0x163)] == '\0')) {
    lastSenseFrame = gameTrackerX.frameCount;
    (&monsterSensed)[*(char *)((int)pvVar1 + 0x163)] = '\x01';
    DAT_800d1b2c = 1;
    *(undefined *)((int)pvVar1 + 0x162) = 1;
    if ((*(uint *)((int)pvVar1 + 4) & 0x20000000) == 0) {
      MONSENSE_Radar(instance);
    }
  }
  else {
    *(undefined *)((int)pvVar1 + 0x162) = 0;
  }
  return;
}
...
// void /*$ra*/ MONSENSE_AdjustRadarFromObjects(struct _Instance *instance /*$s3*/)
 // line 1010, offset 0x800871d4
	...
	// 		struct _Instance *physob; // $s2
		...
		/* begin block 1.1 */
			// Start line: 1019
			// Start offset: 0x80087224
			// Variables:
		// 		struct PhysObProperties *prop; // $s1

			/* begin block 1.1.1 */
				// Start line: 1022
				// Start offset: 0x8008723C

				/* begin block 1.1.1.1 */
					// Start line: 1028
					// Start offset: 0x80087278
					// Variables:
				// 		long dist; // $s0

					/* begin block 1.1.1.1.1 */
						// Start line: 1033
						// Start offset: 0x800872AC
						// Variables:
					// 		int i; // $v1
					// 		int min; // $a1
					// 		int max; // $a2
...
/* WARNING: Removing unreachable block (ram,0x800872e8) */
/* WARNING: Removing unreachable block (ram,0x80087300) */
