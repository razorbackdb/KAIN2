...
// void /*$ra*/ MON_DoCombatTimers(struct _Instance *instance /*$s2*/)
 // line 101, offset 0x800873b8
	/* begin block 1 */
		// Start line: 102
		// Start offset: 0x800873B8
		// Variables:
	...
	// 		unsigned long curtime; // $s1
		...
		/* begin block 1.1 */
			// Start line: 117
			// Start offset: 0x8008743C
			// Variables:
		// 		struct _MonsterCombatAttributes *combat; // $v0
		/* end block 1.1 */
		// End offset: 0x800874AC
		// End Line: 126
	/* end block 1 */
	// End offset: 0x80087588
	// End Line: 142
...

{
  ...
  uVar2 = *puVar3;
  if ((uVar2 & 0x10) == 0) {
    if (((uVar2 & 0x2000) == 0) && (*(short *)(puVar3 + 0x51) < *(short *)((int)puVar3 + 0x146))) {
      amount = (uint)*(ushort *)(puVar3 + 0x51) +
               ((int)*(short *)(*(int *)(puVar3[0x5a] + 8) + 4) * gameTrackerX.timeMult >> 0xc);
      *(short *)(puVar3 + 0x51) = (short)amount;
      if ((int)*(short *)((int)puVar3 + 0x146) < amount * 0x10000 >> 0x10) {
        *(undefined2 *)(puVar3 + 0x51) = *(undefined2 *)((int)puVar3 + 0x146);
      }
      amount = MONSTER_CalcDamageIntensity
                         ((int)*(short *)(puVar3 + 0x51),(int)*(short *)((int)puVar3 + 0x146));
      MONSTER_VertexBlood(instance,(int)*(short *)(puVar3 + 0x53),amount);
    }
  }
  else {
  ...
  if (uVar1 % 1000 < (uVar1 - gameTrackerX.lastLoopTime) % 1000) {
    amount = rand();
    *(char *)((int)puVar3 + 0x165) = (char)amount + (char)(amount / 100) * -100;
  }
  return;
}
...
// void /*$ra*/ MON_ChangeHumanOpinion(struct _Instance *instance /*$a0*/)
 // line 147, offset 0x800875a0
	/* begin block 1 */
		// Start line: 148
		// Start offset: 0x800875A0
		// Variables:
	// 		int good; // $v0
 ...
 // line 192, offset 0x80087648
	...
	// 		struct MATRIX *mat; // $a0
		...
		// 		long color; // stack offset -24
			...
			/* end block 1.1.1 */
			// End offset: 0x8008778C
			// End Line: 221
		/* end block 1.1 */
		// End offset: 0x80087834
		// End Line: 233
	/* end block 1 */
	// End offset: 0x80087884
	// End Line: 238
...
// void /*$ra*/ MON_DeadEntry(struct _Instance *instance /*$s1*/)
 // line 249, offset 0x8008789c
	/* begin block 1 */
		// Start line: 250
		// Start offset: 0x8008789C
		// Variables:
	// 		struct _MonsterVars *mv; // $s0
	/* end block 1 */
	// End offset: 0x80087978
	// End Line: 278
...
// void /*$ra*/ MON_Dead(struct _Instance *instance /*$s2*/)
 // line 280, offset 0x8008798c
	/* begin block 1 */
		// Start line: 281
		// Start offset: 0x8008798C
		// Variables:
	...
	// 		int reanimate; // $s6
		...
		/* begin block 1.1 */
			// Start line: 304
			// Start offset: 0x80087A38
			// Variables:
		// 		struct _MonsterAttributes *ma; // $s0
		// 		int fade_amount; // $a1
		/* end block 1.1 */
		// End offset: 0x80087A6C
		// End Line: 316

		/* begin block 1.2 */
			// Start line: 336
			// Start offset: 0x80087AEC
			// Variables:
		// 		struct _Model *model; // $s0
		// 		int i; // $s0
		// 		struct CVECTOR *ptr; // $v0
		/* end block 1.2 */
		// End offset: 0x80087B3C
		// End Line: 344

		/* begin block 1.3 */
			// Start line: 347
			// Start offset: 0x80087B64
			// Variables:
		...
		// 		struct _Instance *closest; // $s3
			...
			// 		long closestdist; // $s4
				...
				// 		long dist; // $v1
				/* end block 1.3.1.1 */
				// End offset: 0x80087C38
				// End Line: 367
			/* end block 1.3.1 */
			// End offset: 0x80087C48
			// End Line: 370
		/* end block 1.3 */
		// End offset: 0x80087CD4
		// End Line: 383

		/* begin block 1.4 */
			// Start line: 402
			// Start offset: 0x80087D54
			// Variables:
		...
		/* begin block 1.5 */
			// Start line: 448
			// Start offset: 0x80087EDC
			// Variables:
		// 		struct _MonsterAttributes *ma; // $a0
		/* end block 1.5 */
		// End offset: 0x80087FEC
		// End Line: 482
	/* end block 1 */
	// End offset: 0x80088098
	// End Line: 522
...

{
  ...
  if (introUniqueID == 0) {
    if ((*puVar9 & 0x200) == 0) {
      ...
      if ((int)(uVar4 - puVar9[0x43]) < 0x1000) {
        MON_CutOut_Monster(instance,uVar4 - puVar9[0x43],(uint)*(byte *)((int)pvVar7 + 0x19),
  ...
  if (*(char *)(puVar9 + 0x56) == '\x06') {
    MON_KillMonster(instance);
  }
  else {
    if (((byte)(*(char *)(puVar9 + 0x56) - 1U) < 3) && (instance->perVertexColor == (CVECTOR *)0x0))
    {
      ...
      if ((*(char *)(puVar9 + 0x56) == '\0') && (puVar9[0x34] == 0)) {
            ...
            if (((((instance != instance_00) && (instance_00->object != (Object *)0x0)) &&
               ...
               (((Message = CheckPhysObFamily(instance_00,0), Message != 0 ||
                ...
                (lVar3 = MATH3D_LengthXYZ((int)(instance_00->position).x -
                                          ...
                                          (int)(instance->position).z), lVar3 < Data)))) {
        ...
        if (*(char *)(puVar9 + 0x56) == '\x03') {
          if ((puVar9[0x37] != 0) && (uVar4 = MON_GetTime(instance), puVar9[0x47] < uVar4)) {
  ...
  if (((*puVar9 & 0x400000) != 0) && (uVar4 = MON_GetTime(instance), puVar9[0x47] < uVar4)) {
  ...
  while (p_Var5 = DeMessageQueue((__MessageQueue *)(puVar9 + 2)), p_Var5 != (__Event *)0x0) {
    ...
    if (puVar6 == (undefined *)0x100000d) {
      ...
      if ((p_Var5->Data != 0) && ('\x02' < *(char *)((int)pvVar7 + 0x28))) {
        *(undefined *)((int)puVar9 + 0x15e) = 2;
        *puVar9 = *puVar9 | 0x10000000;
        puVar9[0x5a] = *(uint *)(*(int *)((int)pvVar7 + 0x30) + 8);
      }
      *(undefined *)(puVar9 + 0x56) = 0;
      puVar9[0x36] = 0;
...
// void /*$ra*/ MON_MissileHitEntry(struct _Instance *instance /*$s0*/)
 // line 527, offset 0x800880c0
	/* begin block 1 */
		// Start line: 528
		// Start offset: 0x800880C0
		// Variables:
	// 		struct _MonsterVars *mv; // $s1
	/* end block 1 */
	// End offset: 0x800880C0
	// End Line: 528
...
// void /*$ra*/ MON_MissileHit(struct _Instance *instance /*$s1*/)
 // line 551, offset 0x8008818c
	/* begin block 1 */
		// Start line: 552
		// Start offset: 0x8008818C
		// Variables:
...
// void /*$ra*/ MON_ParryEntry(struct _Instance *instance /*$s1*/)
 // line 591, offset 0x80088294
	/* begin block 1 */
		// Start line: 592
		// Start offset: 0x80088294
		// Variables:
	// 		struct _MonsterVars *mv; // $s0
	/* end block 1 */
	// End offset: 0x80088294
	// End Line: 592
...

{
  ...
  if (*(char *)((int)instance->extraData + 0x159) == '\v') {
...
// void /*$ra*/ MON_LandOnFeet(struct _Instance *instance /*$s1*/)
 // line 661, offset 0x800883ec
	/* begin block 1 */
		// Start line: 662
		// Start offset: 0x800883EC
		// Variables:
	// 		struct _MonsterVars *mv; // $s0

		/* begin block 1.1 */
			// Start line: 680
			// Start offset: 0x80088454
			// Variables:
		// 		int state; // $a1
		/* end block 1.1 */
		// End offset: 0x80088504
		// End Line: 711
	/* end block 1 */
	// End offset: 0x80088564
	// End Line: 725
...

{
  ...
  if ((instance->currentMainState == 0x10) &&
     ((*(short *)(puVar1 + 0x55) == 0x20 || (*(short *)(puVar1 + 0x55) == 0x40)))) {
  ...
  if ((instance->flags2 & 0x10U) != 0) {
    ...
    if ((instance->flags2 & 0x8000000U) == 0) {
      if (((*puVar1 & 0x2000) == 0) || (*(short *)(puVar1 + 0x51) != 0)) {
        if (((*puVar1 & 0x400000) == 0) &&
           ((*(short *)(puVar1 + 0x51) == 0 && (*(short *)(puVar1 + 0x55) != 0)))) {
          *puVar1 = *puVar1 & 0xfffffeff;
        }
      }
      else {
        *(undefined2 *)(puVar1 + 0x55) = 0x4000;
      }
    }
...
// void /*$ra*/ MON_BreakHoldEntry(struct _Instance *instance /*$s1*/)
 // line 743, offset 0x800885ac
	/* begin block 1 */
		// Start line: 744
		// Start offset: 0x800885AC
		// Variables:
	// 		struct _MonsterVars *mv; // $s0
	/* end block 1 */
...
// void /*$ra*/ MON_BreakHold(struct _Instance *instance /*$s1*/)
 // line 755, offset 0x80088618
	/* begin block 1 */
		// Start line: 756
		// Start offset: 0x80088618

		/* begin block 1.1 */
			// Start line: 763
			// Start offset: 0x80088658
			// Variables:
		// 		struct _MonsterVars *mv; // $s3
		// 		struct __Event *message; // $a1
			...
			/* end block 1.1.1 */
			// End offset: 0x800886E0
			// End Line: 773

			/* begin block 1.1.2 */
				// Start line: 780
				// Start offset: 0x80088708
				// Variables:
			// 		struct evMonsterHitTerrainData *data; // $v0
			/* end block 1.1.2 */
			// End offset: 0x80088724
			// End Line: 782
		/* end block 1.1 */
		// End offset: 0x800887B0
		// End Line: 808
	/* end block 1 */
	// End offset: 0x800887D8
	// End Line: 814
...
LAB_80088734:
          ...
          if (iVar1 == 0x1000007) {
            ...
            if (iVar1 != 0x100000b) goto LAB_80088734;
          }
        }
      }
    }
    if (instance->LinkParent == (_Instance *)0x0) {
      if ((instance->currentMainState == 0xe) && (*(short *)((int)pvVar2 + 0x12a) != 0)) {
...

{
  ...
  if (*(short *)(puVar3 + 0x51) == 0) {
    ...
    puVar3[0x43] = uVar2 + (int)*(short *)(iVar4 + 2);
...
// void /*$ra*/ MON_Impact(struct _Instance *instance /*$s0*/)
 // line 845, offset 0x800888d8
	/* begin block 1 */
		// Start line: 846
		// Start offset: 0x800888D8
		// Variables:
	// 		struct _MonsterVars *mv; // $s1
	/* end block 1 */
...

{
  ...
  MON_DefaultQueueHandler(instance);
  if ((instance->currentMainState == 0x10) &&
     ((sVar1 = *(short *)((int)pvVar2 + 0x154), sVar1 == 0x20 || (sVar1 == 0x40)))) {
...
// void /*$ra*/ MON_FallEntry(struct _Instance *instance /*$s0*/)
 // line 871, offset 0x80088958
	/* begin block 1 */
		// Start line: 872
		// Start offset: 0x80088958
		// Variables:
	// 		struct _MonsterVars *mv; // $s1
	/* end block 1 */
	// End offset: 0x800889DC
	// End Line: 893
...

{
  ...
  instance->yAccl = 0;
  instance->zAccl = -0x10;
  *(undefined4 *)((int)pvVar3 + 0x108) = 0x100000;
  uVar2 = MON_GetTime(instance);
  *(int *)((int)pvVar3 + 0x114) = uVar2 + 2000;
  return;
}
...
// void /*$ra*/ MON_Fall(struct _Instance *instance /*$s1*/)
 // line 901, offset 0x80088a18
	/* begin block 1 */
		// Start line: 902
		// Start offset: 0x80088A18
		// Variables:
	// 		struct _MonsterVars *mv; // $s3
	// 		struct __Event *message; // $a1
	// 		int state; // $s2
		...
		/* begin block 1.1 */
			// Start line: 929
			// Start offset: 0x80088ACC
			// Variables:
		// 		int x; // $s0
		// 		int y; // $v0
		/* end block 1.1 */
		// End offset: 0x80088B00
		// End Line: 934
	/* end block 1 */
	// End offset: 0x80088B78
	// End Line: 963
...

{
  ...
  uVar1 = MON_GetTime(instance);
  if (((puVar5[0x45] < uVar1) && (*(int *)&instance->position == *(int *)&instance->oldPos)) &&
  ...
  if (((instance->currentMainState == 0x10) && (iVar4 == 4)) &&
     ((*(short *)(puVar5 + 0x55) == 0x20 || (*(short *)(puVar5 + 0x55) == 0x40)))) {
...
// void /*$ra*/ MON_Thrown(struct _Instance *instance /*$s0*/)
 // line 989, offset 0x80088c30
	/* begin block 1 */
		// Start line: 990
		// Start offset: 0x80088C30
		// Variables:
	// 		struct _MonsterVars *mv; // $s1
	// 		struct Intro *impaler; // $v0
		...
		/* begin block 1.1 */
			// Start line: 996
			// Start offset: 0x80088C60
		/* end block 1.1 */
		// End offset: 0x80088CA0
		// End Line: 1006
		...
		// 		struct __Event *message; // $a1
			...
			/* begin block 1.2.1 */
				// Start line: 1024
				// Start offset: 0x80088CFC
				// Variables:
			// 		struct evMonsterHitTerrainData *data; // $v0
			/* end block 1.2.1 */
			// End offset: 0x80088CFC
			// End Line: 1024
		/* end block 1.2 */
		// End offset: 0x80088D74
		// End Line: 1049
	/* end block 1 */
	// End offset: 0x80088D74
	// End Line: 1050
...

{
  ...
  if ((*puVar4 & 2) == 0) {
    ...
    if ((instance->currentMainState == 0x10) &&
       ((*(short *)(puVar4 + 0x55) == 0x20 || (*(short *)(puVar4 + 0x55) == 0x40)))) {
...
// void /*$ra*/ MON_ImpaleDeathEntry(struct _Instance *instance /*$s0*/)
 // line 1055, offset 0x80088d88
	/* begin block 1 */
		// Start line: 1056
		// Start offset: 0x80088D88
		// Variables:
	// 		struct _MonsterVars *mv; // $s1
	/* end block 1 */
	// End offset: 0x80088D88
	// End Line: 1056
...

{
  ...
  MON_PlayAnim(instance,(MonsterAnim)
                        CONCAT412(in_stack_fffffffc,
                                  CONCAT48(unaff_retaddr,CONCAT44(unaff_s1,unaff_s0))),0xd);
...
// void /*$ra*/ MON_ImpaleDeath(struct _Instance *instance /*$s1*/)
 // line 1073, offset 0x80088e08
	/* begin block 1 */
		// Start line: 1074
		// Start offset: 0x80088E08
		// Variables:
	// 		struct _MonsterVars *mv; // $s0
	...
	// 		struct __Event *message; // $v0
		...
		/* begin block 1.1 */
			// Start line: 1081
			// Start offset: 0x80088E3C
			// Variables:
		// 		int thisFrame; // $s3
		// 		int lastFrame; // $a0
		/* end block 1.1 */
		// End offset: 0x80088EB0
		// End Line: 1092
	/* end block 1 */
	// End offset: 0x80088FF4
	// End Line: 1127
  ...
  if ((instance->flags2 & 0x10U) != 0) {
    Data = MON_AnimPlaying(instance,(MonsterAnim)
                                    CONCAT412(local_14,CONCAT48(local_18,CONCAT44(in_stack_ffffffe4,
                                                                                  local_20))));
    if ((Data == 0) ||
       (*(char *)(*(int *)puVar4[0x5a] + 0xd) == *(char *)(*(int *)puVar4[0x5a] + 0x16))) {
...
// void /*$ra*/ MON_TerrainImpaleDeathEntry(struct _Instance *instance /*$s1*/)
 // line 1132, offset 0x80089010
	/* begin block 1 */
		// Start line: 1133
		// Start offset: 0x80089010
		// Variables:
	// 		struct _MonsterVars *mv; // $s2
	// 		struct _MonsterAttributes *ma; // $s0
	// 		struct Intro *impaler; // $s0
	/* end block 1 */
	// End offset: 0x80089148
	// End Line: 1173
...
LAB_80089138:
    ...
    if (uVar2 < 0x801) {
      ...
      if (0x2a9 < mode) goto LAB_80089138;
    }
    mode = 0x20;
  }
LAB_80089140:
...
// void /*$ra*/ MON_TerrainImpaleDeath(struct _Instance *instance /*$s3*/)
 // line 1176, offset 0x80089164
	/* begin block 1 */
		// Start line: 1177
		// Start offset: 0x80089164
		// Variables:
	// 		struct _MonsterVars *mv; // $s2
	// 		struct Intro *impaler; // $v1
		...
		/* end block 1.1 */
		// End offset: 0x8008925C
		// End Line: 1205

		/* begin block 1.2 */
			// Start line: 1212
			// Start offset: 0x8008926C
			// Variables:
		// 		struct _MonsterAttributes *ma; // $s1
		// 		int fade_amount; // $s0
		/* end block 1.2 */
		// End offset: 0x800892D4
		// End Line: 1230
	/* end block 1 */
	// End offset: 0x80089330
	// End Line: 1242
  ...
  if ((*puVar7 & 0x200) == 0) {
    ...
    if ((instance->flags2 & 0x10U) != 0) {
      ...
      *puVar7 = *puVar7 | 0x200;
      ...
      if ((puVar7[0x36] == 0) && (*(short *)(puVar7 + 0x52) != 0)) {
        MON_BirthSoul(instance,1);
      }
    }
  }
    ...
    if (puVar7[0x36] == 0) {
      ...
      if (0xfff < (int)(uVar1 - uVar5)) {
        pIVar3 = INSTANCE_FindIntro(instance->currentStreamUnitID,puVar7[0x69]);
        if (pIVar3 != (Intro *)0x0) {
    ...
    if (((*puVar7 & 0x400000) != 0) && (uVar1 = MON_GetTime(instance), puVar7[0x47] < uVar1)) {
...
// void /*$ra*/ MON_SurprisedEntry(struct _Instance *instance /*$s0*/)
 // line 1247, offset 0x8008934c
	/* begin block 1 */
		// Start line: 1248
		// Start offset: 0x8008934C
		// Variables:
	// 		struct _MonsterVars *mv; // $s1
	/* end block 1 */
	// End offset: 0x8008934C
	// End Line: 1248
...

{
  ...
  *(int *)((int)pvVar2 + 0x114) =
       uVar1 + (int)*(short *)(*(int *)(*(int *)((int)pvVar2 + 0x168) + 8) + 6);
  return;
}
...
// void /*$ra*/ MON_Surprised(struct _Instance *instance /*$s1*/)
 // line 1258, offset 0x800893ac
	/* begin block 1 */
		// Start line: 1259
		// Start offset: 0x800893AC
		// Variables:
	// 		struct _MonsterVars *mv; // $s0
	/* end block 1 */
	// End offset: 0x80089454
	// End Line: 1279
...

{
  ...
  if (*(int *)((int)pvVar2 + 0xc4) != 0) {
    *(int *)((int)pvVar2 + 0x120) = *(int *)(*(int *)((int)pvVar2 + 0xc4) + 4) + 0x5c;
    MON_TurnToPosition(instance,(_Position *)(*(int *)(*(int *)((int)pvVar2 + 0xc4) + 4) + 0x5c),
                       *(short *)(*(int *)((int)pvVar2 + 0x168) + 0x1c));
  }
  MON_DefaultQueueHandler(instance);
  return;
}
...
// void /*$ra*/ MON_StunnedEntry(struct _Instance *instance /*$s1*/)
 // line 1285, offset 0x80089470
	/* begin block 1 */
		// Start line: 1286
		// Start offset: 0x80089470
		// Variables:
	// 		struct _MonsterVars *mv; // $s0
	// 		struct _MonsterCombatAttributes *combat; // $s2
	/* end block 1 */
	// End offset: 0x800895F0
	// End Line: 1328
...

{
  ...
  puVar3 = (uint *)instance->extraData;
  psVar4 = *(short **)(puVar3[0x5a] + 8);
  if ((*puVar3 & 0x40) == 0) {
    if ((*puVar3 & 0x100) != 0) goto LAB_80089574;
    sVar1 = *(short *)(puVar3 + 0x55);
...
LAB_80089574:
  *puVar3 = *puVar3 | 0x10110;
  ...
  if ((*(short *)(puVar3 + 0x55) == 0x40) && (*(char *)(puVar3[0x5a] + 0x38) != '\0')) {
    uVar2 = MON_GetTime(instance);
    mode = (int)*psVar4 << 1;
  }
  else {
...
// void /*$ra*/ MON_Stunned(struct _Instance *instance /*$s0*/)
 // line 1332, offset 0x80089620
	/* begin block 1 */
		// Start line: 1333
		// Start offset: 0x80089620
		// Variables:
	// 		struct _MonsterVars *mv; // $s1
	/* end block 1 */
	// End offset: 0x8008971C
	// End Line: 1363
...
// void /*$ra*/ MON_GrabbedEntry(struct _Instance *instance /*$s0*/)
 // line 1368, offset 0x80089730
	/* begin block 1 */
		// Start line: 1369
		// Start offset: 0x80089730
		// Variables:
	// 		struct _MonsterVars *mv; // $s1
	/* end block 1 */
	// End offset: 0x80089788
	// End Line: 1385
...

{
  ...
  MON_PlayAnim(instance,(MonsterAnim)
                        CONCAT412(in_stack_fffffffc,
                                  CONCAT48(unaff_retaddr,CONCAT44(unaff_s1,unaff_s0))),4);
  instance->flags2 = instance->flags2 & 0xffffffbf;
  uVar1 = MON_GetTime(instance);
  *(int *)((int)pvVar2 + 0x114) =
       uVar1 + (int)*(short *)(*(int *)(*(int *)((int)pvVar2 + 0x168) + 8) + 8);
...
// void /*$ra*/ MON_Grabbed(struct _Instance *instance /*$s1*/)
 // line 1398, offset 0x80089814
	/* begin block 1 */
		// Start line: 1399
		// Start offset: 0x80089814
		// Variables:
	// 		struct _MonsterVars *mv; // $s2
	// 		struct __Event *message; // $a1
	// 		int time; // $v1
		...
		/* begin block 1.1 */
			// Start line: 1424
			// Start offset: 0x80089910
			// Variables:
		// 		struct evMonsterThrownData *data; // $s0
		/* end block 1.1 */
		// End offset: 0x80089910
		// End Line: 1424

		/* begin block 1.2 */
			// Start line: 1431
			// Start offset: 0x80089938
			// Variables:
		// 		struct evMonsterHitTerrainData *data; // $v0
		/* end block 1.2 */
		// End offset: 0x80089954
		// End Line: 1433
	/* end block 1 */
	// End offset: 0x80089A10
	// End Line: 1466
...

{
  ...
  uVar1 = MON_GetTime(instance);
  if (((int)(*(int *)((int)pvVar3 + 0x114) - uVar1) < 1) &&
    ...
    while( true ) {
      while( true ) {
        ...
        if (message == (__Event *)0x0) {
          if (instance->LinkParent == (_Instance *)0x0) {
            if ((instance->currentMainState == 10) && (*(short *)((int)pvVar3 + 0x12a) != 0)) {
              MON_TurnOnBodySpheres(instance);
              MON_SwitchState(instance,(MonsterState)CONCAT44(local_14,local_18));
              (instance->rotation).z = ((gameTrackerX.playerInstance)->rotation).z + 0x800;
            }
        ...
        iVar2 = message->ID;
        if (iVar2 != 0x1000003) break;
        iVar2 = message->Data;
        INSTANCE_UnlinkFromParent(instance);
        MON_LaunchMonster(instance,(int)*(short *)(iVar2 + 8),(int)*(short *)(iVar2 + 0xc),0x32);
      }
      if (iVar2 < 0x1000004) break;
      if (iVar2 != 0x1000007) goto code_r0x800898fc;
      if ((*(ushort *)(message->Data + 0xe) & 0x2000) != 0) {
        MON_UnlinkFromRaziel(instance);
      }
    }
...
// void /*$ra*/ MON_HitEntry(struct _Instance *instance /*$s1*/)
 // line 1471, offset 0x80089a2c
	/* begin block 1 */
		// Start line: 1472
		// Start offset: 0x80089A2C
		// Variables:
	// 		struct _MonsterVars *mv; // $s0
	// 		struct _MonsterIR *enemy; // $a0
	/* end block 1 */
	// End offset: 0x80089A98
	// End Line: 1486
...

{
  ...
  *puVar4 = *puVar4 | 0x10000;
  ...
  instance->checkMask = instance->checkMask | 0x20;
  uVar2 = MON_GetTime(instance);
  *(undefined **)(puVar4 + 0x46) = &DAT_000026ac + uVar2;
  return;
}
...
// void /*$ra*/ MON_AttackEntry(struct _Instance *instance /*$s0*/)
 // line 1524, offset 0x80089bb8
	/* begin block 1 */
		// Start line: 1525
		// Start offset: 0x80089BB8
		// Variables:
	// 		struct _MonsterVars *mv; // $s1
	// 		struct _MonsterAttackAttributes *attack; // $s2
	/* end block 1 */
	// End offset: 0x80089BB8
	// End Line: 1525
...

{
  ...
  uVar5 = puVar6[0x2e];
  uVar7 = puVar6[0x31];
  p_Var2 = MON_GetAnim(instance,(char *)(uVar5 + 0x1b),(int)*(char *)((int)puVar6 + 0x15f));
  if ((p_Var2->velocity != 0) && (iVar3 = MON_TransNodeAnimation(instance), iVar3 == 0)) {
    *(ushort *)((int)puVar6 + 0x12a) = p_Var2->velocity;
  ...
  if ((instance->flags2 & 0x10U) != 0) {
    ...
    cVar1 = *(char *)((int)puVar6 + 0x15f) + '\x01';
    *(char *)((int)puVar6 + 0x15f) = cVar1;
...
// void /*$ra*/ MON_CombatEntry(struct _Instance *instance /*$a0*/)
 // line 1590, offset 0x80089e0c
	/* begin block 1 */
		// Start line: 1592
		// Start offset: 0x80089E0C
		// Variables:
	// 		struct _MonsterVars *mv; // $a0
	/* end block 1 */
	// End offset: 0x80089E0C
	// End Line: 1597
	...
	// 		struct _MonsterIR *enemy; // $s3
		...
		// 		struct _MonsterCombatAttributes *combat; // $s2
			...
			// 		int reason; // $a1
				...
				/* begin block 1.1.1.2 */
					// Start line: 1662
					// Start offset: 0x80089FF4
				/* end block 1.1.1.2 */
				// End offset: 0x8008A010
				// End Line: 1665
			...
			/* begin block 1.1.2 */
				// Start line: 1695
				// Start offset: 0x8008A0B8
				// Variables:
			// 		int state; // $a1
			/* end block 1.1.2 */
			// End offset: 0x8008A0FC
			// End Line: 1706
		/* end block 1.1 */
		// End offset: 0x8008A0FC
		// End Line: 1707
...

{
  ...
  if ((((enemy != (_MonsterIR *)0x0) && ((*puVar2 & 4) == 0)) &&
     ...
     ((reason = MON_ValidPosition(instance), reason != 0 ||
      (uVar1 = MON_GetTime(instance), uVar1 < puVar2[0x46])))) {
    iVar3 = *(int *)(puVar2[0x5a] + 8);
    *(_Position **)(puVar2 + 0x48) = &enemy->instance->position;
    reason = MON_ShouldIFlee(instance);
    if ((reason == 0) &&
       ((enemy->distance < *(short *)(iVar3 + 10) || (*(char *)((int)puVar2 + 0x15a) == '\n')))) {
      ...
      MON_TurnToPosition(instance,&enemy->instance->position,*(short *)(puVar2[0x5a] + 0x1c));
      goto LAB_8008a0fc;
    }
  }
  MON_SwitchState(instance,(MonsterState)CONCAT44(local_14,local_18));
...
// void /*$ra*/ MON_ProjectileEntry(struct _Instance *instance /*$a0*/)
 // line 1715, offset 0x8008a120
	/* begin block 1 */
		// Start line: 1716
		// Start offset: 0x8008A120
		// Variables:
	// 		struct _MonsterVars *mv; // $s0
	// 		struct _MonsterAttributes *ma; // $v1
	// 		struct _MonsterMissile *missileDef; // $a1
	/* end block 1 */
	// End offset: 0x8008A120
	// End Line: 1716
...

{
  ...
  MON_PlayAnimFromList
            (instance,(char *)(*(int *)((int)instance->data + 0x3c) +
                               (int)*(char *)(*(int *)(*(int *)((int)pvVar1 + 0x168) + 8) + 0x1e) *
                               0x10 + 0xe),0,1);
  *(undefined *)((int)pvVar1 + 0x15f) = 0;
  return;
}
...
// void /*$ra*/ MON_Projectile(struct _Instance *instance /*$s2*/)
 // line 1727, offset 0x8008a178
	/* begin block 1 */
		// Start line: 1728
		// Start offset: 0x8008A178
		// Variables:
	// 		struct _MonsterVars *mv; // $s1
	// 		struct _MonsterAttributes *ma; // $v1
	// 		struct _MonsterMissile *missileDef; // $s0
	/* end block 1 */
	// End offset: 0x8008A29C
	// End Line: 1757
  ...
  if (puVar3[0x31] != 0) {
    if ((instance->flags2 & 0x10U) == 0) {
      ...
      MON_TurnToPosition(instance,(_Position *)(*(int *)(puVar3[0x31] + 4) + 0x5c),
                         *(short *)(puVar3[0x5a] + 0x1c));
      goto LAB_8008a29c;
    }
    cVar1 = *(char *)((int)puVar3 + 0x15f) + '\x01';
    *(char *)((int)puVar3 + 0x15f) = cVar1;
...
// void /*$ra*/ MON_IdleEntry(struct _Instance *instance /*$a1*/)
 // line 1766, offset 0x8008a2bc
	/* begin block 1 */
		// Start line: 1767
		// Start offset: 0x8008A2BC
		// Variables:
	// 		struct _MonsterVars *mv; // $s0

		/* begin block 1.1 */
			// Start line: 1777
			// Start offset: 0x8008A2FC
			// Variables:
		// 		struct _MonsterAttributes *ma; // $v1
		/* end block 1.1 */
...
// void /*$ra*/ MON_Idle(struct _Instance *instance /*$s3*/)
 // line 1794, offset 0x8008a374
	/* begin block 1 */
		// Start line: 1795
		// Start offset: 0x8008A374
		// Variables:
	// 		struct _MonsterVars *mv; // $s0
	// 		int combatIdle; // $s4
		...
		/* begin block 1.1 */
			// Start line: 1801
			// Start offset: 0x8008A3B0
			// Variables:
		// 		int state; // $s1
		// 		struct _MonsterIR *enemy; // $s2
		/* end block 1.1 */
		// End offset: 0x8008A4C0
		// End Line: 1831
	/* end block 1 */
	// End offset: 0x8008A588
	// End Line: 1848
...

{
  ...
  if ((*puVar3 & 4) == 0) {
    ...
    if (iVar2 == 0) {
      ...
      if (uVar5 == 0) {
        if (((uint)*(byte *)((int)puVar3 + 0x15a) - 2 < 2) && ((instance->flags2 & 2U) != 0)) {
          iVar4 = 5;
        }
      }
      else {
        ...
        if (iVar2 == 0) {
          if ((*(ushort *)(uVar5 + 0x16) & 0x100) == 0) {
            if (((*(char *)((int)puVar3 + 0x15a) == '\a') &&
                (*(short *)(puVar3 + 0x4f) < *(short *)(uVar5 + 0x14))) ||
    ...
    if (((puVar3[1] & 0x10000000) != 0) &&
       (AngleMoveToward(&(instance->rotation).z,*(short *)(puVar3 + 0x4a),
                        (short)((int)*(short *)(puVar3[0x5a] + 0x1c) * gameTrackerX.timeMult * 0x10
                               >> 0x10)), (instance->rotation).z == *(short *)(puVar3 + 0x4a))) {
...
{ // line 1854, offset 0x8008a5b0
	/* begin block 1 */
		// Start line: 1855
		// Start offset: 0x8008A5B0
		// Variables:
			struct _MonsterVars *mv; // $a1
	/* end block 1 */
	// End offset: 0x8008A5B0
	// End Line: 1855
...
// void /*$ra*/ MON_Flee(struct _Instance *instance /*$s1*/)
 // line 1869, offset 0x8008a604
	/* begin block 1 */
		// Start line: 1870
		// Start offset: 0x8008A604
		// Variables:
	// 		struct _MonsterVars *mv; // $s0

		/* begin block 1.1 */
			// Start line: 1896
			// Start offset: 0x8008A6EC
		/* end block 1.1 */
		// End offset: 0x8008A734
		// End Line: 1903
	/* end block 1 */
	// End offset: 0x8008A734
	// End Line: 1904
...

{
  ...
  if (puVar3[0x31] == 0) {
    MON_SwitchState(instance,(MonsterState)CONCAT44(local_c,local_10));
    *(undefined *)((int)puVar3 + 0x15a) = *(undefined *)((int)puVar3 + 0x15b);
    return;
  }
  if (((((*puVar3 & 0x2000000) == 0) || (puVar3[0x33] == 0)) ||
    ...
    if (*(short *)(puVar3[0x5a] + 0x1a) < *(short *)(puVar3[0x31] + 0x14)) {
      MON_SwitchState(instance,(MonsterState)CONCAT44(local_c,local_10));
      return;
    }
    iVar2 = MON_ValidPosition(instance);
    if (iVar2 != 0) {
      angle = MATH3D_AngleFromPosToPos
                        ((_Position *)(*(int *)(puVar3[0x31] + 4) + 0x5c),&instance->position);
      angle = MONSENSE_GetClosestFreeDirection(instance,angle,1000);
      AngleMoveToward(&(instance->rotation).z,angle,*(short *)(puVar3[0x5a] + 0x22));
      MON_DefaultQueueHandler(instance);
      return;
    }
  }
...
// void /*$ra*/ MON_PursueEntry(struct _Instance *instance /*$s1*/)
 // line 1909, offset 0x8008a748
	/* begin block 1 */
		// Start line: 1910
		// Start offset: 0x8008A748
		// Variables:
	// 		struct _MonsterVars *mv; // $s0
	/* end block 1 */
	// End offset: 0x8008A7A8
	// End Line: 1925
...
// void /*$ra*/ MON_Pursue(struct _Instance *instance /*$s3*/)
 // line 1930, offset 0x8008a7d8
	/* begin block 1 */
		// Start line: 1931
		// Start offset: 0x8008A7D8
		// Variables:
	// 		struct _MonsterVars *mv; // $s1
	// 		int anim; // $a1
	// 		int planresult; // $v1
	...
	// 		int pursueType; // $s2
		...
		/* begin block 1.1 */
			// Start line: 1954
			// Start offset: 0x8008A830

			/* begin block 1.1.1 */
				// Start line: 1960
				// Start offset: 0x8008A860
			/* end block 1.1.1 */
			// End offset: 0x8008A89C
			// End Line: 1966

			/* begin block 1.1.2 */
				// Start line: 1998
				// Start offset: 0x8008A950
				// Variables:
			// 		struct _MonsterCombatAttributes *combat; // $a2

				/* begin block 1.1.2.1 */
					// Start line: 2002
					// Start offset: 0x8008A96C
					// Variables:
				// 		struct _MonsterIR *ally; // $a1
				/* end block 1.1.2.1 */
				// End offset: 0x8008A99C
				// End Line: 2023

				/* begin block 1.1.2.2 */
					// Start line: 2060
					// Start offset: 0x8008AA44
				/* end block 1.1.2.2 */
				// End offset: 0x8008AA9C
				// End Line: 2068
			/* end block 1.1.2 */
			// End offset: 0x8008AA9C
			// End Line: 2070
			...
			/* begin block 1.1.3 */
				// Start line: 2082
				// Start offset: 0x8008AAC8
				// Variables:
			// 		int state; // $s5
			/* end block 1.1.3 */
			// End offset: 0x8008ABB4
			// End Line: 2153
		/* end block 1.1 */
		// End offset: 0x8008ABE8
		// End Line: 2170
	/* end block 1 */
	// End offset: 0x8008ABE8
	// End Line: 2171
        ...
        if (target == (_MonsterIR *)0x0) {
          ...
          if (anim == 0) {
            ...
            *(undefined4 *)&mv->destination = *(undefined4 *)&target->instance->position;
            ...
            if ((anim == 0) ||
               (((mv->behaviorState == '\a' && (pIVar4 = instance->intro, pIVar4 != (Intro *)0x0))
                && (lVar2 = MATH3D_LengthXYZ((int)(mv->destination).x - (int)(pIVar4->position).x,
...
switchD_8008ab3c_caseD_3:
  ...
  case 4:
    ...
    if (uVar6 < 3) {
      if (uVar6 != 1) goto LAB_8008abac;
      goto switchD_8008ab3c_caseD_3;
    }
    if (uVar6 != 3) goto LAB_8008abac;
  }
  MON_GetPlanSlot(mv);
LAB_8008abac:
  if (iVar7 != -1) {
...
// void /*$ra*/ MON_WanderEntry(struct _Instance *instance /*$s1*/)
 // line 2176, offset 0x8008ac10
	/* begin block 1 */
		// Start line: 2177
		// Start offset: 0x8008AC10
		// Variables:
	// 		struct _MonsterVars *mv; // $s0
	/* end block 1 */
	// End offset: 0x8008AC80
	// End Line: 2193
...
// void /*$ra*/ MON_Wander(struct _Instance *instance /*$s2*/)
 // line 2199, offset 0x8008acb8
	/* begin block 1 */
		// Start line: 2200
		// Start offset: 0x8008ACB8
		// Variables:
	// 		struct _MonsterVars *mv; // $s1

		/* begin block 1.1 */
			// Start line: 2205
			// Start offset: 0x8008ACF0
		/* end block 1.1 */
		// End offset: 0x8008AD44
		// End Line: 2210
		...
		// 		int markerID; // $s0
		/* end block 1.2 */
		// End offset: 0x8008ADDC
		// End Line: 2224

		/* begin block 1.3 */
			// Start line: 2232
			// Start offset: 0x8008ADF0
			// Variables:
		// 		struct _Position *target; // $a1
		// 		short range; // $a2
		/* end block 1.3 */
		// End offset: 0x8008AE34
		// End Line: 2246

		/* begin block 1.4 */
			// Start line: 2252
			// Start offset: 0x8008AE44
			// Variables:
		// 		int planresult; // $v1
		// 		int state; // $a1
		/* end block 1.4 */
		// End offset: 0x8008AED4
		// End Line: 2289
	/* end block 1 */
	// End offset: 0x8008AF14
	// End Line: 2297
...

{
  ...
  if ((*puVar7 & 4) == 0) {
    ...
    uVar2 = MON_GetTime(instance);
    if (puVar7[0x45] < uVar2) goto LAB_8008ad38;
    if (*(char *)((int)puVar7 + 0x15a) == '\x03') {
      psVar3 = (short *)puVar7[0x68];
      if (psVar3 != (short *)0x0) {
        r = *psVar3;
        *(short **)(puVar7 + 0x68) = psVar3 + 1;
        streamUnit = STREAM_GetStreamUnitWithID(instance->currentStreamUnitID);
        PLANAPI_FindNodePositionInUnit(streamUnit,(_Position *)(puVar7 + 0x49),(int)r,0);
        if (*(short *)puVar7[0x68] == 0) {
          *(uint **)(puVar7 + 0x68) = puVar7 + 0x62;
        }
        *puVar7 = *puVar7 | 0x40000;
      }
    }
    else {
      r = *(short *)((int)puVar7 + 0x13a);
      in = (_Position *)0x0;
      if (puVar7[0x32] == 0) {
    ...
    MON_TurnToPosition(instance,(_Position *)(puVar7 + 0x49),*(short *)(puVar7[0x5a] + 0x1e));
    lVar1 = MATH3D_LengthXYZ((int)(instance->position).x - (int)*(short *)(puVar7 + 0x49),
                             (int)(instance->position).y - (int)*(short *)((int)puVar7 + 0x126),
                             (int)(instance->position).z - (int)*(short *)(puVar7 + 0x4a));
    if (lVar1 < 300) {
LAB_8008ad38:
      MON_SwitchState(instance,(MonsterState)CONCAT44(local_14,local_18));
    }
...
LAB_8008aed4:
  if (puVar7[0x31] != 0) {
    ...
    puVar7[0x48] = *(int *)(puVar7[0x31] + 4) + 0x5c;
  }
  return;
}
...
// void /*$ra*/ MON_Hide(struct _Instance *instance /*$s1*/)
 // line 2308, offset 0x8008af50
	/* begin block 1 */
		// Start line: 2309
		// Start offset: 0x8008AF50
		// Variables:
	// 		struct _MonsterVars *mv; // $s0
	// 		struct _MonsterIR *enemy; // $s2
	/* end block 1 */
	// End offset: 0x8008B0AC
	// End Line: 2357
...

{
  ...
  puVar2 = (uint *)instance->extraData;
  uVar3 = puVar2[0x31];
  if (((*puVar2 & 4) != 0) || (uVar3 == 0)) goto LAB_8008b06c;
  bVar1 = *(byte *)((int)puVar2 + 0x15a);
  if (bVar1 == 8) {
    if (((*puVar2 & 0x40000000) != 0) || (mode = MON_ShouldIAmbushEnemy(instance), mode == 0))
    goto LAB_8008b06c;
    if (*(char *)((int)puVar2 + 0x157) != '\0') {
      if (*(char *)((int)puVar2 + 0x157) == '\x01') {
        mode = 0x28;
      }
      else {
        mode = 0x29;
...
// void /*$ra*/ MON_SurpriseAttackEntry(struct _Instance *instance /*$a0*/)
 // line 2363, offset 0x8008b0cc
	/* begin block 1 */
		// Start line: 2364
		// Start offset: 0x8008B0CC
		// Variables:
	// 		struct _MonsterVars *mv; // $s0
	// 		struct _MonsterCombatAttributes *combatAttr; // $v0
	// 		struct _MonsterAttributes *ma; // $v1
	/* end block 1 */
	// End offset: 0x8008B150
	// End Line: 2390
...

{
  ...
  pvVar3 = instance->extraData;
  cVar1 = *(char *)(*(int *)(*(int *)((int)pvVar3 + 0x168) + 8) + 0x1f);
  iVar2 = *(int *)((int)instance->data + 0x38);
  *(undefined *)((int)pvVar3 + 0x15f) = 0;
  iVar2 = iVar2 + (int)cVar1 * 0x20;
  *(int *)((int)pvVar3 + 0xb8) = iVar2;
  MON_PlayAnimFromList(instance,(char *)(iVar2 + 0x1b),0,1);
  if (*(char *)((int)pvVar3 + 0x15a) == '\b') {
    if (*(char *)((int)pvVar3 + 0x15d) == -1) {
      *(undefined *)((int)pvVar3 + 0x15a) = *(undefined *)((int)pvVar3 + 0x15b);
    }
    else {
      *(undefined *)((int)pvVar3 + 0x15a) = *(undefined *)((int)pvVar3 + 0x15d);
    }
  }
  return;
}
...
// void /*$ra*/ MON_MonsterGlow(struct _Instance *instance /*$fp*/, long color /*stack 4*/, int glowtime /*$s5*/, int glowin /*$s6*/, int glowfade /*stack 16*/)
 // line 2408, offset 0x8008b190
	/* begin block 1 */
		// Start line: 2409
		// Start offset: 0x8008B190
		// Variables:
	// 		struct _FXGlowEffect *glow; // $v0
	// 		struct _MonsterAttributes *ma; // $s4
	/* end block 1 */
	// End offset: 0x8008B1F8
	// End Line: 2417
...
// void /*$ra*/ MON_GeneralDeathEntry(struct _Instance *instance /*$s1*/)
 // line 2436, offset 0x8008b31c
	/* begin block 1 */
		// Start line: 2437
		// Start offset: 0x8008B31C
		// Variables:
	// 		struct _MonsterVars *mv; // $s0
	// 		struct _MonsterAttributes *ma; // $s2
	/* end block 1 */
	// End offset: 0x8008B538
	// End Line: 2511
...

{
  ...
  instance->flags2 = instance->flags2 | 0x80;
  uVar1 = *(ushort *)(puVar4 + 0x55);
  *puVar4 = *puVar4 & 0xffffffef | 0x202000;
  if (uVar1 == 0x20) {
    *(undefined *)(puVar4 + 0x56) = 1;
LAB_8008b42c:
    ...
    MON_PlayAnim(instance,(MonsterAnim)
                 ...
                 ,mode);
    if (*(short *)(puVar4 + 0x55) == 0x40) {
      *(undefined *)(puVar4 + 0x56) = 2;
    }
    uVar2 = MON_GetTime(instance);
    puVar4[0x45] = uVar2 + 2000;
    *puVar4 = *puVar4 | 0x400000;
    uVar2 = MON_GetTime(instance);
    *(undefined **)(puVar4 + 0x47) = &DAT_00002710 + uVar2;
    ...
    if (uVar1 < 0x21) {
      if (uVar1 == 0x10) {
        ...
        puVar4[0x37] = uVar2;
        MON_PlayAnim(instance,(MonsterAnim)
                              CONCAT412(local_c,CONCAT48(local_10,CONCAT44(in_stack_ffffffec,puVar6)
                                                        )),0x1b);
        *(undefined *)(puVar4 + 0x56) = 3;
        uVar2 = MON_GetTime(instance);
        puVar4[0x45] = uVar2 + 3000;
        uVar2 = MON_GetTime(instance);
        *(undefined **)(puVar4 + 0x47) = &DAT_00002ee0 + uVar2;
      }
      else {
LAB_8008b4dc:
        if (puVar4[0x31] == 0) {
        ...
        MON_PlayAnim(instance,(MonsterAnim)
                              CONCAT412(local_c,CONCAT48(local_10,CONCAT44(in_stack_ffffffec,
                                                                           local_18))),mode);
        puVar4[0x45] = 0;
        *(undefined *)(puVar4 + 0x56) = 7;
        MON_TurnOffAllSpheres(instance);
      }
    }
    else {
      if (uVar1 == 0x40) goto LAB_8008b42c;
      if (uVar1 != 0x400) goto LAB_8008b4dc;
      MON_PlayAnim(instance,(MonsterAnim)
                            CONCAT412(local_c,CONCAT48(local_10,CONCAT44(in_stack_ffffffec,local_18)
                                                      )),0x24);
      *(undefined *)(puVar4 + 0x56) = 6;
      puVar4[0x45] = 0;
    }
    instance->xAccl = 0;
  }
...
// void /*$ra*/ MON_GeneralDeath(struct _Instance *instance /*$s1*/)
 // line 2524, offset 0x8008b568
	/* begin block 1 */
		// Start line: 2525
		// Start offset: 0x8008B568
		// Variables:
	// 		struct _MonsterVars *mv; // $s0
	// 		struct __Event *message; // $v0
	// 		int dead; // $s2
...

{
  ...
  if ((((instance->flags2 & 0x10U) == 0) ||
      (iVar2 = MON_AnimPlaying(instance,(MonsterAnim)
                                        CONCAT412(local_c,CONCAT48(local_10,CONCAT44(local_14,
                                                  local_18)))), iVar2 == 0)) &&
     (*(char *)(puVar6 + 0x56) != '\x06')) {
    if (((instance->flags2 & 0x12U) != 0) && (uVar3 = MON_GetTime(instance), puVar6[0x45] < uVar3))
    {
      MON_PlayAnim(instance,(MonsterAnim)
                            CONCAT412(local_c,CONCAT48(local_10,CONCAT44(local_14,local_18))),0x24);
      MON_TurnOffAllSpheres(instance);
    }
  }
  else {
...

{
  ...
  if ((*(int *)((int)pvVar1 + 4) < 0) &&
     (*(int *)(*(int *)(*(int *)((int)pvVar1 + 0x168) + 0xc) + 4) != 0)) {
    MON_PlayAnim(instance,(MonsterAnim)
                          CONCAT412(in_stack_fffffffc,
    ...
    INSTANCE_Broadcast(instance,*(long *)(*(int *)(*(int *)((int)pvVar1 + 0x168) + 0xc) + 4),
                       0x1000011,Data);
  }
  else {
    MON_PlayAnim(instance,(MonsterAnim)
...
// void /*$ra*/ MON_Notice(struct _Instance *instance /*$s1*/)
 // line 2598, offset 0x8008b798
	/* begin block 1 */
		// Start line: 2599
		// Start offset: 0x8008B798
		// Variables:
	// 		struct _MonsterVars *mv; // $s0
	/* end block 1 */
	// End offset: 0x8008B81C
	// End Line: 2616
...

{
  ...
  if (*(int *)((int)pvVar1 + 0xc4) != 0) {
    *(int *)((int)pvVar1 + 0x120) = *(int *)(*(int *)((int)pvVar1 + 0xc4) + 4) + 0x5c;
    MON_TurnToPosition(instance,(_Position *)(*(int *)(*(int *)((int)pvVar1 + 0xc4) + 4) + 0x5c),
                       *(short *)(*(int *)((int)pvVar1 + 0x168) + 0x1c));
  }
  MON_DefaultQueueHandler(instance);
  return;
}
...
// void /*$ra*/ MON_PupateEntry(struct _Instance *instance /*$a0*/)
 // line 2622, offset 0x8008b838
	/* begin block 1 */
		// Start line: 2623
		// Start offset: 0x8008B838
		// Variables:
	// 		struct _MonsterVars *mv; // $s1
	/* end block 1 */
	// End offset: 0x8008B838
	// End Line: 2623
...

{
  ...
  uVar1 = MON_GetTime(instance);
  uVar2 = rand();
  *(int *)((int)pvVar3 + 0x11c) = uVar1 + (uVar2 & 0xfff) + 2000;
  return;
}
...
// void /*$ra*/ MON_Pupate(struct _Instance *instance /*$s2*/)
 // line 2632, offset 0x8008b898
	/* begin block 1 */
		// Start line: 2633
		// Start offset: 0x8008B898
		// Variables:
	// 		struct _MonsterVars *mv; // $s3

		/* begin block 1.1 */
			// Start line: 2639
			// Start offset: 0x8008B8D8
			// Variables:
		// 		struct _MonsterAttributes *ma; // $s0
		...
		// 		int burst; // $s7
			...
			/* begin block 1.1.1 */
				// Start line: 2657
				// Start offset: 0x8008B958
				// Variables:
			// 		long dist; // $v1
			/* end block 1.1.1 */
			// End offset: 0x8008BA58
			// End Line: 2675
		/* end block 1.1 */
		// End offset: 0x8008BB44
		// End Line: 2712
	/* end block 1 */
	// End offset: 0x8008BBAC
	// End Line: 2728
  ...
  if ((instance->flags & 0x800U) == 0) {
    ...
    if (puVar8[0x31] != 0) {
      MON_TurnToPosition(instance,(_Position *)(*(int *)(puVar8[0x31] + 4) + 0x5c),
                         *(short *)(puVar8[0x5a] + 0x1c));
    }
    if ((instance->flags2 & 0x10U) != 0) {
      MON_ChangeBehavior(instance,(uint)*(byte *)(puVar8 + 0x57));
    }
  }
  else {
    Inst = (_Instance *)0x0;
    ...
    if (Data != -1) {
      instance_00 = (gameTrackerX.instanceList)->first;
      pOVar10 = (Object *)(&objectAccess)[(byte)(&DAT_800cc4d0)[Data]].object;
      while (instance_00 != (_Instance *)0x0) {
        if ((instance_00->object == pOVar10) && ((instance_00->flags & 0x20U) == 0)) {
          ...
          if (lVar3 < *(short *)((int)puVar8 + 0x13a)) {
            lVar3 = MATH3D_LengthXYZ((int)(instance_00->position).x -
...
// void /*$ra*/ MON_EmbraceEntry(struct _Instance *instance /*$s0*/)
 // line 2733, offset 0x8008bbd8
	/* begin block 1 */
		// Start line: 2734
		// Start offset: 0x8008BBD8
		// Variables:
	// 		struct _MonsterVars *mv; // $s1
	/* end block 1 */
	// End offset: 0x8008BBD8
	// End Line: 2734
...

{
  ...
  uVar1 = MON_GetTime(instance);
  *(int *)((int)pvVar2 + 0x114) =
       uVar1 + (int)*(short *)(*(int *)(*(int *)((int)pvVar2 + 0x168) + 8) + 0x1a);
  return;
}
...

{
  ...
  puVar3 = (uint *)instance->extraData;
  uVar4 = puVar3[0x31];
  if ((((uVar4 == 0) || (*(short *)(*(int *)(puVar3[0x5a] + 8) + 0x18) < *(short *)(uVar4 + 0x14)))
      || ((*(uint *)(uVar4 + 0x14) & 0x10200000) != 0x10200000)) ||
     (((*puVar3 & 4) != 0 || (uVar1 = MON_GetTime(instance), puVar3[0x45] < uVar1)))) {
    MON_SwitchState(instance,(MonsterState)CONCAT44(local_14,local_18));
  }
  else {
    ei = *(_Instance **)(uVar4 + 4);
    MON_DoDrainEffects(instance,ei);
    INSTANCE_Post(ei,(int)&PTR_00040006,(int)*(short *)(*(int *)(puVar3[0x5a] + 8) + 0x16) << 8);
    iVar2 = (int)*(short *)(*(int *)(puVar3[0x5a] + 8) + 0x16);
    if (iVar2 < 0) {
      iVar2 = iVar2 + 7;
    }
    INSTANCE_Post(instance,0x1000016,iVar2 >> 3);
    MON_TurnToPosition(instance,&ei->position,*(short *)(puVar3[0x5a] + 0x1c));
  }
  MON_DefaultQueueHandler(instance);
...
// void /*$ra*/ MON_PetrifiedEntry(struct _Instance *instance /*$a0*/)
 // line 2857, offset 0x8008bdb8
	/* begin block 1 */
		// Start line: 2858
		// Start offset: 0x8008BDB8
		// Variables:
	// 		struct _MonsterVars *mv; // $s0
	/* end block 1 */
	// End offset: 0x8008BDB8
	// End Line: 2858
...

{
  ...
  puVar2 = (uint *)instance->extraData;
  uVar1 = MON_GetTime(instance);
  *(undefined **)(puVar2 + 0x45) = &DAT_00001b58 + uVar1;
  *puVar2 = *puVar2 | 0x80;
  return;
}
...
// void /*$ra*/ MON_Petrified(struct _Instance *instance /*$s1*/)
 // line 2865, offset 0x8008bdf4
	/* begin block 1 */
		// Start line: 2866
		// Start offset: 0x8008BDF4
		// Variables:
	// 		struct _MonsterVars *mv; // $s0
	// 		struct __Event *message; // $v0
	// 		int time; // $v1
...
// void /*$ra*/ MONSTER_ProcessClosestVerts(struct _Instance *instance /*$fp*/, struct _SVector *location /*stack 4*/, TDRFuncPtr_MONSTER_ProcessClosestVerts2processVert_cb processVert_cb /*stack 8*/, void *cb_data /*stack 12*/)
 // line 2907, offset 0x8008bf18
	/* begin block 1 */
		// Start line: 2908
		// Start offset: 0x8008BF18
		// Variables:
	// 		int i; // $s2
	...
	// 		long flag; // stack offset -48
		...
		// 		int dist; // $a0
		/* end block 1.1 */
		// End offset: 0x8008C098
		// End Line: 2958
	/* end block 1 */
	// End offset: 0x8008C0B0
	// End Line: 2960
...
// void /*$ra*/ ProcessBloodyMess(struct _Instance *instance /*$a0*/, int vertidx /*$a1*/, int segidx /*$a2*/, int dist /*$a3*/, void *cb_data /*stack 16*/)
 // line 2967, offset 0x8008c0e0
	/* begin block 1 */
		// Start line: 2968
		// Start offset: 0x8008C0E0
		// Variables:
	// 		struct _MonsterVars *mv; // $t0

		/* begin block 1.1 */
			// Start line: 2988
			// Start offset: 0x8008C110
			// Variables:
		// 		long scl; // $a2
		// 		struct CVECTOR *cv; // $a0
		/* end block 1.1 */
		// End offset: 0x8008C1E4
		// End Line: 3014
	/* end block 1 */
	// End offset: 0x8008C1E4
	// End Line: 3015
...

{
  ...
  if (dist < 100) {
    ...
    pCVar2->r = ~(byte)((0xff - (uint)*(byte *)(*(int *)((int)pvVar4 + 0x168) + 0x3f)) * iVar3 >> 8)
    ;
    pCVar2->g = ~(byte)((0xff - (uint)*(byte *)(*(int *)((int)pvVar4 + 0x168) + 0x40)) * iVar3 >> 8)
    ;
    bVar1 = *(byte *)(*(int *)((int)pvVar4 + 0x168) + 0x41);
    pCVar2->cd = '\x01';
...
// void /*$ra*/ MONSTER_InitVertexColors(struct _Instance *instance /*$s1*/, struct _Model *model /*$s0*/)
 // line 3017, offset 0x8008c1ec
	/* begin block 1 */
		// Start line: 3018
		// Start offset: 0x8008C1EC
		// Variables:
	// 		int i; // $s0
	// 		struct CVECTOR *ptr; // $v0
	/* end block 1 */
	// End offset: 0x8008C240
	// End Line: 3027
...
// int /*$ra*/ MONSTER_StartVertexBlood(struct _Instance *instance /*$s2*/, struct _SVector *location /*$s0*/, int amount /*$s4*/)
 // line 3029, offset 0x8008c254
	...
	// 		struct bloodyMessType bmt; // stack offset -88
		...
		/* begin block 1.1 */
			// Start line: 3041
			// Start offset: 0x8008C2B8
			// Variables:
		// 		struct _SVector localloc; // stack offset -64

			/* begin block 1.1.1 */
				// Start line: 3052
				// Start offset: 0x8008C328
				// Variables:
			...
			/* end block 1.1.1 */
			// End offset: 0x8008C328
			// End Line: 3052
		/* end block 1.1 */
		// End offset: 0x8008C3B8
		// End Line: 3075
	/* end block 1 */
	// End offset: 0x8008C3B8
	// End Line: 3079
...
// void /*$ra*/ MONSTER_VertexBlood(struct _Instance *instance /*$s0*/, int vert /*$a1*/, int amount /*$a2*/)
 // line 3081, offset 0x8008c3dc
	/* begin block 1 */
		// Start line: 3082
		// Start offset: 0x8008C3DC
		// Variables:
	// 		int i; // $v1
	// 		struct _Model *model; // $t0
		...
		/* begin block 1.1 */
			// Start line: 3088
			// Start offset: 0x8008C410
			// Variables:
		// 		struct CVECTOR *c; // $a3

			/* begin block 1.1.1 */
				// Start line: 3097
				// Start offset: 0x8008C428
				// Variables:
...

{
  ...
  if ((uint)pCVar6->r < uVar4) {
    if ((uint)pCVar6->r < (uint)pCVar6->b) {
      uVar4 = (uint)pCVar6->r;
      uVar3 = (uint)*(byte *)(*(int *)((int)pvVar1 + 0x168) + 0x3f);
      goto LAB_8008c4a0;
    }
  }
  else {
    if (uVar4 < pCVar6->b) {
      uVar3 = (uint)*(byte *)(*(int *)((int)pvVar1 + 0x168) + 0x40);
      goto LAB_8008c4a0;
    }
  }
  uVar4 = (uint)pCVar6->b;
  uVar3 = (uint)*(byte *)(*(int *)((int)pvVar1 + 0x168) + 0x41);
LAB_8008c4a0:
...
// void /*$ra*/ ProcessBurntMess(struct _Instance *instance /*$a0*/, int vertidx /*$a1*/, int segidx /*$a2*/, int dist /*$a3*/, void *cb_data /*stack 16*/)
 // line 3164, offset 0x8008c5a8
	/* begin block 1 */
		// Start line: 3165
		// Start offset: 0x8008C5A8
		// Variables:
	// 		short scl; // $a2
	// 		struct burntTuneType *burntTune; // $t0
	/* end block 1 */
	// End offset: 0x8008C60C
	// End Line: 3185
...
// int /*$ra*/ MONSTER_StartVertexBurnt(struct _Instance *instance /*$s2*/, struct _SVector *location /*$s4*/, struct burntTuneType *burntTune /*$s0*/)
 // line 3195, offset 0x8008c654
	...
	// 		struct burntMessType bmt; // stack offset -80
		...
		/* begin block 1.1 */
			// Start line: 3206
			// Start offset: 0x8008C6B8
			// Variables:
		// 		struct _SVector localloc; // stack offset -64

			/* begin block 1.1.1 */
				// Start line: 3216
				// Start offset: 0x8008C728
				// Variables:
			// 		struct _MVertex *vertexList; // $s1
			// 		struct _Vector locVec; // stack offset -56
			// 		long flag; // stack offset -40
			// 		struct MATRIX *segMatrix; // $s0
			/* end block 1.1.1 */
			// End offset: 0x8008C728
			// End Line: 3216
		/* end block 1.1 */
		// End offset: 0x8008C7B0
		// End Line: 3237
	/* end block 1 */
	// End offset: 0x8008C7B0
	// End Line: 3240
...
// void /*$ra*/ MONSTER_VertexBurnt(struct _Instance *instance /*$a0*/, struct burntTuneType *burntTune /*$a1*/)
 // line 3242, offset 0x8008c7d4
	/* begin block 1 */
		// Start line: 3244
		// Start offset: 0x8008C7D4
		// Variables:
	// 		int i; // $a3
	// 		int fade; // $a2
	// 		struct _Model *model; // $t0
		...
		/* begin block 1.1 */
			// Start line: 3253
			// Start offset: 0x8008C80C
			// Variables:
		// 		struct CVECTOR *c; // $v1
		/* end block 1.1 */
		// End offset: 0x8008C860
		// End Line: 3262
	/* end block 1 */
	// End offset: 0x8008C878
	// End Line: 3265
...
// void /*$ra*/ MON_DamageEffect(struct _Instance *instance /*$s2*/, struct evFXHitData *data /*$s0*/)
 // line 3272, offset 0x8008c880
	/* begin block 1 */
		// Start line: 3273
		// Start offset: 0x8008C880
		// Variables:
	...
	// 		struct _MonsterVars *mv; // $s4
		...
		/* begin block 1.1 */
			// Start line: 3289
			// Start offset: 0x8008C8DC
			// Variables:
		// 		struct _MonsterAttributes *ma; // $s3

			/* begin block 1.1.1 */
				// Start line: 3293
				// Start offset: 0x8008C8FC
				// Variables:
			...
			/* end block 1.1.1 */
			// End offset: 0x8008C9D8
			// End Line: 3308

			/* begin block 1.1.2 */
				// Start line: 3312
				// Start offset: 0x8008C9F0
				// Variables:
			...
			/* begin block 1.1.3 */
				// Start line: 3325
				// Start offset: 0x8008CA64
				// Variables:
			// 		struct Object *flame; // $v0

				/* begin block 1.1.3.1 */
					// Start line: 3332
					// Start offset: 0x8008CA74
					// Variables:
				// 		struct _Model *model; // $s0
				/* end block 1.1.3.1 */
				// End offset: 0x8008CACC
				// End Line: 3338
			/* end block 1.1.3 */
			// End offset: 0x8008CAD8
			// End Line: 3340

			/* begin block 1.1.4 */
				// Start line: 3345
				// Start offset: 0x8008CB18
				// Variables:
			// 		struct MATRIX *mat; // $s0
			...
			// 		int cnt; // $s4
			/* end block 1.1.4 */
			// End offset: 0x8008CC18
			// End Line: 3364
		/* end block 1.1 */
		// End offset: 0x8008CC18
		// End Line: 3365
	/* end block 1 */
	// End offset: 0x8008CCC0
	// End Line: 3387
...
/* WARNING: Removing unreachable block (ram,0x8008ca74) */
...

{
  ...
  if (data == (evFXHitData *)0x0) {
    ...
    if ((*puVar5 & 0x800010) == 0x800010) {
      pMVar3 = instance->matrix + *(byte *)((int)pvVar4 + 0x18);
      memset(&_Stack64,0,8);
    ...
    local_28.x = 0;
    local_28.z = 0;
    iVar6 = instance->object->modelList[instance->currentModel]->numSegments;
    amount = 1;
    if (iVar6 < 2) {
      return;
    }
  ...
  if (data->type == 0x20) {
    location = data;
    if (data->amount == 0) goto LAB_8008cc50;
  }
  else {
    if (data->type != 0x10) {
      amount = MONSTER_CalcDamageIntensity
                         ((int)*(short *)(puVar5 + 0x51),(int)*(short *)((int)puVar5 + 0x146));
      amount = MONSTER_StartVertexBlood(instance,(_SVector *)data,amount);
      *(short *)(puVar5 + 0x53) = (short)amount;
      goto LAB_8008cc90;
    }
LAB_8008cc50:
...
// void /*$ra*/ MON_DefaultInit(struct _Instance *instance /*$s2*/)
 // line 3392, offset 0x8008cce4
	/* begin block 1 */
		// Start line: 3393
		// Start offset: 0x8008CCE4
		// Variables:
	// 		struct _MonsterAttributes *ma; // $s1
	// 		struct _MonsterVars *mv; // $s3
	...
	// 		int state; // $a1
		...
		/* begin block 1.1 */
			// Start line: 3440
			// Start offset: 0x8008CE40
			// Variables:
		// 		struct Level *level; // $s0
		/* end block 1.1 */
		// End offset: 0x8008CEA8
		// End Line: 3448
	/* end block 1 */
	// End offset: 0x8008CF0C
	// End Line: 3466
...

{
  ...
  *puVar10 = uVar4;
  ...
  if (((((instance->flags & 2U) == 0) && (cVar2 = *(char *)((int)puVar10 + 0x15a), cVar2 != '\x04'))
      && (cVar2 != '\x10')) && (cVar2 == '\r')) {
    *(undefined2 *)(puVar10 + 0x55) = 0;
  }
  MON_SwitchState(instance,(MonsterState)CONCAT44(local_14,local_18));
  return;
}
...
// void /*$ra*/ MON_CleanUp(struct _Instance *instance /*$s2*/)
 // line 3472, offset 0x8008cf30
	/* begin block 1 */
		// Start line: 3473
		// Start offset: 0x8008CF30
		// Variables:
	// 		struct _MonsterVars *mv; // $s0
	// 		struct _MonsterAttributes *ma; // $s1
	/* end block 1 */
...

{
  ...
  if ((*(char *)((int)pvVar3 + 0x158) == '\x03') && (*(ulong *)((int)pvVar3 + 0xdc) != 0)) {
    SndEndLoop(*(ulong *)((int)pvVar3 + 0xdc));
    *(undefined4 *)((int)pvVar3 + 0xdc) = 0;
  }
  if ((int)*(char *)((int)pvVar3 + 0x166) != -1) {
    ENMYPLAN_ReleasePlanningWorkspace((int)*(char *)((int)pvVar3 + 0x166));
  }
