  ...
  if (*(int *)(param_1 + 0x40) != 0) {
    ...
    *(int *)(param_1 + 0x120) =
         -((int)*(short *)(param_1 + 0x118) * (int)sStack56 +
           ...
           (int)*(short *)(param_1 + 0x11c) * (int)sStack52 >> 0xc);
  }
  return;
}
...

{
  ...
  puVar1 = (uint *)param_1->extraData;
  instance_00 = (_Instance *)0x0;
  introUniqueID = puVar1[0x36];
  if (introUniqueID == 0) {
    if ((*puVar1 & 0x200) != 0) {
                    /* WARNING: Subroutine does not return */
      MON_GetTime(param_1);
    ...
    if (instance_00 == (_Instance *)0x0) {
      ...
      if (*(int *)((int)instance_00->extraData + 0xd8) == 0) {
        *(long *)((int)instance_00->extraData + 0xd8) = param_1->introUniqueID;
      }
    }
  }
  if (*(char *)(puVar1 + 0x51) == '\x06') {
    MON_KillMonster(param_1);
  }
  else {
    if (((byte)(*(char *)(puVar1 + 0x51) - 1U) < 3) && (param_1->perVertexColor == (CVECTOR *)0x0))
    {
                    /* WARNING: Subroutine does not return */
      MEMPACK_Malloc(param_1->object->modelList[param_1->currentModel]->numVertices << 2,'!');
    }
    if ((*(char *)(puVar1 + 0x51) == '\0') && (puVar1[0x34] == 0)) {
      ...
      if (puVar1[0x35] == 0) {
        ...
        instance_00 = INSTANCE_Find(puVar1[0x35]);
      }
      if (instance_00 != (_Instance *)0x0) {
        Data = CheckPhysObFamily(instance_00,3);
        if (Data == 0) {
          Data = SetPhysicsSwimData(0,(_SVector *)0x0,0,(int)param_1,3);
          Message = 0x800002;
        }
        else {
  ...
  introUniqueID = *puVar1 & 0x400;
  if (introUniqueID != 0) {
    MON_ApplyPhysics(param_1);
    if (introUniqueID == 0) {
      introUniqueID = *puVar1 & 0xfffffffd;
    }
    else {
      introUniqueID = *puVar1 | 2;
    }
    *puVar1 = introUniqueID;
  }
  if ((*puVar1 & 2) == 0) {
...

{
  ...
  (instance->rotation).z = *(short *)(*(int *)(*(int *)((int)pvVar1 + 0xc4) + 4) + 0x78) + 0x800;
                    /* WARNING: Subroutine does not return */
  DeMessageQueue((__MessageQueue *)((int)pvVar1 + 8));
}
...

{
  ...
  if (iVar1 == 0) {
    FUN_80088cf4(instance);
    return;
  }
  iVar1 = G2EmulationInstanceQueryFrame(instance,0);
  instance_00 = (_Instance *)G2EmulationInstanceQueryLastFrame(instance,0);
  if (((int)(uint)*(byte *)((int)pvVar3 + 0x26) <= (int)instance_00) ||
     (iVar1 < (int)(uint)*(byte *)((int)pvVar3 + 0x26))) {
    if ((int)(uint)*(byte *)((int)pvVar3 + 0x27) <= (int)instance_00) {
      FUN_80088cf4(instance_00);
      return;
    }
  ...
  iVar1 = MON_AnimPlaying(instance,(MonsterAnim)
                                   CONCAT412(local_14,CONCAT48(local_18,in_stack_ffffffe0)));
  if ((iVar1 != 0) &&
     (iVar1 = **(int **)((int)pvVar2 + 0x154), *(char *)(iVar1 + 0xd) != *(char *)(iVar1 + 0x16))) {
                    /* WARNING: Subroutine does not return */
    MON_GetTime(instance);
  }
                    /* WARNING: Subroutine does not return */
...

{
  ...
  *(uint *)instance->extraData = *(uint *)instance->extraData & 0xffffffef | 0x200000;
  MON_TurnOffAllSpheres(instance);
  MON_DropAllObjects(instance);
                    /* WARNING: Subroutine does not return */
  FX_BloodCone(instance,(ushort)*(byte *)((int)pvVar1 + 0x25),0x50);
}
...

{
  ...
  if ((*puVar2 & 0x200) == 0) {
    ...
    if ((instance->flags2 & 0x10U) != 0) {
      ...
      *puVar2 = *puVar2 | 0x200;
      ...
      if ((puVar2[0x36] == 0) && (*(short *)(puVar2 + 0x4d) != 0)) {
        MON_BirthSoul(instance,1);
      }
    }
    return;
  ...
  if ((*puVar2 & 0x400000) == 0) {
    MON_TerrainImpaleDeath(instance_00);
    return;
  }
                    /* WARNING: Subroutine does not return */
  MON_GetTime(instance);
    ...
    if ((sVar1 == 0x40) || (sVar1 == 0x2000)) {
      ...
      if (sVar1 == 0x10) {
        ...
        mode = 5;
                    ...
                    /* WARNING: Subroutine does not return */
    MON_PlayAnim(instance,(MonsterAnim)
                          CONCAT412(unaff_retaddr,CONCAT48(unaff_s2,CONCAT44(unaff_s1,unaff_s0))),
                 mode);
  }
...

{
  ...
  puVar1 = (uint *)instance->extraData;
  target = (_MonsterIR *)puVar1[0x31];
  if (((target != (_MonsterIR *)0x0) && ((*puVar1 & 4) == 0)) &&
     (((*puVar1 & 0x10000000) == 0 || ((target->mirFlags & 0x1000) == 0)))) {
    ...
    *(_Position **)(puVar1 + 0x43) = &target->instance->position;
    reason = MON_ShouldIFlee(instance);
    if ((reason == 0) &&
       ((target->distance < *(short *)(iVar2 + 10) || (*(char *)((int)puVar1 + 0x146) == '\n')))) {
      ...
      if (reason == 0) {
        if ((*puVar1 & 0x40000000) == 0) {
          ...
          reason = MON_ShouldIFireAtTarget(instance,target);
          if (reason == 1) {
                    /* WARNING: Subroutine does not return */
            MON_SwitchState(instance,(MonsterState)CONCAT44(local_14,local_18));
          }
        ...
        if (reason != 0) {
          ...
          MON_PlayAnim(instance,(MonsterAnim)
                    ...
                    /* WARNING: Subroutine does not return */
      MON_TurnToPosition(instance,&target->instance->position,*(short *)(puVar1[0x55] + 0x1c));
    }
  }
                    /* WARNING: Subroutine does not return */
  MON_SwitchState(instance,(MonsterState)CONCAT44(local_14,local_18));
...

{
  ...
  MON_PlayAnimFromList
            (instance,(char *)(*(int *)((int)instance->data + 0x3c) +
                               (int)*(char *)(*(int *)(*(int *)((int)instance->extraData + 0x154) +
                                                      8) + 0x1e) * 0x10 + 0xe),0,1);
}
  ...
  if ((*puVar3 & 4) == 0) {
    ...
    if (((puVar3[1] & 0x10000000) != 0) &&
       (AngleMoveToward(&(instance->rotation).z,*(short *)((int)puVar3 + 0x116),
                        (short)((uint)(*(short *)(puVar3[0x55] + 0x1c) * theCamera.tiltList[0][0] *
                                      0x10) >> 0x10)),
...
switchD_8008a980_caseD_3:
  ...
  case 4:
    ...
    if (uVar5 < 3) {
      if (uVar5 != 1) goto LAB_8008a9f0;
      goto switchD_8008a980_caseD_3;
    }
    if (uVar5 != 3) goto LAB_8008a9f0;
  }
  MON_GetPlanSlot(mv);
LAB_8008a9f0:
  if (iVar6 == -1) {
...

{
  ...
  p_Var1 = FX_DoInstanceTwoSegmentGlow
                     (param_1,(uint)*(byte *)((int)pvVar4 + 0x1d),
  ...
  p_Var1->fadeout_time = sVar5;
  p_Var1 = FX_DoInstanceTwoSegmentGlow
                     (param_1,(uint)*(byte *)((int)pvVar4 + 0x1b),
                      (uint)*(byte *)((int)pvVar4 + 0x23),local_res4,1,0x400,0x80);
  p_Var1->lifeTime = sVar2;
  p_Var1->fadein_time = sVar3;
  p_Var1->fadeout_time = sVar5;
  p_Var1 = FX_DoInstanceTwoSegmentGlow
                     (param_1,(uint)*(byte *)((int)pvVar4 + 0x1c),
                      (uint)*(byte *)((int)pvVar4 + 0x24),local_res4,1,0x400,0x80);
  p_Var1->lifeTime = sVar2;
  p_Var1->fadein_time = sVar3;
  p_Var1->fadeout_time = sVar5;
  p_Var1 = FX_DoInstanceTwoSegmentGlow
                     (param_1,(uint)*(byte *)((int)pvVar4 + 0x19),
...
LAB_8008b270:
  ...
  if (uVar1 < 0x21) {
    ...
    if (uVar1 == 0x40) goto LAB_8008b270;
    if (uVar1 == 0x400) {
                    /* WARNING: Subroutine does not return */
      MON_PlayAnim(instance,(MonsterAnim)
                            CONCAT412(local_c,CONCAT48(local_10,CONCAT44(in_stack_ffffffec,local_18)
...

{
  ...
  if ((*puVar4 & 2) == 0) {
    MON_MoveForward(instance);
                    ...
                    /* WARNING: Subroutine does not return */
  DeMessageQueue((__MessageQueue *)(puVar4 + 2));
}
...

{
  ...
  if ((instance->flags & 0x800U) == 0) {
    ...
    if (iVar3 != -1) {
      iVar5 = *(int *)(theCamera.core.vvNormalWorVecMat[1].t[2] + 4);
      iVar7 = (&objectAccess.lower)[(uint)*(byte *)((int)&SHORT_800ca9ec + iVar3) * 2];
      while (iVar5 != 0) {
        if ((*(int *)(iVar5 + 0x1c) == iVar7) && ((*(uint *)(iVar5 + 0x14) & 0x20) == 0)) {
    ...
    if (instance->currentMainState == 0x1a) {
      if (iVar7 == 0) {
        iVar7 = MON_ShouldIAmbushEnemy(instance);
        if (iVar7 != 0) {
                    /* WARNING: Subroutine does not return */
          MON_PlayAnim(instance,(MonsterAnim)
                                CONCAT412(local_24,CONCAT48(local_28,in_stack_ffffffd0)),0x1c);
        }
      }
      else {
...

{
  ...
  uVar2 = puVar1[0x31];
  if (uVar2 == 0) {
    MONSTER_StartVertexBurnt(instance,(_SVector *)&DAT_00000002,in_a2);
    return;
  }
  if (((*(short *)(uVar2 + 0x14) <= *(short *)(*(int *)(puVar1[0x55] + 8) + 0x18)) &&
      ((*(uint *)(uVar2 + 0x14) & 0x10200000) == 0x10200000)) && ((*puVar1 & 4) == 0)) {
                    /* WARNING: Subroutine does not return */
    MON_GetTime(instance);
  }
                    /* WARNING: Subroutine does not return */
...

{
  ...
  if (1 < p_Var1->numSegments) {
    if (p_Var1->segmentList[1].lastVertex != -1) {
      PIPE3D_InvertTransform((MATRIX *)(_Instance *)auStack80,instance->matrix + 1);
      SetRotMatrix((undefined4 *)(_Instance *)auStack80);
                    /* WARNING: Subroutine does not return */
      SetTransMatrix((int)(_Instance *)auStack80);
    }
    if (2 < p_Var1->numSegments) {
      MON_DamageEffect((_Instance *)auStack80,(evFXHitData *)location);
      return;
    }
  }
  return;
...

{
  ...
  if (address == (char *)0x0) {
    MONSTER_VertexBlood((_Instance *)0x0,param_2,param_3);
    return;
  }
  pbVar3 = (byte *)(address + param_2 * 4);
  if (param_3 == 0) {
                    /* WARNING: Subroutine does not return */
...
LAB_8008c2e4:
  instance = (_Instance *)((int)((0x100 - param_3) * (0xff - uVar2)) >> 8);
  if (pbVar3[3] != 1) {
    MONSTER_VertexBlood(instance,vert,param_3);
    return;
  }
  if ((int)instance <= (int)vert) {
    MONSTER_VertexBlood(instance,vert,param_3);
    return;
  }
  iVar1 = **(int **)((int)*(short *)(param_1 + 0x10a) * 4 + *(int *)(*(int *)(param_1 + 0x1c) + 0xc)
                    );
  puVar4 = *(uint **)(param_1 + 0x264);
  if (iVar1 == 0) {
    MONSTER_VertexBlood(instance,vert,param_3);
    return;
  }
  pbVar3 = (byte *)((int)puVar4 + 3);
  do {
    if (*pbVar3 == 1) {
      if ((uint)*(byte *)puVar4 + 8 < 0x100) {
        *(byte *)puVar4 = (byte)((uint)*(byte *)puVar4 + 8);
      }
      else {
        *(byte *)puVar4 = 0xff;
      }
      if ((uint)pbVar3[-2] + 8 < 0x100) {
        pbVar3[-2] = (byte)((uint)pbVar3[-2] + 8);
      }
      else {
        pbVar3[-2] = 0xff;
      }
      if ((uint)pbVar3[-1] + 8 < 0x100) {
        pbVar3[-1] = (byte)((uint)pbVar3[-1] + 8);
      }
      else {
        pbVar3[-1] = 0xff;
      }
      if ((*puVar4 & 0xffffff) == 0xffffff) {
        *pbVar3 = 0;
      }
    }
    iVar1 = iVar1 + -1;
...

{
  ...
  local_68 = default_lightgroup.colorMatrix.t[2];
    ...
    if ((*puVar2 & 0x800010) != 0x800010) {
      if ((*puVar2 & 0x400000) != 0) {
        if (DebugMenuLine_800c87c4.text != (char *)0x0) {
          model = (_Model *)(*(_Model **)(DebugMenuLine_800c87c4.text + 0xc))->numVertices;
        ...
        MONSTER_VertexBurnt(instance,(burntTuneType *)default_lightgroup.colorMatrix.t);
      }
      if ((*(char *)(puVar2 + 0x51) == '\x03') && ((*(uint *)((int)pvVar1 + 0x10) & 2) != 0)) {
                    /* WARNING: Subroutine does not return */
        MON_GetTime(instance);
      }
      return;
  ...
  if (data->type == 0x20) {
    if (data->amount != 0) goto LAB_8008ca9c;
  }
  else {
    if (data->type != 0x10) {
      amount = MONSTER_CalcDamageIntensity
                         ((int)*(short *)(puVar2 + 0x4c),(int)*(short *)((int)puVar2 + 0x132));
  ...
  data = (evFXHitData *)&instance->position;
LAB_8008ca9c:
  MONSTER_StartVertexBurnt
            (instance,(_SVector *)data,(burntTuneType *)default_lightgroup.colorMatrix.t);
  SKINNER_PursueEntry(instance);
  return;
}
...

{
  ...
  uVar3 = *puVar8 & 0x1000000;
  if (uVar3 != 0) {
    MONAPI_CheckGenerator(instance);
  }
  MON_ApplyPhysics(instance);
  if (uVar3 == 0) {
    uVar3 = *puVar8 & 0xfffffffd;
  }
  else {
    uVar3 = *puVar8 | 2;
  }
  *puVar8 = uVar3;
  ...
  if ((instance->object->oflags & 0x80000U) == 0) {
                    /* WARNING: Subroutine does not return */
    STREAM_GetLevelWithID(*(long *)(_CHAR_00h_800cff98 + 0x38));
  }
  if (((((instance->flags & 2U) == 0) && (cVar2 = *(char *)((int)puVar8 + 0x146), cVar2 != '\x04'))
      && (cVar2 != '\x10')) && (cVar2 == '\r')) {
