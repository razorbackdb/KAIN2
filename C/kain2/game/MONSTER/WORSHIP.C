...
// void /*$ra*/ WORSHIP_Init(struct _Instance *instance /*$s2*/)
 // line 47, offset 0x8008ef48
	/* begin block 1 */
		// Start line: 48
		// Start offset: 0x8008EF48
		// Variables:
	// 		struct _MonsterAttributes *ma; // $s0
	// 		struct _MonsterVars *mv; // $s1
	// 		struct _Instance *weapon; // $v0
	/* end block 1 */
	// End offset: 0x8008EFD0
	// End Line: 68
...

{
  ...
  *(undefined2 *)((int)pvVar5 + 0x148) = uVar2;
  return;
}
...
// void /*$ra*/ WORSHIP_CombatEntry(struct _Instance *instance /*$s3*/)
 // line 73, offset 0x8008efe8
	/* begin block 1 */
		// Start line: 74
		// Start offset: 0x8008EFE8
		// Variables:
	// 		struct _MonsterVars *mv; // $s1

		/* begin block 1.1 */
			// Start line: 79
			// Start offset: 0x8008F050
			// Variables:
		// 		struct _MonsterAttributes *ma; // $s2

			/* begin block 1.1.1 */
				// Start line: 83
				// Start offset: 0x8008F060
			/* end block 1.1.1 */
			// End offset: 0x8008F084
			// End Line: 89
		/* end block 1.1 */
		// End offset: 0x8008F0C4
		// End Line: 100
	/* end block 1 */
	// End offset: 0x8008F0C4
	// End Line: 102
...

{
  ...
  if (((puVar1[0x31] != 0) &&
      (*(short *)(puVar1[0x31] + 0x14) < *(short *)(*(int *)(puVar1[0x5a] + 8) + 10))) &&
     (*(char *)((int)puVar1 + 0x15e) == '\x01')) {
    ...
    if (instance_00 == (_Instance *)0x0) {
      ...
      if ((instance_00->LinkSibling != (_Instance *)0x0) ||
         (instance_00->ParentLinkNode != (uint)*(byte *)((int)pvVar2 + 0x24))) goto LAB_8008f0c4;
