...
// void /*$ra*/ OBTABLE_InstanceInit(struct _Instance *instance /*$s0*/)
 // line 88, offset 0x8003dfb8
	/* begin block 1 */
		// Start line: 89
		// Start offset: 0x8003DFB8
		// Variables:
	// 		long id; // $a0
	/* end block 1 */
	// End offset: 0x8003E08C
	// End Line: 126
...
// void /*$ra*/ OBTABLE_GetInstanceCollideFunc(struct _Instance *instance /*$a0*/)
 // line 144, offset 0x8003e09c
	/* begin block 1 */
		// Start line: 146
		// Start offset: 0x8003E09C
		// Variables:
	// 		long id; // $a1
	/* end block 1 */
	// End offset: 0x8003E0DC
	// End Line: 159
...
// void /*$ra*/ OBTABLE_GetInstanceProcessFunc(struct _Instance *instance /*$a0*/)
 // line 206, offset 0x8003e124
	/* begin block 1 */
		// Start line: 208
		// Start offset: 0x8003E124
		// Variables:
	// 		long id; // $a1
	/* end block 1 */
	// End offset: 0x8003E164
	// End Line: 220
...
// void /*$ra*/ OBTABLE_GetInstanceQueryFunc(struct _Instance *instance /*$a0*/)
 // line 236, offset 0x8003e16c
	/* begin block 1 */
		// Start line: 238
		// Start offset: 0x8003E16C
		// Variables:
	// 		long id; // $a1
	/* end block 1 */
	// End offset: 0x8003E1AC
	// End Line: 250
...
// void /*$ra*/ OBTABLE_GetInstanceMessageFunc(struct _Instance *instance /*$a0*/)
 // line 266, offset 0x8003e1b4
	/* begin block 1 */
		// Start line: 268
		// Start offset: 0x8003E1B4
		// Variables:
	// 		long id; // $a1
	/* end block 1 */
	// End offset: 0x8003E1F4
	// End Line: 280
...
// void /*$ra*/ OBTABLE_InitObjectWithID(struct Object *object /*$s2*/)
 // line 283, offset 0x8003e1fc
	/* begin block 1 */
		// Start line: 284
		// Start offset: 0x8003E1FC
		// Variables:
	// 		long id; // $s1

		/* begin block 1.1 */
			// Start line: 289
			// Start offset: 0x8003E21C
			// Variables:
		// 		struct ObjectAccess *oa; // $a0
		/* end block 1.1 */
		// End offset: 0x8003E3B8
		// End Line: 349
	/* end block 1 */
	// End offset: 0x8003E3B8
	// End Line: 350
...
// void /*$ra*/ OBTABLE_ClearObjectReferences()
 // line 372, offset 0x8003e3d4
	/* begin block 1 */
		// Start line: 374
		// Start offset: 0x8003E3D4
		// Variables:
	// 		struct ObjectAccess *oa; // $a0
	/* end block 1 */
	// End offset: 0x8003E400
	// End Line: 378
...
// void /*$ra*/ OBTABLE_RemoveObjectEntry(struct Object *object /*$a0*/)
 // line 380, offset 0x8003e408
	/* begin block 1 */
		// Start line: 382
		// Start offset: 0x8003E408
		// Variables:
	// 		struct ObjectAccess *oa; // $a1
	/* end block 1 */
	// End offset: 0x8003E448
	// End Line: 392
...
// struct Object * /*$ra*/ OBTABLE_FindObject(char *objectName /*$s3*/)
 // line 394, offset 0x8003e450
	/* begin block 1 */
		// Start line: 395
		// Start offset: 0x8003E450
		// Variables:
	// 		struct Object *object; // $s0
	// 		struct _ObjectTracker *otr; // $v0
	// 		int i; // $s2
	/* end block 1 */
	// End offset: 0x8003E4E0
	// End Line: 412
...
// void /*$ra*/ OBTABLE_ChangeObjectAccessPointers(struct Object *oldObject /*$a0*/, struct Object *newObject /*$a1*/)
 // line 414, offset 0x8003e4fc
	/* begin block 1 */
		// Start line: 416
		// Start offset: 0x8003E4FC
		// Variables:
	// 		struct ObjectAccess *oa; // $a2
	/* end block 1 */
	// End offset: 0x8003E53C
	// End Line: 426
...
// void /*$ra*/ OBTABLE_RelocateObjectTune(struct Object *object /*$a0*/, long offset /*$a1*/)
 // line 428, offset 0x8003e544
	/* begin block 1 */
		// Start line: 429
		// Start offset: 0x8003E544
		// Variables:
	// 		long id; // $a2

		/* begin block 1.1 */
			// Start line: 442
			// Start offset: 0x8003E590
		/* end block 1.1 */
...
// void /*$ra*/ OBTABLE_InitAnimPointers(struct _ObjectTracker *objectTracker /*$s5*/)
 // line 461, offset 0x8003e604
	/* begin block 1 */
		// Start line: 462
		// Start offset: 0x8003E604
		// Variables:
	// 		struct Object *object; // $s3
		...
		// 		struct _G2AnimKeylist_Type **keyPtr; // $s1
			...
			// 		struct _ObjectOwnerInfo *oi; // $s0
				...
				// 		int objectIndex; // $a0
				/* end block 1.1.1.1 */
				// End offset: 0x8003E73C
				// End Line: 504
			/* end block 1.1.1 */
			// End offset: 0x8003E73C
			// End Line: 505
		/* end block 1.1 */
		// End offset: 0x8003E760
		// End Line: 514
	/* end block 1 */
