...
// char @0x800CED84, len = 0x00000001
midiDataByteCount = 0x02;
	...
	if ((((int)(uint)slot->channelMute >> uVar12 & 1U) == 0) && (*(char *)(iVar7 + 0x590) != -1))
	{
		...
		if (event->dataByte[1] == '\0')
		{
			...
			do
			{
				...
				if ((((uint) * (byte *)(puVar8 + 2) == ((uint)slot->slotID | uVar12)) &&
				...
				if (uVar10 < uVar10 + (uint)progAtr->numTones)
				{
					...
					do
					{
							...
							(voice = aadAllocateVoice((uint)toneAtr->priority), voice != (AadSynthVoice *)0x0))
						{
							...
							{
								aadPlayTonePitchBend(toneAtr, *(ulong *)(aadMem->dynamicWaveAddr[(uint)bVar2] + (int)toneAtr->waveIndex * 4), progAtr, local_38,
													 (uint)(byte)event->dataByte[1], (uint) * (byte *)(iVar7 + 0x5a0),
													 (uint) * (byte *)(iVar7 + 0x5b0), (uint)slot->slotVolume, *slot->masterVolPtr, voice, (uint) * (ushort *)(puVar5 + 0x15c));
								voice->handle = 0;
							}
...

{
	...
	do
	{
		...
		if ((uint) * (byte *)(iVar6 + 8) == ((uint)slot->slotID | channel))
		{
			...
			iVar2 = iVar2 * iVar2 + -1;
			local_28 = (short)((uint)((int)local_28 * iVar2) >> 0xe);
			local_26 = (short)((uint)((int)local_26 * iVar2) >> 0xe);
			if ((aadMem->flags & 1U) == 0)
			{
			...
			iVar4 = iVar4 * iVar4 + -1;
			SpuSetVoiceVolume(iVar8, (int)(short)((uint)((int)(short)((uint)((int)(short)((uint)((int)(short)((uint)((int)local_28 * iVar5) >> 0xe) * iVar2) >> 0xe) * iVar3) >> 0xe) * iVar4) >> 0xe),
							  (int)(short)((uint)((int)(short)((uint)((int)(short)((uint)((int)(short)((
																										   uint)((int)local_26 * iVar5) >>
																									   0xe) *
																						  iVar2) >>
																				   0xe) *
																	  iVar3) >>
...

{
	...
	do
	{
		...
		if (((uint) * (byte *)(iVar3 + 8) & 0xf0) == (uint)slot->slotID)
		{
			...
			iVar4 = *slot->masterVolPtr + 1;
			iVar4 = iVar4 * iVar4 + -1;
			SpuSetVoiceVolume(iVar7, (int)(short)((uint)((int)(short)((uint)((int)(short)((uint)((int)(short)((uint)((int)local_18 * iVar5) >> 0xe) * iVar3) >> 0xe) * iVar2) >> 0xe) * iVar4) >> 0xe),
							  (int)(short)((uint)((int)(short)((uint)((int)(short)((uint)((int)(short)((
																										   uint)((int)local_16 * iVar5) >>
																									   0xe) *
																						  iVar3) >>
																				   0xe) *
																	  iVar2) >>
	...
	do
	{
		...
		if ((uint) * (byte *)(iVar1 + 8) == ((uint)slot->slotID | channel))
		{
			...
			if (*(byte *)(iVar3 + 9) != 0)
			{
				...
				SpuSetVoicePitch(iVar4, sVar2 + (short)(((int)(&aadStepsPerSemitone)[iVar1] * (iVar6 % iVar7)) / iVar7));
			}
		}
		iVar4 = iVar4 + 1;
		iVar5 = iVar5 + 0x1c;
...
{
	if (aadMem->controller11Callback != (_func_77 *)0x0)
	{
		(*aadMem->controller11Callback)(aadMem->controller11CallbackData, (uint)slot->thisSlotNumber,
