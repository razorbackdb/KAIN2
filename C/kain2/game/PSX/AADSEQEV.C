				...
				if (uVar10 < uVar10 + progAtr->numTones)
				{
					...
					do
					{
							...
							(voice = aadAllocateVoice((uint)toneAtr->priority), voice != (AadSynthVoice *)0x0))
						{
							...
							{
								aadPlayTone(toneAtr, *(ulong *)(aadMem->dynamicWaveAddr[bVar2] + (int)toneAtr->waveIndex * 4), progAtr, local_38,
							...
							{
								aadPlayTonePitchBend(toneAtr, *(ulong *)(aadMem->dynamicWaveAddr[bVar2] + (int)toneAtr->waveIndex * 4), progAtr, local_38,
													 (uint)(byte)event->dataByte[1], (uint) * (byte *)(iVar7 + 0x5a0),
...

{
	...
	do
	{
		...
		if ((uint) * (byte *)(iVar6 + 8) == ((uint)slot->slotID | channel))
		{
			...
			iVar4 = iVar4 * iVar4 + -1;
			SpuSetVoiceVolume(iVar8, (int)(short)((uint)((short)((uint)((short)((uint)((short)((uint)(local_28 * iVar5) >> 0xe) * iVar2) >> 0xe) * iVar3) >> 0xe) * iVar4) >> 0xe),
...

{
	...
	do
	{
		...
		if (((uint) * (byte *)(iVar3 + 8) & 0xf0) == (uint)slot->slotID)
		{
			...
			iVar4 = *slot->masterVolPtr + 1;
			iVar4 = iVar4 * iVar4 + -1;
			SpuSetVoiceVolume(iVar7, (int)(short)((uint)((short)((uint)((short)((uint)((short)((uint)(local_18 * iVar5) >> 0xe) * iVar3) >> 0xe) * iVar2) >> 0xe) * iVar4) >> 0xe),
