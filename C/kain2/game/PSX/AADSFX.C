...
// int /*$ra*/ aadIsSfxPlaying(unsigned long handle /*$a0*/)
 // line 53, offset 0x80056fc8
	/* begin block 1 */
		// Start line: 55
		// Start offset: 0x80056FC8
		// Variables:
...
// int /*$ra*/ aadIsSfxTypePlayingOrRequested(unsigned int sfxToneID /*$s0*/)
 // line 111, offset 0x80057164
	/* begin block 1 */
		// Start line: 112
		// Start offset: 0x80057164
		// Variables:
	// 		int commandOut; // $a1
	// 		int i; // $a2
	// 		struct AadSfxCommand *sfxCmd; // $v1
	/* end block 1 */
	// End offset: 0x8005720C
	// End Line: 129
...
// void /*$ra*/ aadPutSfxCommand(int statusByte /*$s0*/, int dataByte0 /*$s2*/, int dataByte1 /*$s3*/, unsigned long ulongParam /*$s4*/, int shortParam /*stack 16*/)
 // line 177, offset 0x800572a8
	/* begin block 1 */
		// Start line: 178
		// Start offset: 0x800572A8
		// Variables:
	// 		struct AadSfxCommand *sfxCmd; // $v1
	/* end block 1 */
	// End offset: 0x8005737C
	// End Line: 209
...
// void /*$ra*/ sfxCmdPlayTone(struct AadSfxCommand *sfxCmd /*$s4*/)
 // line 248, offset 0x800573e8
	/* begin block 1 */
		// Start line: 249
		// Start offset: 0x800573E8
		// Variables:
...
// void /*$ra*/ sfxCmdStopTone(struct AadSfxCommand *sfxCmd /*$a0*/)
 // line 344, offset 0x80057554
	/* begin block 1 */
		// Start line: 346
		// Start offset: 0x80057554
		// Variables:
...
// void /*$ra*/ sfxCmdStopAllTones(struct AadSfxCommand *sfxCmd /*$a0*/)
 // line 372, offset 0x8005760c
	/* begin block 1 */
		// Start line: 374
		// Start offset: 0x8005760C
		// Variables:
	// 		struct AadSynthVoice *voice; // $a0
	// 		unsigned long vmask; // $v1
	// 		unsigned short i; // $a3
	/* end block 1 */
	// End offset: 0x80057684
	// End Line: 393
...
// void /*$ra*/ sfxCmdSetToneVolumeAndPan(struct AadSfxCommand *sfxCmd /*$a0*/)
 // line 399, offset 0x800576b0
	/* begin block 1 */
		// Start line: 400
		// Start offset: 0x800576B0
		// Variables:
	...
	// 		struct AadVolume newVoiceVol; // stack offset -16
		...
		/* begin block 1.1 */
			// Start line: 418
			// Start offset: 0x80057764
			// Variables:
		// 		unsigned long tmp; // $v0
		/* end block 1.1 */
		// End offset: 0x80057764
		// End Line: 418
		...
		/* end block 1.2 */
		// End offset: 0x800577CC
		// End Line: 419

		/* begin block 1.3 */
			// Start line: 420
			// Start offset: 0x8005784C
			// Variables:
		// 		unsigned long tmp; // $v0
		/* end block 1.3 */
		// End offset: 0x8005784C
		// End Line: 420

		/* begin block 1.4 */
			// Start line: 421
			// Start offset: 0x800578B8
			// Variables:
		// 		unsigned long masterVolumeSquared; // $v1
		/* end block 1.4 */
		// End offset: 0x800578B8
		// End Line: 421
...

{
  ...
  while ((((pAVar7 = aadMem->synthVoice + uVar6, pAVar7->voiceID != -0x30 ||
           (pAVar7->handle != sfxCmd->ulongParam)) || (aadMem->voiceStatus[uVar6] == '\0')) ||
  ...
  iVar2 = iVar2 * iVar2 + -1;
  local_10 = (short)((uint)(local_10 * iVar2) >> 0xe);
  ...
  SpuSetVoiceVolume((uint)uVar8,
                    (int)(short)((uint)((short)((uint)((short)((uint)((short)((uint)(local_10 *
                                                                     ...
                                                                     iVar5) >> 0xe) * iVar2) >> 0xe)
                                       * iVar3) >> 0xe),
                    (int)(short)((uint)((short)((uint)((short)((uint)((short)((uint)(local_e * iVar4
                                                                                    ) >> 0xe) *
                                                                     iVar5) >> 0xe) * iVar2) >> 0xe)
                                       * iVar3) >> 0xe));
  return;
...
// void /*$ra*/ sfxCmdSetToneVolPanPitch(struct AadSfxCommand *sfxCmd /*$s2*/)
 // line 439, offset 0x80057a24
	...
	// 		unsigned short pitchIndex; // $a0
		...
		// 		unsigned long masterVolumeSquared; // $v1
		/* end block 1.2 */
		// End offset: 0x80057B50
		// End Line: 460

		/* begin block 1.3 */
			// Start line: 461
			// Start offset: 0x80057BD0
			// Variables:
		// 		unsigned long tmp; // $v0
		/* end block 1.3 */
		// End offset: 0x80057BD0
		// End Line: 461

		/* begin block 1.4 */
			// Start line: 462
			// Start offset: 0x80057C3C
			// Variables:
		// 		unsigned long masterVolumeSquared; // $v1
		/* end block 1.4 */
		// End offset: 0x80057C3C
		// End Line: 462
...
// void /*$ra*/ sfxCmdLockVoice(struct AadSfxCommand *sfxCmd /*$a0*/)
 // line 498, offset 0x80057e90
	/* begin block 1 */
		// Start line: 499
		// Start offset: 0x80057E90
		// Variables:
	// 		void (*callbackProc)(); // $s0
	// 		struct AadSynthVoice *voice; // $v1
	/* end block 1 */
	// End offset: 0x80057ECC
	// End Line: 513
...
// void /*$ra*/ sfxCmdSetVoiceAttr(struct AadSfxCommand *sfxCmd /*$a0*/)
 // line 516, offset 0x80057edc
	/* begin block 1 */
		// Start line: 517
		// Start offset: 0x80057EDC
		// Variables:
	// 		unsigned long v; // $s0
	// 		unsigned long vmask; // $v1
	// 		struct SpuVoiceAttr *voiceAttr; // $s1
	/* end block 1 */
	// End offset: 0x80057F1C
	// End Line: 528
