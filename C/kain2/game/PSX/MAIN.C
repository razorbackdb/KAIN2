...

{
  ...
  DRAW_TranslucentQuad
            (0,0,0x200,0,0,0xf0,0x200,0xf0,0,0,0,2,*(_PrimPool **)(baseAreaName + 0x40),
...

{
  ...
  aadStartMasterVolumeFade
            (theCamera.collisionTargetFocusRotation._4_4_,0x100,
...

{
  ...
  theCamera.smallBaseSphere.position.x._1_1_ = 0xff;
  theCamera.smallBaseSphere.position.x._0_1_ = 0xff;
  theCamera._308_4_ = &debugOrgFogRed;
  gameTracker = pGVar6;
...
LAB_8003933c:
    ...
    case 4:
      ...
      do {
        ...
        if (5 < (uint)theCamera.savedTargetFocusDistance[0]) goto LAB_800390f0;
        ...
        if (InterfaceItems[lVar2].timeout != 0) {
          do {
            ...
            if (((int)(uint)InterfaceItems[lVar2].buttonTimeout < iVar4) &&
               ((theCamera.core.vvPlaneConsts[5] & 0x80U) != 0)) break;
            VSync(0);
...
LAB_800390f0:
      ...
      if (theCamera.savedMode[1] != 6) {
        if (DoMainMenu != 0) goto LAB_8003933c;
        MAIN_ResetGame();
        theCamera.maxFocusVel.pad = 0;
        mainMenuFading = 1;
        MAIN_StartGame();
