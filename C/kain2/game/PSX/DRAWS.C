...
no_subdiv:
        *(undefined4 *)(iVar17 + 0xac) = 0;
        if ((uVar8 & 0x66000) != 0) goto subdiv_begin;
        *(undefined4 *)(iVar17 + 0xac) = 0;
        ...
        if ((int)uVar8 < 0x280) goto subdiv_begin;
...
code_r0x80026728:
        *(undefined **)(iVar17 + 0xac) = &DAT_00004e20 + iVar23;
        if (-1 < (int)(&DAT_00004e20 + iVar23)) goto no_subdiv;
      }
      else {
        iVar23 = getCopReg(2,0xc000);
        if (*(int *)(iVar17 + 0xac) == 0) goto code_r0x80026728;
      }
subdiv_begin:
      uVar34 = getCopReg(2,0xa800);
      if ((uVar20 & 8) != 0) {
