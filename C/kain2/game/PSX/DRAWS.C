...
size_t CheckVolatile(size_t param_1)
...
undefined4 DRAW_DisplayTFace_S(undefined4 uParm1, uint uParm2, int iParm3)

{
	...
	if ((uVar8 & unaff_s2) == 0)
	{
		...
		iParm3 = (uVar5 & 0xfffc) + (int)*(char *)(in_t4 + 200) * 0x10;
		if (0x2fff < iParm3)
		{
			return 0;
		}
			...
			(((iVar3 < 0x200 && (-0x200 < in_t6)) && (in_t6 < 0x200))))
		{
			...
			{
				uVar4 = *(uint *)(iParm3 + (int)ot);
				*(uint *)(iParm3 + (int)ot) = (uint)texture & uParm2;
				texture->tag = uVar4 | unaff_s3;
				uVar1 = getCopReg(2, 0xc);
				*(undefined4 *)&texture->x0 = uVar1;
				uVar1 = getCopReg(2, 0xd);
				*(undefined4 *)&texture->x1 = uVar1;
				uVar1 = getCopReg(2, 0xe);
				*(undefined4 *)&texture->x2 = uVar1;
				uVar1 = getCopReg(2, 0x14);
				*(undefined4 *)&texture->r0 = uVar1;
				uVar1 = getCopReg(2, 0x15);
				*(undefined4 *)&texture->r1 = uVar1;
				uVar1 = getCopReg(2, 0x16);
				*(undefined4 *)&texture->r2 = uVar1;
				return 0;
			}
		}
	}
	*(POLY_GT3 **)(in_t4 + 0xdc) = texture;
	*(undefined4 *)(in_t4 + 0xe0) = in_t1;
	*(undefined4 *)(in_t4 + 0xe4) = in_t2;
	*(undefined4 *)(in_t4 + 0xe8) = in_t3;
	*(int *)(in_t4 + 0xec) = in_t6;
	*(uint *)(in_t4 + 0xf0) = uParm2;
	*(int *)(in_t4 + 0xf4) = iParm3;
	*(undefined4 *)(in_t4 + 0xf8) = unaff_retaddr;
	plVar2 = DRAW_Zclip_subdiv(texture, ot, 0);
	if (plVar2 == (long *)0x0)
	{
		return 1;
	}
...
/* WARNING: Instruction at (ram,0x80026720) overlaps instruction at (ram,0x8002671c)
    */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void DRAW_DisplaySubdivPolytope_S(int *piParm1, int iParm2)

{
	...
	iVar17 = 0x1f800000;
	DAT_1f8000ac = 0;
	iVar27 = *(int *)(iParm2 + 0x1c);
	iVar9 = (int)*(short *)(*piParm1 + 0xc);
	puVar25 = *(uint **)(*piParm1 + 8);
	...
	if (iVar9 != 0)
	{
		puVar28 = puVar25 + iVar9 * 3;
		iVar9 = *(int *)(iParm2 + 0x34);
		uVar13 = 0xffffff;
		_DAT_1f800014 = unaff_s8;
		DAT_1f800088 = unaff_s0;
		DAT_1f80008c = unaff_s1;
		...
		do
		{
			...
			piVar15 = (int *)(iVar27 + (*puVar25 & 0xffff) * 0xc);
			setCopReg(2, in_zero, *piVar15);
			setCopReg(2, in_at, piVar15[1]);
			copFunction(2, 0x180001);
			piVar12 = (int *)(iVar27 + (*puVar25 >> 0x10) * 0xc);
			iVar23 = *piVar12;
			iVar30 = piVar12[1];
			uVar34 = getCopReg(2, 8);
			*(undefined4 *)(iVar17 + 0xbc) = uVar34;
			setCopReg(2, 0, iVar23);
			setCopReg(2, 0x800, iVar30);
			uVar26 = getCopControlWord(2, 0xf800);
			copFunction(2, 0x180001);
			piVar14 = (int *)(iVar27 + (uVar7 & 0xffff) * 0xc);
			iVar23 = *piVar14;
			iVar30 = piVar14[1];
			uVar34 = getCopReg(2, 8);
			*(undefined4 *)(iVar17 + 0xc0) = uVar34;
			setCopReg(2, 0, iVar23);
			setCopReg(2, 0x800, iVar30);
			uVar7 = getCopControlWord(2, 0xf800);
			copFunction(2, 0x180001);
			puVar16 = (uint *)((int)*(short *)((int)puVar25 + 10) + iVar9);
			uVar24 = *puVar16;
			uVar29 = puVar16[1];
			uVar10 = puVar16[2];
			uVar8 = getCopControlWord(2, 0xf800);
			uVar34 = getCopReg(2, 8);
			*(undefined4 *)(iVar17 + 0xc4) = uVar34;
			uVar8 = uVar26 | uVar7 | uVar8;
			copFunction(2, 0x1400006);
			in_t0[3] = uVar24;
			in_t0[6] = uVar29;
			in_t0[9] = uVar10;
			*(uint *)(iVar17 + 0xd8) = uVar10;
			iVar23 = getCopReg(2, 0xc000);
			if (-1 < iVar23)
			{
				in_at = &UNK_00026000;
				uVar7 = uVar8 & 0x26000;
				...
				if (uVar7 != 0)
				{
					iVar23 = getCopReg(2, 0x8800);
					iVar30 = getCopReg(2, 0x9000);
					iVar32 = getCopReg(2, 0x9800);
					in_at = (undefined *)(uint)(iVar23 < 0x801);
					if ((iVar23 < 0x801) && (((0x9f < iVar23 || (0x9f < iVar30)) || (0x9f < iVar32))))
						goto do_poly;
				}
				goto skip_tface;
			}
		do_poly:
			...
			uVar24 = getCopReg(2, 0x7000);
			if (((uVar24 & uVar10 & uVar7 & 0x80008000) != 0) ||
				((0xf00200 - uVar24 & 0xf00200 - uVar10 & 0xf00200 - uVar7 & 0x80008000) != 0))
				goto skip_tface;
			iVar23 = piVar12[2];
			uVar26 = piVar15[2];
			*(int *)(iVar17 + 0x84) = piVar14[2];
			*(int *)(iVar17 + 0x80) = iVar23;
			*(uint *)(iVar17 + 0x7c) = uVar26;
			iVar23 = *piVar15;
			if (*(int *)(iVar17 + 0x18) != 0)
			{
				uVar34 = getCopReg(2, 8);
				*(undefined4 *)(iVar17 + 0xc4) = uVar34;
				iVar30 = (int)(short)iVar23 - *(int *)(iVar17 + 0x1c);
				iVar23 = (iVar23 >> 0x10) - *(int *)(iVar17 + 0x20);
				if (iVar30 < 0)
				{
					iVar30 = -iVar30;
				}
				...
				iVar32 = *(int *)(iVar17 + 0x18);
				if (iVar23 <= iVar30)
				{
					iVar23 = iVar30;
				}
				iVar30 = (int)*(short *)(piVar15 + 1) - *(int *)(iVar17 + 0x24);
				if (iVar30 < 0)
				{
					iVar30 = -iVar30;
				}
				...
				if (iVar23 < (int)*(short *)(iVar32 + 0x10))
				{
					setCopReg(2, uVar7, *(undefined4 *)(iVar32 + 4));
					setCopReg(2, uVar10, *(undefined4 *)(iVar32 + 8));
					setCopReg(2, uVar24, *(undefined4 *)(iVar32 + 0xc));
					setCopReg(2, 0x4000, ((int)*(short *)(iVar32 + 0x10) - iVar23) * 0x10);
					setCopReg(2, 0x3000, uVar26);
					uVar26 = uVar26 & uVar13;
					setCopReg(2, 0xc800, (uVar26 & 0xff) << 4);
					setCopReg(2, 0xd000, (uVar26 & 0xff00) >> 4);
					setCopReg(2, 0xd800, (uVar26 >> 0x10) << 4);
					copFunction(2, 0x1a8003e);
					uVar34 = getCopReg(2, 0x16);
					*(undefined4 *)(iVar17 + 0x7c) = uVar34;
				}
				iVar23 = (int)(short)*piVar12 - *(int *)(iVar17 + 0x1c);
				iVar30 = (*piVar12 >> 0x10) - *(int *)(iVar17 + 0x20);
				if (iVar23 < 0)
				{
					iVar23 = -iVar23;
				}
				...
				iVar23 = (int)*(short *)(piVar12 + 1) - *(int *)(iVar17 + 0x24);
				if (iVar23 < 0)
				{
					iVar23 = -iVar23;
				}
				...
				if (iVar30 < (int)*(short *)(iVar32 + 0x10))
				{
					setCopReg(2, uVar7, *(undefined4 *)(iVar32 + 4));
					setCopReg(2, uVar10, *(undefined4 *)(iVar32 + 8));
					setCopReg(2, uVar24, *(undefined4 *)(iVar32 + 0xc));
					setCopReg(2, 0x4000, ((int)*(short *)(iVar32 + 0x10) - iVar30) * 0x10);
					setCopReg(2, 0x3000, *(uint *)(iVar17 + 0x80));
					uVar26 = *(uint *)(iVar17 + 0x80) & uVar13;
					setCopReg(2, 0xc800, (uVar26 & 0xff) << 4);
					setCopReg(2, 0xd000, (uVar26 & 0xff00) >> 4);
					setCopReg(2, 0xd800, (uVar26 >> 0x10) << 4);
					copFunction(2, 0x1a8003e);
					uVar34 = getCopReg(2, 0x16);
					*(undefined4 *)(iVar17 + 0x80) = uVar34;
				}
				iVar23 = (int)(short)*piVar14 - *(int *)(iVar17 + 0x1c);
				iVar30 = (*piVar14 >> 0x10) - *(int *)(iVar17 + 0x20);
				if (iVar23 < 0)
				{
					iVar23 = -iVar23;
				}
				...
				iVar23 = (int)*(short *)(piVar14 + 1) - *(int *)(iVar17 + 0x24);
				iVar18 = (int)*(short *)(iVar32 + 0x10);
				if (iVar23 < 0)
				{
					iVar23 = -iVar23;
				}
				...
				in_at = (undefined *)(uint)(iVar30 < iVar18);
				if (iVar30 < iVar18)
				{
					setCopReg(2, uVar7, *(undefined4 *)(iVar32 + 4));
					setCopReg(2, uVar10, *(undefined4 *)(iVar32 + 8));
					setCopReg(2, uVar24, *(undefined4 *)(iVar32 + 0xc));
					setCopReg(2, 0x4000, (iVar18 - iVar30) * 0x10);
					setCopReg(2, 0x3000, *(uint *)(iVar17 + 0x84));
					uVar26 = *(uint *)(iVar17 + 0x84) & uVar13;
					setCopReg(2, 0xc800, (uVar26 & 0xff) << 4);
					setCopReg(2, 0xd000, (uVar26 & 0xff00) >> 4);
					setCopReg(2, 0xd800, (uVar26 >> 0x10) << 4);
					copFunction(2, 0x1a8003e);
					uVar34 = getCopReg(2, 0x16);
					*(undefined4 *)(iVar17 + 0x84) = uVar34;
				}
				setCopReg(2, in_t0, *(undefined4 *)(iVar17 + 0xc4));
			}
			if ((uVar20 & 8) != 0)
			{
			no_subdiv:
				*(undefined4 *)(iVar17 + 0xac) = 0;
				if ((uVar8 & 0x66000) != 0)
					goto subdiv_begin;
				*(undefined4 *)(iVar17 + 0xac) = 0;
				uVar26 = getCopReg(2, 0x8800);
				uVar33 = getCopReg(2, 0x9000);
				uVar19 = getCopReg(2, 0x9800);
				uVar8 = uVar33;
				...
				in_at = (undefined *)(uint)((int)uVar8 < (int)uVar26);
				if ((int)uVar8 >= (int)uVar26)
				{
					uVar8 = uVar26;
				}
				uVar33 = uVar33 & 0xfffc;
				iVar23 = uVar33 + ((int)uVar20 >> 8) * 0x10;
				if (((iVar23 < 1) || (uVar33 < 0xa0)) ||
					((0x2fff < iVar23 ||
					  (bVar3 = (int)uVar8 < *(int *)(iVar17 + 0xd0), in_at = (undefined *)(uint)bVar3, !bVar3))))
					goto skip_tface;
				in_at = (undefined *)(uint)((int)uVar8 < 0x280);
				if ((int)uVar8 < 0x280)
					goto subdiv_begin;
				if ((int)uVar33 < *(int *)(iVar17 + 0xb0))
				{
					uVar34 = getCopReg(2, 0xa800);
					if ((uVar20 & 8) != 0)
					{
						uVar21 = getCopReg(2, 0xb000);
						uVar11 = getCopReg(2, 0xb800);
						setCopReg(2, 0xa800, 0);
						setCopReg(2, 0xb000, 0);
						setCopReg(2, 0xb800, 0);
						iVar30 = getCopReg(2, 0x8800);
						iVar30 = 0x1000 - iVar30;
						if (iVar30 < 0x1001)
						{
							if (iVar30 < 1)
							{
							...
							setCopReg(2, piVar14, *(undefined4 *)(iVar17 + 0x7c));
							setCopReg(2, 0x4000, iVar30);
							copFunction(2, 0x780010);
							uVar4 = getCopReg(2, 0x16);
							*(undefined4 *)(iVar17 + 0x7c) = uVar4;
						}
						iVar30 = getCopReg(2, 0x9000);
						iVar30 = 0x1000 - iVar30;
						if (iVar30 < 0x1001)
						{
							...
							setCopReg(2, piVar14, *(undefined4 *)(iVar17 + 0x80));
							setCopReg(2, 0x4000, iVar30);
							copFunction(2, 0x780010);
							uVar4 = getCopReg(2, 0x16);
							*(undefined4 *)(iVar17 + 0x80) = uVar4;
						}
						iVar30 = getCopReg(2, 0x9800);
						iVar30 = 0x1000 - iVar30;
						in_at = (undefined *)(uint)(0x1000 < iVar30);
						if (0x1000 >= iVar30)
						{
							if (iVar30 < 1)
							{
							...
							setCopReg(2, piVar14, *(undefined4 *)(iVar17 + 0x84));
							setCopReg(2, 0x4000, iVar30);
							copFunction(2, 0x780010);
							uVar4 = getCopReg(2, 0x16);
							*(undefined4 *)(iVar17 + 0x84) = uVar4;
						}
						setCopReg(2, 0xa800, uVar34);
						setCopReg(2, 0xb000, uVar21);
						setCopReg(2, 0xb800, uVar11);
					}
					uVar8 = *(uint *)(iVar17 + 0x80);
					uVar20 = *(uint *)(iVar17 + 0x7c);
					in_t0[7] = *(uint *)(iVar17 + 0x84);
					in_t0[4] = uVar8;
					in_t0[1] = uVar20;
					in_t0[8] = uVar24;
					uVar20 = *(uint *)(iVar23 + unaff_s4);
					*(uint *)(iVar23 + unaff_s4) = (uint)in_t0 & uVar13;
					*in_t0 = uVar20 | 0x9000000;
					in_t0[2] = uVar7;
					in_t0[5] = uVar10;
					in_t0 = in_t0 + 10;
				}
				else
				{
					setCopReg(2, piVar14, *(undefined4 *)(iVar17 + 0x84));
					setCopReg(2, in_t0, *(undefined4 *)(iVar17 + 0xc4));
					puVar16 = (uint *)(iVar23 + unaff_s4);
					uVar8 = *puVar16;
					copFunction(2, 0x780010);
					*puVar16 = (uint)in_t0 & uVar13;
					*in_t0 = uVar8 | 0x9000000;
					uVar8 = getCopReg(2, 0x16);
					in_t0[7] = uVar8;
					setCopReg(2, puVar16, *(undefined4 *)(iVar17 + 0x80));
					setCopReg(2, in_t0, *(undefined4 *)(iVar17 + 0xc0));
					copFunction(2, 0x780010);
					in_t0[8] = uVar24;
					in_t0[5] = uVar10;
					cVar1 = *(char *)(iVar17 + 0x7f);
					uVar8 = getCopReg(2, 0x16);
					in_t0[4] = uVar8;
					setCopReg(2, puVar16, *(undefined4 *)(iVar17 + 0x7c));
					setCopReg(2, in_t0, *(undefined4 *)(iVar17 + 0xbc));
					uVar34 = *(undefined4 *)(iVar17 + 0xcc);
					in_t0[2] = uVar7;
					copFunction(2, 0x780010);
					bVar3 = *(int *)(iVar17 + 0xb8) < (int)uVar33;
					in_at = (undefined *)(uint)bVar3;
					puVar16 = in_t0 + 10;
					if ((bVar3) && ((uVar20 & 1 | (int)cVar1 & 2U) == 0))
					{
						uVar5 = (ushort)(uVar29 >> 0x10);
						if (*(char *)(iVar17 + 0xda) == '\0')
						{
							setCopReg(2, 0x3000, uVar34);
							uVar20 = getCopReg(2, 0xb000);
							in_t0[1] = uVar20 | 0x2000000;
							iVar32 = *(int *)(iVar17 + 0xcc);
							copFunction(2, 0x780010);
							*(ushort *)((int)in_t0 + 0x1a) = uVar5 & 0xff9f | 0x20;
							uVar34 = *(undefined4 *)(iVar17 + 0xc0);
							in_t0[0xd] = uVar7;
							iVar30 = getCopReg(2, 0xb000);
							in_t0[0xc] = iVar32 - iVar30 | 0x30000000;
							setCopReg(2, 0x4000, uVar34);
							copFunction(2, 0x780010);
							uVar34 = *(undefined4 *)(iVar17 + 0xc4);
							in_t0[0xf] = uVar10;
							in_t0[0xb] = 0xe1000640;
							iVar30 = getCopReg(2, 0xb000);
							in_t0[0xe] = iVar32 - iVar30;
							setCopReg(2, 0x4000, uVar34);
							copFunction(2, 0x780010);
							uVar7 = *(uint *)(iVar23 + unaff_s4);
							*(uint *)(iVar23 + unaff_s4) = (uint)puVar16 & uVar13;
							in_at = (undefined *)0x7000000;
							*puVar16 = uVar7 | 0x7000000;
							in_t0[0x11] = uVar24;
							iVar23 = getCopReg(2, 0xb000);
							in_t0[0x10] = iVar32 - iVar23;
							in_t0 = in_t0 + 0x12;
						}
						else
						{
							...
							uVar20 = getCopReg(2, 0xb000);
							in_t0[1] = uVar20 | 0x2000000;
							iVar30 = *(int *)(iVar17 + 0xcc);
							if ((uVar20 & 0xff000000 | 0x2000000) != 0x36000000)
							{
								getCopReg(2, 0xb000);
							}
							copFunction(2, 0x780010);
							*(ushort *)((int)in_t0 + 0x1a) = uVar5 & 0xff9f | 0x20;
							uVar34 = *(undefined4 *)(iVar17 + 0xc0);
							in_t0[0xc] = uVar7;
							iVar32 = getCopReg(2, 0xb000);
							in_t0[0xb] = iVar30 - iVar32 | 0x34000000;
							setCopReg(2, 0x4000, uVar34);
							in_t0[0x10] = uVar29 & 0xff9fffff;
							copFunction(2, 0x780010);
							in_t0[0xd] = in_t0[3];
							in_t0[0x13] = in_t0[9];
							*(undefined2 *)((int)in_t0 + 0x36) = *(undefined2 *)(iVar17 + 0xd4);
							uVar34 = *(undefined4 *)(iVar17 + 0xc4);
							in_t0[0xf] = uVar10;
							iVar32 = getCopReg(2, 0xb000);
							in_t0[0xe] = iVar30 - iVar32;
							setCopReg(2, 0x4000, uVar34);
							copFunction(2, 0x780010);
							uVar7 = *(uint *)(iVar23 + unaff_s4);
							*(uint *)(iVar23 + unaff_s4) = (uint)puVar16 & uVar13;
							in_at = (undefined *)0x9000000;
							*puVar16 = uVar7 | 0x9000000;
							in_t0[0x12] = uVar24;
							iVar23 = getCopReg(2, 0xb000);
							in_t0[0x11] = iVar30 - iVar23;
							in_t0 = in_t0 + 0x14;
						}
					}
					else
				...
				goto joined_r0x80026a90;
			}
			if ((uVar20 & 2) == 0)
			{
				iVar23 = getCopReg(2, 0xc000);
			code_r0x80026728:
				*(undefined **)(iVar17 + 0xac) = &DAT_00004e20 + iVar23;
				if (-1 < (int)(&DAT_00004e20 + iVar23))
					goto no_subdiv;
			}
			else
			{
				iVar23 = getCopReg(2, 0xc000);
				if (*(int *)(iVar17 + 0xac) == 0)
					goto code_r0x80026728;
			}
		subdiv_begin:
			uVar34 = getCopReg(2, 0xa800);
			if ((uVar20 & 8) != 0)
			{
				...
				if (iVar23 < 0x1001)
				{
					...
					setCopReg(2, piVar14, *(undefined4 *)(iVar17 + 0x7c));
					setCopReg(2, 0x4000, iVar23);
					copFunction(2, 0x780010);
					uVar4 = getCopReg(2, 0x16);
					*(undefined4 *)(iVar17 + 0x7c) = uVar4;
				}
				iVar23 = getCopReg(2, 0x9000);
				iVar23 = 0x1000 - iVar23;
				if (iVar23 < 0x1001)
				{
					if (iVar23 < 1)
				...
				iVar23 = getCopReg(2, 0x9800);
				iVar23 = 0x1000 - iVar23;
				in_at = (undefined *)(uint)(0x1000 < iVar23);
				if (0x1000 >= iVar23)
				{
					if (iVar23 < 1)
					{
			...
			iVar32 = *piVar15;
			iVar31 = (int)*(short *)(piVar15 + 1);
			iVar18 = *piVar12;
			iVar30 = (int)*(short *)(piVar12 + 1);
			iVar23 = *piVar14;
			iVar22 = (int)*(short *)(piVar14 + 1);
			*(int *)(iVar17 + 0x30) = iVar18;
			*(int *)(iVar17 + 0x34) = iVar30;
			*(int *)(iVar17 + 0x28) = iVar32;
			*(int *)(iVar17 + 0x2c) = iVar31;
			*(int *)(iVar17 + 0x38) = iVar23;
			*(int *)(iVar17 + 0x3c) = iVar22;
			*(undefined2 *)(iVar17 + 0x40) = (short)((int)(short)iVar32 + (int)(short)iVar18 >> 1);
			*(undefined2 *)(iVar17 + 0x42) = (short)((iVar32 >> 0x10) + (iVar18 >> 0x10) >> 1);
			*(undefined2 *)(iVar17 + 0x44) = (short)(iVar31 + iVar30 >> 1);
			*(undefined2 *)(iVar17 + 0x48) = (short)((int)(short)iVar18 + (int)(short)iVar23 >> 1);
			*(undefined2 *)(iVar17 + 0x4a) = (short)((iVar18 >> 0x10) + (iVar23 >> 0x10) >> 1);
			*(undefined2 *)(iVar17 + 0x4c) = (short)(iVar30 + iVar22 >> 1);
			*(undefined2 *)(iVar17 + 0x50) = (short)((int)(short)iVar23 + (int)(short)iVar32 >> 1);
			*(undefined2 *)(iVar17 + 0x52) = (short)((iVar23 >> 0x10) + (iVar32 >> 0x10) >> 1);
			*(undefined2 *)(iVar17 + 0x54) = (short)(iVar22 + iVar31 >> 1);
			uVar24 = *puVar16;
			uVar26 = puVar16[1];
			uVar7 = puVar16[2];
			...
			uVar8 = uVar26 >> 8 & 0xff;
			uVar10 = uVar7 >> 8 & 0xff;
			*(uint *)(iVar17 + 0x58) = uVar24;
			*(uint *)(iVar17 + 0x5c) = uVar26;
			*(uint *)(iVar17 + 0x60) = uVar7;
			*(undefined *)(iVar17 + 100) = (char)((uVar24 & 0xff) + (uVar26 & 0xff) >> 1);
			*(undefined *)(iVar17 + 0x65) = (char)(uVar20 + uVar8 >> 1);
			*(undefined *)(iVar17 + 0x68) = (char)((uVar26 & 0xff) + (uVar7 & 0xff) >> 1);
			*(undefined *)(iVar17 + 0x69) = (char)(uVar8 + uVar10 >> 1);
			*(undefined *)(iVar17 + 0x6c) = (char)((uVar7 & 0xff) + (uVar24 & 0xff) >> 1);
			*(undefined *)(iVar17 + 0x6d) = (char)(uVar10 + uVar20 >> 1);
			uVar7 = *(uint *)(iVar17 + 0x7c);
			uVar10 = *(uint *)(iVar17 + 0x80);
			uVar29 = *(uint *)(iVar17 + 0x84);
			uVar20 = uVar7 >> 8 & 0xff;
			uVar8 = uVar7 >> 0x10 & 0xff;
			*(uint *)(iVar17 + 0x7c) = uVar7;
			uVar24 = uVar10 >> 8 & 0xff;
			uVar26 = uVar10 >> 0x10 & 0xff;
			*(uint *)(iVar17 + 0x80) = uVar10;
			uVar19 = uVar29 >> 8 & 0xff;
			uVar33 = uVar29 >> 0x10 & 0xff;
			*(uint *)(iVar17 + 0x84) = uVar29;
			uVar6 = (undefined)(uVar29 >> 0x18);
			*(undefined *)(iVar17 + 0x73) = uVar6;
			*(undefined *)(iVar17 + 0x77) = uVar6;
			*(undefined *)(iVar17 + 0x7b) = uVar6;
			*(undefined *)(iVar17 + 0x70) = (char)((int)((uVar7 & 0xff) + (uVar10 & 0xff)) >> 1);
			*(undefined *)(iVar17 + 0x71) = (char)((int)(uVar20 + uVar24) >> 1);
			*(undefined *)(iVar17 + 0x72) = (char)((int)(uVar8 + uVar26) >> 1);
			*(undefined *)(iVar17 + 0x74) = (char)((int)((uVar10 & 0xff) + (uVar29 & 0xff)) >> 1);
			*(undefined *)(iVar17 + 0x75) = (char)((int)(uVar24 + uVar19) >> 1);
			*(undefined *)(iVar17 + 0x76) = (char)((int)(uVar26 + uVar33) >> 1);
			*(undefined *)(iVar17 + 0x78) = (char)((int)((uVar7 & 0xff) + (uVar29 & 0xff)) >> 1);
			*(undefined *)(iVar17 + 0x79) = (char)((int)(uVar20 + uVar19) >> 1);
			*(undefined *)(iVar17 + 0x7a) = (char)((int)(uVar8 + uVar33) >> 1);
			sVar2 = *(short *)(iVar17 + 0x5e);
			uVar6 = *(undefined *)((int)puVar25 + 7);
			*(short *)(iVar17 + 0x66) = sVar2;
			*(short *)(iVar17 + 0x6a) = sVar2;
			*(short *)(iVar17 + 0x6e) = *(short *)(iVar17 + 0x5a);
			*(undefined *)(iVar17 + 200) = uVar6;
			setCopReg(2, in_zero, *(undefined4 *)(iVar17 + 0x28));
			setCopReg(2, in_at, *(undefined4 *)(iVar17 + 0x2c));
			setCopReg(2, (int)*(short *)(iVar17 + 0x5a), *(undefined4 *)(iVar17 + 0x40));
			setCopReg(2, (int)sVar2, *(undefined4 *)(iVar17 + 0x44));
			setCopReg(2, piVar12, *(undefined4 *)(iVar17 + 0x50));
			setCopReg(2, uVar13, *(undefined4 *)(iVar17 + 0x54));
			copFunction(2, 0x280030);
			uVar7 = *(uint *)(iVar17 + 100);
			uVar20 = *(uint *)(iVar17 + 0x6c);
			in_t0[3] = *(uint *)(iVar17 + 0x58);
			in_t0[6] = uVar7;
			in_t0[9] = uVar20;
			setCopReg(2, iVar27, *(undefined4 *)(iVar17 + 0x70));
			setCopReg(2, puVar28, *(undefined4 *)(iVar17 + 0x78));
			setCopReg(2, 0xa000, *(undefined4 *)(iVar17 + 0x7c));
			setCopReg(2, 0x3000, *(undefined4 *)(iVar17 + 0x7c));
			lVar35 = DRAW_DisplayTFace_S();
			if (lVar35 < 0x100000000)
			{
				setCopReg(2, in_zero, *(undefined4 *)(iVar17 + 0x50));
				setCopReg(2, in_at, *(undefined4 *)(iVar17 + 0x54));
				setCopReg(2, (int)((ulonglong)lVar35 >> 0x20), *(undefined4 *)(iVar17 + 0x48));
				setCopReg(2, (int)lVar35, *(undefined4 *)(iVar17 + 0x4c));
				setCopReg(2, piVar12, *(undefined4 *)(iVar17 + 0x38));
				setCopReg(2, uVar13, *(undefined4 *)(iVar17 + 0x3c));
				copFunction(2, 0x280030);
				uVar7 = *(uint *)(iVar17 + 0x68);
				uVar20 = *(uint *)(iVar17 + 0x60);
				in_t0[3] = *(uint *)(iVar17 + 0x6c);
				in_t0[6] = uVar7;
				in_t0[9] = uVar20;
				setCopReg(2, iVar27, *(undefined4 *)(iVar17 + 0x74));
				setCopReg(2, puVar28, *(undefined4 *)(iVar17 + 0x84));
				setCopReg(2, 0xa000, *(undefined4 *)(iVar17 + 0x78));
				setCopReg(2, 0x3000, *(undefined4 *)(iVar17 + 0x78));
				iVar23 = DRAW_DisplayTFace_S();
				if (iVar23 < 1)
				{
					*(short *)(iVar17 + 0x66) = *(short *)(iVar17 + 0x5a);
					*(short *)(iVar17 + 0x6e) = *(short *)(iVar17 + 0x5e);
					setCopReg(2, in_zero, *(undefined4 *)(iVar17 + 0x40));
					setCopReg(2, in_at, *(undefined4 *)(iVar17 + 0x44));
					setCopReg(2, (int)*(short *)(iVar17 + 0x5a), *(undefined4 *)(iVar17 + 0x48));
					setCopReg(2, (int)*(short *)(iVar17 + 0x5e), *(undefined4 *)(iVar17 + 0x4c));
					setCopReg(2, piVar12, *(undefined4 *)(iVar17 + 0x50));
					setCopReg(2, uVar13, *(undefined4 *)(iVar17 + 0x54));
					copFunction(2, 0x280030);
					uVar7 = *(uint *)(iVar17 + 0x68);
					uVar20 = *(uint *)(iVar17 + 0x6c);
					in_t0[3] = *(uint *)(iVar17 + 100);
					in_t0[6] = uVar7;
					in_t0[9] = uVar20;
					setCopReg(2, iVar27, *(undefined4 *)(iVar17 + 0x74));
					setCopReg(2, puVar28, *(undefined4 *)(iVar17 + 0x78));
					setCopReg(2, 0xa000, *(undefined4 *)(iVar17 + 0x70));
					setCopReg(2, 0x3000, *(undefined4 *)(iVar17 + 0x70));
					lVar35 = DRAW_DisplayTFace_S();
					if (lVar35 < 0x100000000)
					{
						setCopReg(2, in_zero, *(undefined4 *)(iVar17 + 0x40));
						setCopReg(2, in_at, *(undefined4 *)(iVar17 + 0x44));
						setCopReg(2, (int)((ulonglong)lVar35 >> 0x20), *(undefined4 *)(iVar17 + 0x30));
						setCopReg(2, (int)lVar35, *(undefined4 *)(iVar17 + 0x34));
						setCopReg(2, piVar12, *(undefined4 *)(iVar17 + 0x48));
						setCopReg(2, uVar13, *(undefined4 *)(iVar17 + 0x4c));
						copFunction(2, 0x280030);
						uVar7 = *(uint *)(iVar17 + 0x5c);
						uVar20 = *(uint *)(iVar17 + 0x68);
						in_t0[3] = *(uint *)(iVar17 + 100);
						in_t0[6] = uVar7;
						in_t0[9] = uVar20;
						setCopReg(2, iVar27, *(undefined4 *)(iVar17 + 0x80));
						setCopReg(2, puVar28, *(undefined4 *)(iVar17 + 0x74));
						setCopReg(2, 0xa000, *(undefined4 *)(iVar17 + 0x70));
						setCopReg(2, 0x3000, *(undefined4 *)(iVar17 + 0x70));
						lVar35 = DRAW_DisplayTFace_S();
						if (lVar35 < 0x100000000)
						{
							iVar23 = (int)*(char *)(iVar17 + 200) + 1;
							*(undefined *)(iVar17 + 200) = (char)iVar23;
							setCopReg(2, in_zero, *(undefined4 *)(iVar17 + 0x28));
							setCopReg(2, in_at, *(undefined4 *)(iVar17 + 0x2c));
							setCopReg(2, iVar23, *(undefined4 *)(iVar17 + 0x30));
							setCopReg(2, (int)lVar35, *(undefined4 *)(iVar17 + 0x34));
							setCopReg(2, piVar12, *(undefined4 *)(iVar17 + 0x40));
							setCopReg(2, uVar13, *(undefined4 *)(iVar17 + 0x44));
							copFunction(2, 0x280030);
							uVar7 = *(uint *)(iVar17 + 0x5c);
							uVar20 = *(uint *)(iVar17 + 100);
							in_t0[3] = *(uint *)(iVar17 + 0x58);
							in_t0[6] = uVar7;
							in_t0[9] = uVar20;
							setCopReg(2, iVar27, *(undefined4 *)(iVar17 + 0x80));
							setCopReg(2, puVar28, *(undefined4 *)(iVar17 + 0x70));
							setCopReg(2, 0xa000, *(undefined4 *)(iVar17 + 0x7c));
							setCopReg(2, 0x3000, *(undefined4 *)(iVar17 + 0x7c));
							DRAW_DisplayTFace_S();
							*(short *)(iVar17 + 0x6a) = *(short *)(iVar17 + 0x5a);
							setCopReg(2, in_zero, *(undefined4 *)(iVar17 + 0x48));
							setCopReg(2, in_at, *(undefined4 *)(iVar17 + 0x4c));
							setCopReg(2, (int)*(short *)(iVar17 + 0x5a), *(undefined4 *)(iVar17 + 0x30));
							setCopReg(2, extraout_v1, *(undefined4 *)(iVar17 + 0x34));
							setCopReg(2, piVar12, *(undefined4 *)(iVar17 + 0x38));
							setCopReg(2, uVar13, *(undefined4 *)(iVar17 + 0x3c));
							copFunction(2, 0x280030);
							uVar7 = *(uint *)(iVar17 + 0x5c);
							uVar20 = *(uint *)(iVar17 + 0x60);
							in_t0[3] = *(uint *)(iVar17 + 0x68);
							in_t0[6] = uVar7;
							in_t0[9] = uVar20;
							setCopReg(2, iVar27, *(undefined4 *)(iVar17 + 0x80));
							setCopReg(2, puVar28, *(undefined4 *)(iVar17 + 0x84));
							setCopReg(2, 0xa000, *(undefined4 *)(iVar17 + 0x74));
							setCopReg(2, 0x3000, *(undefined4 *)(iVar17 + 0x74));
							uVar36 = DRAW_DisplayTFace_S();
							setCopReg(2, in_zero, *(undefined4 *)(iVar17 + 0x28));
							setCopReg(2, in_at, *(undefined4 *)(iVar17 + 0x2c));
							setCopReg(2, (int)((ulonglong)uVar36 >> 0x20), *(undefined4 *)(iVar17 + 0x50));
							setCopReg(2, (int)uVar36, *(undefined4 *)(iVar17 + 0x54));
							setCopReg(2, piVar12, *(undefined4 *)(iVar17 + 0x38));
							setCopReg(2, uVar13, *(undefined4 *)(iVar17 + 0x3c));
							copFunction(2, 0x280030);
							uVar7 = *(uint *)(iVar17 + 0x6c);
							uVar20 = *(uint *)(iVar17 + 0x60);
							in_t0[3] = *(uint *)(iVar17 + 0x58);
							in_t0[6] = uVar7;
							in_t0[9] = uVar20;
							setCopReg(2, iVar27, *(undefined4 *)(iVar17 + 0x78));
							setCopReg(2, puVar28, *(undefined4 *)(iVar17 + 0x84));
							setCopReg(2, 0xa000, *(undefined4 *)(iVar17 + 0x7c));
							setCopReg(2, 0x3000, *(undefined4 *)(iVar17 + 0x7c));
							DRAW_DisplayTFace_S();
...
uint PIPE3D_TransformAnimatedInstanceVertices_S(int param_1, undefined4 *param_2, int param_3, undefined4 *param_4, ushort *param_5,
...
void DRAW_MFace3_S(undefined4 uParm1, undefined4 uParm2)
	...
	if ((in_v0 & 2) == 0)
	{
		if (iVar14 != 0)
		{
			...
			*(undefined4 *)(unaff_s8 + 0x78) = uVar13;
			...
			setCopReg(2, uParm1, **(undefined4 **)(unaff_s8 + 0x54));
			setCopReg(2, uParm2, (*(undefined4 **)(unaff_s8 + 0x54))[1]);
			setCopReg(2, 0x3000, in_v1);
			copFunction(2, 0xf80416);
			*unaff_s0 = *(uint *)(iVar4 + unaff_s1);
...
/* WARNING: Instruction at (ram,0x80028508) overlaps instruction at (ram,0x80028504)
    */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
...

{
	...
	{
		_DAT_1f800000 = (undefined *)0x800285c8;
	}
	else
	{
	...
	while ((puVar2 < DAT_1f800020 && (*(uint *)(param_5 + 4) < DAT_1f800024)))
	{
		...
		{
			DAT_1f80008c = 0;
			/* WARNING: Could not recover jumptable at 0x8002866c. Too many branches */
			/* WARNING: Treating indirect jump as call */
			uVar1 = (**(code **)((((uint)(0 < *(short *)(param_3 + (uint)puVar2[2] * 8 + 4)) << 1 |
								   (uint)(0 < *(short *)(param_3 + (uint)puVar2[1] * 8 + 4)))
									  << 1 |
								  (uint)(0 < *(short *)(param_3 + (uint)*puVar2 * 8 + 4))) *
									 4 +
								 0x1f800000))(&gNormalList, *(undefined4 *)(param_1 + 4));
			return uVar1;
		}
		puVar2 = puVar2 + 6;
	}
