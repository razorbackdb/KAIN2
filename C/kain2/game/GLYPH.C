...
// void /*$ra*/ GlyphProcess(struct _Instance *instance /*$s0*/, struct GameTracker *gameTracker /*$a1*/)
 // line 186, offset 0x8007ac88
	/* begin block 1 */
		// Start line: 187
		// Start offset: 0x8007AC88
		// Variables:
	// 		struct __GlyphData *data; // $v0
	/* end block 1 */
	// End offset: 0x8007AC88
	// End Line: 187
...
// void /*$ra*/ GlyphPost(struct _Instance *instance /*$a0*/, unsigned long message /*$a1*/, unsigned long messageData /*$a2*/)
 // line 233, offset 0x8007ad30
	/* begin block 1 */
		// Start line: 234
		// Start offset: 0x8007AD30
		// Variables:
	// 		struct __GlyphData *data; // $a0
	/* end block 1 */
	// End offset: 0x8007AD54
	// End Line: 251
...
// void /*$ra*/ _GlyphSwitchProcess(struct _Instance *instance /*$s1*/, TDRFuncPtr__GlyphSwitchProcess1process process /*$s3*/)
 // line 261, offset 0x8007ad64
	/* begin block 1 */
		// Start line: 262
		// Start offset: 0x8007AD64
		// Variables:
	// 		struct __GlyphData *data; // $s2
	/* end block 1 */
	// End offset: 0x8007AD64
	// End Line: 262
...
// int /*$ra*/ _GlyphIsGlyphSet(int glyph /*$s0*/)
 // line 295, offset 0x8007ae18
	/* begin block 1 */
		// Start line: 296
		// Start offset: 0x8007AE18
		// Variables:
	// 		unsigned long abilities; // $v1
	/* end block 1 */
	// End offset: 0x8007AE18
	// End Line: 296
...
// int /*$ra*/ _GlyphIsAnyGlyphSet()
 // line 308, offset 0x8007ae98
	/* begin block 1 */
		// Start line: 309
		// Start offset: 0x8007AE98
		// Variables:
	// 		unsigned long abilities; // $v0
	/* end block 1 */
	// End offset: 0x8007AE98
	// End Line: 309
...
// void /*$ra*/ GlyphDrawMenu(struct _Instance *instance /*stack 0*/)
 // line 372, offset 0x8007b000
	/* begin block 1 */
		// Start line: 373
		// Start offset: 0x8007B000
		// Variables:
	...
	// 		struct _GlyphTuneData *glyphtunedata; // $s7
		...
		/* begin block 1.1 */
			// Start line: 395
			// Start offset: 0x8007B06C
			// Variables:
		// 		int diff; // $v0
		/* end block 1.1 */
		// End offset: 0x8007B0D0
		// End Line: 411

		/* begin block 1.2 */
			// Start line: 422
			// Start offset: 0x8007B100
			// Variables:
		// 		int enabled; // $v1
		// 		int scale_modify; // $s2
		// 		int num; // $s1
		/* end block 1.2 */
		// End offset: 0x8007B240
		// End Line: 464
      ...
      if (iVar7 == 0x1000) {
        if ((*(short *)((int)pvVar6 + 0x98) == *(short *)((int)pvVar6 + 0x96)) &&
          ...
          DRAW_CreateAGlowingCircle
                    (&local_38,0x140,gameTrackerX.primPool,gameTrackerX.drawOT,5,0x1404040,0x14,0x18
                     ,0);
        }
        iVar7 = (int)*(short *)((int)pvVar6 + 0x90);
      }
...
// void /*$ra*/ ShrinkGlyphMenu(struct _Instance *instance /*$s1*/)
 // line 509, offset 0x8007b380
	/* begin block 1 */
		// Start line: 510
		// Start offset: 0x8007B380
		// Variables:
...
// void /*$ra*/ _GlyphOffProcess(struct _Instance *instance /*$s1*/, int data1 /*$s4*/, int data2 /*$s5*/)
 // line 588, offset 0x8007b5a0
	/* begin block 1 */
		// Start line: 589
		// Start offset: 0x8007B5A0
		// Variables:
	// 		struct __Event *Ptr; // $v0
	// 		struct __GlyphData *data; // $s0
	/* end block 1 */
	// End offset: 0x8007B6AC
	// End Line: 624
...

{
  ...
  ppcVar3 = (code **)instance->extraData;
  ShrinkGlyphMenu(instance);
  do {
    p_Var1 = PeekMessageQueue((__MessageQueue *)(ppcVar3 + 1));
    if (p_Var1 == (__Event *)0x0) {
      if (*ppcVar3 == _GlyphSelectProcess) {
        SndPlayVolPan(0x11,0x7f,0x40,0);
      }
      Glyph_DoFX(instance);
      return;
...
LAB_8007b670:
        ...
        if (puVar2 != &DAT_00100004) goto LAB_8007b670;
      }
    }
    DeMessageQueue((__MessageQueue *)(ppcVar3 + 1));
  } while( true );
}
...
// void /*$ra*/ _GlyphSelectProcess(struct _Instance *instance /*$s3*/, int data1 /*$s6*/, int data2 /*$s7*/)
 // line 629, offset 0x8007b6d8
	/* begin block 1 */
		// Start line: 630
		// Start offset: 0x8007B6D8
		// Variables:
	// 		struct __Event *Ptr; // $v0
	// 		struct __GlyphData *data; // $s1
...
LAB_8007bb18:
        ...
        if (puVar6 != &DAT_80000010) goto LAB_8007bb34;
        bVar1 = true;
        _GlyphSwitchProcess(instance,_GlyphOffProcess);
        sample = 0xf;
        vol = 0x7f;
      ...
      if (puVar6 == (undefined *)0x10000002) {
        ...
        if (iVar4 != 0) {
          ...
          if ((int)((uint)vol << 0x10) < 0) {
            ...
            if (-(int)sVar2 < 0x40) goto LAB_8007b9cc;
          }
          else {
            sVar2 = AngleDiff(*(short *)((int)pvVar7 + 0x96),*(short *)((int)pvVar7 + 0x98));
            if (sVar2 < 0x40) {
...
joined_r0x8007ba5c:
                sample = 0x12;
                if (0x3f < sVar2) goto LAB_8007bb18;
              }
            }
          }
        }
        ...
        if ((int)puVar6 < 0x10000003) {
          ...
          if (puVar6 == (undefined *)0x10000004) {
            ...
            if (iVar4 != 0) {
              ...
              if ((int)((uint)vol << 0x10) < 0) {
                sVar2 = AngleDiff(*(short *)((int)pvVar7 + 0x96),*(short *)((int)pvVar7 + 0x98));
                if (-(int)sVar2 < 0x40) goto LAB_8007b884;
              }
              else {
                sVar2 = AngleDiff(*(short *)((int)pvVar7 + 0x96),*(short *)((int)pvVar7 + 0x98));
                if (sVar2 < 0x40) {
...
// void /*$ra*/ Glyph_StartSpell(struct _Instance *instance /*$a0*/, int glyphnum /*$a1*/)
 // line 739, offset 0x8007bba0
	/* begin block 1 */
		// Start line: 740
		// Start offset: 0x8007BBA0
		// Variables:
	// 		int message; // $a2
	/* end block 1 */
...

{
  ...
  case 1:
    ...
    break;
  case 2:
    Message = &DAT_00080002;
    break;
  case 3:
    Message = &DAT_00080003;
    break;
  case 4:
  ...
  INSTANCE_Post(gameTrackerX.playerInstance,(int)Message,0);
  return;
}
...
// void /*$ra*/ Glyph_Broadcast(struct _Instance *sender /*$s6*/, int glyphnum /*$a1*/)
 // line 776, offset 0x8007bc48
	/* begin block 1 */
		// Start line: 777
		// Start offset: 0x8007BC48
		// Variables:
	...
	// 		int range; // $s5
		...
		// 		long whatAmI; // $s0
		/* end block 1.1 */
		// End offset: 0x8007BE60
		// End Line: 860
	/* end block 1 */
	// End offset: 0x8007BE70
	// End Line: 861
...

{
  ...
  while (Inst != (_Instance *)0x0) {
    ...
    if (((((Inst != sender) && ((uVar2 & uVar9) != 0)) &&
      ...
      iVar7 = MATH3D_veclen2(iVar7 - (sender->position).x,iVar8 - (sender->position).y);
...
// void /*$ra*/ Glyph_DoSpell(struct _Instance *instance /*stack 0*/, int glyphnum /*$s1*/)
 // line 863, offset 0x8007bea0
	/* begin block 1 */
		// Start line: 864
		// Start offset: 0x8007BEA0
		// Variables:
	// 		int fx_radius; // $fp
	// 		int fx_accl; // $v0
	// 		int fx_vel; // $s5
...
// void /*$ra*/ _GlyphGenericProcess(struct _Instance *instance /*$s2*/, int data1 /*$s3*/, int data2 /*$s4*/)
 // line 1006, offset 0x8007c208
	/* begin block 1 */
		// Start line: 1007
		// Start offset: 0x8007C208
		// Variables:
	// 		struct __Event *Ptr; // $v0
	// 		struct __GlyphData *data; // $s1
		...
		/* begin block 1.1 */
			// Start line: 1036
			// Start offset: 0x8007C2E0
			// Variables:
		// 		struct _GlyphTuneData *glyphtunedata; // $s0
		/* end block 1.1 */
		// End offset: 0x8007C318
		// End Line: 1042
	/* end block 1 */
	// End offset: 0x8007C318
	// End Line: 1044
...
LAB_8007c2b8:
        ...
        if (puVar2 != &DAT_00100004) goto LAB_8007c2b8;
      }
    }
...
// void /*$ra*/ HUD_Damp(short *val /*$v1*/, short target /*$a1*/, short *vel /*$a3*/, short max /*$a3*/)
 // line 1086, offset 0x8007c404
	/* begin block 1 */
		// Start line: 1087
		// Start offset: 0x8007C404
		// Variables:
...
// original method signature: 
// void /*$ra*/ HUD_Draw()
 // line 1211, offset 0x8007c6f0
	/* begin block 1 */
		// Start line: 1212
		// Start offset: 0x8007C6F0
		// Variables:
...

{
  ...
  if ((theCamera.instance_mode & 0x80000000) == 0) {
    if (warpDraw == 0) goto LAB_8007c89c;
...
LAB_8007c89c:
  ...
  if (-0x40 < MANNA_Position) {
    ...
    FONT_Print((char *)&PTR_DAT_800d1a98);
  ...
  if (-1000 < HUD_Position) {
    ...
    if ((HUD_Count != 0) || (HUD_Count_Overall < 0xf)) {
      uVar7 = 0;
      ppuVar8 = &PTR_LAB_80011e70;
      bVar1 = true;
      do {
        if (bVar1) {
                    /* WARNING: Could not recover jumptable at 0x8007cb04. Too many branches */
