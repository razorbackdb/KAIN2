...
// void /*$ra*/ _SplineS2Pos(struct vecS *p /*$t6*/, long s /*$t1*/, struct SplineKey *key /*$t2*/, struct SplineKey *key2 /*$t5*/)
 // line 70, offset 0x80041224
	/* begin block 1 */
		// Start line: 71
		// Start offset: 0x80041224
		// Variables:
	// 		long s2; // $a3
	// 		long s3; // $t0
	// 		long h0; // $a2
...
// void /*$ra*/ SplineSetDefDenom(struct Spline *spline /*$a0*/, struct SplineDef *def /*$a1*/, int denomFlag /*$a2*/)
 // line 132, offset 0x80041394
	/* begin block 1 */
		// Start line: 140
		// Start offset: 0x80041394
		// Variables:
	// 		unsigned long denom; // $v1
	/* end block 1 */
	// End offset: 0x80041450
	// End Line: 165
...
// short /*$ra*/ SplineSetDef2FrameNumber(struct Spline *spline /*$a0*/, struct SplineDef *def /*$a1*/, unsigned short frame_number /*$a2*/)
 // line 288, offset 0x800414ec
	/* begin block 1 */
		// Start line: 289
		// Start offset: 0x800414EC
		// Variables:
...
// short /*$ra*/ SplineIsWhere(struct Spline *spline /*$a0*/, struct SplineDef *def /*$a1*/)
 // line 355, offset 0x8004161c
	/* begin block 1 */
		// Start line: 357
		// Start offset: 0x8004161C
		// Variables:
	// 		short curr; // $v1
	/* end block 1 */
	// End offset: 0x8004167C
	// End Line: 367
...
// short /*$ra*/ SplineMultiIsWhere(struct MultiSpline *multi /*$s0*/)
 // line 368, offset 0x80041684
	/* begin block 1 */
		// Start line: 369
		// Start offset: 0x80041684
		// Variables:
	// 		short where; // $v1
	/* end block 1 */
...
// struct _SVector * /*$ra*/ SplineGetNextPoint(struct Spline *spline /*$s0*/, struct SplineDef *def /*$s1*/)
 // line 499, offset 0x80041760
	/* begin block 1 */
		// Start line: 500
		// Start offset: 0x80041760
		// Variables:
	// 		static struct _SVector point; // offset 0x8
	/* end block 1 */
	// End offset: 0x800417A4
	// End Line: 511
...
// struct _SVector * /*$ra*/ SplineGetPreviousPoint(struct Spline *spline /*$s0*/, struct SplineDef *def /*$s1*/)
 // line 513, offset 0x800417b8
	/* begin block 1 */
		// Start line: 514
		// Start offset: 0x800417B8
		// Variables:
	// 		static struct _SVector point; // offset 0x10
	/* end block 1 */
	// End offset: 0x800417FC
	// End Line: 525
...
// struct _SVector * /*$ra*/ SplineGetNearestPoint(struct Spline *spline /*$fp*/, struct _SVector *point /*$s4*/, struct SplineDef *def /*$t1*/)
 // line 539, offset 0x80041810
	/* begin block 1 */
		// Start line: 540
		// Start offset: 0x80041810
		// Variables:
...

{
  ...
  if (0 < iVar13) {
    do {
      ...
      setCopReg(2,uVar7,(int)point->y - (int)DAT_800d392a);
      setCopReg(2,in_t3,(int)point->z - (int)DAT_800d392c);
      copFunction(2,0xa00428);
...
// unsigned long /*$ra*/ SplineGetData(struct Spline *spline /*$s1*/, struct SplineDef *def /*$s0*/, void *p /*$s4*/)
 // line 933, offset 0x80041bcc
	/* begin block 1 */
		// Start line: 934
		// Start offset: 0x80041BCC
		// Variables:
	...
	// 		struct _G2EulerAngles_Type ea; // stack offset -32
		...
		/* begin block 1.1 */
			// Start line: 965
			// Start offset: 0x80041CA0
		/* end block 1.1 */
		// End offset: 0x80041CA0
		// End Line: 966

		/* begin block 1.2 */
			// Start line: 976
			// Start offset: 0x80041CDC
		/* end block 1.2 */
		// End offset: 0x80041CDC
		// End Line: 977

		/* begin block 1.3 */
			// Start line: 990
			// Start offset: 0x80041D58
			// Variables:
		// 		short _x1; // $v1
		// 		short _y1; // $a0
		// 		short _z1; // $v0
...
// unsigned long /*$ra*/ SplineGetQuatData(struct Spline *spline /*$s1*/, struct SplineDef *def /*$s0*/, void *p /*$s3*/)
 // line 1003, offset 0x80041ddc
	/* begin block 1 */
		// Start line: 1004
		// Start offset: 0x80041DDC
		// Variables:
	...
	// 		struct _G2Quat_Type quat; // stack offset -32
		...
		/* begin block 1.1 */
			// Start line: 1023
			// Start offset: 0x80041E74
		/* end block 1.1 */
		// End offset: 0x80041E74
		// End Line: 1024
	/* end block 1 */
	// End offset: 0x80041EF0
	// End Line: 1039
...
// unsigned long /*$ra*/ SplineGetNext(struct Spline *spline /*$s1*/, struct SplineDef *def /*$s0*/)
 // line 1052, offset 0x80041f10
	/* begin block 1 */
		// Start line: 1053
		// Start offset: 0x80041F10
		// Variables:
	// 		unsigned long movedSplineOk; // $s3
	// 		int count; // $s2
	/* end block 1 */
	// End offset: 0x8004200C
	// End Line: 1106
...
// unsigned long /*$ra*/ SplineGetPrev(struct Spline *spline /*$s0*/, struct SplineDef *def /*$s1*/)
 // line 1118, offset 0x8004202c
	/* begin block 1 */
		// Start line: 1119
		// Start offset: 0x8004202C
		// Variables:
	// 		unsigned long movedSplineOk; // $s2
	// 		unsigned long isRot; // $a1
	// 		int count; // $v0
	/* end block 1 */
	// End offset: 0x8004213C
	// End Line: 1184
...

{
  ...
  if (def->currkey < 1) {
    ...
    def->currkey = uVar3;
    if (bVar2) goto LAB_8004211c;
LAB_800420f0:
    sVar1 = (&spline->key->count)[(int)(short)uVar3 * 5];
  }
  else {
    def->currkey = uVar3;
    if (!bVar2) goto LAB_800420f0;
LAB_8004211c:
...
// unsigned long /*$ra*/ SplineGetOffsetNext(struct Spline *spline /*$s2*/, struct SplineDef *def /*$s1*/, long fracOffset /*$s5*/)
 // line 1205, offset 0x80042158
	/* begin block 1 */
		// Start line: 1206
		// Start offset: 0x80042158
		// Variables:
	// 		unsigned long movedSplineOk; // $s3
	// 		unsigned long isRot; // $s4
	// 		int count; // $s0
	/* end block 1 */
	// End offset: 0x80042314
	// End Line: 1271
    ...
    if (iVar5 < spline->numkeys) {
      ...
      do {
        ...
        if ((int)spline->numkeys + -1 < (int)def->currkey) {
          ...
          if ((int)def->currkey <= (int)spline->numkeys + -1) goto LAB_80042294;
        }
        else {
LAB_80042294:
          if (bVar2) {
      ...
      while (iVar4 < 0) {
        ...
        if (def->currkey < 1) {
          if ((*(uint *)&spline->numkeys & 0x6000000) != 0) {
            ...
            def->currkey = uVar3;
            if (bVar2) goto LAB_80042424;
LAB_80042450:
            sVar1 = *(short *)((int)&spline->key->count + ((int)((uint)uVar3 << 0x10) >> 0xb));
            goto code_r0x80042464;
          }
          uVar5 = 0;
          def->currkey = 0;
          def->fracCurr = 0;
...
// struct _SVector * /*$ra*/ SplineGetOffsetNextPoint(struct Spline *spline /*$s0*/, struct SplineDef *def /*$s1*/, long offset /*$a2*/)
 // line 1354, offset 0x800424b0
	/* begin block 1 */
		// Start line: 1355
		// Start offset: 0x800424B0
		// Variables:
	// 		static struct _SVector point; // offset 0x28
	/* end block 1 */
	// End offset: 0x800424F4
	// End Line: 1366
...
// struct _SVector * /*$ra*/ SplineGetOffsetPreviousPoint(struct Spline *spline /*$s0*/, struct SplineDef *def /*$s1*/, long offset /*$a2*/)
 // line 1368, offset 0x80042508
	/* begin block 1 */
		// Start line: 1369
		// Start offset: 0x80042508
		// Variables:
	// 		static struct _SVector point; // offset 0x30
	/* end block 1 */
	// End offset: 0x8004254C
	// End Line: 1380
