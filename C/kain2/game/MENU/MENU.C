...

{
  ...
  DRAW_TranslucentQuad
            (x1 + -0xe,(short)(y + -1 + y3 >> 1),x1,(short)y3,x2,y + -1,(len >> 1) + 0x105,y3,0,0,0,
             0,(_PrimPool *)theCamera.core.vvPlaneConsts[2],
...

{
  ...
  if (iVar4 < 0xf) {
                    /* WARNING: Subroutine does not return */
    DRAW_TranslucentQuad
              ((short)(iVar2 + iVar4),y0_00 - (short)(&DAT_800cf9b4)[iVar4],
               (short)iVar2 + (short)iVar3,y0_00 - (short)(&DAT_800cf9b4)[iVar3],iVar2 + iVar4,
               y2 + (&DAT_800cf9b4)[iVar4],iVar2 + iVar3,y2 + (&DAT_800cf9b4)[iVar3],0,0,0,0,
               (_PrimPool *)theCamera.core.vvPlaneConsts[2],
               (ulong **)(theCamera.posSphere.position._0_4_ + 4));
  }
                    /* WARNING: Subroutine does not return */
  DRAW_TranslucentQuad
...

{
  ...
  pvVar1 = (void *)(*(int *)gt * 0x24 + (int)gt);
  iVar5 = *(int *)((int)pvVar1 + -0x14);
  ypos = 0;
  if (*(code **)((int)gt + 0x380) != (code *)0x0) {
    (**(code **)((int)gt + 0x380))(*(undefined4 *)((int)gt + 900));
  }
  iVar3 = 0;
  if (0 < *(int *)((int)gt + 4)) {
    iVar4 = 0xc0;
    do {
      ppcVar2 = (char **)((int)gt + iVar4);
      if ((iVar3 != 0) || (color = 3, ((uint)ppcVar2[3] & 4) == 0)) {
        color = (uint)(iVar3 != iVar5);
      }
      iVar4 = iVar4 + 0x10;
      iVar3 = iVar3 + 1;
      ypos = menu_draw_item((menu_t *)gt,ypos,0,0,*ppcVar2,color,(long)ppcVar2[3],&local_30);
    } while (iVar3 < *(int *)((int)gt + 4));
  }
  ypos = *(int *)((int)pvVar1 + 8);
  if (ypos != 0) {
...

{
  ...
  if ((-1 < iVar5) && (mVar1 != menu_ctrl_none)) {
    ...
    tim_path = (char *)menu->opaque;
    sound = (*menu->items[iVar5].fn)(tim_path,menu->items[iVar5].parameter,mVar1);
    if (sound == menu_sound_none) {
      if (mVar1 == menu_ctrl_down) {
        ...
        if (mVar1 < menu_ctrl_left) {
          ...
          if (mVar1 == menu_ctrl_cancel) {
            womp_background(tim_path);
            return;
          }
        }
      }
