...
// int /*$ra*/ menu_data_size()
 // line 83, offset 0x800b76f8
	/* begin block 1 */
		// Start line: 85
		// Start offset: 0x800B76F8
	/* end block 1 */
	// End offset: 0x800B76F8
	// End Line: 86
...
// void /*$ra*/ menu_format(struct menu_t *menu /*$a0*/, int center /*$a1*/, int xpos /*$a2*/, int ypos /*$a3*/, int width /*stack 16*/, int lineskip /*stack 20*/, int itemskip /*stack 24*/, int border /*stack 28*/)
 // line 97, offset 0x800b7744
	/* begin block 1 */
		// Start line: 98
		// Start offset: 0x800B7744
...
// void /*$ra*/ menu_push(struct menu_t *menu /*$a0*/, TDRFuncPtr_menu_push1fn fn /*$a1*/)
 // line 123, offset 0x800b77b8
	/* begin block 1 */
		// Start line: 125
		// Start offset: 0x800B77B8
...
// void /*$ra*/ menu_item_flags(struct menu_t *menu /*$s2*/, TDRFuncPtr_menu_item_flags1fn fn /*$a1*/, long parameter /*$a2*/, long flags /*$a3*/, char *format /*stack 16*/)
 // line 152, offset 0x800b783c
	/* begin block 1 */
		// Start line: 153
		// Start offset: 0x800B783C
...
// void /*$ra*/ menu_item(struct menu_t *menu /*$s2*/, TDRFuncPtr_menu_item1fn fn /*$a1*/, long parameter /*$a2*/, char *format /*stack 12*/)
 // line 170, offset 0x800b78cc
	/* begin block 1 */
		// Start line: 171
		// Start offset: 0x800B78CC
		...
		// 		struct menu_item_t *item; // $s1
			...
			/* begin block 1.1.1 */
				// Start line: 181
				// Start offset: 0x800B792C
			/* end block 1.1.1 */
			// End offset: 0x800B792C
			// End Line: 183
		/* end block 1.1 */
		// End offset: 0x800B7958
		// End Line: 192
	/* end block 1 */
	// End offset: 0x800B7958
	// End Line: 193
...
// void /*$ra*/ menu_build(struct menu_t *menu /*$a0*/)
 // line 195, offset 0x800b7970
	/* begin block 1 */
		// Start line: 196
		// Start offset: 0x800B7970
...
// void /*$ra*/ DisplayHintBox(int len /*$a0*/, int y /*$a1*/)
 // line 221, offset 0x800b79c8
	/* begin block 1 */
		// Start line: 222
		// Start offset: 0x800B79C8
		// Variables:
	...
	// 		int i; // $s0
		...
		/* begin block 1.1 */
			// Start line: 239
			// Start offset: 0x800B7A00
		/* end block 1.1 */
		// End offset: 0x800B7A00
		// End Line: 239
	/* end block 1 */
	// End offset: 0x800B7AE4
	// End Line: 255
...
// void /*$ra*/ DisplayMenuBox(int x0 /*$a0*/, int x1 /*$a1*/, int y0 /*$a2*/, int y1 /*$a3*/)
 // line 257, offset 0x800b7af4
	/* begin block 1 */
		// Start line: 258
		// Start offset: 0x800B7AF4
		// Variables:
	...
	// 		struct _PrimPool *primPool; // $s4
		...
		/* begin block 1.1 */
			// Start line: 276
			// Start offset: 0x800B7B8C

			/* begin block 1.1.1 */
				// Start line: 278
				// Start offset: 0x800B7B9C
			/* end block 1.1.1 */
			// End offset: 0x800B7B9C
			// End Line: 278
		/* end block 1.1 */
		// End offset: 0x800B7C94
		// End Line: 290
	/* end block 1 */
	// End offset: 0x800B7CFC
	// End Line: 300
...

{
  ...
  do {
    ...
    while (iVar1 < 0xf) {
      iVar6 = iVar1 + 1;
      piVar2 = &DAT_800d1efc + iVar1;
      piVar5 = &DAT_800d1efc + iVar6;
      DRAW_TranslucentQuad
...
// int /*$ra*/ menu_draw_item(struct menu_t *menu /*$a0*/, int ypos /*stack 4*/, int xadj /*stack 8*/, int yadj /*$a3*/, char *text /*stack 16*/, int color /*stack 20*/, long flags /*stack 24*/, struct Extents2d *e /*stack 28*/)
 // line 311, offset 0x800b7d2c
	/* begin block 1 */
		// Start line: 312
		// Start offset: 0x800B7D2C
		// Variables:
	...
	// 		int xpos; // $s4
		...
		/* begin block 1.1 */
			// Start line: 403
			// Start offset: 0x800B7EF4
			// Variables:
		// 		char *eol; // $s6

			/* begin block 1.1.1 */
				// Start line: 410
				// Start offset: 0x800B7F18
				// Variables:
			// 		char *eop; // $s2
				...
				// 		int wd; // $v0
				/* end block 1.1.1.1 */
				// End offset: 0x800B7F70
				// End Line: 427

				/* begin block 1.1.1.2 */
					// Start line: 434
					// Start offset: 0x800B7F98
				/* end block 1.1.1.2 */
				...
				/* begin block 1.1.1.3 */
					// Start line: 443
					// Start offset: 0x800B7FE0
					// Variables:
				// 		int wd; // $s0
				/* end block 1.1.1.3 */
				// End offset: 0x800B8030
				// End Line: 450
			/* end block 1.1.1 */
			// End offset: 0x800B8044
			// End Line: 453
		/* end block 1.1 */
		// End offset: 0x800B805C
		// End Line: 457
	/* end block 1 */
	// End offset: 0x800B80FC
	// End Line: 478
...
// void /*$ra*/ menu_draw(struct menu_t *menu /*$s2*/)
 // line 481, offset 0x800b8130
	/* begin block 1 */
		// Start line: 482
		// Start offset: 0x800B8130
		...
		// 		int i; // $s0
			...
			/* begin block 1.1.1 */
				// Start line: 496
				// Start offset: 0x800B81D4
				// Variables:
			// 		struct menu_item_t *item; // $v1
			// 		int color; // $t0
			/* end block 1.1.1 */
			// End offset: 0x800B81F8
			// End Line: 504
		/* end block 1.1 */
		// End offset: 0x800B8268
		// End Line: 517
	/* end block 1 */
	// End offset: 0x800B8268
	// End Line: 518
...
// void /*$ra*/ menu_run(struct menu_t *menu /*$s2*/)
 // line 524, offset 0x800b8290
	/* begin block 1 */
		// Start line: 525
		// Start offset: 0x800B8290
		// Variables:
	...
	// 		struct menu_item_t *item; // $s3
		...
		/* begin block 1.1 */
			// Start line: 546
			// Start offset: 0x800B82F8
			// Variables:
		// 		enum menu_sound_t sound; // $v0
		/* end block 1.1 */
		// End offset: 0x800B832C
		// End Line: 559
	/* end block 1 */
	// End offset: 0x800B8460
	// End Line: 588
