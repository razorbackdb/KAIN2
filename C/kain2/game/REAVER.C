...
// void /*$ra*/ SoulReaverInit(struct _Instance *instance /*$s0*/, struct GameTracker *gameTracker /*$a1*/)
 // line 55, offset 0x80079ff0
	/* begin block 1 */
		// Start line: 56
		// Start offset: 0x80079FF0
		// Variables:
	// 		struct __ReaverData *data; // $v1
	/* end block 1 */
	// End offset: 0x8007A078
	// End Line: 109
...
// void /*$ra*/ SoulReaverCollide(struct _Instance *instance /*$s2*/, struct GameTracker *gameTracker /*$a1*/)
 // line 114, offset 0x8007a090
	/* begin block 1 */
		// Start line: 115
		// Start offset: 0x8007A090
		// Variables:
	...
	// 		struct __ReaverData *reaverData; // $v0
		...
		/* begin block 1.2 */
			// Start line: 229
			// Start offset: 0x8007A1C0
			// Variables:
		// 		struct _Instance *inst; // $v1
		/* end block 1.2 */
		// End offset: 0x8007A1C0
		// End Line: 229
	/* end block 1 */
	// End offset: 0x8007A1E4
	// End Line: 236
...
// void /*$ra*/ SoulReaverProcess(struct _Instance *instance /*$a0*/, struct GameTracker *gameTracker /*$a1*/)
 // line 240, offset 0x8007a200
	/* begin block 1 */
		// Start line: 241
		// Start offset: 0x8007A200
		// Variables:
	// 		struct __ReaverData *data; // $v0
	/* end block 1 */
	// End offset: 0x8007A234
	// End Line: 248
...
// void /*$ra*/ CollideReaverProjectile(struct _Instance *instance /*$s2*/, struct GameTracker *gameTracker /*$s4*/)
 // line 256, offset 0x8007a24c
	/* begin block 1 */
		// Start line: 257
		// Start offset: 0x8007A24C
		// Variables:
	...
	// 		long reavType; // $a0
		...
		/* begin block 1.1 */
			// Start line: 279
			// Start offset: 0x8007A2C4
			// Variables:
		// 		struct Level *level; // $v1
		/* end block 1.1 */
		// End offset: 0x8007A2F4
		// End Line: 288

		/* begin block 1.2 */
			// Start line: 342
			// Start offset: 0x8007A358
			// Variables:
		// 		struct _Instance *inst; // $v1
		/* end block 1.2 */
		// End offset: 0x8007A358
		// End Line: 342
	/* end block 1 */
	// End offset: 0x8007A388
	// End Line: 350
...
// unsigned long /*$ra*/ SoulReaverQuery(struct _Instance *instance /*$a0*/, unsigned long query /*$a1*/)
 // line 354, offset 0x8007a3a8
	/* begin block 1 */
		// Start line: 357
		// Start offset: 0x8007A3A8

		/* begin block 1.1 */
			// Start line: 366
			// Start offset: 0x8007A3F0
			// Variables:
		// 		struct __ReaverData *reaverData; // $a0
		// 		unsigned long retval; // $v1
		/* end block 1.1 */
		// End offset: 0x8007A424
		// End Line: 375
	/* end block 1 */
	// End offset: 0x8007A424
	// End Line: 381
...
// void /*$ra*/ SoulReaverCharge(struct _Instance *instance /*$s2*/, struct __ReaverData *data /*$s0*/)
 // line 415, offset 0x8007a4b8
	/* begin block 1 */
		// Start line: 416
		// Start offset: 0x8007A4B8
		// Variables:
	// 		long color; // $v1
	// 		long shock; // $a0
	// 		struct __ReaverTuneData *tuneData; // $s1
	/* end block 1 */
	// End offset: 0x8007A5C4
	// End Line: 461
...
// void /*$ra*/ SoulReaverPost(struct _Instance *instance /*$s1*/, unsigned long message /*$a1*/, unsigned long data /*$s3*/)
 // line 475, offset 0x8007a61c
	/* begin block 1 */
		// Start line: 476
		// Start offset: 0x8007A61C
		// Variables:
	// 		struct __ReaverData *reaverData; // $s0

		/* begin block 1.1 */
			// Start line: 526
			// Start offset: 0x8007A804
			// Variables:
  ...
  if (message < 0x800102) {
    ...
    if (message == 0x800010) {
      ...
      peVar1 = PHYSOB_BirthProjectile
                         (instance->LinkParent,0,(int)*(short *)((int)instance->extraData + 4) + 2);
    ...
    data_00->ReaverOn = '\x01';
    if (data_00->ReaverTargetScale != 0) goto LAB_8007a93c;
  }
  else {
    if (message == 0x800105) {
      StopSoulReaverCharge(data_00,instance);
...
// unsigned long /*$ra*/ REAVER_GetGlowColor(struct _Instance *instance /*$a0*/)
 // line 617, offset 0x8007a978
	/* begin block 1 */
		// Start line: 619
		// Start offset: 0x8007A978
		// Variables:
	// 		struct __ReaverTuneData *tuneData; // $v1
	// 		struct __ReaverData *data; // $v0
	/* end block 1 */
	// End offset: 0x8007A978
	// End Line: 623
...
// void /*$ra*/ _SoulReaverAnimate(struct _Instance *instance /*$s2*/)
 // line 635, offset 0x8007a99c
	/* begin block 1 */
		// Start line: 636
		// Start offset: 0x8007A99C
		// Variables:
	// 		struct __ReaverData *data; // $s0
	// 		struct __ReaverTuneData *tuneData; // $s1
	/* end block 1 */
	// End offset: 0x8007AB34
	// End Line: 687
...

{
  ...
  iVar1 = data->ReaverTargetScale - iVar3;
  if (iVar1 < 0) {
    if (0x80 < iVar3 - data->ReaverTargetScale) {
      iVar3 = (int)data->ReaverScale;
      goto LAB_8007aabc;
    }
  }
    ...
    if (0x80 < iVar1) {
LAB_8007aabc:
      if (data->ReaverTargetScale < iVar3) {
