...
// struct __Event * /*$ra*/ DeMessageQueue(struct __MessageQueue *In /*$a0*/)
 // line 95, offset 0x80070c9c
	/* begin block 1 */
		// Start line: 97
		// Start offset: 0x80070C9C
	/* end block 1 */
	// End offset: 0x80070CD0
	// End Line: 109
...
// void * /*$ra*/ CIRC_Alloc(int size /*$a0*/)
 // line 268, offset 0x80070db4
	/* begin block 1 */
		// Start line: 270
		// Start offset: 0x80070DB4
		// Variables:
	// 		void *ret; // $v1
	/* end block 1 */
	// End offset: 0x80070DF0
	// End Line: 287
...
// int /*$ra*/ SetCollideInfoData(struct _CollideInfo *srcCI /*$s0*/)
 // line 298, offset 0x80070df8
	/* begin block 1 */
		// Start line: 299
		// Start offset: 0x80070DF8
		// Variables:
	// 		struct _CollideInfo *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x80070E44
	// End Line: 305
...
// int /*$ra*/ SetMonsterThrownData(struct _Instance *Sender /*$s1*/, struct _Rotation *Direction /*$s0*/, int Power /*$s2*/)
 // line 332, offset 0x80070ec0
	/* begin block 1 */
		// Start line: 333
		// Start offset: 0x80070EC0
		// Variables:
	// 		struct evMonsterThrownData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x80070EC0
	// End Line: 333
...
// int /*$ra*/ SetMonsterAlarmData(struct _Instance *sender /*$s1*/, struct _Position *position /*$s0*/, int type /*$s2*/)
 // line 348, offset 0x80070f28
	/* begin block 1 */
		// Start line: 349
		// Start offset: 0x80070F28
		// Variables:
	// 		struct evMonsterAlarmData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x80070F28
	// End Line: 349
...
// int /*$ra*/ SetMonsterSoulSuckData(struct _Instance *Sender /*$s0*/, int x /*$s1*/, int y /*$s2*/, int z /*$s3*/)
 // line 365, offset 0x80070f90
	/* begin block 1 */
		// Start line: 366
		// Start offset: 0x80070F90
		// Variables:
	// 		struct evMonsterSoulSuckData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x80070F90
	// End Line: 366
...
// int /*$ra*/ SetMonsterImpaleData(struct _Instance *weapon /*$s2*/, struct _Rotation *direction /*$s0*/, struct _Position *position /*$s1*/, int distance /*$s3*/)
 // line 382, offset 0x80070fec
	/* begin block 1 */
		// Start line: 383
		// Start offset: 0x80070FEC
		// Variables:
	// 		struct evMonsterImpaleData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x80070FEC
	// End Line: 383
...
// int /*$ra*/ SetObjectData(int x /*$s1*/, int y /*$s2*/, int PathNumber /*$s3*/, struct _Instance *Force /*$s4*/, int node /*stack 16*/)
 // line 403, offset 0x80071084
	/* begin block 1 */
		// Start line: 404
		// Start offset: 0x80071084
		// Variables:
	// 		struct evObjectData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x80071084
	// End Line: 404
...
// int /*$ra*/ SetPositionData(int x /*$s0*/, int y /*$s1*/, int z /*$s2*/)
 // line 420, offset 0x800710f0
	/* begin block 1 */
		// Start line: 421
		// Start offset: 0x800710F0
		// Variables:
	// 		struct evPositionData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x800710F0
	// End Line: 421
...
// int /*$ra*/ SetPhysicsGravityData(int UpperOffset /*$s2*/, int LowerOffset /*$s3*/, int x /*$s4*/, int y /*$s5*/, int z /*stack 16*/, int slope /*stack 20*/)
 // line 438, offset 0x8007113c
	/* begin block 1 */
		// Start line: 439
		// Start offset: 0x8007113C
		// Variables:
	// 		struct evPhysicsGravityData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x8007113C
	// End Line: 439
...
// int /*$ra*/ SetPhysicsEdgeData(int UpperOffset /*$s5*/, int ForwardOffset /*$s6*/, int AboveOffset /*$s7*/, int x /*$fp*/, int y /*stack 16*/, int z /*stack 20*/, struct _SVector *Normal1 /*stack 24*/, struct _SVector *Normal2 /*stack 28*/, struct _SVector *Delta /*stack 32*/)
 // line 462, offset 0x800711b8
	/* begin block 1 */
		// Start line: 463
		// Start offset: 0x800711B8
		// Variables:
	// 		struct evPhysicsEdgeData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x800711B8
	// End Line: 463
...
// int /*$ra*/ SetPhysicsSwimData(int CheckDepth /*$s1*/, struct _SVector *iVelocity /*$s2*/, int SwimDepth /*$s3*/, int WadeDepth /*$s4*/, int TreadDepth /*stack 16*/)
 // line 485, offset 0x80071264
	/* begin block 1 */
		// Start line: 486
		// Start offset: 0x80071264
		// Variables:
	// 		struct evPhysicsSwimData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x80071264
	// End Line: 486
...
// int /*$ra*/ SetPhysicsDropOffData(int xOffset /*$s1*/, int yOffset /*$s2*/, int DropOffset /*$s3*/, int slipSlope /*$s4*/, int UpperOffset /*stack 16*/)
 // line 503, offset 0x800712d0
	/* begin block 1 */
		// Start line: 504
		// Start offset: 0x800712D0
		// Variables:
	// 		struct evPhysicsDropOffData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x800712D0
	// End Line: 504
...
// int /*$ra*/ SetPhysicsSlideData(int Segment /*$s3*/, int ForwardVectorX /*$s4*/, int ForwardVectorY /*$s5*/, int ForwardVectorZ /*$s6*/, int DropOffset /*stack 16*/, int UpperOffset /*stack 20*/, int Height /*stack 24*/)
 // line 523, offset 0x8007133c
	/* begin block 1 */
		// Start line: 524
		// Start offset: 0x8007133C
		// Variables:
	// 		struct evPhysicsSlideData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x8007133C
	// End Line: 524
...
// int /*$ra*/ SetPhysicsLinkedMoveData(struct _Instance *instance /*$s1*/, int segment /*$s0*/, struct _SVector *posDelta /*$s2*/, struct _SVector *rotDelta /*$s3*/)
 // line 561, offset 0x80071424
	/* begin block 1 */
		// Start line: 562
		// Start offset: 0x80071424
		// Variables:
	// 		struct evPhysicsLinkedMoveData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x800714A8
	// End Line: 574
...
// int /*$ra*/ SetPhysicsDropHeightData(struct _Position *offset /*$s0*/, int dropOffset /*$s1*/, int mode /*$s2*/)
 // line 582, offset 0x800714c4
	/* begin block 1 */
		// Start line: 583
		// Start offset: 0x800714C4
		// Variables:
	// 		struct evPhysicsDropHeightData *ptr; // $v0
	/* end block 1 */
	// End offset: 0x800714C4
	// End Line: 583
...
// int /*$ra*/ SetAnimationControllerDoneData(struct _Instance *instance /*$s0*/, long segment /*$s1*/, long type /*$s2*/, int data /*$s3*/)
 // line 602, offset 0x80071534
	/* begin block 1 */
		// Start line: 603
		// Start offset: 0x80071534
		// Variables:
	// 		struct evAnimationControllerDoneData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x80071534
	// End Line: 603
...
// int /*$ra*/ SetAnimationInstanceSwitchData(struct _Instance *instance /*$s1*/, int anim /*$s2*/, int frame /*$s3*/, int frames /*$s4*/, int mode /*stack 16*/)
 // line 620, offset 0x80071590
	/* begin block 1 */
		// Start line: 621
		// Start offset: 0x80071590
		// Variables:
	// 		struct evAnimationInstanceSwitchData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x80071590
	// End Line: 621
...
// int /*$ra*/ SetFXHitData(struct _Instance *hitter /*$s2*/, int segment /*$s3*/, int amount /*$s0*/, int type /*$s1*/)
 // line 639, offset 0x800715fc
	/* begin block 1 */
		// Start line: 640
		// Start offset: 0x800715FC
		// Variables:
...
// int /*$ra*/ SetObjectBreakOffData(struct _Instance *force /*$s3*/, short node /*$a1*/, short distance /*$a2*/, short animation /*$a3*/, int frame /*stack 16*/, int type /*stack 20*/, int action /*stack 24*/)
 // line 750, offset 0x80071864
	/* begin block 1 */
		// Start line: 751
		// Start offset: 0x80071864
		// Variables:
	// 		struct evObjectBreakOffData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x80071864
	// End Line: 751
...
// int /*$ra*/ SetControlInitHangData(struct _Instance *instance /*$s0*/, long frame /*$s1*/, long frames /*$s2*/)
 // line 767, offset 0x800718f0
	/* begin block 1 */
		// Start line: 768
		// Start offset: 0x800718F0
		// Variables:
	// 		struct evControlInitHangData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x800718F0
	// End Line: 768
...
// int /*$ra*/ SetControlInitIdleData(int mode /*$s0*/, long frame /*$s1*/, long frames /*$s2*/)
 // line 781, offset 0x8007193c
	/* begin block 1 */
		// Start line: 782
		// Start offset: 0x8007193C
		// Variables:
	// 		struct evControlInitIdleData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x8007193C
	// End Line: 782
...
// int /*$ra*/ SetObjectDraftData(short force /*$a0*/, unsigned short radius /*$a1*/, unsigned short radiusCoef /*$a2*/, unsigned short height /*$a3*/, int maxVelocity /*stack 16*/)
 // line 795, offset 0x80071988
	/* begin block 1 */
		// Start line: 796
		// Start offset: 0x80071988
		// Variables:
...
// int /*$ra*/ SetObjectAbsorbData(struct _Instance *force /*$s0*/, unsigned short node /*$a1*/, unsigned short steps /*$a2*/)
 // line 811, offset 0x800719f4
	/* begin block 1 */
		// Start line: 812
		// Start offset: 0x800719F4
		// Variables:
	// 		struct evObjectAbsorbData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x800719F4
	// End Line: 812
...
// int /*$ra*/ SetControlSaveDataData(long length /*$s0*/, void *data /*$s1*/)
 // line 827, offset 0x80071a40
	/* begin block 1 */
		// Start line: 828
		// Start offset: 0x80071A40
		// Variables:
	// 		struct evControlSaveDataData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x80071A40
	// End Line: 828
...
// int /*$ra*/ SetObjectIdleData(long mode /*$s0*/, struct _Instance *instance /*$s1*/)
 // line 840, offset 0x80071a7c
	/* begin block 1 */
		// Start line: 841
		// Start offset: 0x80071A7C
		// Variables:
...
// int /*$ra*/ SetActionPlayHostAnimationData(struct _Instance *instance /*$s2*/, struct _Instance *host /*$s3*/, int newAnim /*$s4*/, int newFrame /*$s5*/, int frames /*stack 16*/, int mode /*stack 20*/)
 // line 869, offset 0x80071ab8
	/* begin block 1 */
		// Start line: 870
		// Start offset: 0x80071AB8
		// Variables:
	// 		struct evActionPlayHostAnimationData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x80071AB8
	// End Line: 870
...
// int /*$ra*/ SetObjectBirthProjectileData(struct _Instance *instance /*$s0*/, int joint /*$s1*/, int type /*$s2*/)
 // line 888, offset 0x80071b34
	/* begin block 1 */
		// Start line: 889
		// Start offset: 0x80071B34
		// Variables:
	// 		struct evObjectBirthProjectileData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x80071B34
	// End Line: 889
...
// int /*$ra*/ SetShadowSegmentData(unsigned long total /*$s0*/)
 // line 907, offset 0x80071b84
	/* begin block 1 */
		// Start line: 908
		// Start offset: 0x80071B84
		// Variables:
	// 		struct evShadowSegmentData *Ptr; // $v0
	/* end block 1 */
	// End offset: 0x80071B84
	// End Line: 908
...

{
  ...
  if (PTR_800d1a54 == (_G2AnimAlphaTable_Type *)0x0) {
    PTR_800d1a54 = (_G2AnimAlphaTable_Type *)MEMPACK_Malloc(0x12,'\x19');
    PTR_800d1a54->size = 4;
    PTR_800d1a54[1] = (_G2AnimAlphaTable_Type)0x0;
    PTR_800d1a54[2] = (_G2AnimAlphaTable_Type)0x100;
    PTR_800d1a54[3] = (_G2AnimAlphaTable_Type)0x400;
    PTR_800d1a54[4] = (_G2AnimAlphaTable_Type)0x1000;
  }
  if (PTR_800d1a58 == (_G2AnimAlphaTable_Type *)0x0) {
    PTR_800d1a58 = (_G2AnimAlphaTable_Type *)MEMPACK_Malloc(0x12,'\x19');
    PTR_800d1a58->size = 4;
    PTR_800d1a58[1] = (_G2AnimAlphaTable_Type)0x0;
    PTR_800d1a58[2] = (_G2AnimAlphaTable_Type)0xc00;
    PTR_800d1a58[3] = (_G2AnimAlphaTable_Type)0xf00;
    PTR_800d1a58[4] = (_G2AnimAlphaTable_Type)0x1000;
  }
  if (PTR_800d1a5c == (_G2AnimAlphaTable_Type *)0x0) {
    PTR_800d1a5c = (_G2AnimAlphaTable_Type *)MEMPACK_Malloc(6,'\x19');
    PTR_800d1a5c->size = 1;
    PTR_800d1a5c[1] = (_G2AnimAlphaTable_Type)0x1000;
  }
  if (PTR_800d1a60 == (_G2AnimAlphaTable_Type *)0x0) {
    PTR_800d1a60 = (_G2AnimAlphaTable_Type *)MEMPACK_Malloc(0x12,'\x19');
    PTR_800d1a60->size = 4;
    PTR_800d1a60[1] = (_G2AnimAlphaTable_Type)0x0;
    PTR_800d1a60[2] = (_G2AnimAlphaTable_Type)0x100;
    PTR_800d1a60[3] = (_G2AnimAlphaTable_Type)0xf00;
    PTR_800d1a60[4] = (_G2AnimAlphaTable_Type)0x1000;
  }
  if (PTR_800d1a64 == (_G2AnimAlphaTable_Type *)0x0) {
    PTR_800d1a64 = (_G2AnimAlphaTable_Type *)MEMPACK_Malloc(0x12,'\x19');
    PTR_800d1a64->size = 4;
    PTR_800d1a64[1] = (_G2AnimAlphaTable_Type)0x0;
    PTR_800d1a64[2] = (_G2AnimAlphaTable_Type)0x80;
    PTR_800d1a64[3] = (_G2AnimAlphaTable_Type)0x200;
    PTR_800d1a64[4] = (_G2AnimAlphaTable_Type)0x1000;
  }
  if (PTR_800d1a68 == (_G2AnimAlphaTable_Type *)0x0) {
    PTR_800d1a68 = (_G2AnimAlphaTable_Type *)MEMPACK_Malloc(0x12,'\x19');
    PTR_800d1a68->size = 4;
    PTR_800d1a68[1] = (_G2AnimAlphaTable_Type)0x0;
    PTR_800d1a68[2] = (_G2AnimAlphaTable_Type)0xe00;
    PTR_800d1a68[3] = (_G2AnimAlphaTable_Type)0xf80;
    PTR_800d1a68[4] = (_G2AnimAlphaTable_Type)0x1000;
  }
  return;
}
...
// void /*$ra*/ G2EmulationInstancePlayAnimation(struct _Instance *instance /*$a0*/)
 // line 978, offset 0x80071d9c
	/* begin block 1 */
		// Start line: 979
		// Start offset: 0x80071D9C
		// Variables:
	// 		int i; // $s0
...
// void /*$ra*/ G2EmulationInstanceSwitchAnimation(struct _Instance *instance /*$a0*/, int CurrentSection /*$a1*/, int NewAnim /*$s2*/, int NewFrame /*$s3*/, int Frames /*stack 16*/, int Mode /*stack 20*/)
 // line 1032, offset 0x80071f20
	/* begin block 1 */
		// Start line: 1033
		// Start offset: 0x80071F20
		// Variables:
	// 		struct _G2AnimSection_Type *animSection; // $s4
	// 		struct _G2AnimKeylist_Type *keylist; // $s1
	/* end block 1 */
	// End offset: 0x80071FF0
	// End Line: 1054
...
// void /*$ra*/ G2EmulationInstanceSwitchAnimationAlpha(struct _Instance *instance /*$a0*/, int CurrentSection /*$a1*/, int NewAnim /*$a2*/, int NewFrame /*$a3*/, int Frames /*stack 16*/, int Mode /*stack 20*/, int AlphaTable /*stack 24*/)
 // line 1057, offset 0x80072014
	/* begin block 1 */
		// Start line: 1058
		// Start offset: 0x80072014
		// Variables:
	// 		struct _G2AnimSection_Type *animSection; // $s1
	/* end block 1 */
	// End offset: 0x80072014
	// End Line: 1058
...
// void /*$ra*/ G2EmulationSwitchAnimationAlpha(struct __CharacterState *In /*$a0*/, int CurrentSection /*$a1*/, int NewAnim /*$a2*/, int NewFrame /*$a3*/, int Frames /*stack 16*/, int Mode /*stack 20*/, int AlphaTable /*stack 24*/)
 // line 1081, offset 0x800720c4
	/* begin block 1 */
		// Start line: 1082
		// Start offset: 0x800720C4
		// Variables:
	// 		struct _G2AnimSection_Type *animSection; // $s1
	/* end block 1 */
	// End offset: 0x800720C4
	// End Line: 1082
...
// void /*$ra*/ G2EmulationSwitchAnimationSync(struct __CharacterState *In /*stack 0*/, int SlaveSectionID /*$fp*/, int MasterSectionID /*$a2*/, int Frames /*stack 12*/)
 // line 1093, offset 0x80072138
	/* begin block 1 */
		// Start line: 1094
		// Start offset: 0x80072138
		// Variables:
...
// void /*$ra*/ G2EmulationInstanceToInstanceSwitchAnimationCharacter(struct _Instance *instance /*$s0*/, struct _Instance *host /*$a1*/, int NewAnim /*$s2*/, int NewFrame /*$s3*/, int Frames /*stack 16*/, int Mode /*stack 20*/)
 // line 1137, offset 0x80072304
	/* begin block 1 */
		// Start line: 1138
		// Start offset: 0x80072304
		// Variables:
	// 		struct _G2AnimKeylist_Type *keylist1; // $s0
	/* end block 1 */
	// End offset: 0x800723CC
	// End Line: 1160
...
// void /*$ra*/ G2EmulationSwitchAnimationCharacter(struct __CharacterState *In /*$a0*/, int NewAnim /*$s2*/, int NewFrame /*$s5*/, int Frames /*$s3*/, int Mode /*stack 16*/)
 // line 1164, offset 0x800723f0
	/* begin block 1 */
		// Start line: 1165
		// Start offset: 0x800723F0
		// Variables:
	// 		struct _Instance *instance; // $s0
	// 		struct _G2AnimKeylist_Type *keylist; // $s0
	/* end block 1 */
	// End offset: 0x800724C0
	// End Line: 1192
...
// void /*$ra*/ G2EmulationInstanceSetAnimation(struct _Instance *instance /*$a0*/, int CurrentSection /*$a1*/, int NewAnim /*$s3*/, int NewFrame /*$s4*/, int Frames /*stack 16*/)
 // line 1203, offset 0x800724e4
	/* begin block 1 */
		// Start line: 1204
		// Start offset: 0x800724E4
		// Variables:
	// 		struct _G2AnimSection_Type *animSection; // $s2
	// 		struct _G2AnimKeylist_Type *keylist; // $s1
	/* end block 1 */
	// End offset: 0x800724E4
	// End Line: 1204
...
// void /*$ra*/ G2EmulationInstanceSetMode(struct _Instance *instance /*$a0*/, int CurrentSection /*$a1*/, int Mode /*$s1*/)
 // line 1232, offset 0x800725c4
	/* begin block 1 */
		// Start line: 1233
		// Start offset: 0x800725C4
		// Variables:
	// 		struct _G2AnimSection_Type *animSection; // $s0
	/* end block 1 */
	// End offset: 0x80072630
	// End Line: 1249
...
// int /*$ra*/ G2EmulationInstanceQueryAnimation(struct _Instance *instance /*$a0*/, int CurrentSection /*$a1*/)
 // line 1272, offset 0x80072684
	/* begin block 1 */
		// Start line: 1275
		// Start offset: 0x80072684
		// Variables:
	// 		struct _G2AnimSection_Type *animSection; // $v0
	/* end block 1 */
	// End offset: 0x80072684
	// End Line: 1277
...
// int /*$ra*/ G2EmulationInstanceQueryFrame(struct _Instance *instance /*$a0*/, int CurrentSection /*$a1*/)
 // line 1291, offset 0x800726c8
	/* begin block 1 */
		// Start line: 1292
		// Start offset: 0x800726C8
	/* end block 1 */
	// End offset: 0x800726C8
	// End Line: 1292
...
// int /*$ra*/ G2EmulationInstanceQueryLastFrame(struct _Instance *instance /*$a0*/, int CurrentSection /*$a1*/)
 // line 1303, offset 0x800726fc
	/* begin block 1 */
		// Start line: 1304
		// Start offset: 0x800726FC
	/* end block 1 */
	// End offset: 0x800726FC
	// End Line: 1304
...
// int /*$ra*/ G2EmulationInstanceQueryPassedFrame(struct _Instance *instance /*$s2*/, int CurrentSection /*$a1*/, int frame /*$s1*/)
 // line 1314, offset 0x80072730
	/* begin block 1 */
		// Start line: 1315
		// Start offset: 0x80072730
		// Variables:
	// 		struct _G2AnimSection_Type *animSection; // $s0
	/* end block 1 */
	// End offset: 0x800727C0
	// End Line: 1329
...
// int /*$ra*/ G2EmulationInstanceQueryMode(struct _Instance *instance /*$a0*/, int CurrentSection /*$a1*/)
 // line 1341, offset 0x800727fc
	/* begin block 1 */
		// Start line: 1344
		// Start offset: 0x800727FC
		// Variables:
	// 		struct _G2AnimSection_Type *animSection; // $v0
	/* end block 1 */
	// End offset: 0x8007283C
	// End Line: 1356
...
// void /*$ra*/ G2EmulationInstanceSetStartAndEndSegment(struct _Instance *instance /*$a0*/, int CurrentSection /*$a1*/, short Start /*$a2*/, short End /*$a3*/)
 // line 1368, offset 0x80072868
	/* begin block 1 */
		// Start line: 1371
		// Start offset: 0x80072868
		// Variables:
	// 		struct _G2AnimSection_Type *animSection; // $a0
	/* end block 1 */
	// End offset: 0x80072868
	// End Line: 1373
...
// void /*$ra*/ G2EmulationInstanceSetTotalSections(struct _Instance *instance /*$s2*/, short Total /*$a1*/)
 // line 1387, offset 0x800728c4
	/* begin block 1 */
		// Start line: 1388
		// Start offset: 0x800728C4
		// Variables:
	// 		struct _G2Anim_Type *anim; // $s0
	/* end block 1 */
	// End offset: 0x8007291C
	// End Line: 1397
...
// void /*$ra*/ G2EmulationInstanceInitSection(struct _Instance *instance /*$a0*/, int CurrentSection /*$a1*/, void *callback /*$a2*/, void *data /*$a3*/)
 // line 1414, offset 0x80072978
	/* begin block 1 */
		// Start line: 1417
		// Start offset: 0x80072978
		// Variables:
	// 		struct _G2AnimSection_Type *animSection; // $a0
	/* end block 1 */
	// End offset: 0x80072978
	// End Line: 1419
...
// void /*$ra*/ StateSwitchStateDataDefault(struct __CharacterState *In /*$s1*/, int CurrentSection /*$s0*/, TDRFuncPtr_StateSwitchStateDataDefault2NewProcess NewProcess /*$a2*/, int Data /*$a3*/)
 // line 1456, offset 0x80072a24
	/* begin block 1 */
		// Start line: 1457
		// Start offset: 0x80072A24
		// Variables:
	// 		void (*process)(); // $s2
	/* end block 1 */
	// End offset: 0x80072A24
	// End Line: 1457
...
// void /*$ra*/ StateSwitchStateCharacterDataDefault(struct __CharacterState *In /*$s1*/, TDRFuncPtr_StateSwitchStateCharacterDataDefault1NewProcess NewProcess /*$s2*/, int Data /*$s3*/)
 // line 1465, offset 0x80072a8c
	/* begin block 1 */
		// Start line: 1466
		// Start offset: 0x80072A8C
		// Variables:
	// 		int i; // $s0
	/* end block 1 */
	// End offset: 0x80072AE8
	// End Line: 1474
...
// void /*$ra*/ StateSwitchStateCharacterData(struct __CharacterState *In /*$s3*/, TDRFuncPtr_StateSwitchStateCharacterData1NewProcess NewProcess /*$s5*/, int Data /*$s6*/)
 // line 1492, offset 0x80072bd0
	/* begin block 1 */
		// Start line: 1493
		// Start offset: 0x80072BD0
		// Variables:
	// 		int i; // $s1
	/* end block 1 */
	// End offset: 0x80072C9C
	// End Line: 1509
...

{
  ...
  if (0 < In->TotalSections) {
    ...
    p_Var2 = In;
    do {
      In_00 = (__MessageQueue *)((int)&In->TotalSections + iVar3);
      PurgeMessageQueue(In_00);
      EnMessageQueueData(In_00,(int)&DAT_00100004,0);
      iVar3 = iVar3 + 0x11c;
      (*p_Var2->SectionList[0].Process)(In,iVar1,0);
      PurgeMessageQueue(In_00);
      EnMessageQueueData(In_00,(int)&DAT_00100001,Data);
      *(TDRFuncPtr_StateSwitchStateCharacterData1NewProcess *)&p_Var2->SectionList[0].Process =
           NewProcess;
      (*NewProcess)(In,iVar1,0);
      iVar1 = iVar1 + 1;
      p_Var2 = (__CharacterState *)&p_Var2->SectionList[0].Data1;
    } while (iVar1 < In->TotalSections);
  }
  return;
}
